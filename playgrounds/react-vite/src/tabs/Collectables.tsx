...
import { FilterProvider, useMarketplace } from 'shared-components';
import Filters from 'shared-components/src/components/filter/Filters';
...
export function Collectibles() {
	...
	return (
		<FilterProvider chainId={chainId} collectionAddress={collectionAddress}>
