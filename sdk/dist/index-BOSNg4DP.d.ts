import {
	...
	GetCountOfPrimarySaleItemsReturn,
...
import {
	...
	UseInventoryArgs,
	UseListBalancesArgs,
} from './index-DD06c5io.js';
import { MarketCollectibleCardProps } from './CollectibleCard-D_pZac8f.js';
import * as react420 from 'react';
import * as _tanstack_react_query27 from '@tanstack/react-query';
import { skipToken } from '@tanstack/react-query';
import * as _0xsequence_indexer26 from '@0xsequence/indexer';
import {
	GetTokenBalancesDetailsReturn,
	GetTokenIDRangesReturn,
} from '@0xsequence/indexer';
import * as _0xsequence_metadata30 from '@0xsequence/metadata';
import { PropertyFilter as PropertyFilter$1 } from '@0xsequence/metadata';
import * as react_jsx_runtime421 from 'react/jsx-runtime';
import * as viem60 from 'viem';
import { Address } from 'viem';
import * as nuqs61 from 'nuqs';
 ...
 * ```
 */
declare function useBalanceOfCollectible(
	args: UseBalanceOfCollectibleArgs,
): _tanstack_react_query27.UseQueryResult<
	_0xsequence_indexer26.TokenBalance,
	Error
>;
//#endregion
...
interface FetchCheckoutOptionsSalesContractParams
 ...
 */
declare function fetchCheckoutOptionsSalesContract(
...
): _tanstack_react_query27.OmitKeyof<
	_tanstack_react_query27.UseQueryOptions<
		CheckoutOptionsSalesContractReturn,
		Error,
		CheckoutOptionsSalesContractReturn,
		(string | CheckoutOptionsSalesContractQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
		| _tanstack_react_query27.QueryFunction<
				CheckoutOptionsSalesContractReturn,
				(string | CheckoutOptionsSalesContractQueryOptions)[],
				never
		  >
...
type UseCheckoutOptionsSalesContractParams = Optional<
 ...
 * ```
 */
declare function useCheckoutOptionsSalesContract(
...
type UseCheckoutOptionsSalesContractReturn = Awaited<
...
declare function useCollectible(
	params: UseCollectibleParams,
): _tanstack_react_query27.UseQueryResult<
	_0xsequence_metadata30.TokenMetadata,
	Error
>;
//#endregion
...
declare function collectionQueryOptions(
	params: CollectionQueryOptions,
): _tanstack_react_query27.OmitKeyof<
	_tanstack_react_query27.UseQueryOptions<
		_0xsequence_metadata30.ContractInfo,
		Error,
		_0xsequence_metadata30.ContractInfo,
		('collections' | 'detail' | CollectionQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
	...
	queryKey: ('collections' | 'detail' | CollectionQueryOptions)[] & {
		[dataTagSymbol]: _0xsequence_metadata30.ContractInfo;
		[dataTagErrorSymbol]: Error;
	};
};
//#endregion
 ...
 */
declare function fetchCollectionBalanceDetails(
...
declare function collectionBalanceDetailsQueryOptions(
	...
	_tanstack_react_query27.UseQueryOptions<
		...
		Error,
		GetTokenBalancesDetailsReturn,
		(string | CollectionBalanceDetailsQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
...
type UseCollectionBalanceDetailsParams = Optional<
 ...
 * ```
 */
declare function useCollectionBalanceDetails(
	params: UseCollectionBalanceDetailsParams,
): _tanstack_react_query27.UseQueryResult<
	_0xsequence_indexer26.GetTokenBalancesDetailsReturn,
	Error
>;
 ...
 * ```
 */
declare function useCollectionDetails(
	params: UseCollectionDetailsParams,
): _tanstack_react_query27.UseQueryResult<Collection, Error>;
//#endregion
...
declare const collectionDetailsPollingOptions: (
	...
	_tanstack_react_query27.UseQueryOptions<
		...
		Error,
		Collection,
		('collections' | 'detail' | CollectionDetailsQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
...
declare const useCollectionDetailsPolling: (
	args: UseCollectionDetailsPolling,
) => _tanstack_react_query27.UseQueryResult<Collection, Error>;
//#endregion
...
declare function comparePricesQueryOptions(
	params: ComparePricesQueryOptions,
): _tanstack_react_query27.OmitKeyof<
	_tanstack_react_query27.UseQueryOptions<
		ComparePricesReturn$1,
		Error,
		ComparePricesReturn$1,
		(string | ComparePricesQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
 ...
 * ```
 */
declare function useComparePrices(
	params: UseComparePricesParams,
): _tanstack_react_query27.UseQueryResult<ComparePricesReturn$1, Error>;
...
declare function convertPriceToUSDQueryOptions(
	...
	_tanstack_react_query27.UseQueryOptions<
		...
		Error,
		ConvertPriceToUSDReturn,
		(string | ConvertPriceToUSDQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
...
type UseConvertPriceToUSDParams = Optional<
 ...
 * ```
 */
declare function useConvertPriceToUSD(
	params: UseConvertPriceToUSDParams,
): _tanstack_react_query27.UseQueryResult<ConvertPriceToUSDReturn, Error>;
...
declare function countListingsForCollectibleQueryOptions(
...
type UseCountListingsForCollectibleParams = Optional<
	CountListingsForCollectibleQueryOptions,
	'config'
>;
/**
 ...
 * ```
 */
declare function useCountListingsForCollectible(
	params: UseCountListingsForCollectibleParams,
): _tanstack_react_query27.UseQueryResult<number, Error>;
//#endregion
...
declare function countOfCollectablesQueryOptions(
	...
	_tanstack_react_query27.UseQueryOptions<
		...
		Error,
		number,
		('collectable' | 'counts' | CountOfCollectablesQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
...
type UseCountOfCollectablesParams = Optional<
 ...
 * ```
 */
declare function useCountOfCollectables(
	params: UseCountOfCollectablesParams,
): _tanstack_react_query27.UseQueryResult<number, Error>;
//#endregion
...
declare function countOffersForCollectibleQueryOptions(
	...
	_tanstack_react_query27.UseQueryOptions<
		...
		Error,
		number,
		('collectable' | 'offersCount' | CountOffersForCollectibleQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
...
type UseCountOffersForCollectibleParams = Optional<
	CountOffersForCollectibleQueryOptions,
	'config'
>;
/**
...
): _tanstack_react_query27.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useERC721SaleMintedTokens({
	...
	isLoading: boolean;
	error: viem60.ReadContractErrorType | null;
	saleDetails:
		| {
				supplyCap: bigint;
				cost: bigint;
...
declare function useFilterState(): {
	...
	setFilterOptions: (
		value:
			| PropertyFilter[]
			| ((old: PropertyFilter[]) => PropertyFilter[] | null)
			| null,
		options?: nuqs61.Options,
...
declare function filtersQueryOptions(
	params: FiltersQueryOptions,
): _tanstack_react_query27.OmitKeyof<
	_tanstack_react_query27.UseQueryOptions<
		PropertyFilter$1[],
		Error,
		PropertyFilter$1[],
		(string | FiltersQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
...
declare function useFilters(
	params: UseFiltersParams,
): _tanstack_react_query27.UseQueryResult<PropertyFilter$1[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams):
	| {
			...
			isStale: boolean;
			refetch: (
				options?: _tanstack_react_query27.RefetchOptions,
			) => Promise<
				_tanstack_react_query27.QueryObserverResult<PropertyFilter$1[], Error>
			>;
			fetchStatus: _tanstack_react_query27.FetchStatus;
 ...
 * ```
 */
declare function useFloorOrder(
	params: UseFloorOrderParams,
): _tanstack_react_query27.UseQueryResult<CollectibleOrder, Error>;
//#endregion
...
declare const generateCancelTransaction: (
	args: GenerateCancelTransactionArgsWithNumberChainId,
	config: SdkConfig,
) => Promise<Step[]>;
declare const useGenerateCancelTransaction: (
	params: UseGenerateCancelTransactionArgs,
) =>
	| {
			generateCancelTransaction: _tanstack_react_query27.UseMutateFunction<
				Step[],
				Error,
				GenerateCancelTransactionArgsWithNumberChainId,
				unknown
			>;
			generateCancelTransactionAsync: _tanstack_react_query27.UseMutateAsyncFunction<
				Step[],
				Error,
				GenerateCancelTransactionArgsWithNumberChainId,
				unknown
...
type GenerateListingTransactionProps = Omit<
	GenerateListingTransactionArgs,
	'listing'
> & {
...
declare const generateListingTransaction: (
	params: GenerateListingTransactionArgsWithNumberChainId,
	config: SdkConfig,
) => Promise<Step[]>;
declare const useGenerateListingTransaction: (
	params: UseGenerateListingTransactionArgs,
) =>
	| {
			generateListingTransaction: _tanstack_react_query27.UseMutateFunction<
				Step[],
				Error,
				Omit<GenerateListingTransactionArgsWithNumberChainId, 'chainId'>,
				unknown
			>;
			generateListingTransactionAsync: _tanstack_react_query27.UseMutateAsyncFunction<
				Step[],
				Error,
				Omit<GenerateListingTransactionArgsWithNumberChainId, 'chainId'>,
				unknown
...
type GenerateOfferTransactionProps = Omit<
	GenerateOfferTransactionArgs,
	'offer'
> & {
...
declare const generateOfferTransaction: (
	params: GenerateOfferTransactionArgsWithNumberChainId,
	config: SdkConfig,
	walletKind?: WalletKind,
) => Promise<Step[]>;
declare const useGenerateOfferTransaction: (
	params: UseGenerateOfferTransactionArgs,
) =>
	| {
			generateOfferTransaction: _tanstack_react_query27.UseMutateFunction<
				Step[],
				Error,
				Omit<GenerateOfferTransactionArgsWithNumberChainId, 'chainId'>,
				unknown
			>;
			generateOfferTransactionAsync: _tanstack_react_query27.UseMutateAsyncFunction<
				Step[],
				Error,
				Omit<GenerateOfferTransactionArgsWithNumberChainId, 'chainId'>,
				unknown
...
declare const generateSellTransaction: (
	args: GenerateSellTransactionArgsWithNumberChainId,
	config: SdkConfig,
) => Promise<Step[]>;
declare const useGenerateSellTransaction: (
	params: UseGenerateSellTransactionArgs,
) =>
	| {
			generateSellTransaction: _tanstack_react_query27.UseMutateFunction<
				Step[],
				Error,
				Omit<GenerateSellTransactionArgsWithNumberChainId, 'chainId'>,
				unknown
			>;
			generateSellTransactionAsync: _tanstack_react_query27.UseMutateAsyncFunction<
				Step[],
				Error,
				Omit<GenerateSellTransactionArgsWithNumberChainId, 'chainId'>,
				unknown
 ...
 * ```
 */
declare function useGetCountOfPrimarySaleItems(
 ...
 */
declare function fetchGetTokenRanges(
...
declare function getTokenRangesQueryOptions(
	params: GetTokenRangesQueryOptions,
): _tanstack_react_query27.OmitKeyof<
	_tanstack_react_query27.UseQueryOptions<
		GetTokenIDRangesReturn,
		Error,
		GetTokenIDRangesReturn,
		(string | GetTokenRangesQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
...
declare function useGetTokenRanges(
	params: UseGetTokenRangesParams,
): _tanstack_react_query27.UseQueryResult<
	_0xsequence_indexer26.GetTokenIDRangesReturn,
	Error
>;
 ...
 * ```
 */
declare function useHighestOffer(
	params: UseHighestOfferParams,
): _tanstack_react_query27.UseQueryResult<Order | null, Error>;
//#endregion
//#region src/react/provider.d.ts
declare const MarketplaceSdkContext$1: react420.Context<MarketplaceSdkContext>;
...
declare function MarketplaceProvider({
	...
	children,
	openConnectModal,
}: MarketplaceSdkProviderProps): react_jsx_runtime421.JSX.Element;
declare function MarketplaceQueryClientProvider({
	children,
}: {
	children: React.ReactNode;
}): react_jsx_runtime421.JSX.Element;
//#endregion
//#region src/react/hooks/useInventory.d.ts
declare function useInventory(
	args: UseInventoryArgs,
): _tanstack_react_query27.UseInfiniteQueryResult<
	_tanstack_react_query27.InfiniteData<CollectiblesResponse, unknown>,
	Error
>;
//#endregion
...
declare function useList721ShopCardData({
	...
	saleDetailsError: viem60.ReadContractErrorType | null;
	...
	saleDetails:
		...
		| undefined;
	primarySaleItems:
		| _tanstack_react_query27.InfiniteData<ListPrimarySaleItemsReturn, unknown>
		| undefined;
	isLoading: boolean;
};
//#endregion
 ...
 * ```
 */
declare function useListBalances(
	args: UseListBalancesArgs,
): _tanstack_react_query27.UseInfiniteQueryResult<
	_tanstack_react_query27.InfiniteData<
		_0xsequence_indexer26.GetTokenBalancesReturn,
		unknown
	>,
	Error
>;
...
interface FetchListCollectibleActivitiesParams
	extends Omit<
		ListCollectibleActivitiesArgs,
 ...
 */
declare function fetchListCollectibleActivities(
...
type UseListCollectibleActivitiesParams = Optional<
	ListCollectibleActivitiesQueryOptions,
	'config'
>;
/**
 ...
 * ```
 */
declare function useListCollectibleActivities(
 ...
 * ```
 */
declare function useListCollectibles(
	params: UseListCollectiblesParams,
): _tanstack_react_query27.UseInfiniteQueryResult<
	_tanstack_react_query27.InfiniteData<ListCollectiblesReturn, unknown>,
	Error
>;
type UseListCollectiblesArgs = UseListCollectiblesParams;
//#endregion
//#region src/react/queries/listCollectiblesPaginated.d.ts
interface FetchListCollectiblesPaginatedParams
 ...
 */
declare function fetchListCollectiblesPaginated(
...
declare function listCollectiblesPaginatedQueryOptions(
	...
	_tanstack_react_query27.UseQueryOptions<
		...
		Error,
		ListCollectiblesReturn,
		(string | ListCollectiblesPaginatedQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
...
type UseListCollectiblesPaginatedParams = Optional<
 ...
 */
declare function fetchListCollectionActivities(
...
type UseListCollectionActivitiesParams = Optional<
	ListCollectionActivitiesQueryOptions,
	'config'
>;
/**
 ...
 * ```
 */
declare function useListCollectionActivities(
 ...
 * ```
 */
declare function useListCollections(
	params?: UseListCollectionsParams,
): _tanstack_react_query27.UseQueryResult<
	(
		| {
				chainId: number;
				...
				deployed: boolean;
				bytecodeHash: string;
				extensions: _0xsequence_metadata30.ContractInfoExtensions;
				updatedAt: string;
				queuedAt?: string;
				status: _0xsequence_metadata30.ResourceStatus;
...
interface FetchListListingsForCollectibleParams
	extends Omit<
		ListCollectibleListingsArgs,
 ...
 */
declare function fetchListListingsForCollectible(
...
declare function listListingsForCollectibleQueryOptions(
	...
	_tanstack_react_query27.UseQueryOptions<
		...
		Error,
		ListCollectibleListingsReturn,
		('collectable' | 'listings' | ListListingsForCollectibleQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
...
type UseListListingsForCollectibleParams = Optional<
	ListListingsForCollectibleQueryOptions,
	'config'
>;
/**
 ...
 * ```
 */
declare function useListListingsForCollectible(
	params: UseListListingsForCollectibleParams,
): _tanstack_react_query27.UseQueryResult<ListCollectibleListingsReturn, Error>;
type UseListListingsForCollectibleArgs = UseListListingsForCollectibleParams;
type UseListListingsForCollectibleReturn = Awaited<
...
declare function useListMarketCardData({
	...
	fetchNextPage: (
		options?: _tanstack_react_query27.FetchNextPageOptions,
	) => Promise<
		_tanstack_react_query27.InfiniteQueryObserverResult<
			_tanstack_react_query27.InfiniteData<ListCollectiblesReturn, unknown>,
			Error
		>
	>;
...
type UseListOffersForCollectibleReturn = Awaited<
	ReturnType<typeof fetchListOffersForCollectible>
>;
declare const fetchListOffersForCollectible: (
	config: SdkConfig,
	args: UseListOffersForCollectibleArgs,
) => Promise<ListCollectibleOffersReturn>;
declare const listOffersForCollectibleOptions: (
	args: UseListOffersForCollectibleArgs,
	config: SdkConfig,
) => _tanstack_react_query27.OmitKeyof<
	_tanstack_react_query27.UseQueryOptions<
		...
		Error,
		ListCollectibleOffersReturn,
		(SdkConfig | 'collectable' | UseListOffersForCollectibleArgs | 'offers')[]
	>,
	'queryFn'
> & {
	queryFn?:
...
declare const useListOffersForCollectible: (
	args: UseListOffersForCollectibleArgs,
) => _tanstack_react_query27.UseQueryResult<ListCollectibleOffersReturn, Error>;
//#endregion
//#region src/react/hooks/useListPrimarySaleItems.d.ts
type UseListPrimarySaleItemsParams = Optional<
 ...
 * ```
 */
declare function useListPrimarySaleItems(
	params: UseListPrimarySaleItemsParams,
): _tanstack_react_query27.UseInfiniteQueryResult<
	_tanstack_react_query27.InfiniteData<ListPrimarySaleItemsReturn, unknown>,
	Error
>;
...
type UseListTokenMetadataParams = Optional<
	ListTokenMetadataQueryOptions,
	'config'
>;
/**
 ...
 * ```
 */
declare function useListTokenMetadata(
	params: UseListTokenMetadataParams,
): _tanstack_react_query27.UseQueryResult<
	_0xsequence_metadata30.TokenMetadata[],
	Error
>;
 ...
 * ```
 */
declare function useLowestListing(
	params: UseLowestListingParams,
): _tanstack_react_query27.UseQueryResult<Order | null | undefined, Error>;
//#endregion
//#region src/react/hooks/useMarketCurrencies.d.ts
type UseMarketCurrenciesParams = Optional<
	MarketCurrenciesQueryOptions,
	'config'
>;
/**
 ...
 * ```
 */
declare function useMarketCurrencies(
	params: UseMarketCurrenciesParams,
): _tanstack_react_query27.UseQueryResult<
	{
		contractAddress: string;
		chainId: number;
...
declare const useMarketplaceConfig: () => _tanstack_react_query27.UseQueryResult<
	MarketplaceConfig,
	Error
>;
//#endregion
...
declare function useRoyalty(args: UseRoyaltyArgs):
	| {
			...
			error: viem60.ReadContractErrorType;
			isError: true;
			isPending: false;
			isLoading: false;
			isLoadingError: false;
			...
			errorUpdatedAt: number;
			failureCount: number;
			failureReason: viem60.ReadContractErrorType | null;
			errorUpdateCount: number;
			isFetched: boolean;
			isFetchedAfterMount: boolean;
			isFetching: boolean;
			...
			refetch: (
				...
				_tanstack_react_query27.QueryObserverResult<
					readonly [`0x${string}`, bigint],
					viem60.ReadContractErrorType
				>
			>;
			fetchStatus: _tanstack_react_query27.FetchStatus;
			promise: Promise<readonly [`0x${string}`, bigint]>;
			queryKey: _tanstack_react_query27.QueryKey;
	  }
	| {
			data: {
				percentage: bigint;
 ...
 * ```
 */
declare function useTokenSupplies(
	params: UseTokenSuppliesParams,
): _tanstack_react_query27.UseQueryResult<
	_0xsequence_indexer26.GetTokenSuppliesReturn,
	Error
>;
//#endregion
...
export {
	...
	CountOfCollectablesQueryOptions,
	CountOffersForCollectibleQueryOptions,
	CreateReqWithDateExpiry$1 as CreateReqWithDateExpiry,
	...
	MarketplaceSdkContext$1 as MarketplaceSdkContext,
...
//# sourceMappingURL=index-BOSNg4DP.d.ts.map
