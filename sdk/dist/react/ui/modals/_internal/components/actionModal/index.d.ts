...
import * as _xstate_store3 from "@xstate/store";
...
declare const ActionModal: ({
  ...
  hideCtas
}: ActionModalProps) => react_jsx_runtime7.JSX.Element | null;
//#endregion
...
declare const actionModalStore: _xstate_store3.Store<ActionModalState, _xstate_store3.ExtractEvents<{
  open: {
    chainId: number;
