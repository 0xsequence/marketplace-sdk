...
import * as _xstate_store34 from "@xstate/store";
...
declare const ActionModal: ({
  ...
  hideCtas
}: ActionModalProps) => react_jsx_runtime33.JSX.Element | null;
//#endregion
...
declare const actionModalStore: _xstate_store34.Store<ActionModalState, _xstate_store34.ExtractEvents<{
  open: {
    chainId: number;
