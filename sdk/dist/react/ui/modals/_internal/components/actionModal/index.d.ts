...
import * as _xstate_store196 from "@xstate/store";
...
declare const ActionModal: ({
  ...
  hideCtas
}: ActionModalProps) => react_jsx_runtime195.JSX.Element | null;
//#endregion
...
declare const actionModalStore: _xstate_store196.Store<ActionModalState, _xstate_store196.ExtractEvents<{
  open: {
    chainId: number;
