...
import * as _xstate_store58 from "@xstate/store";
...
declare const ActionModal: ({
  ...
  hideCtas
}: ActionModalProps) => react_jsx_runtime49.JSX.Element | null;
//#endregion
...
declare const actionModalStore: _xstate_store58.Store<ActionModalState, _xstate_store58.ExtractEvents<{
  open: {
    chainId: number;
