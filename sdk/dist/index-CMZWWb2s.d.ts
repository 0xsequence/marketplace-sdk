...
declare class CollectableKeys {
	...
	static highestOffers: readonly [
		'collectable',
		'collectable',
		'details',
		'highestOffers',
	];
	static lowestListings: readonly [
		'collectable',
		'collectable',
		'details',
		'lowestListings',
	...
	static collectibleActivities: readonly [
		'collectable',
...
declare class BalanceQueries {
	...
	static collectionBalanceDetails: readonly [
		'balances',
...
declare const getIndexerClient: (
	chain: ChainNameOrId,
	config: SdkConfig,
) => SequenceIndexer;
