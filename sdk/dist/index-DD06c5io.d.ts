...
import * as _0xsequence_indexer224 from '@0xsequence/indexer';
import {
	ContractInfo,
	GetTokenBalancesReturn,
	GetTokenSuppliesArgs,
	Page as Page$1,
} from '@0xsequence/indexer';
import * as _0xsequence_metadata232 from '@0xsequence/metadata';
 ...
 */
declare function fetchBalanceOfCollectible(
	args: Omit<UseBalanceOfCollectibleArgs, 'userAddress'> & {
		userAddress: Address;
	},
	config: SdkConfig,
): Promise<_0xsequence_indexer224.TokenBalance>;
/**
 ...
 */
declare function balanceOfCollectibleOptions(
	args: UseBalanceOfCollectibleArgs,
	config: SdkConfig,
): _tanstack_react_query227.UseQueryOptions<
	_0xsequence_indexer224.TokenBalance,
	Error,
	_0xsequence_indexer224.TokenBalance,
	('collectable' | UseBalanceOfCollectibleArgs | 'details' | 'userBalances')[]
> & {
	initialData?:
		| _0xsequence_indexer224.TokenBalance
		| _tanstack_react_query227.InitialDataFunction<_0xsequence_indexer224.TokenBalance>
		| undefined;
} & {
	queryKey: (
		| 'collectable'
		...
		[dataTagSymbol]: _0xsequence_indexer224.TokenBalance;
 ...
 */
interface StandardInfiniteQueryOptions<TError = Error>
 ...
 */
declare function fetchCollectible(
	params: FetchCollectibleParams,
): Promise<_0xsequence_metadata232.TokenMetadata>;
type CollectibleQueryOptions = ValuesOptional<FetchCollectibleParams> & {
	query?: StandardQueryOptions;
};
declare function collectibleQueryOptions(
	params: CollectibleQueryOptions,
): _tanstack_react_query227.OmitKeyof<
	_tanstack_react_query227.UseQueryOptions<
		_0xsequence_metadata232.TokenMetadata,
		Error,
		_0xsequence_metadata232.TokenMetadata,
		('collectable' | 'details' | CollectibleQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
		| _tanstack_react_query227.QueryFunction<
				_0xsequence_metadata232.TokenMetadata,
				('collectable' | 'details' | CollectibleQueryOptions)[],
				never
		  >
	...
	queryKey: ('collectable' | 'details' | CollectibleQueryOptions)[] & {
		[dataTagSymbol]: _0xsequence_metadata232.TokenMetadata;
		[dataTagErrorSymbol]: Error;
	};
};
//#endregion
//#region src/react/queries/collectionDetails.d.ts
interface FetchCollectionDetailsParams
 ...
 */
declare function fetchCollectionDetails(
...
declare function collectionDetailsQueryOptions(
...
interface UseCountOfPrimarySaleItemsArgs
	extends Omit<
		GetCountOfPrimarySaleItemsArgs,
...
declare function fetchCountOfPrimarySaleItems(
	args: UseCountOfPrimarySaleItemsArgs,
	config: SdkConfig,
): Promise<number>;
declare function countOfPrimarySaleItemsOptions(
	args: UseCountOfPrimarySaleItemsArgs,
	config: SdkConfig,
): _tanstack_react_query227.OmitKeyof<
	_tanstack_react_query227.UseQueryOptions<
		...
		Error,
		number,
		(string | UseCountOfPrimarySaleItemsArgs)[]
	>,
	'queryFn'
> & {
	queryFn?:
 ...
 */
declare function fetchCurrency(
	params: FetchCurrencyParams,
): Promise<Currency | undefined>;
type CurrencyQueryOptions = ValuesOptional<FetchCurrencyParams> & {
	query?: StandardQueryOptions;
};
declare function currencyQueryOptions(
	params: CurrencyQueryOptions,
): _tanstack_react_query227.UseQueryOptions<
	Currency | undefined,
	Error,
	Currency | undefined,
	('details' | 'currencies' | CurrencyQueryOptions)[]
> & {
	initialData?:
		| Currency
		| _tanstack_react_query227.InitialDataFunction<Currency>
		| undefined;
} & {
...
interface FetchFloorOrderParams
 ...
 */
declare function fetchFloorOrder(
	params: FetchFloorOrderParams,
): Promise<CollectibleOrder>;
type FloorOrderQueryOptions = ValuesOptional<FetchFloorOrderParams> & {
	query?: StandardQueryOptions;
};
declare function floorOrderQueryOptions(
	params: FloorOrderQueryOptions,
): _tanstack_react_query227.OmitKeyof<
	_tanstack_react_query227.UseQueryOptions<
		CollectibleOrder,
		Error,
		CollectibleOrder,
		('collectable' | 'floorOrders' | FloorOrderQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
 ...
 */
declare function fetchHighestOffer(
	params: FetchHighestOfferParams,
): Promise<Order | null>;
...
declare function highestOfferQueryOptions(
	...
	_tanstack_react_query227.UseQueryOptions<
		...
		Error,
		Order | null,
		('collectable' | 'details' | 'highestOffers' | HighestOfferQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
...
declare function fetchInventory(
	args: GetInventoryArgs,
	config: SdkConfig,
	page: Page,
): Promise<CollectiblesResponse>;
declare function inventoryOptions(
	args: UseInventoryArgs,
	config: SdkConfig,
): _tanstack_react_query227.OmitKeyof<
	_tanstack_react_query227.UseInfiniteQueryOptions<
		CollectiblesResponse,
		Error,
		_tanstack_react_query227.InfiniteData<CollectiblesResponse, unknown>,
		(string | number)[],
		Page
	>,
	'queryFn'
> & {
	...
	queryKey: (string | number)[] & {
		[dataTagSymbol]: _tanstack_react_query227.InfiniteData<
			CollectiblesResponse,
			unknown
		>;
		[dataTagErrorSymbol]: Error;
...
declare function fetchBalances(
...
declare function listBalancesOptions(
	...
	_tanstack_react_query227.UseInfiniteQueryOptions<
		GetTokenBalancesReturn,
		Error,
		_tanstack_react_query227.InfiniteData<GetTokenBalancesReturn, unknown>,
		(SdkConfig | 'balances' | UseListBalancesArgs | 'tokenBalances')[],
		any
	>,
	'queryFn'
> & {
...
interface FetchListCollectiblesParams
 ...
 */
declare function fetchListCollectibles(
...
declare function listCollectiblesQueryOptions(
	params: ListCollectiblesQueryOptions,
): _tanstack_react_query227.OmitKeyof<
	_tanstack_react_query227.UseInfiniteQueryOptions<
		ListCollectiblesReturn,
		Error,
		_tanstack_react_query227.InfiniteData<ListCollectiblesReturn, unknown>,
		('collectable' | 'list' | ListCollectiblesQueryOptions)[],
		Page
	>,
	'queryFn'
> & {
 ...
 */
declare function fetchListCollections(
	params: FetchListCollectionsParams,
): Promise<
	(
		| {
				chainId: number;
				...
				deployed: boolean;
				bytecodeHash: string;
				extensions: _0xsequence_metadata232.ContractInfoExtensions;
				updatedAt: string;
				queuedAt?: string;
				status: _0xsequence_metadata232.ResourceStatus;
				marketplaceType: MarketplaceType;
...
declare function listCollectionsQueryOptions(
...
> & {
	initialData?:
		...
		| _tanstack_react_query227.InitialDataFunction<
				(
					| {
							chainId: number;
							address: string;
 ...
 */
declare function fetchListTokenMetadata(
...
declare function listTokenMetadataQueryOptions(
	...
	_tanstack_react_query227.UseQueryOptions<
		...
		Error,
		_0xsequence_metadata232.TokenMetadata[],
		('tokens' | 'metadata' | ListTokenMetadataQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
...
interface FetchLowestListingParams
 ...
 */
declare function fetchLowestListing(
...
declare function lowestListingQueryOptions(
	...
	_tanstack_react_query227.UseQueryOptions<
		...
		Error,
		Order | null | undefined,
		('collectable' | 'details' | 'lowestListings' | LowestListingQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
 ...
 */
declare function fetchMarketCurrencies(
...
declare function marketCurrenciesQueryOptions(
	...
	_tanstack_react_query227.UseQueryOptions<
		...
		('currencies' | 'list' | MarketCurrenciesQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
...
interface FetchTokenSuppliesParams
 ...
 */
declare function fetchTokenSupplies(
	params: FetchTokenSuppliesParams,
): Promise<_0xsequence_indexer224.GetTokenSuppliesReturn>;
type TokenSuppliesQueryOptions = ValuesOptional<FetchTokenSuppliesParams> & {
	query?: StandardQueryOptions;
};
declare function tokenSuppliesQueryOptions(
	params: TokenSuppliesQueryOptions,
): _tanstack_react_query227.OmitKeyof<
	_tanstack_react_query227.UseQueryOptions<
		_0xsequence_indexer224.GetTokenSuppliesReturn,
		Error,
		_0xsequence_indexer224.GetTokenSuppliesReturn,
		('tokens' | 'supplies' | TokenSuppliesQueryOptions)[]
	>,
	'queryFn'
> & {
	queryFn?:
	...
	queryKey: ('tokens' | 'supplies' | TokenSuppliesQueryOptions)[] & {
		[dataTagSymbol]: _0xsequence_indexer224.GetTokenSuppliesReturn;
		[dataTagErrorSymbol]: Error;
	};
};
//#endregion
...
//# sourceMappingURL=index-DD06c5io.d.ts.map
