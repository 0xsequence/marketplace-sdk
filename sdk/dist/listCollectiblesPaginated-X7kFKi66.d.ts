import { CollectiblesFilter, ListCollectibleActivitiesArgs, ListCollectibleActivitiesReturn, ListCollectiblesArgs, ListCollectiblesReturn, MarketplaceConfig, MarketplaceType, OrderSide, Page, SdkConfig, SortBy, ValuesOptional } from "./create-config-tyvmEx4z.js";
...
import * as _0xsequence_indexer206 from "@0xsequence/indexer";
import * as _0xsequence_metadata220 from "@0xsequence/metadata";
...
declare function fetchBalanceOfCollectible(args: Omit<UseBalanceOfCollectibleArgs, 'userAddress'> & {
  userAddress: Address;
}, config: SdkConfig): Promise<_0xsequence_indexer206.TokenBalance>;
/**
 ...
 */
declare function balanceOfCollectibleOptions(args: UseBalanceOfCollectibleArgs, config: SdkConfig): _tanstack_react_query209.UseQueryOptions<_0xsequence_indexer206.TokenBalance, Error, _0xsequence_indexer206.TokenBalance, ("details" | "collectable" | UseBalanceOfCollectibleArgs | "userBalances")[]> & {
  initialData?: _0xsequence_indexer206.TokenBalance | _tanstack_react_query209.InitialDataFunction<_0xsequence_indexer206.TokenBalance> | undefined;
} & {
  queryKey: ("details" | "collectable" | UseBalanceOfCollectibleArgs | "userBalances")[] & {
    [dataTagSymbol]: _0xsequence_indexer206.TokenBalance;
 ...
 */
declare function fetchCollectible(params: FetchCollectibleParams): Promise<_0xsequence_metadata220.TokenMetadata>;
type CollectibleQueryOptions = ValuesOptional<FetchCollectibleParams> & {
  query?: StandardQueryOptions;
};
declare function collectibleQueryOptions(params: CollectibleQueryOptions): _tanstack_react_query209.OmitKeyof<_tanstack_react_query209.UseQueryOptions<_0xsequence_metadata220.TokenMetadata, Error, _0xsequence_metadata220.TokenMetadata, ("details" | "collectable" | CollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query209.QueryFunction<_0xsequence_metadata220.TokenMetadata, ("details" | "collectable" | CollectibleQueryOptions)[], never> | undefined;
} & {
  queryKey: ("details" | "collectable" | CollectibleQueryOptions)[] & {
    [dataTagSymbol]: _0xsequence_metadata220.TokenMetadata;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function countOfCollectablesQueryOptions(params: CountOfCollectablesQueryOptions): _tanstack_react_query209.OmitKeyof<_tanstack_react_query209.UseQueryOptions<number, Error, number, ("collectable" | "counts" | CountOfCollectablesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query209.QueryFunction<number, ("collectable" | "counts" | CountOfCollectablesQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectiblesQueryOptions(params: ListCollectiblesQueryOptions): _tanstack_react_query209.OmitKeyof<_tanstack_react_query209.UseInfiniteQueryOptions<ListCollectiblesReturn, Error, _tanstack_react_query209.InfiniteData<ListCollectiblesReturn, unknown>, ("collectable" | "list" | ListCollectiblesQueryOptions)[], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query209.QueryFunction<ListCollectiblesReturn, ("collectable" | "list" | ListCollectiblesQueryOptions)[], Page> | undefined;
} & {
  queryKey: ("collectable" | "list" | ListCollectiblesQueryOptions)[] & {
    [dataTagSymbol]: _tanstack_react_query209.InfiniteData<ListCollectiblesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listCollectiblesPaginatedQueryOptions(params: ListCollectiblesPaginatedQueryOptions): _tanstack_react_query209.OmitKeyof<_tanstack_react_query209.UseQueryOptions<ListCollectiblesReturn, Error, ListCollectiblesReturn, (string | ListCollectiblesPaginatedQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query209.QueryFunction<ListCollectiblesReturn, (string | ListCollectiblesPaginatedQueryOptions)[], never> | undefined;
} & {
...
//# sourceMappingURL=listCollectiblesPaginated-X7kFKi66.d.ts.map