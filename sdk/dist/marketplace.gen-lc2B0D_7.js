...
const WebrpcHeaderValue =
	'webrpc@v0.25.4;gen-typescript@v0.17.0;marketplace-api@v0.0.0-cf3a5fae407a732cd5a90e4fd68184ac5591b2c1';
const WebRPCVersion = 'v1';
const WebRPCSchemaVersion = '';
const WebRPCSchemaHash = 'cf3a5fae407a732cd5a90e4fd68184ac5591b2c1';
...
const SortOrder = /* @__PURE__ */ ((SortOrder$1) => {
	SortOrder$1['ASC'] = 'ASC';
	SortOrder$1['DESC'] = 'DESC';
	return SortOrder$1;
})({});
const PropertyType = /* @__PURE__ */ ((PropertyType$1) => {
...
const MarketplaceKind = /* @__PURE__ */ ((MarketplaceKind$1) => {
...
const OrderbookKind = /* @__PURE__ */ ((OrderbookKind$1) => {
...
const SourceKind = /* @__PURE__ */ ((SourceKind$1) => {
...
const ContractType = /* @__PURE__ */ ((ContractType$1) => {
	ContractType$1['UNKNOWN'] = 'UNKNOWN';
	ContractType$1['ERC20'] = 'ERC20';
	ContractType$1['ERC721'] = 'ERC721';
	ContractType$1['ERC1155'] = 'ERC1155';
	ContractType$1['LAOS_ERC_721'] = 'LAOS-ERC-721';
	return ContractType$1;
})({});
const CollectionPriority = /* @__PURE__ */ ((CollectionPriority$1) => {
...
const CollectionStatus = /* @__PURE__ */ ((CollectionStatus$1) => {
...
const CollectibleStatus = /* @__PURE__ */ ((CollectibleStatus$1) => {
...
const CollectibleSource = /* @__PURE__ */ ((CollectibleSource$1) => {
...
const CurrencyStatus = /* @__PURE__ */ ((CurrencyStatus$1) => {
...
const WalletKind = /* @__PURE__ */ ((WalletKind$1) => {
	WalletKind$1['unknown'] = 'unknown';
	WalletKind$1['sequence'] = 'sequence';
	return WalletKind$1;
})({});
const StepType = /* @__PURE__ */ ((StepType$1) => {
...
const TransactionCrypto = /* @__PURE__ */ ((TransactionCrypto$1) => {
...
const TransactionNFTCheckoutProvider = /* @__PURE__ */ ((
	TransactionNFTCheckoutProvider$1,
) => {
...
const TransactionOnRampProvider = /* @__PURE__ */ ((
	TransactionOnRampProvider$1,
) => {
...
const PrimarySaleContractStatus = /* @__PURE__ */ ((
	PrimarySaleContractStatus$1,
) => {
...
const PrimarySaleItemDetailType = /* @__PURE__ */ ((
	PrimarySaleItemDetailType$1,
) => {
...
const errors = /* @__PURE__ */ ((errors$1) => {
...
const WebrpcErrorCodes = /* @__PURE__ */ ((WebrpcErrorCodes$1) => {
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['WebrpcEndpoint'] = 0)] =
		'WebrpcEndpoint';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['WebrpcRequestFailed'] = -1)] =
		'WebrpcRequestFailed';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['WebrpcBadRoute'] = -2)] =
		'WebrpcBadRoute';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['WebrpcBadMethod'] = -3)] =
		'WebrpcBadMethod';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['WebrpcBadRequest'] = -4)] =
		'WebrpcBadRequest';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['WebrpcBadResponse'] = -5)] =
		'WebrpcBadResponse';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['WebrpcServerPanic'] = -6)] =
		'WebrpcServerPanic';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['WebrpcInternalError'] = -7)] =
		'WebrpcInternalError';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['WebrpcClientDisconnected'] = -8)] =
		'WebrpcClientDisconnected';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['WebrpcStreamLost'] = -9)] =
		'WebrpcStreamLost';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['WebrpcStreamFinished'] = -10)] =
		'WebrpcStreamFinished';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['Unauthorized'] = 1e3)] =
		'Unauthorized';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['PermissionDenied'] = 1001)] =
		'PermissionDenied';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['SessionExpired'] = 1002)] =
		'SessionExpired';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['MethodNotFound'] = 1003)] =
		'MethodNotFound';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['Timeout'] = 2e3)] = 'Timeout';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['InvalidArgument'] = 2001)] =
		'InvalidArgument';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['NotFound'] = 3e3)] = 'NotFound';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['UserNotFound'] = 3001)] =
		'UserNotFound';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['ProjectNotFound'] = 3002)] =
		'ProjectNotFound';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['InvalidTier'] = 3003)] =
		'InvalidTier';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['ProjectLimitReached'] = 3005)] =
		'ProjectLimitReached';
	WebrpcErrorCodes$1[(WebrpcErrorCodes$1['NotImplemented'] = 9999)] =
		'NotImplemented';
...
//# sourceMappingURL=marketplace.gen-lc2B0D_7.js.map
