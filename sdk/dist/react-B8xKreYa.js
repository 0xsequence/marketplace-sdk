...
import { TransactionType } from './_internal-DslqcNC1.js';
...
} from './api-BwkAXGhb.js';
import {
	BellIcon_default,
	CalendarIcon_default,
	CartIcon_default,
} from './CalendarIcon-C6SCLjqS.js';
...
import {
	...
	StepType,
	WalletKind,
} from './marketplace.gen-lc2B0D_7.js';
import { SequenceMarketplaceV1_ABI } from './marketplace-B5Z8G03R.js';
import { getNetwork } from './network-CuCj_F5Q.js';
import { ERC721_SALE_ABI } from './primary-sale-utk1jDRd.js';
import { DEFAULT_MARKETPLACE_FEE_PERCENTAGE } from './src-Dz2CfBL0.js';
import { InvalidContractTypeError } from './transaction-B7pHesqY.js';
...
const initialState$1 = {
	...
	expiry: new Date(addDays(/* @__PURE__ */ new Date(), 7).toJSON()),
				...
				/* @__PURE__ */ jsxs('div', {
					...
					children: [
						...
						/* @__PURE__ */ jsxs(Text, {
							...
							color: 'text50',
							fontWeight: 'semibold',
							children: ['(in ', option.token.symbol, ')'],
						}),
						/* @__PURE__ */ jsx(Text, {
							className: 'font-body text-sm',
							color: 'text100',
							...
							: /* @__PURE__ */ jsxs('div', {
									...
									children: [
										...
										/* @__PURE__ */ jsx(Skeleton, {
											className: 'h-[20px] w-6 animate-shimmer',
										}),
									],
								})
						: /* @__PURE__ */ jsxs('div', {
...
const useSelectWaasFeeOptionsStore = () => {
	...
	return {
		...
		setPendingFeeOptionConfirmation: (confirmation) =>
			selectWaasFeeOptionsStore.send({
...
//#endregion
//#region src/react/hooks/useCurrencyBalance.tsx
/**
...
function useCurrencyBalance(args) {
	...
	const formattedData =
		balance !== void 0 && decimals !== void 0
			? {
					value: balance,
	...
	useEffect(() => {
		if (!selectedFeeOption && storedPendingFeeOptionConfirmation) {
			if (storedPendingFeeOptionConfirmation.options.length > 0)
				setSelectedFeeOption(storedPendingFeeOptionConfirmation.options[0]);
		}
	}, [
	...
	return /* @__PURE__ */ jsxs('div', {
		...
		children: [
			...
			!feeOptionsConfirmed &&
				!pendingFeeOptionConfirmation &&
				/* @__PURE__ */ jsx(Skeleton, {
					className: 'h-[52px] w-full animate-shimmer rounded-xl',
				}),
			...
			/* @__PURE__ */ jsxs('div', {
				...
				children: [
					!feeOptionsConfirmed &&
						...
						/* @__PURE__ */ jsx(Skeleton, {
							className: 'h-[20px] w-2/3 animate-shimmer rounded-xl',
						}),
					(feeOptionsConfirmed ||
						(pendingFeeOptionConfirmation && !currencyBalanceLoading)) &&
						/* @__PURE__ */ jsx(BalanceIndicator_default, {
							insufficientBalance,
							currencyBalance,
							selectedFeeOption,
						}),
...
const TokenQuantityInput = ({
	...
	if (balanceAmount !== void 0 && modalState.quantity)
		try {
	...
	return /* @__PURE__ */ jsxs('div', {
		...
		children: [
			/* @__PURE__ */ jsx(QuantityInput, {
				...
				className:
					'[&>label>div>div>div>input]:text-sm [&>label>div>div>div]:h-13 [&>label>div>div>div]:rounded-xl [&>label>div>div>span]:text-sm [&>label>div>div>span]:text-text-80 [&>label]:gap-1',
			}),
			/* @__PURE__ */ jsx(Text, {
...
const WalletAddressInput = () => {
	...
	return /* @__PURE__ */ jsxs('div', {
		className:
			'[&>label>div>span]:text-sm [&>label>div>span]:text-text-80 [&>label]:gap-1',
		children: [
...
function TransactionFooter({
	...
	const icon =
		((isConfirmed || orderId) && /* @__PURE__ */ jsx(PositiveCircle, {})) ||
		(isConfirming && /* @__PURE__ */ jsx(Spinner, { size: 'md' }));
	const title =
...
const PositiveCircle = () =>
	/* @__PURE__ */ jsx('div', {
		className:
			'flex h-5 w-5 items-center justify-center rounded-full bg-[#35a554]',
...
const useTransactionModalState = () =>
		...
		children: [
			/* @__PURE__ */ jsxs('div', {
				...
				children: [
					...
					isConfirming &&
						/* @__PURE__ */ jsx(TimeAgo, { date: /* @__PURE__ */ new Date() }),
				],
			}),
			/* @__PURE__ */ jsxs('div', {
						...
						/* @__PURE__ */ jsxs('div', {
							...
							children: [
								...
								/* @__PURE__ */ jsxs(Text, {
									...
									color: 'text100',
									fontWeight: 'bold',
									children: [priceFormatted, ' ', price?.currency.symbol],
								}),
							],
						}),
				],
...
function TransactionStatusModalContent() {
	...
	const transactionStatus = useTransactionStatus_default(
		hash,
		chainId,
		callbacks,
	);
...
const EnterWalletAddressView = () => {
	...
	let insufficientBalance = true;
	if (balanceAmount !== void 0 && quantity)
		try {
		...
		children: [
			...
			/* @__PURE__ */ jsxs('div', {
				...
				children: [
					...
					showQuantityInput &&
						/* @__PURE__ */ jsx(TokenQuantityInput_default, {
			...
			!shouldHideTransferButton &&
				/* @__PURE__ */ jsx(TransferButton_default, {
...
const TransactionModalView = () => {
	...
	switch (view) {
		case 'enterReceiverAddress':
			return /* @__PURE__ */ jsx(enterWalletAddress_default, {});
...
const TransferModal = () => {
	...
	return /* @__PURE__ */ jsxs(Modal, {
		...
		children: [
			...
			waasFeeOptionsShown &&
				/* @__PURE__ */ jsx(selectWaasFeeOptions_default, {
...
function ActionButton({
	...
	if (isOwnerAction || prioritizeOwnerActions)
		return /* @__PURE__ */ jsx(OwnerActions, {
			action,
			tokenId,
			collectionAddress,
			chainId,
...
const ModelViewerComponent = lazy(() =>
	import('@google/model-viewer').then(() => ({
		default: ({ posterSrc, src, onLoad, onError }) =>
			/* @__PURE__ */ jsx('div', {
...
const isImage = (fileName) => {
	const isImage$1 = /.*\.(png|jpg|jpeg|gif|svg|webp)$/.test(
...
function MarketplaceCollectibleCardSkeleton() {
	return /* @__PURE__ */ jsxs('div', {
		...
		className:
			'w-card-width overflow-hidden rounded-xl border border-border-base focus-visible:border-border-focus focus-visible:shadow-none focus-visible:outline-focus active:border-border-focus active:shadow-none',
		children: [
			/* @__PURE__ */ jsx('div', {
				className:
					'relative aspect-square overflow-hidden bg-background-secondary',
...
function BaseCard({
	...
	if (isLoading)
		return /* @__PURE__ */ jsx(MarketplaceCollectibleCardSkeleton, {});
	return /* @__PURE__ */ jsx('div', {
		'data-testid': 'collectible-card',
		className:
			'w-card-width min-w-card-min-width overflow-hidden rounded-xl border border-border-base bg-background-primary focus-visible:border-border-focus focus-visible:shadow-focus-ring focus-visible:outline-focus active:border-border-focus active:shadow-active-ring',
		onClick,
		onKeyDown,
		...
		children: /* @__PURE__ */ jsx('div', {
			className:
				'group relative z-10 flex h-full w-full cursor-pointer flex-col items-start overflow-hidden rounded-xl border-none bg-none p-0 focus:outline-none [&:focus]:rounded-[10px] [&:focus]:outline-[3px] [&:focus]:outline-black [&:focus]:outline-offset-[-3px]',
		...
		return /* @__PURE__ */ jsxs('div', {
			...
			children: [
				/* @__PURE__ */ jsx(ChevronLeftIcon, {
					className: 'h-3 w-3 text-text-100',
				}),
				/* @__PURE__ */ jsx(Text, {
...
const Footer = ({
	...
	return /* @__PURE__ */ jsxs('div', {
		...
		children: [
				...
				children: [
					/* @__PURE__ */ jsx(Text, {
						className: cn$1(
							...
							isShop &&
								(quantityInitial === void 0 || quantityRemaining === void 0) &&
								'text-text-50',
						),
					...
					highestOffer &&
						...
						/* @__PURE__ */ jsx(IconButton, {
							className:
								'absolute top-0 right-0 h-[22px] w-[22px] hover:animate-bell-ring',
							size: 'xs',
							variant: 'primary',
							onClick: (e) => {
								onOfferClick?.(e);
			...
			isShop &&
				!salePriceAmount &&
				/* @__PURE__ */ jsx('div', { className: 'h-5 w-full' }),
			isMarketplace &&
	...
	return /* @__PURE__ */ jsxs(BaseCard, {
		...
		children: [
			/* @__PURE__ */ jsx(Footer, {
				...
				quantityInitial:
					highestOffer?.quantityInitial !== void 0
						? highestOffer.quantityInitial
						: collectible?.listing?.quantityInitial !== void 0
							? collectible.listing.quantityInitial
							: void 0,
				quantityRemaining:
					highestOffer?.quantityRemaining !== void 0
						? highestOffer.quantityRemaining
						: collectible?.listing?.quantityRemaining !== void 0
...
function ShopCard({
	...
	const showActionButton =
		...
		collectionType === ContractType.ERC1155 &&
		(unlimitedSupply ||
			(quantityRemaining !== void 0 && Number(quantityRemaining) > 0));
	...
	return /* @__PURE__ */ jsxs(BaseCard, {
		...
		children: [
			...
			/* @__PURE__ */ jsx(ActionButtonWrapper, {
				...
				quantityDecimals,
				quantityRemaining:
					quantityRemaining !== void 0 ? Number(quantityRemaining) : void 0,
				unlimitedSupply,
			}),
		],
	});
...
function CollectibleCard(props) {
	switch (props.marketplaceType) {
		case 'shop':
			return /* @__PURE__ */ jsx(ShopCard, { ...props });
		case 'market':
		default:
			return /* @__PURE__ */ jsx(MarketCard, { ...props });
	}
}

//#endregion
//#region src/react/ui/modals/_internal/components/actionModal/ErrorModal.tsx
const ErrorModal = ({ isOpen, chainId, onClose, title, message }) =>
...
const LoadingModal = ({ isOpen, chainId, onClose, title }) =>
	/* @__PURE__ */ jsx(ActionModal, {
		isOpen,
		chainId,
		onClose,
...
const getBuyCollectableParams = async ({
	chainId,
	collectionAddress,
	collectibleId,
	callbacks,
	...
	const approveStep = steps$2.find(
		(step) => step.id === StepType.tokenApproval,
	);
	const approvedSpenderAddress = approveStep
		? decodeERC20Approval(approveStep.data).spender
		: void 0;
	...
	return {
		...
		...(transakContractId && {
			transakConfig: { contractId: transakContractId },
		}),
	};
};
...
const getERC721SalePaymentParams = async ({
	chainId,
	address,
	salesContractAddress,
	collectionAddress,
...
const ERC721ShopModal = ({ collection, shopData, chainId }) => {
	...
	return /* @__PURE__ */ jsx(PaymentModalOpener$1, {
		paymentModalParams: erc721SalePaymentParams,
	});
};
...
const TotalPrice = ({
	...
	if (isMarket && currency && order)
		try {
			...
			const totalPriceRaw =
				BigInt(order ? order.priceAmount : '0') * quantity$1;
...
const ERC1155SaleContractCheckoutModalOpener = ({
	...
	if (isLoading)
		return /* @__PURE__ */ jsx(LoadingModal, {
			isOpen: true,
			chainId,
			onClose: () => buyModalStore.send({ type: 'close' }),
...
const BuyModalRouter = () => {
	...
	onError(
		/* @__PURE__ */ new Error(
			`Unsupported configuration: ${collection.type} in ${isShop ? 'shop' : 'market'} mode`,
		),
	);
	return /* @__PURE__ */ jsx(ErrorModal, {
		isOpen: true,
		...
		children: [
			...
			/* @__PURE__ */ jsx(DropdownMenuPortal, {
				children: /* @__PURE__ */ jsx(DropdownMenuContent, {
					className:
						'pointer-events-auto z-20 w-full rounded-xl border border-border-base bg-surface-neutral p-3',
					sideOffset: 5,
					children: /* @__PURE__ */ jsxs('div', {
...
const ExpirationDateSelect = function ExpirationDateSelect$1({
	className,
	date,
	onDateChange,
	disabled,
	...
	function handleSelectPresetRange(range) {
		...
		const newDate =
			presetRange.value === 'today'
				...
				: addDays$1(baseDate, presetRange.offset);
	...
	if (!date)
		return /* @__PURE__ */ jsx(Skeleton, {
			className: 'mr-3 h-7 w-20 rounded-2xl',
		});
	return /* @__PURE__ */ jsxs('div', {
		className: cn(
			'relative w-full',
...
function CurrencyImage({ price }) {
	...
	if (!price?.currency)
		return /* @__PURE__ */ jsx('div', {
			className: 'h-3 w-3 rounded-full bg-background-secondary',
		});
	if (imageLoadErrorCurrencyAddresses?.includes(price.currency.contractAddress))
		return /* @__PURE__ */ jsx('div', {
			className: 'h-3 w-3 rounded-full bg-background-secondary',
		});
		...
		children: [
			...
			/* @__PURE__ */ jsx(DropdownMenuPortal, {
				children: /* @__PURE__ */ jsx(DropdownMenuContent, {
					...
					sideOffset: 8,
					className:
						'z-[1000] overflow-hidden rounded-xl border border-border-base bg-color-overlay-glass shadow-lg backdrop-blur-md',
						...
						children: items.map((item) =>
							/* @__PURE__ */ jsx(
								DropdownMenuCheckboxItem,
								{
									...
									className:
										"group relative flex cursor-pointer select-none items-center rounded-lg px-2 py-1.5 outline-none transition-colors hover:bg-background-hover data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&>span[data-state='checked']]:hidden",
...
function CurrencyOptionsSelect({
	...
	useEffect(() => {
		if (
			...
			if (secondCurrencyAsDefault) onCurrencyChange(currencies[1]);
	...
	const onChange = (value) => {
		const selectedCurrency$1 = currencies.find(
...
function PriceInput({
	...
	return /* @__PURE__ */ jsxs('div', {
		...
		children: [
			...
			/* @__PURE__ */ jsx('div', {
				className:
					'[&>label>div>div>.rounded-xl]:h-9 [&>label>div>div>.rounded-xl]:rounded-sm [&>label>div>div>.rounded-xl]:px-2 [&>label]:gap-1',
...
function TokenPreview({
	...
	if (collectibleLoading)
		return /* @__PURE__ */ jsxs('div', {
			...
			children: [
				/* @__PURE__ */ jsx(Skeleton, { className: 'h-9 w-9 rounded-sm' }),
				/* @__PURE__ */ jsxs('div', {
		...
		children: [
			...
			/* @__PURE__ */ jsxs('div', {
				...
				children: [
					...
					priceLoading
						? /* @__PURE__ */ jsx(Skeleton, {
								className: 'h-4 w-24 animate-shimmer',
							})
						: /* @__PURE__ */ jsxs(Text, {
								className: 'font-body font-medium text-xs',
								color: 'text100',
...
const useGetTokenApprovalData$2 = (params) => {
	...
	const listing = {
		...
		expiry: String(
			Number(dateToUnixTime(/* @__PURE__ */ new Date())) + ONE_DAY_IN_SECONDS$1,
		),
	};
	const isEnabled =
		wallet &&
	...
	const { data, isLoading, isSuccess } = useQuery({
		...
		queryFn: isEnabled
			? async () => {
					...
					const steps$2 = await marketplaceClient
						.generateListingTransaction(args)
						.then((resp) => resp.steps);
					const tokenApprovalStep = steps$2.find(
						(step) => step.id === StepType.tokenApproval,
					);
...
const getSequenceMarketplaceRequestId = async (
	hash,
	publicClient,
	walletAddress,
) => {
...
const useTransactionSteps$2 = ({
	...
	const currency = currencies?.find(
		(currency$1) =>
			currency$1.contractAddress === listingInput.listing.currencyAddress,
	);
			...
			const steps$2 = await generateListingTransactionAsync({
				...
				listing: {
					...
					expiry: /* @__PURE__ */ new Date(
						Number(listingInput.listing.expiry) * 1e3,
					),
				},
			});
			return steps$2;
	...
	const executeApproval = async () => {
		...
		try {
			...
			const approvalStep = await getListingSteps().then((steps$2) =>
				steps$2?.find((step) => step.id === StepType.tokenApproval),
			);
	...
	const createListing = async ({ isTransactionExecuting }) => {
		...
		try {
			...
			const transactionStep = steps$2?.find(
				(step) => step.id === StepType.createListing,
			);
			const signatureStep = steps$2?.find(
...
const useGetTokenApprovalData$1 = (params) => {
	...
	const offer = {
		...
		pricePerToken: '1',
		expiry: String(
			Number(dateToUnixTime(/* @__PURE__ */ new Date())) + ONE_DAY_IN_SECONDS,
		),
	};
...
const useTransactionSteps$1 = ({
		...
		try {
			...
			const steps$2 = await generateOfferTransactionAsync({
				...
				offer: {
					...offerInput.offer,
					expiry: /* @__PURE__ */ new Date(
						Number(offerInput.offer.expiry) * 1e3,
					),
				},
			});
			return steps$2;
	...
	const executeApproval = async () => {
		...
		try {
			steps$.approval.isExecuting.set(true);
			const approvalStep = await getOfferSteps().then((steps$2) =>
				steps$2?.find((step) => step.id === StepType.tokenApproval),
			);
			const hash = await wallet.handleSendTransactionStep(
				Number(chainId),
...
const Modal$2 = observer(() => {
	...
	return /* @__PURE__ */ jsx(Fragment, {
		children: /* @__PURE__ */ jsxs(ActionModal, {
			isOpen: makeOfferModal$.isOpen.get(),
			chainId: Number(chainId),
			onClose: () => {
...
const useTransactionSteps = ({
	...
	const executeApproval = async () => {
		...
		try {
			steps$.approval.isExecuting.set(true);
			const approvalStep = await getSellSteps().then((steps$2) =>
				steps$2?.find((step) => step.id === StepType.tokenApproval),
			);
			const hash = await wallet.handleSendTransactionStep(
				Number(chainId),
	...
	const sell = async ({ isTransactionExecuting }) => {
		...
		try {
			...
			if (hash || orderId) {
				const currency = currencies?.find(
					(currency$1) =>
						currency$1.contractAddress === ordersData[0].currencyAddress,
				);
				const currencyDecimal = currency?.decimals || 0;
	...
	return /* @__PURE__ */ jsx(Modal, {
		...
		children: /* @__PURE__ */ jsxs('div', {
			...
			children: [
				...
				/* @__PURE__ */ jsx(CollectiblesGrid, {
					collectibles: modalState.collectibles,
				}),
				/* @__PURE__ */ jsxs('div', {
					className: 'flex items-center gap-1',
					children: [
...
function CollectiblesGrid({ collectibles }) {
	...
	return /* @__PURE__ */ jsx('div', {
		className:
			'grid grid-cols-[repeat(auto-fill,minmax(150px,1fr))] gap-2 [&:has(div:nth-child(4))>div]:col-[unset] [&>div:nth-child(1):only-child]:h-[312px] [&>div:nth-child(1):only-child]:w-[312px] [&>div:nth-child(3)]:col-[1/-1] [&>div:nth-child(3)]:justify-self-center',
				...
				'div',
				{
					...
					children: [
						...
						showPlus &&
							/* @__PURE__ */ jsx('div', {
								className:
									'absolute top-0 right-0 bottom-0 left-0 flex items-center justify-center bg-background-overlay backdrop-blur-md',
								children: /* @__PURE__ */ jsxs(Text, {
									className:
										'rounded-lg bg-background-secondary px-2 py-1.5 text-sm backdrop-blur-md',
									fontWeight: 'medium',
									color: 'text80',
