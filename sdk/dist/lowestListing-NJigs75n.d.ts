import { CollectibleOrder, GetCollectibleHighestOfferArgs, GetCollectibleLowestListingArgs, GetCollectibleLowestListingReturn, GetFloorOrderArgs, ListCollectibleListingsArgs, ListCollectibleListingsReturn, Order, OrderFilter, SdkConfig, ValuesOptional } from "./create-config-DxYEfdhK.js";
...
declare function countListingsForCollectibleQueryOptions(params: CountListingsForCollectibleQueryOptions): _tanstack_react_query252.OmitKeyof<_tanstack_react_query252.UseQueryOptions<number, Error, number, ("collectable" | "listingsCount" | CountListingsForCollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query252.QueryFunction<number, ("collectable" | "listingsCount" | CountListingsForCollectibleQueryOptions)[], never> | undefined;
} & {
...
declare function countOffersForCollectibleQueryOptions(params: CountOffersForCollectibleQueryOptions): _tanstack_react_query252.OmitKeyof<_tanstack_react_query252.UseQueryOptions<number, Error, number, ("collectable" | "offersCount" | CountOffersForCollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query252.QueryFunction<number, ("collectable" | "offersCount" | CountOffersForCollectibleQueryOptions)[], never> | undefined;
} & {
...
declare function floorOrderQueryOptions(params: FloorOrderQueryOptions): _tanstack_react_query252.OmitKeyof<_tanstack_react_query252.UseQueryOptions<CollectibleOrder, Error, CollectibleOrder, ("collectable" | "floorOrders" | FloorOrderQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query252.QueryFunction<CollectibleOrder, ("collectable" | "floorOrders" | FloorOrderQueryOptions)[], never> | undefined;
} & {
...
declare function highestOfferQueryOptions(params: HighestOfferQueryOptions): _tanstack_react_query252.OmitKeyof<_tanstack_react_query252.UseQueryOptions<Order | null, Error, Order | null, ("details" | "collectable" | "highestOffers" | HighestOfferQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query252.QueryFunction<Order | null, ("details" | "collectable" | "highestOffers" | HighestOfferQueryOptions)[], never> | undefined;
} & {
...
declare function listListingsForCollectibleQueryOptions(params: ListListingsForCollectibleQueryOptions): _tanstack_react_query252.OmitKeyof<_tanstack_react_query252.UseQueryOptions<ListCollectibleListingsReturn, Error, ListCollectibleListingsReturn, ("collectable" | "listings" | ListListingsForCollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query252.QueryFunction<ListCollectibleListingsReturn, ("collectable" | "listings" | ListListingsForCollectibleQueryOptions)[], never> | undefined;
} & {
...
declare function lowestListingQueryOptions(params: LowestListingQueryOptions): _tanstack_react_query252.OmitKeyof<_tanstack_react_query252.UseQueryOptions<Order | null | undefined, Error, Order | null | undefined, ("details" | "collectable" | "lowestListings" | LowestListingQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query252.QueryFunction<Order | null | undefined, ("details" | "collectable" | "lowestListings" | LowestListingQueryOptions)[], never> | undefined;
} & {
...
//# sourceMappingURL=lowestListing-NJigs75n.d.ts.map