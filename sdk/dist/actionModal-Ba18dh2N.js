	...
	return /* @__PURE__ */ jsx(Modal, {
		...
		children: /* @__PURE__ */ jsxs('div', {
			...
			children: [
				/* @__PURE__ */ jsx(Text, {
					className:
						'w-full text-center font-body font-bold text-large text-text-100',
					children: title,
				}),
