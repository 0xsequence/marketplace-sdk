 ...
 * ```
 */
declare function useBalanceOfCollectible(args: UseBalanceOfCollectibleArgs): _tanstack_react_query219.UseQueryResult<_0xsequence_indexer218.TokenBalance, Error>;
//#endregion
...
declare function checkoutOptionsSalesContractQueryOptions(params: CheckoutOptionsSalesContractQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<CheckoutOptionsSalesContractReturn, Error, CheckoutOptionsSalesContractReturn, (string | CheckoutOptionsSalesContractQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<CheckoutOptionsSalesContractReturn, (string | CheckoutOptionsSalesContractQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useCheckoutOptionsSalesContract(params: UseCheckoutOptionsSalesContractParams | typeof skipToken): _tanstack_react_query219.UseQueryResult<CheckoutOptionsSalesContractReturn, Error>;
 ...
 * ```
 */
declare function useCollectible(params: UseCollectibleParams): _tanstack_react_query219.UseQueryResult<_0xsequence_metadata222.TokenMetadata, Error>;
//#endregion
...
declare function collectionQueryOptions(params: CollectionQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<_0xsequence_metadata222.ContractInfo, Error, _0xsequence_metadata222.ContractInfo, ("collections" | "detail" | CollectionQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<_0xsequence_metadata222.ContractInfo, ("collections" | "detail" | CollectionQueryOptions)[], never> | undefined;
} & {
  queryKey: ("collections" | "detail" | CollectionQueryOptions)[] & {
    [dataTagSymbol]: _0xsequence_metadata222.ContractInfo;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
 ...
 * ```
 */
declare function useCollection(params: UseCollectionParams): _tanstack_react_query219.UseQueryResult<_0xsequence_metadata222.ContractInfo, Error>;
//#endregion
...
declare function collectionBalanceDetailsQueryOptions(params: CollectionBalanceDetailsQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<GetTokenBalancesDetailsReturn, Error, GetTokenBalancesDetailsReturn, (string | CollectionBalanceDetailsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<GetTokenBalancesDetailsReturn, (string | CollectionBalanceDetailsQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query219.UseQueryResult<_0xsequence_indexer218.GetTokenBalancesDetailsReturn, Error>;
 ...
 * ```
 */
declare function useCollectionDetails(params: UseCollectionDetailsParams): _tanstack_react_query219.UseQueryResult<Collection, Error>;
//#endregion
...
declare const collectionDetailsPollingOptions: (args: UseCollectionDetailsPolling, config: SdkConfig) => _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<Collection, Error, Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[], never> | undefined;
} & {
...
declare const useCollectionDetailsPolling: (args: UseCollectionDetailsPolling) => _tanstack_react_query219.UseQueryResult<Collection, Error>;
//#endregion
...
declare function comparePricesQueryOptions(params: ComparePricesQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<ComparePricesReturn$1, Error, ComparePricesReturn$1, (string | ComparePricesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<ComparePricesReturn$1, (string | ComparePricesQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useComparePrices(params: UseComparePricesParams): _tanstack_react_query219.UseQueryResult<ComparePricesReturn$1, Error>;
...
declare function convertPriceToUSDQueryOptions(params: ConvertPriceToUSDQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<ConvertPriceToUSDReturn, Error, ConvertPriceToUSDReturn, (string | ConvertPriceToUSDQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<ConvertPriceToUSDReturn, (string | ConvertPriceToUSDQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useConvertPriceToUSD(params: UseConvertPriceToUSDParams): _tanstack_react_query219.UseQueryResult<ConvertPriceToUSDReturn, Error>;
...
declare function countListingsForCollectibleQueryOptions(params: CountListingsForCollectibleQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<number, Error, number, ("collectable" | "listingsCount" | CountListingsForCollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<number, ("collectable" | "listingsCount" | CountListingsForCollectibleQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useCountListingsForCollectible(params: UseCountListingsForCollectibleParams): _tanstack_react_query219.UseQueryResult<number, Error>;
//#endregion
...
declare function countOfCollectablesQueryOptions(params: CountOfCollectablesQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<number, Error, number, ("collectable" | "counts" | CountOfCollectablesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<number, ("collectable" | "counts" | CountOfCollectablesQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useCountOfCollectables(params: UseCountOfCollectablesParams): _tanstack_react_query219.UseQueryResult<number, Error>;
//#endregion
...
declare function countOffersForCollectibleQueryOptions(params: CountOffersForCollectibleQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<number, Error, number, ("collectable" | "offersCount" | CountOffersForCollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<number, ("collectable" | "offersCount" | CountOffersForCollectibleQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useCountOffersForCollectible(params: UseCountOffersForCollectibleParams): _tanstack_react_query219.UseQueryResult<number, Error>;
//#endregion
//#region src/react/hooks/useCountOfPrimarySaleItems.d.ts
declare function useCountOfPrimarySaleItems(args: UseCountOfPrimarySaleItemsArgs): _tanstack_react_query219.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query219.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useERC721SaleMintedTokens({
  ...
  isLoading: boolean;
  error: viem252.ReadContractErrorType | null;
  saleDetails: {
    supplyCap: bigint;
    cost: bigint;
...
declare function useFilterState(): {
  ...
  setFilterOptions: (value: PropertyFilter[] | ((old: PropertyFilter[]) => PropertyFilter[] | null) | null, options?: nuqs253.Options) => Promise<URLSearchParams>;
  setSearchText: (value: string | ((old: string) => string | null) | null, options?: nuqs253.Options) => Promise<URLSearchParams>;
  setShowListedOnly: (value: boolean | ((old: boolean) => boolean | null) | null, options?: nuqs253.Options) => Promise<URLSearchParams>;
};
//#endregion
...
declare function filtersQueryOptions(params: FiltersQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<PropertyFilter$1[], Error, PropertyFilter$1[], (string | FiltersQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<PropertyFilter$1[], (string | FiltersQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query219.UseQueryResult<PropertyFilter$1[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  refetch: (options?: _tanstack_react_query219.RefetchOptions) => Promise<_tanstack_react_query219.QueryObserverResult<PropertyFilter$1[], Error>>;
  fetchStatus: _tanstack_react_query219.FetchStatus;
 ...
 * ```
 */
declare function useFloorOrder(params: UseFloorOrderParams): _tanstack_react_query219.UseQueryResult<CollectibleOrder, Error>;
//#endregion
...
declare const useGenerateCancelTransaction: (params: UseGenerateCancelTransactionArgs) => {
  generateCancelTransaction: _tanstack_react_query219.UseMutateFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  generateCancelTransactionAsync: _tanstack_react_query219.UseMutateAsyncFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateListingTransaction: (params: UseGenerateListingTransactionArgs) => {
  generateListingTransaction: _tanstack_react_query219.UseMutateFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateListingTransactionAsync: _tanstack_react_query219.UseMutateAsyncFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateOfferTransaction: (params: UseGenerateOfferTransactionArgs) => {
  generateOfferTransaction: _tanstack_react_query219.UseMutateFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateOfferTransactionAsync: _tanstack_react_query219.UseMutateAsyncFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateSellTransaction: (params: UseGenerateSellTransactionArgs) => {
  generateSellTransaction: _tanstack_react_query219.UseMutateFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateSellTransactionAsync: _tanstack_react_query219.UseMutateAsyncFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
 ...
 * ```
 */
declare function useGetCountOfPrimarySaleItems(params: UseGetCountParams): _tanstack_react_query219.UseQueryResult<GetCountOfPrimarySaleItemsReturn, Error>;
//#endregion
...
declare function getTokenRangesQueryOptions(params: GetTokenRangesQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<GetTokenIDRangesReturn, Error, GetTokenIDRangesReturn, (string | GetTokenRangesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<GetTokenIDRangesReturn, (string | GetTokenRangesQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useGetTokenRanges(params: UseGetTokenRangesParams): _tanstack_react_query219.UseQueryResult<_0xsequence_indexer218.GetTokenIDRangesReturn, Error>;
 ...
 * ```
 */
declare function useHighestOffer(params: UseHighestOfferParams): _tanstack_react_query219.UseQueryResult<Order | null, Error>;
//#endregion
//#region src/react/provider.d.ts
declare const MarketplaceSdkContext$1: react421.Context<MarketplaceSdkContext>;
...
declare function MarketplaceProvider({
  ...
  children,
  openConnectModal
}: MarketplaceSdkProviderProps): react_jsx_runtime422.JSX.Element;
declare function MarketplaceQueryClientProvider({
  children
}: {
  children: React.ReactNode;
}): react_jsx_runtime422.JSX.Element;
//#endregion
//#region src/react/hooks/useInventory.d.ts
declare function useInventory(args: UseInventoryArgs): _tanstack_react_query219.UseInfiniteQueryResult<_tanstack_react_query219.InfiniteData<CollectiblesResponse, unknown>, Error>;
//#endregion
...
declare function useList721ShopCardData({
  ...
  saleDetailsError: viem252.ReadContractErrorType | null;
  ...
  primarySaleItems: _tanstack_react_query219.InfiniteData<ListPrimarySaleItemsReturn, unknown> | undefined;
  isLoading: boolean;
};
//#endregion
 ...
 * ```
 */
declare function useListBalances(args: UseListBalancesArgs): _tanstack_react_query219.UseInfiniteQueryResult<_tanstack_react_query219.InfiniteData<_0xsequence_indexer218.GetTokenBalancesReturn, unknown>, Error>;
//#endregion
...
declare function listCollectibleActivitiesQueryOptions(params: ListCollectibleActivitiesQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<ListCollectibleActivitiesReturn, Error, ListCollectibleActivitiesReturn, ("collectable" | "collectibleActivities" | ListCollectibleActivitiesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<ListCollectibleActivitiesReturn, ("collectable" | "collectibleActivities" | ListCollectibleActivitiesQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useListCollectibleActivities(params: UseListCollectibleActivitiesParams): _tanstack_react_query219.UseQueryResult<ListCollectibleActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollectibles(params: UseListCollectiblesParams): _tanstack_react_query219.UseInfiniteQueryResult<_tanstack_react_query219.InfiniteData<ListCollectiblesReturn, unknown>, Error>;
...
declare function listCollectiblesPaginatedQueryOptions(params: ListCollectiblesPaginatedQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<ListCollectiblesReturn, Error, ListCollectiblesReturn, (string | ListCollectiblesPaginatedQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<ListCollectiblesReturn, (string | ListCollectiblesPaginatedQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useListCollectiblesPaginated(params: UseListCollectiblesPaginatedParams): _tanstack_react_query219.UseQueryResult<ListCollectiblesReturn, Error>;
...
declare function listCollectionActivitiesQueryOptions(params: ListCollectionActivitiesQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<ListCollectionActivitiesReturn, Error, ListCollectionActivitiesReturn, ("collections" | "collectionActivities" | ListCollectionActivitiesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<ListCollectionActivitiesReturn, ("collections" | "collectionActivities" | ListCollectionActivitiesQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useListCollectionActivities(params: UseListCollectionActivitiesParams): _tanstack_react_query219.UseQueryResult<ListCollectionActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollections(params?: UseListCollectionsParams): _tanstack_react_query219.UseQueryResult<({
  chainId: number;
  address: string;
  source: string;
  name: string;
  ...
  deployed: boolean;
  bytecodeHash: string;
  extensions: _0xsequence_metadata222.ContractInfoExtensions;
  updatedAt: string;
  queuedAt?: string;
  status: _0xsequence_metadata222.ResourceStatus;
...
declare function listListingsForCollectibleQueryOptions(params: ListListingsForCollectibleQueryOptions): _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<ListCollectibleListingsReturn, Error, ListCollectibleListingsReturn, ("collectable" | "listings" | ListListingsForCollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<ListCollectibleListingsReturn, ("collectable" | "listings" | ListListingsForCollectibleQueryOptions)[], never> | undefined;
} & {
 ...
 * ```
 */
declare function useListListingsForCollectible(params: UseListListingsForCollectibleParams): _tanstack_react_query219.UseQueryResult<ListCollectibleListingsReturn, Error>;
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query219.FetchNextPageOptions) => Promise<_tanstack_react_query219.InfiniteQueryObserverResult<_tanstack_react_query219.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
...
declare const listOffersForCollectibleOptions: (args: UseListOffersForCollectibleArgs, config: SdkConfig) => _tanstack_react_query219.OmitKeyof<_tanstack_react_query219.UseQueryOptions<ListCollectibleOffersReturn, Error, ListCollectibleOffersReturn, (SdkConfig | "collectable" | "offers" | UseListOffersForCollectibleArgs)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query219.QueryFunction<ListCollectibleOffersReturn, (SdkConfig | "collectable" | "offers" | UseListOffersForCollectibleArgs)[], never> | undefined;
} & {
...
declare const useListOffersForCollectible: (args: UseListOffersForCollectibleArgs) => _tanstack_react_query219.UseQueryResult<ListCollectibleOffersReturn, Error>;
//#endregion
 ...
 * ```
 */
declare function useListPrimarySaleItems(params: UseListPrimarySaleItemsParams): _tanstack_react_query219.UseInfiniteQueryResult<_tanstack_react_query219.InfiniteData<ListPrimarySaleItemsReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useListTokenMetadata(params: UseListTokenMetadataParams): _tanstack_react_query219.UseQueryResult<_0xsequence_metadata222.TokenMetadata[], Error>;
//#endregion
 ...
 * ```
 */
declare function useLowestListing(params: UseLowestListingParams): _tanstack_react_query219.UseQueryResult<Order | null | undefined, Error>;
//#endregion
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query219.UseQueryResult<{
  contractAddress: string;
  chainId: number;
...
declare const useMarketplaceConfig: () => _tanstack_react_query219.UseQueryResult<MarketplaceConfig, Error>;
//#endregion
...
declare function useRoyalty(args: UseRoyaltyArgs): {
  ...
  error: viem252.ReadContractErrorType;
  isError: true;
  isPending: false;
  isLoading: false;
  isLoadingError: false;
  ...
  errorUpdatedAt: number;
  failureCount: number;
  failureReason: viem252.ReadContractErrorType | null;
  errorUpdateCount: number;
  isFetched: boolean;
  isFetchedAfterMount: boolean;
  isFetching: boolean;
  ...
  isRefetching: boolean;
  isStale: boolean;
  refetch: (options?: _tanstack_react_query219.RefetchOptions) => Promise<_tanstack_react_query219.QueryObserverResult<readonly [`0x${string}`, bigint], viem252.ReadContractErrorType>>;
  fetchStatus: _tanstack_react_query219.FetchStatus;
  promise: Promise<readonly [`0x${string}`, bigint]>;
  queryKey: _tanstack_react_query219.QueryKey;
} | {
  data: {
    percentage: bigint;
    recipient: Address;
 ...
 * ```
 */
declare function useTokenSupplies(params: UseTokenSuppliesParams): _tanstack_react_query219.UseQueryResult<_0xsequence_indexer218.GetTokenSuppliesReturn, Error>;
//#endregion
...
//# sourceMappingURL=index-CvC8_8T6.d.ts.map