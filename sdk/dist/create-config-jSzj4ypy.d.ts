...
declare const marketplaceConfigOptions: (config: SdkConfig) => _tanstack_react_query203.OmitKeyof<_tanstack_react_query203.UseQueryOptions<MarketplaceConfig, Error, MarketplaceConfig, ("configs" | "marketplace")[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query203.QueryFunction<MarketplaceConfig, ("configs" | "marketplace")[], never> | undefined;
} & {
...
declare const createWagmiConfig: (marketplaceConfig: MarketplaceConfig, sdkConfig: SdkConfig, ssr?: boolean) => wagmi15.Config<[Chain, ...Chain[]], Record<number, Transport>, wagmi15.CreateConnectorFn[]>;
...
//# sourceMappingURL=create-config-jSzj4ypy.d.ts.map