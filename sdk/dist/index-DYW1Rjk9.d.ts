import { Collection, CollectionFilterSettings, ContractType, ListCollectionActivitiesReturn, MarketplaceType, Optional, OrderbookKind, SdkConfig } from "./create-config-DxYEfdhK.js";
import { CollectionBalanceDetailsQueryOptions, CollectionBalanceFilter, CollectionDetailsQueryOptions, CollectionQueryOptions, ListCollectionActivitiesQueryOptions, ListCollectionsQueryOptions, fetchCollectionBalanceDetails, fetchListCollectionActivities } from "./listCollections-B4Y9mf0z.js";
import * as _tanstack_react_query272 from "@tanstack/react-query";
import * as _0xsequence_indexer273 from "@0xsequence/indexer";
import * as _0xsequence_metadata271 from "@0xsequence/metadata";
 ...
 * ```
 */
declare function useCollection(params: UseCollectionParams): _tanstack_react_query272.UseQueryResult<_0xsequence_metadata271.ContractInfo, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query272.UseQueryResult<_0xsequence_indexer273.GetTokenBalancesDetailsReturn, Error>;
 ...
 * ```
 */
declare function useCollectionDetails(params: UseCollectionDetailsParams): _tanstack_react_query272.UseQueryResult<Collection, Error>;
//#endregion
...
declare const collectionDetailsPollingOptions: (args: UseCollectionDetailsPolling, config: SdkConfig) => _tanstack_react_query272.OmitKeyof<_tanstack_react_query272.UseQueryOptions<Collection, Error, Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query272.QueryFunction<Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[], never> | undefined;
} & {
...
declare const useCollectionDetailsPolling: (args: UseCollectionDetailsPolling) => _tanstack_react_query272.UseQueryResult<Collection, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectionActivities(params: UseListCollectionActivitiesParams): _tanstack_react_query272.UseQueryResult<ListCollectionActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollections(params?: UseListCollectionsParams): _tanstack_react_query272.UseQueryResult<({
  chainId: number;
  address: string;
  source: string;
  name: string;
  ...
  deployed: boolean;
  bytecodeHash: string;
  extensions: _0xsequence_metadata271.ContractInfoExtensions;
  updatedAt: string;
  queuedAt?: string;
  status: _0xsequence_metadata271.ResourceStatus;
...
//# sourceMappingURL=index-DYW1Rjk9.d.ts.map