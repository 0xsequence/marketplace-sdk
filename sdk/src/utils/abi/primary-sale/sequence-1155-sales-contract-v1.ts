export const ERC1155_SALES_CONTRACT_ABI_V1 = [
	{ inputs: [], name: 'GlobalSaleInactive', type: 'error' },
	{
		inputs: [
	...
	{
		inputs: [
			{ internalType: 'address', name: 'paymentTokenAddr', type: 'address' },
		],
	...
	},
	{
		inputs: [
			...
			{ internalType: 'uint64[]', name: 'startTimes', type: 'uint64[]' },
			{ internalType: 'uint64[]', name: 'endTimes', type: 'uint64[]' },
