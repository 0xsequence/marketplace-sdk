...
// Basic Stories
export const ImageJPG: Story = {
	args: {
		name: 'Sample JPEG Image',
...
export const InteractiveHTML: Story = {
	args: {
		name: 'CodePen Interactive',
		assets: ['https://codepen.io/team/codepen/embed/PNaGbb.html'],
		className: 'rounded-lg border',
	},
};

export const Model3DGLTF: Story = {
	args: {
		name: 'Astronaut 3D Model (GLTF)',
		assets: ['https://modelviewer.dev/shared-assets/models/Astronaut.gltf'],
		className: 'rounded-lg border',
	},
};

export const Model3DGLB: Story = {
	args: {
		name: 'Shishkebab 3D Model (GLB)',
...
export const AllAssetsFail: Story = {
	args: {
		name: 'All Assets Fail - Default Fallback',
		assets: [
			MOCK_ASSETS.invalid.broken,
			MOCK_ASSETS.invalid.notFound,
	...
	args: {
		...
		fallbackContent: (
			<div className="flex flex-col items-center justify-center p-4 text-center">
				...
				<div className="text-sm font-medium">Custom Artwork</div>
...
export const UndefinedAssets: Story = {
	args: {
		name: 'Undefined Assets',
...
export const LoadingWithoutListening: Story = {
	args: {
		name: 'Loading Without Event Listening',
		assets: [MOCK_ASSETS.images.jpg],
...
// Asset Prefix URL
export const WithAssetPrefix: Story = {
	args: {
		name: 'With Asset Prefix URL',
...
export const RectangularAspect: Story = {
	args: {
		name: 'Rectangular Aspect Ratio',
		assets: [MOCK_ASSETS.images.jpg],
...
// Edge Cases
export const VeryLongAssetURL: Story = {
	args: {
		name: 'Very Long Asset URL',
		assets: [
...
export const UnicodeCharactersInName: Story = {
	args: {
		name: '🎨 Unicode Art 🖼️ 中文 العربية 🌟',
		assets: [MOCK_ASSETS.images.jpg],
		className: 'rounded-lg border',
	},
};

// Multiple Media Types Grid
export const MediaTypesGrid: Story = {
	render: () => (
		<div className="grid grid-cols-2 gap-4 p-4">
			<div className="space-y-2">
				<h3 className="text-sm font-medium">Image (JPG)</h3>
				<Media
					name="Grid Image"
					assets={[MOCK_ASSETS.images.jpg]}
					className="rounded border aspect-square"
				/>
			</div>
			<div className="space-y-2">
				<h3 className="text-sm font-medium">Video (MP4)</h3>
				<Media
					name="Grid Video"
					assets={[
						'https://sample-videos.com/zip/10/mp4/SampleVideo_1280x720_1mb.mp4',
			...
			<div className="space-y-2">
				<h3 className="text-sm font-medium">Fallback</h3>
				<Media
					name="Grid Fallback"
					assets={[MOCK_ASSETS.invalid.broken]}
					className="rounded border aspect-square"
