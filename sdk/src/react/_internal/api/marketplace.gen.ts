/* eslint-disable */
// marketplace-api  167453a22ec042d69cb1e51b03a19cb48c73a280
// --
...
//
// TEMPORARY MANUAL ADDITIONS (will be removed when backend regenerates this file):
// - GetCountOfListingsArgs interface
// - GetCountOfListingsReturn interface
// - getCountOfListings method in Marketplace interface
// - getCountOfListings implementation in Marketplace class
// These additions enable frontend development while waiting for backend implementation.

export const WebrpcHeader = "Webrpc"

export const WebrpcHeaderValue = "webrpc@v0.25.4;gen-typescript@v0.17.0;marketplace-api@v0.0.0-167453a22ec042d69cb1e51b03a19cb48c73a280"
...
export const WebRPCSchemaHash = "167453a22ec042d69cb1e51b03a19cb48c73a280"
...
export interface Marketplace {
  ...
  listOrders(args: ListOrdersArgs, headers?: object, signal?: AbortSignal): Promise<ListOrdersReturn>
  ...
  getCountOfListings(args: GetCountOfListingsArgs, headers?: object, signal?: AbortSignal): Promise<GetCountOfListingsReturn>
...
export interface GetCountOfListingsArgs {
  chainId: string
  contractAddress: string
  filter?: OrderFilter
}

export interface GetCountOfListingsReturn {
  count: string  
}
...
export class Marketplace implements Marketplace {
  ...
  getCountOfListings = (args: GetCountOfListingsArgs, headers?: object, signal?: AbortSignal): Promise<GetCountOfListingsReturn> => {
    return this.fetch(
      this.url('GetCountOfListings'),
      createHTTPRequest(args, headers, signal)).then((res) => {
      return buildResponse(res).then(_data => {
        return {
          count: <string>(_data.count),
        }
      })
    }, (error) => {
      throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error.message || ''}` })
