...
- **Intent-based transactions** - Complex multi-step transactions are orchestrated into a single 1-click experience
...
All modal components now export their internal context hooks and types for fully custom UI implementations:
...
All SDK types now use `bigint` primitives and are fully compatible with viem:
...
```typescript
// Migration
const tokenId = 123n;  // Was: "123"
const amount = 1000000000000000000n;  // Was: "1000000000000000000"
```
...
**New Utilities**
- `normalizeProperties` / `normalizeAttributes` - Normalize NFT metadata
