import { Optional, PropertyFilter, PropertyType } from "./create-config-Co40OaTJ.js";
import { FiltersQueryOptions } from "./filters-BKZEBr-E.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query367.UseQueryResult<PropertyFilter$1[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query367.RefetchOptions) => Promise<_tanstack_react_query367.QueryObserverResult<PropertyFilter$1[], Error>>;
...
//# sourceMappingURL=index-Ce7x4WUW.d.ts.map