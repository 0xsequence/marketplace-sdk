import { Er as Page, Hn as ContractInfo$1, Jn as ContractType, Y as SdkQueryParams, lt as WithOptionalParams, tt as WithRequired, yr as MetadataStatus } from "./create-config.js";
...
declare function inventoryOptions(params: WithOptionalParams<WithRequired<InventoryQueryOptions, 'accountAddress' | 'collectionAddress' | 'chainId' | 'config'>>): _tanstack_react_query20.OmitKeyof<_tanstack_react_query20.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query20.QueryFunction<CollectiblesResponse, readonly unknown[], never> | undefined;
} & {
