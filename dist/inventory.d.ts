import { At as MetadataStatus, Dn as WithRequired, J as ContractType$1, vr as Page$1, xn as SdkQueryParams } from "./create-config.js";
...
declare function inventoryOptions(params: InventoryQueryOptions): _tanstack_react_query99.OmitKeyof<_tanstack_react_query99.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query99.QueryFunction<CollectiblesResponse, readonly unknown[], never> | undefined;
} & {
