...
declare function inventoryOptions(params: WithOptionalParams<WithRequired<InventoryQueryOptions, 'userAddress' | 'collectionAddress' | 'chainId' | 'config'>>): _tanstack_react_query363.OmitKeyof<_tanstack_react_query363.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query363.QueryFunction<CollectiblesResponse, readonly unknown[], never> | undefined;
} & {
