import { Gt as MetadataStatus, Qt as Page, gt as ContractInfo$1, s as ContractType } from "./index2.js";
...
declare function inventoryOptions(params: WithOptionalParams<WithRequired<InventoryQueryOptions, 'accountAddress' | 'collectionAddress' | 'chainId' | 'config'>>): _tanstack_react_query91.OmitKeyof<_tanstack_react_query91.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query91.QueryFunction<CollectiblesResponse, readonly unknown[], never> | undefined;
} & {
