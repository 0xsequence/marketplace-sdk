import { CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PropertyFilter } from "./create-config-Sy3PDbP4.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-QTKonCYJ.js";
import { MarketCollectibleCardProps } from "./types-Bimxg8Rw.js";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query367.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query367.FetchNextPageOptions) => Promise<_tanstack_react_query367.InfiniteQueryObserverResult<_tanstack_react_query367.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query367.UseQueryResult<{
...
//# sourceMappingURL=index-Ce2_TJp9.d.ts.map