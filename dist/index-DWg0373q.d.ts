import { Optional } from "./create-config-Sy3PDbP4.js";
import { GetTokenRangesQueryOptions, ListTokenMetadataQueryOptions, SearchTokenMetadataQueryOptions, TokenSuppliesQueryOptions, UseListBalancesArgs, fetchGetTokenRanges } from "./tokenSupplies-C9Q9CBkG.js";
 ...
 * ```
 */
declare function useGetTokenRanges(params: UseGetTokenRangesParams): _tanstack_react_query213.UseQueryResult<_0xsequence_indexer13.GetTokenIDRangesReturn, Error>;
 ...
 * ```
 */
declare function useListBalances(args: UseListBalancesArgs): _tanstack_react_query213.UseInfiniteQueryResult<_tanstack_react_query213.InfiniteData<_0xsequence_indexer13.GetTokenBalancesReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useListTokenMetadata(params: UseListTokenMetadataParams): _tanstack_react_query213.UseQueryResult<_0xsequence_metadata63.TokenMetadata[], Error>;
//#endregion
...
declare function useSearchTokenMetadata(params: UseSearchTokenMetadataParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query213.FetchNextPageOptions) => Promise<_tanstack_react_query213.InfiniteQueryObserverResult<_tanstack_react_query213.InfiniteData<_0xsequence_metadata63.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query213.FetchPreviousPageOptions) => Promise<_tanstack_react_query213.InfiniteQueryObserverResult<_tanstack_react_query213.InfiniteData<_0xsequence_metadata63.SearchTokenMetadataReturn, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query213.RefetchOptions) => Promise<_tanstack_react_query213.QueryObserverResult<_tanstack_react_query213.InfiniteData<_0xsequence_metadata63.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchStatus: _tanstack_react_query213.FetchStatus;
  promise: Promise<_tanstack_react_query213.InfiniteData<_0xsequence_metadata63.SearchTokenMetadataReturn, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata63.TokenMetadata[];
    page: _0xsequence_metadata63.Page;
  } | undefined;
  error: Error;
  isError: true;
  isPending: false;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata63.TokenMetadata[];
    page: _0xsequence_metadata63.Page | undefined;
  } | undefined;
  isLoading: boolean;
  isFetching: boolean;
  error: Error | null;
 ...
 * ```
 */
declare function useTokenSupplies(params: UseTokenSuppliesParams): _tanstack_react_query213.UseInfiniteQueryResult<_tanstack_react_query213.InfiniteData<_0xsequence_indexer13.GetTokenSuppliesReturn, unknown>, Error>;
//#endregion
...
//# sourceMappingURL=index-DWg0373q.d.ts.map