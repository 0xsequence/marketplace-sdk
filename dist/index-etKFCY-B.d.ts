import { CardType, Collection, CollectionFilterSettings, ContractType, ListCollectionActivitiesReturn, Optional, OrderbookKind, SdkConfig } from "./create-config-sLNrdjHZ.js";
import { CollectionBalanceDetailsQueryOptions, CollectionBalanceFilter, CollectionDetailsQueryOptions, CollectionQueryOptions, ListCollectionActivitiesQueryOptions, ListCollectionsQueryOptions, fetchCollectionBalanceDetails, fetchListCollectionActivities } from "./listCollections-DPtryaYz.js";
 ...
 * ```
 */
declare function useCollection(params: UseCollectionParams): _tanstack_react_query178.UseQueryResult<_0xsequence_metadata59.ContractInfo, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query178.UseQueryResult<_0xsequence_indexer11.GetTokenBalancesDetailsReturn, Error>;
...
declare function useListCollections(params?: UseListCollectionsParams): _tanstack_react_query178.UseQueryResult<({
  ...
  deployed: boolean;
  bytecodeHash: string;
  extensions: _0xsequence_metadata59.ContractInfoExtensions;
  updatedAt: string;
  queuedAt?: string;
  status: _0xsequence_metadata59.ResourceStatus;
  cardType: CardType;
...
//# sourceMappingURL=index-etKFCY-B.d.ts.map