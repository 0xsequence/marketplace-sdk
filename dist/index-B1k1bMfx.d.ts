import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-sLNrdjHZ.js";
import { FiltersQueryOptions } from "./filters-kC3tpGHE.js";
import * as _tanstack_react_query159 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query159.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query159.RefetchOptions) => Promise<_tanstack_react_query159.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query159.FetchStatus;
...
//# sourceMappingURL=index-B1k1bMfx.d.ts.map