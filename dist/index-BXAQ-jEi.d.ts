import { Ki as TokenMetadata, O as CollectionType, fi as OrderbookKind, lt as BuyModalProps, si as Order, ut as ModalCallbacks } from "./create-config-CrbgqkBr.js";
...
declare const ModalProvider: ({
  children
}: ModalProviderProps) => react_jsx_runtime22.JSX.Element;
//#endregion
...
declare function Media({
  ...
  fallbackContent,
  shouldListenForLoad
}: MediaProps): react_jsx_runtime22.JSX.Element;
//#endregion
...
//# sourceMappingURL=index-BXAQ-jEi.d.ts.map