import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-DmCoYOfk.js";
import { FiltersQueryOptions } from "./filters-CO2rSNId.js";
import * as _tanstack_react_query145 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query145.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query145.RefetchOptions) => Promise<_tanstack_react_query145.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query145.FetchStatus;
...
//# sourceMappingURL=index-53lx00EJ.d.ts.map