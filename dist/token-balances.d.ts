import { A as ListCollectiblesResponse, B as ListPrimarySaleItemsResponse, C as GetLowestPriceListingForCollectibleRequest, D as ListCollectibleListingsResponse, E as ListCollectibleActivitiesRequest, F as ListOffersForCollectibleRequest, N as ListListingsForCollectibleRequest, Nt as CollectiblesFilter, O as ListCollectibleOffersResponse, S as GetHighestPriceOfferForCollectibleRequest, St as Address$1, Ut as ListCollectibleActivitiesResponse, X as Order, Xt as OrderSide, Yt as OrderFilter, en as Page, h as GetCountOfAllCollectiblesRequest, ht as TokenMetadata$1, k as ListCollectiblesRequest, on as SortBy, rn as PrimarySaleItemsFilter, v as GetCountOfListingsForCollectibleRequest, w as GetPrimarySaleItemResponse, xt as TokenBalance$1, y as GetCountOfOffersForCollectibleRequest, z as ListPrimarySaleItemsRequest } from "./index2.js";
 ...
 */
declare function balanceOfCollectibleOptions(params: WithOptionalParams<WithRequired<BalanceOfCollectibleQueryOptions, 'chainId' | 'collectionAddress' | 'tokenId' | 'userAddress' | 'config'>>): _tanstack_react_query135.OmitKeyof<_tanstack_react_query135.UseQueryOptions<TokenBalance$1, Error, TokenBalance$1, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query135.QueryFunction<TokenBalance$1, readonly unknown[], never> | undefined;
} & {
...
declare function countOfCollectablesQueryOptions(params: WithOptionalParams<WithRequired<CountOfCollectablesQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query135.OmitKeyof<_tanstack_react_query135.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query135.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function listCollectiblesQueryOptions(params: WithOptionalParams<WithRequired<ListCollectiblesQueryOptions, 'chainId' | 'collectionAddress' | 'side' | 'config'>>): _tanstack_react_query135.OmitKeyof<_tanstack_react_query135.UseInfiniteQueryOptions<ListCollectiblesResponse, Error, _tanstack_react_query135.InfiniteData<ListCollectiblesResponse, unknown>, readonly unknown[], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query135.QueryFunction<ListCollectiblesResponse, readonly unknown[], Page> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _tanstack_react_query135.InfiniteData<ListCollectiblesResponse, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listCollectiblesPaginatedQueryOptions(params: WithOptionalParams<WithRequired<ListCollectiblesPaginatedQueryOptions, 'collectionAddress' | 'chainId' | 'side' | 'config'>>): _tanstack_react_query135.OmitKeyof<_tanstack_react_query135.UseQueryOptions<ListCollectiblesResponse, Error, ListCollectiblesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query135.QueryFunction<ListCollectiblesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function countListingsForCollectibleQueryOptions(params: WithOptionalParams<WithRequired<CountListingsForCollectibleQueryOptions, 'chainId' | 'collectionAddress' | 'tokenId' | 'config'>>): _tanstack_react_query135.OmitKeyof<_tanstack_react_query135.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query135.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: number;
...
declare function listOffersForCollectibleQueryOptions(params: WithOptionalParams<WithRequired<ListOffersForCollectibleQueryOptions, 'chainId' | 'collectionAddress' | 'tokenId' | 'config'>>): _tanstack_react_query135.OmitKeyof<_tanstack_react_query135.UseQueryOptions<ListCollectibleOffersResponse, Error, ListCollectibleOffersResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query135.QueryFunction<ListCollectibleOffersResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function countOffersForCollectibleQueryOptions(params: WithOptionalParams<WithRequired<CountOffersForCollectibleQueryOptions, 'chainId' | 'collectionAddress' | 'tokenId' | 'config'>>): _tanstack_react_query135.OmitKeyof<_tanstack_react_query135.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query135.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: number;
...
declare function collectibleQueryOptions(params: WithOptionalParams<WithRequired<CollectibleQueryOptions, 'chainId' | 'collectionAddress' | 'tokenId' | 'config'>>): _tanstack_react_query135.OmitKeyof<_tanstack_react_query135.UseQueryOptions<TokenMetadata$1, Error, TokenMetadata$1, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query135.QueryFunction<TokenMetadata$1, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function primarySaleItemQueryOptions(params: WithOptionalParams<WithRequired<PrimarySaleItemQueryOptions, 'chainId' | 'primarySaleContractAddress' | 'tokenId' | 'config'>>): _tanstack_react_query135.OmitKeyof<_tanstack_react_query135.UseQueryOptions<GetPrimarySaleItemResponse, Error, GetPrimarySaleItemResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query135.QueryFunction<GetPrimarySaleItemResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare const primarySaleItemsQueryOptions: (params: ListPrimarySaleItemsQueryOptions) => _tanstack_react_query135.OmitKeyof<_tanstack_react_query135.UseInfiniteQueryOptions<ListPrimarySaleItemsResponse, Error, _tanstack_react_query135.InfiniteData<ListPrimarySaleItemsResponse, unknown>, readonly ["collectible", "primary-sale-items", {
  readonly chainId: number;
  readonly primarySaleContractAddress: string;
  readonly filter: PrimarySaleItemsFilter | undefined;
}], {
  ...
  queryFn?: _tanstack_react_query135.QueryFunction<ListPrimarySaleItemsResponse, readonly ["collectible", "primary-sale-items", {
    readonly chainId: number;
    readonly primarySaleContractAddress: string;
    readonly filter: PrimarySaleItemsFilter | undefined;
  }], {
  ...
  queryKey: readonly ["collectible", "primary-sale-items", {
    ...
    [dataTagSymbol]: _tanstack_react_query135.InfiniteData<ListPrimarySaleItemsResponse, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
 ...
 * @returns Query options configuration
 */
declare function tokenBalancesOptions(params: WithOptionalParams<WithRequired<TokenBalancesQueryOptions, 'chainId' | 'collectionAddress' | 'userAddress' | 'config'>>): _tanstack_react_query135.OmitKeyof<_tanstack_react_query135.UseQueryOptions<TokenBalance$1[], Error, TokenBalance$1[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query135.QueryFunction<TokenBalance$1[], readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: TokenBalance$1[];
