 ...
 */
declare function fetchBalanceOfCollectible(params: WithRequired<BalanceOfCollectibleQueryOptions, 'chainId' | 'collectionAddress' | 'tokenId' | 'userAddress' | 'config'>): Promise<_0xsequence_api_client38.IndexerTokenBalance>;
/**
 ...
 */
declare function balanceOfCollectibleOptions(params: BalanceOfCollectibleQueryOptions): _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseQueryOptions<_0xsequence_api_client38.IndexerTokenBalance, Error, _0xsequence_api_client38.IndexerTokenBalance, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query90.QueryFunction<_0xsequence_api_client38.IndexerTokenBalance, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _0xsequence_api_client38.IndexerTokenBalance;
...
declare function listCollectibleActivitiesQueryOptions(params: ListCollectibleActivitiesQueryOptions): _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseQueryOptions<ListCollectibleActivitiesResponse, Error, ListCollectibleActivitiesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query90.QueryFunction<ListCollectibleActivitiesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function countOfCollectablesQueryOptions(params: CountOfCollectablesQueryOptions): _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query90.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function getHighestOfferQueryKey(params: HighestOfferQueryOptions): readonly ["collectible", "market-highest-offer", {
  ...
  readonly collectionAddress: "" | `0x${string}`;
  readonly tokenId: bigint;
  readonly filter: _0xsequence_api_client38.OrderFilter | undefined;
}];
declare function highestOfferQueryOptions(params: HighestOfferQueryOptions): ReturnType<typeof buildQueryOptions<WithRequired<HighestOfferQueryOptions, 'chainId' | 'collectionAddress' | 'tokenId' | 'config'>, Order | undefined, readonly ['chainId', 'collectionAddress', 'tokenId', 'config']>>;
//#endregion
...
declare function getListCollectiblesQueryKey(params: ListCollectiblesQueryOptions): readonly ["collectible", "market-list", {
  readonly chainId: number;
  readonly collectionAddress: "" | `0x${string}`;
  readonly side: _0xsequence_api_client38.OrderSide | undefined;
  readonly filter: _0xsequence_api_client38.CollectiblesFilter | undefined;
}];
declare function listCollectiblesQueryOptions(params: ListCollectiblesQueryOptions): _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseInfiniteQueryOptions<ListCollectiblesResponse, Error, _tanstack_react_query90.InfiniteData<ListCollectiblesResponse, unknown>, readonly unknown[], Page$2>, "queryFn"> & {
  queryFn?: _tanstack_react_query90.QueryFunction<ListCollectiblesResponse, readonly unknown[], Page$2> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _tanstack_react_query90.InfiniteData<ListCollectiblesResponse, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listCollectiblesPaginatedQueryOptions(params: ListCollectiblesPaginatedQueryOptions): _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseQueryOptions<ListCollectiblesResponse, Error, ListCollectiblesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query90.QueryFunction<ListCollectiblesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function getListListingsForCollectibleQueryKey(params: ListListingsForCollectibleQueryOptions): readonly ["collectible", "market-listings", {
  ...
  readonly tokenId: bigint;
  readonly filter: _0xsequence_api_client38.OrderFilter | undefined;
  readonly page: _0xsequence_api_client38.Page | undefined;
}];
declare function listListingsForCollectibleQueryOptions(params: ListListingsForCollectibleQueryOptions): _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseQueryOptions<ListCollectibleListingsResponse, Error, ListCollectibleListingsResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query90.QueryFunction<ListCollectibleListingsResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function countListingsForCollectibleQueryOptions(params: CountListingsForCollectibleQueryOptions): _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query90.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: number;
...
declare function lowestListingQueryOptions(params: LowestListingQueryOptions): ReturnType<typeof buildQueryOptions<WithRequired<LowestListingQueryOptions, 'chainId' | 'collectionAddress' | 'tokenId' | 'config'>, Order | undefined, readonly ['chainId', 'collectionAddress', 'tokenId', 'config']>>;
//#endregion
...
declare function listOffersForCollectibleQueryOptions(params: ListOffersForCollectibleQueryOptions): _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseQueryOptions<ListCollectibleOffersResponse, Error, ListCollectibleOffersResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query90.QueryFunction<ListCollectibleOffersResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function countOffersForCollectibleQueryOptions(params: CountOffersForCollectibleQueryOptions): _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query90.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: number;
 ...
 */
declare function fetchCollectible(params: WithRequired<CollectibleQueryOptions, 'chainId' | 'collectionAddress' | 'tokenId' | 'config'>): Promise<_0xsequence_api_client38.TokenMetadata>;
/**
 * Query key structure: [resource, operation, params]
...
declare function collectibleQueryOptions(params: CollectibleQueryOptions): _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseQueryOptions<_0xsequence_api_client38.TokenMetadata, Error, _0xsequence_api_client38.TokenMetadata, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query90.QueryFunction<_0xsequence_api_client38.TokenMetadata, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _0xsequence_api_client38.TokenMetadata;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function primarySaleItemQueryOptions(params: PrimarySaleItemQueryOptions): _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseQueryOptions<GetPrimarySaleItemResponse, Error, GetPrimarySaleItemResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query90.QueryFunction<GetPrimarySaleItemResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare const primarySaleItemsQueryOptions: (params: ListPrimarySaleItemsQueryOptions) => _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseInfiniteQueryOptions<ListPrimarySaleItemsResponse, Error, _tanstack_react_query90.InfiniteData<ListPrimarySaleItemsResponse, unknown>, readonly ["collectible", "primary-sale-items", {
  readonly chainId: number;
  readonly primarySaleContractAddress: string;
  readonly filter: PrimarySaleItemsFilter | undefined;
}], {
  ...
  queryFn?: _tanstack_react_query90.QueryFunction<ListPrimarySaleItemsResponse, readonly ["collectible", "primary-sale-items", {
    readonly chainId: number;
    readonly primarySaleContractAddress: string;
    readonly filter: PrimarySaleItemsFilter | undefined;
  }], {
  ...
  queryKey: readonly ["collectible", "primary-sale-items", {
    ...
    [dataTagSymbol]: _tanstack_react_query90.InfiniteData<ListPrimarySaleItemsResponse, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
 ...
 * @returns The balance data
 */
declare function fetchTokenBalances(params: WithRequired<TokenBalancesQueryOptions, 'chainId' | 'collectionAddress' | 'userAddress' | 'config'>): Promise<_0xsequence_api_client38.IndexerTokenBalance[]>;
 ...
 * @returns Query options configuration
 */
declare function tokenBalancesOptions(params: TokenBalancesQueryOptions): _tanstack_react_query90.OmitKeyof<_tanstack_react_query90.UseQueryOptions<_0xsequence_api_client38.IndexerTokenBalance[], Error, _0xsequence_api_client38.IndexerTokenBalance[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query90.QueryFunction<_0xsequence_api_client38.IndexerTokenBalance[], readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _0xsequence_api_client38.IndexerTokenBalance[];
