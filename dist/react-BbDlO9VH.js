...
import { balanceQueries, collectableKeys, getMarketplaceClient, getQueryClient } from "./api-lja0wRc1.js";
...
import { calculateEarningsAfterFees, cn as cn$1, compareAddress, truncateMiddle } from "./utils-0_QdfbSM.js";
...
const useBuyModalData = () => {
	...
	const collectibleId = isMarket ? buyModalProps.collectibleId : void 0;
	...
	return {
		...
		address,
		isLoading: collectableLoading || isMarket && ordersLoading || walletIsLoading || currencyLoading,
...
const FallbackPurchaseUI = ({ chainId, steps: steps$2, onSuccess }) => {
	...
	const canApprove = hasSufficientBalance && !isLoadingBalance && isOnCorrectChain;
	const canBuy = hasSufficientBalance && !isLoadingBalance && !approvalStep && isOnCorrectChain;
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
					...
					children: [/* @__PURE__ */ jsx("img", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: [/* @__PURE__ */ jsxs(Text, {
								...
								children: ["$", order?.priceUSDFormatted]
							})]
						})]
					})]
				}),
				!hasSufficientBalance && isOnCorrectChain && /* @__PURE__ */ jsxs(Text, {
					className: "text-text-50",
					children: [
				...
				approvalStep && /* @__PURE__ */ jsx(Button, {
...
const BuyModalContent = () => {
	...
	const { collectible, currencyAddress, currency, order, isLoading: isBuyModalDataLoading } = useBuyModalData();
	...
	const handleTransactionSuccess = (hash) => {
		...
		transactionStatusModal.show({
			...
			collectionAddress: collectible.contractAddress,
			chainId: modalProps.chainId,
...
//# sourceMappingURL=react-BbDlO9VH.js.map