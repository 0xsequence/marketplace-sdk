import { Optional } from "./create-config-BpPJGqAC.js";
import { GetTokenRangesQueryOptions, ListTokenMetadataQueryOptions, SearchTokenMetadataQueryOptions, TokenSuppliesQueryOptions, UseListBalancesArgs, fetchGetTokenRanges$1 as fetchGetTokenRanges } from "./tokenSupplies-CjJUHWGq.js";
import * as _tanstack_react_query105 from "@tanstack/react-query";
...
import * as _0xsequence_metadata6 from "@0xsequence/metadata";
 ...
 * ```
 */
declare function useGetTokenRanges(params: UseGetTokenRangesParams): _tanstack_react_query105.UseQueryResult<_0xsequence_indexer2.GetTokenIDRangesReturn, Error>;
 ...
 * ```
 */
declare function useListBalances(args: UseListBalancesArgs): _tanstack_react_query106.UseInfiniteQueryResult<_tanstack_react_query106.InfiniteData<_0xsequence_indexer3.GetTokenBalancesReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useListTokenMetadata(params: UseListTokenMetadataParams): _tanstack_react_query108.UseQueryResult<_0xsequence_metadata5.TokenMetadata[], Error>;
//#endregion
...
declare function useSearchTokenMetadata(params: UseSearchTokenMetadataParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query109.FetchNextPageOptions) => Promise<_tanstack_react_query109.InfiniteQueryObserverResult<_tanstack_react_query109.InfiniteData<_0xsequence_metadata6.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query109.FetchPreviousPageOptions) => Promise<_tanstack_react_query109.InfiniteQueryObserverResult<_tanstack_react_query109.InfiniteData<_0xsequence_metadata6.SearchTokenMetadataReturn, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query109.RefetchOptions) => Promise<_tanstack_react_query109.QueryObserverResult<_tanstack_react_query109.InfiniteData<_0xsequence_metadata6.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchStatus: _tanstack_react_query109.FetchStatus;
  promise: Promise<_tanstack_react_query109.InfiniteData<_0xsequence_metadata6.SearchTokenMetadataReturn, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata6.TokenMetadata[];
    page: _0xsequence_metadata6.Page;
  } | undefined;
  error: Error;
  isError: true;
  isPending: false;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata6.TokenMetadata[];
    page: _0xsequence_metadata6.Page | undefined;
  } | undefined;
  isLoading: boolean;
  isFetching: boolean;
  error: Error | null;
 ...
 * ```
 */
declare function useTokenSupplies(params: UseTokenSuppliesParams): _tanstack_react_query259.UseInfiniteQueryResult<_tanstack_react_query259.InfiniteData<_0xsequence_indexer4.GetTokenSuppliesReturn, unknown>, Error>;
//#endregion
...
//# sourceMappingURL=index-7kp_rQWg.d.ts.map