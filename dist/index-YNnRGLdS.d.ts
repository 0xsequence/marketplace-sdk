import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-DDGnmsgd.js";
import { FiltersQueryOptions } from "./filters-CKEoVh8t.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query50.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query50.RefetchOptions) => Promise<_tanstack_react_query50.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query50.FetchStatus;
...
//# sourceMappingURL=index-YNnRGLdS.d.ts.map