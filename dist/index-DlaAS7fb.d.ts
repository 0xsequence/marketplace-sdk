import { Optional } from "./create-config-Cvi1W2a1.js";
import { GetTokenRangesQueryOptions, ListTokenMetadataQueryOptions, SearchTokenMetadataQueryOptions, TokenSuppliesQueryOptions, UseListBalancesArgs, fetchGetTokenRanges } from "./tokenSupplies-Bh3lAcQ4.js";
 ...
 * ```
 */
declare function useGetTokenRanges(params: UseGetTokenRangesParams): _tanstack_react_query79.UseQueryResult<_0xsequence_indexer1.GetTokenIDRangesReturn, Error>;
 ...
 * ```
 */
declare function useListBalances(args: UseListBalancesArgs): _tanstack_react_query79.UseInfiniteQueryResult<_tanstack_react_query79.InfiniteData<_0xsequence_indexer1.GetTokenBalancesReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useListTokenMetadata(params: UseListTokenMetadataParams): _tanstack_react_query79.UseQueryResult<_0xsequence_metadata5.TokenMetadata[], Error>;
//#endregion
...
declare function useSearchTokenMetadata(params: UseSearchTokenMetadataParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query79.FetchNextPageOptions) => Promise<_tanstack_react_query79.InfiniteQueryObserverResult<_tanstack_react_query79.InfiniteData<_0xsequence_metadata5.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query79.FetchPreviousPageOptions) => Promise<_tanstack_react_query79.InfiniteQueryObserverResult<_tanstack_react_query79.InfiniteData<_0xsequence_metadata5.SearchTokenMetadataReturn, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query79.RefetchOptions) => Promise<_tanstack_react_query79.QueryObserverResult<_tanstack_react_query79.InfiniteData<_0xsequence_metadata5.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchStatus: _tanstack_react_query79.FetchStatus;
  promise: Promise<_tanstack_react_query79.InfiniteData<_0xsequence_metadata5.SearchTokenMetadataReturn, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
 ...
 * ```
 */
declare function useTokenSupplies(params: UseTokenSuppliesParams): _tanstack_react_query79.UseInfiniteQueryResult<_tanstack_react_query79.InfiniteData<_0xsequence_indexer1.GetTokenSuppliesReturn, unknown>, Error>;
//#endregion
...
//# sourceMappingURL=index-DlaAS7fb.d.ts.map