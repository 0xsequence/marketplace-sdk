 ...
 * ```
 */
declare function useCollectibleBalance(args: Omit<BalanceOfCollectibleQueryOptions, 'config'>): _tanstack_react_query401.UseQueryResult<TokenBalance$1, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketCount(params: UseCollectibleMarketCountParams): _tanstack_react_query401.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketList(params: UseCollectibleMarketListParams): _tanstack_react_query401.UseInfiniteQueryResult<_tanstack_react_query401.InfiniteData<ListCollectiblesResponse, unknown>, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketListPaginated(params: UseCollectibleMarketListPaginatedParams): _tanstack_react_query401.UseQueryResult<ListCollectiblesResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketListings(params: UseCollectibleMarketListingsParams): _tanstack_react_query401.UseQueryResult<ListCollectibleListingsResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketListingsCount(params: UseCollectibleMarketListingsCountParams): _tanstack_react_query401.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketOffers(params: UseCollectibleMarketOffersParams): _tanstack_react_query401.UseQueryResult<ListCollectibleOffersResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketOffersCount(params: UseCollectibleMarketOffersCountParams): _tanstack_react_query401.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMetadata(params: UseCollectibleMetadataParams): _tanstack_react_query401.UseQueryResult<TokenMetadata$1 | undefined, Error>;
//#endregion
 ...
 * ```
 */
declare function usePrimarySaleItem(params: UsePrimarySaleItemParams): _tanstack_react_query401.UseQueryResult<GetPrimarySaleItemResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function usePrimarySaleItems(params: UsePrimarySaleItemsParams): _tanstack_react_query401.UseInfiniteQueryResult<_tanstack_react_query401.InfiniteData<ListPrimarySaleItemsResponse, unknown>, Error>;
//#endregion
...
declare function usePrimarySaleItemsCount(args: UsePrimarySaleItemsCountParams): _tanstack_react_query401.UseQueryResult<GetCountOfPrimarySaleItemsResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleTokenBalances(args: Omit<TokenBalancesQueryOptions, 'config'>): _tanstack_react_query401.UseQueryResult<TokenBalance$1[], Error>;
//#endregion
