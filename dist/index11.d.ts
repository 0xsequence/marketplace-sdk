import { Cn as Order, G as Optional, Vn as TokenMetadata$1, an as ListCollectibleListingsResponse, cn as ListCollectiblesResponse, hr as ListCollectibleActivitiesResponse, mr as GetCountOfPrimarySaleItemsResponse, on as ListCollectibleOffersResponse, qn as TokenBalance$1, rn as GetPrimarySaleItemResponse, tt as WithRequired, vn as ListPrimarySaleItemsResponse } from "./create-config.js";
 ...
 * ```
 */
declare function useCollectibleBalance(args: Omit<BalanceOfCollectibleQueryOptions, 'config'>): _tanstack_react_query412.UseQueryResult<TokenBalance$1, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketActivities(params: UseCollectibleMarketActivitiesParams): _tanstack_react_query412.UseQueryResult<ListCollectibleActivitiesResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketCount(params: UseCollectibleMarketCountParams): _tanstack_react_query412.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketList(params: UseCollectibleMarketListParams): _tanstack_react_query412.UseInfiniteQueryResult<_tanstack_react_query412.InfiniteData<ListCollectiblesResponse, unknown>, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketListPaginated(params: UseCollectibleMarketListPaginatedParams): _tanstack_react_query412.UseQueryResult<ListCollectiblesResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketListings(params: UseCollectibleMarketListingsParams): _tanstack_react_query412.UseQueryResult<ListCollectibleListingsResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketListingsCount(params: UseCollectibleMarketListingsCountParams): _tanstack_react_query412.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketOffers(params: UseCollectibleMarketOffersParams): _tanstack_react_query412.UseQueryResult<ListCollectibleOffersResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketOffersCount(params: UseCollectibleMarketOffersCountParams): _tanstack_react_query412.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMetadata(params: UseCollectibleMetadataParams): _tanstack_react_query412.UseQueryResult<TokenMetadata$1, Error>;
//#endregion
 ...
 * ```
 */
declare function usePrimarySaleItem(params: UsePrimarySaleItemParams): _tanstack_react_query412.UseQueryResult<GetPrimarySaleItemResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function usePrimarySaleItems(params: UsePrimarySaleItemsParams): _tanstack_react_query412.UseInfiniteQueryResult<_tanstack_react_query412.InfiniteData<ListPrimarySaleItemsResponse, unknown>, Error>;
//#endregion
...
declare function usePrimarySaleItemsCount(args: UsePrimarySaleItemsCountParams): _tanstack_react_query412.UseQueryResult<GetCountOfPrimarySaleItemsResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleTokenBalances(args: Omit<TokenBalancesQueryOptions, 'config'>): _tanstack_react_query412.UseQueryResult<TokenBalance$1[], Error>;
//#endregion
