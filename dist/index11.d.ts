import { A as ListCollectiblesResponse, B as ListPrimarySaleItemsResponse, Bt as GetCountOfPrimarySaleItemsResponse, D as ListCollectibleListingsResponse, O as ListCollectibleOffersResponse, Vt as ListCollectibleActivitiesResponse, X as Order, ht as TokenMetadata$2, w as GetPrimarySaleItemResponse, xt as TokenBalance$1 } from "./index2.js";
import { G as Optional, tt as WithRequired } from "./create-config.js";
import { A as LowestListingQueryOptions, B as fetchListListingsForCollectible, E as ListOffersForCollectibleQueryOptions, G as fetchListCollectiblesPaginated, J as ListCollectiblesQueryOptions, P as CountListingsForCollectibleQueryOptions, Q as HighestOfferQueryOptions, W as ListCollectiblesPaginatedQueryOptions, ct as fetchListCollectibleActivities, dt as BalanceOfCollectibleQueryOptions, f as PrimarySaleItemQueryOptions, g as CollectibleQueryOptions, n as TokenBalancesQueryOptions, nt as CountOfCollectablesQueryOptions, s as ListPrimarySaleItemsQueryOptions, st as ListCollectibleActivitiesQueryOptions, x as CountOffersForCollectibleQueryOptions, z as ListListingsForCollectibleQueryOptions } from "./token-balances.js";
 ...
 * ```
 */
declare function useCollectibleBalance(args: Omit<BalanceOfCollectibleQueryOptions, 'config'>): _tanstack_react_query395.UseQueryResult<TokenBalance$1, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketActivities(params: UseCollectibleMarketActivitiesParams): _tanstack_react_query395.UseQueryResult<ListCollectibleActivitiesResponse, Error>;
...
type UseCollectibleMarketCountParams = Optional<WithRequired<CountOfCollectablesQueryOptions, 'chainId' | 'collectionAddress'>, 'config'>;
/**
 ...
 * ```
 */
declare function useCollectibleMarketCount(params: UseCollectibleMarketCountParams): _tanstack_react_query395.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketHighestOffer(params: UseCollectibleMarketHighestOfferParams): UseQueryResult<Order | null, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketList(params: UseCollectibleMarketListParams): _tanstack_react_query395.UseInfiniteQueryResult<_tanstack_react_query395.InfiniteData<ListCollectiblesResponse, unknown>, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketListPaginated(params: UseCollectibleMarketListPaginatedParams): _tanstack_react_query395.UseQueryResult<ListCollectiblesResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketListings(params: UseCollectibleMarketListingsParams): _tanstack_react_query395.UseQueryResult<ListCollectibleListingsResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketListingsCount(params: UseCollectibleMarketListingsCountParams): _tanstack_react_query395.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketLowestListing(params: UseCollectibleMarketLowestListingParams): UseQueryResult<Order | null, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketOffers(params: UseCollectibleMarketOffersParams): _tanstack_react_query395.UseQueryResult<ListCollectibleOffersResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketOffersCount(params: UseCollectibleMarketOffersCountParams): _tanstack_react_query395.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMetadata(params: UseCollectibleMetadataParams): _tanstack_react_query395.UseQueryResult<TokenMetadata$2, Error>;
//#endregion
 ...
 * ```
 */
declare function usePrimarySaleItem(params: UsePrimarySaleItemParams): _tanstack_react_query395.UseQueryResult<GetPrimarySaleItemResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function usePrimarySaleItems(params: UsePrimarySaleItemsParams): _tanstack_react_query395.UseInfiniteQueryResult<_tanstack_react_query395.InfiniteData<ListPrimarySaleItemsResponse, unknown>, Error>;
//#endregion
...
declare function usePrimarySaleItemsCount(args: UsePrimarySaleItemsCountParams): _tanstack_react_query395.UseQueryResult<GetCountOfPrimarySaleItemsResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleTokenBalances(args: Omit<TokenBalancesQueryOptions, 'config'>): _tanstack_react_query395.UseQueryResult<TokenBalance$1[], Error>;
//#endregion
