...
import { balanceQueries, collectableKeys, getIndexerClient, getMarketplaceClient, getQueryClient } from "./api-DBiZzw5L.js";
import { CollectionStatus$1 as CollectionStatus, ContractType$1 as ContractType, ExecuteType$1 as ExecuteType, MarketplaceKind$1 as MarketplaceKind, OfferType$1 as OfferType, OrderSide$1 as OrderSide, OrderbookKind$1 as OrderbookKind, PropertyType$1 as PropertyType, StepType$1 as StepType, WalletKind$1 as WalletKind } from "./marketplace.gen-D_dVD9lc.js";
import { getNetwork$1 as getNetwork, getPresentableChainName$1 as getPresentableChainName } from "./network-DwdZ_5-7.js";
import { PROVIDER_ID, TransactionType$1 as TransactionType } from "./_internal-MJWv57Fm.js";
...
import { calculateEarningsAfterFees, cn, compareAddress, formatPrice, truncateMiddle } from "./utils-BQvKFJIE.js";
...
import { AddIcon, Button, CheckmarkIcon, ChevronDownIcon, ChevronLeftIcon, ChevronUpIcon, CloseIcon, Divider, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuPortal, DropdownMenuRoot, DropdownMenuTrigger, ExternalLinkIcon, IconButton, Image, Modal, NetworkImage, NumericInput, Select, Skeleton, Spinner, SubtractIcon, Text, TextInput, ThemeProvider, TokenImage, Tooltip, WarningIcon, cn as cn$1 } from "@0xsequence/design-system";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import * as dn from "dnum";
import * as dnum from "dnum";
import { BaseError as BaseError$1, UserRejectedRequestError as UserRejectedRequestError$1, WaitForTransactionReceiptTimeoutError, encodeFunctionData, erc20Abi, erc721Abi, formatUnits, hexToBigInt, isAddress, isHex, parseEventLogs, parseUnits, zeroAddress } from "viem";
...
const useIsOpen$4 = () => useSelector(buyModalStore, (state) => state.context.isOpen);
...
const FallbackPurchaseUI = ({ chainId, steps: steps$2, onSuccess }) => {
	...
	const executeTransaction = async (step) => {
		...
		if (!data$1 || !to) {
			const errorDetails = new Error(`Invalid step: 'data' and 'to' are required:
				data: ${data$1}
				to: ${to}
	...
	const executeBuy = async () => {
		...
		setIsExecuting(true);
		try {
			const hash = isShop && approvalStep ? await executeBundledTransactions({
				step: buyStep,
	...
	const renderPriceUSD = () => {
		...
		if (!priceUSD) return "";
		const numericPrice = typeof priceUSD === "string" ? Number.parseFloat(priceUSD) : priceUSD;
		if (numericPrice < 1e-4) return /* @__PURE__ */ jsxs("div", {
			className: "flex items-center",
			children: [
...
//# sourceMappingURL=react-BhKbLfd1.js.map