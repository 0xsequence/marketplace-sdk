import { CardType, CollectiblesFilter, ListCollectibleActivitiesArgs, ListCollectibleActivitiesReturn, ListCollectiblesArgs, ListCollectiblesReturn, OrderSide, Page as Page$1, SdkConfig, SortBy, ValuesOptional } from "./create-config-BVC8_JNU.js";
...
declare function collectibleQueryOptions(params: CollectibleQueryOptions): _tanstack_react_query9.OmitKeyof<_tanstack_react_query9.UseQueryOptions<_0xsequence_metadata0.TokenMetadata, Error, _0xsequence_metadata0.TokenMetadata, ("collectable" | "details" | CollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query9.QueryFunction<_0xsequence_metadata0.TokenMetadata, ("collectable" | "details" | CollectibleQueryOptions)[], never> | undefined;
} & {
...
//# sourceMappingURL=listCollectiblesPaginated-CSVVZKji.d.ts.map