import { CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PriceFilter, PropertyFilter } from "./create-config-BJwAgEA2.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-CfhoD6Ze.js";
import { MarketCollectibleCardProps } from "./types-DkWCEoY6.js";
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query344.FetchNextPageOptions) => Promise<_tanstack_react_query344.InfiniteQueryObserverResult<_tanstack_react_query344.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query344.UseQueryResult<{
...
//# sourceMappingURL=index-ocUjg7iB.d.ts.map