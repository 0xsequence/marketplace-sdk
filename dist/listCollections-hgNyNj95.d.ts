import { CardType, Collection, CollectionFilterSettings, ContractType, GetCollectionDetailArgs, ListCollectionActivitiesArgs, ListCollectionActivitiesReturn, MarketplaceConfig, OrderbookKind, SdkConfig, SortBy, ValuesOptional } from "./create-config-BQet0plq.js";
...
declare function collectionQueryOptions(params: CollectionQueryOptions): _tanstack_react_query14.OmitKeyof<_tanstack_react_query14.UseQueryOptions<_0xsequence_metadata0.ContractInfo, Error, _0xsequence_metadata0.ContractInfo, ("collections" | "detail" | CollectionQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query14.QueryFunction<_0xsequence_metadata0.ContractInfo, ("collections" | "detail" | CollectionQueryOptions)[], never> | undefined;
} & {
...
declare function collectionBalanceDetailsQueryOptions(params: CollectionBalanceDetailsQueryOptions): _tanstack_react_query14.OmitKeyof<_tanstack_react_query14.UseQueryOptions<GetTokenBalancesDetailsReturn, Error, GetTokenBalancesDetailsReturn, (string | CollectionBalanceDetailsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query14.QueryFunction<GetTokenBalancesDetailsReturn, (string | CollectionBalanceDetailsQueryOptions)[], never> | undefined;
} & {
...
declare function collectionDetailsQueryOptions(params: CollectionDetailsQueryOptions): _tanstack_react_query14.OmitKeyof<_tanstack_react_query14.UseQueryOptions<Collection, Error, Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query14.QueryFunction<Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectionActivitiesQueryOptions(params: ListCollectionActivitiesQueryOptions): _tanstack_react_query14.OmitKeyof<_tanstack_react_query14.UseQueryOptions<ListCollectionActivitiesReturn, Error, ListCollectionActivitiesReturn, ("collections" | "collectionActivities" | ListCollectionActivitiesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query14.QueryFunction<ListCollectionActivitiesReturn, ("collections" | "collectionActivities" | ListCollectionActivitiesQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectionsQueryOptions(params: ListCollectionsQueryOptions): _tanstack_react_query14.UseQueryOptions<({
  chainId: number;
  address: string;
  source: string;
  name: string;
  ...
  initialData?: ({
    ...
    sortOrder?: number;
    private: boolean;
  })[] | _tanstack_react_query14.InitialDataFunction<({
    chainId: number;
    address: string;
    source: string;
    name: string;
...
declare const listCollectionsOptions: ({
  ...
  config: SdkConfig;
}) => _tanstack_react_query14.UseQueryOptions<({
  chainId: number;
  address: string;
  source: string;
  name: string;
...
//# sourceMappingURL=listCollections-hgNyNj95.d.ts.map