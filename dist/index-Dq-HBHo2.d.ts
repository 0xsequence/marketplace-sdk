 ...
 */
declare function tokenBalancesOptions(args: UseTokenBalancesArgs, config: SdkConfig): _tanstack_react_query3.UseQueryOptions<xtrails0.TokenBalance[], Error, xtrails0.TokenBalance[], readonly ["collectable", "collectable", "details", "userBalances", {
  chainId: number;
  accountAddress: `0x${string}` | undefined;
  contractAddress: `0x${string}`;
  includeMetadata: boolean | undefined;
  ...
  initialData?: xtrails0.TokenBalance[] | _tanstack_react_query3.InitialDataFunction<xtrails0.TokenBalance[]> | undefined;
} & {
...
//# sourceMappingURL=index-Dq-HBHo2.d.ts.map