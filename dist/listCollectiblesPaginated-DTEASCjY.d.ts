import { CardType, CollectiblesFilter, ListCollectibleActivitiesArgs, ListCollectibleActivitiesReturn, ListCollectiblesArgs, ListCollectiblesReturn, OrderSide, Page, SdkConfig, SortBy, ValuesOptional } from "./create-config-rrEYvm6u.js";
...
import * as _tanstack_react_query296 from "@tanstack/react-query";
 ...
 */
declare function balanceOfCollectibleOptions(args: UseBalanceOfCollectibleArgs, config: SdkConfig): _tanstack_react_query292.UseQueryOptions<_0xsequence_indexer12.TokenBalance, Error, _0xsequence_indexer12.TokenBalance, readonly ["collectable", "collectable", "details", "userBalances", {
  chainId: number;
  accountAddress: `0x${string}` | undefined;
  contractAddress: `0x${string}`;
  tokenID: string;
  ...
  initialData?: _0xsequence_indexer12.TokenBalance | _tanstack_react_query292.InitialDataFunction<_0xsequence_indexer12.TokenBalance> | undefined;
} & {
 ...
 */
declare function fetchCollectible(params: FetchCollectibleParams): Promise<_0xsequence_metadata129.TokenMetadata>;
...
declare function collectibleQueryOptions(params: CollectibleQueryOptions): _tanstack_react_query296.OmitKeyof<_tanstack_react_query296.UseQueryOptions<_0xsequence_metadata129.TokenMetadata, Error, _0xsequence_metadata129.TokenMetadata, readonly ["collectable", "details", {
  chainID: string;
  contractAddress: string | undefined;
  tokenIDs: string[];
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query296.QueryFunction<_0xsequence_metadata129.TokenMetadata, readonly ["collectable", "details", {
    chainID: string;
    contractAddress: string | undefined;
    tokenIDs: string[];
  }], never> | undefined;
  ...
  queryKey: readonly ["collectable", "details", {
    ...
    [dataTagSymbol]: _0xsequence_metadata129.TokenMetadata;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function countOfCollectablesQueryOptions(params: CountOfCollectablesQueryOptions): _tanstack_react_query300.OmitKeyof<_tanstack_react_query300.UseQueryOptions<number, Error, number, readonly ["collectable", "counts", {
  chainId: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query300.QueryFunction<number, readonly ["collectable", "counts", {
    chainId: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare function listCollectibleActivitiesQueryOptions(params: ListCollectibleActivitiesQueryOptions): _tanstack_react_query303.OmitKeyof<_tanstack_react_query303.UseQueryOptions<ListCollectibleActivitiesReturn, Error, ListCollectibleActivitiesReturn, readonly ["collectable", "collectibleActivities", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  tokenId: string | undefined;
  page: {
  ...
  queryFn?: _tanstack_react_query303.QueryFunction<ListCollectibleActivitiesReturn, readonly ["collectable", "collectibleActivities", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    tokenId: string | undefined;
    page: {
...
declare function listCollectiblesQueryOptions(params: ListCollectiblesQueryOptions): _tanstack_react_query306.OmitKeyof<_tanstack_react_query306.UseInfiniteQueryOptions<ListCollectiblesReturn, Error, _tanstack_react_query306.InfiniteData<ListCollectiblesReturn, unknown>, readonly ["collectable", "list", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  side: OrderSide | undefined;
  filter: CollectiblesFilter | undefined;
}], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query306.QueryFunction<ListCollectiblesReturn, readonly ["collectable", "list", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    side: OrderSide | undefined;
    filter: CollectiblesFilter | undefined;
  ...
  queryKey: readonly ["collectable", "list", {
    ...
    [dataTagSymbol]: _tanstack_react_query306.InfiniteData<ListCollectiblesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listCollectiblesPaginatedQueryOptions(params: ListCollectiblesPaginatedQueryOptions): _tanstack_react_query312.OmitKeyof<_tanstack_react_query312.UseQueryOptions<ListCollectiblesReturn, Error, ListCollectiblesReturn, readonly ["collectable", "list", "paginated", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  side: OrderSide | undefined;
  filter: CollectiblesFilter | undefined;
  ...
  queryFn?: _tanstack_react_query312.QueryFunction<ListCollectiblesReturn, readonly ["collectable", "list", "paginated", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    side: OrderSide | undefined;
    filter: CollectiblesFilter | undefined;
...
//# sourceMappingURL=listCollectiblesPaginated-DTEASCjY.d.ts.map