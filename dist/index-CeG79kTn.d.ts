import { Collection, CollectionFilterSettings, ContractType, ListCollectionActivitiesReturn, MarketplaceType, Optional, OrderbookKind, SdkConfig } from "./create-config-DjQjhu3-.js";
import { CollectionBalanceDetailsQueryOptions, CollectionBalanceFilter, CollectionDetailsQueryOptions, CollectionQueryOptions, ListCollectionActivitiesQueryOptions, ListCollectionsQueryOptions, fetchCollectionBalanceDetails, fetchListCollectionActivities } from "./listCollections-rFBDcEn9.js";
import * as _tanstack_react_query165 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useCollection(params: UseCollectionParams): _tanstack_react_query165.UseQueryResult<_0xsequence_metadata58.ContractInfo, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query165.UseQueryResult<_0xsequence_indexer10.GetTokenBalancesDetailsReturn, Error>;
 ...
 * ```
 */
declare function useCollectionDetails(params: UseCollectionDetailsParams): _tanstack_react_query165.UseQueryResult<Collection, Error>;
//#endregion
...
declare const collectionDetailsPollingOptions: (args: UseCollectionDetailsPolling, config: SdkConfig) => _tanstack_react_query165.OmitKeyof<_tanstack_react_query165.UseQueryOptions<Collection, Error, Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query165.QueryFunction<Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[], never> | undefined;
} & {
...
declare const useCollectionDetailsPolling: (args: UseCollectionDetailsPolling) => _tanstack_react_query165.UseQueryResult<Collection, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectionActivities(params: UseListCollectionActivitiesParams): _tanstack_react_query165.UseQueryResult<ListCollectionActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollections(params?: UseListCollectionsParams): _tanstack_react_query165.UseQueryResult<({
  chainId: number;
  address: string;
  source: string;
  name: string;
...
//# sourceMappingURL=index-CeG79kTn.d.ts.map