import { Oi as PropertyFilter$1, _i as PriceFilter, j as Optional, ki as PropertyType } from "./create-config-BA_ne-vj.js";
import { n as FiltersQueryOptions } from "./filters-CTdOlrPO.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query24.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query24.RefetchOptions) => Promise<_tanstack_react_query24.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query24.FetchStatus;
...
//# sourceMappingURL=index-Xo2Pt8oV.d.ts.map