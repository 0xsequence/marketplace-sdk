import { CardType, CollectiblesFilter, ListCollectibleActivitiesArgs, ListCollectibleActivitiesReturn, ListCollectiblesArgs, ListCollectiblesReturn, OrderSide, Page as Page$1, SdkConfig, SortBy, ValuesOptional } from "./create-config-DDGnmsgd.js";
 ...
 */
declare function balanceOfCollectibleOptions(args: UseBalanceOfCollectibleArgs, config: SdkConfig): _tanstack_react_query237.UseQueryOptions<xtrails0.TokenBalance, Error, xtrails0.TokenBalance, ("collectable" | "details" | "userBalances" | UseBalanceOfCollectibleArgs)[]> & {
  initialData?: xtrails0.TokenBalance | _tanstack_react_query237.InitialDataFunction<xtrails0.TokenBalance> | undefined;
} & {
 ...
 */
declare function fetchCollectible(params: FetchCollectibleParams): Promise<_0xsequence_metadata76.TokenMetadata>;
type CollectibleQueryOptions = ValuesOptional<FetchCollectibleParams> & {
  query?: StandardQueryOptions;
};
declare function collectibleQueryOptions(params: CollectibleQueryOptions): _tanstack_react_query237.OmitKeyof<_tanstack_react_query237.UseQueryOptions<_0xsequence_metadata76.TokenMetadata, Error, _0xsequence_metadata76.TokenMetadata, ("collectable" | "details" | CollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query237.QueryFunction<_0xsequence_metadata76.TokenMetadata, ("collectable" | "details" | CollectibleQueryOptions)[], never> | undefined;
} & {
  queryKey: ("collectable" | "details" | CollectibleQueryOptions)[] & {
    [dataTagSymbol]: _0xsequence_metadata76.TokenMetadata;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listCollectiblesQueryOptions(params: ListCollectiblesQueryOptions): _tanstack_react_query237.OmitKeyof<_tanstack_react_query237.UseInfiniteQueryOptions<ListCollectiblesReturn, Error, _tanstack_react_query237.InfiniteData<ListCollectiblesReturn, unknown>, ("collectable" | "list" | ListCollectiblesQueryOptions)[], Page$1>, "queryFn"> & {
  queryFn?: _tanstack_react_query237.QueryFunction<ListCollectiblesReturn, ("collectable" | "list" | ListCollectiblesQueryOptions)[], Page$1> | undefined;
} & {
...
//# sourceMappingURL=listCollectiblesPaginated-2_EYTWTi.d.ts.map