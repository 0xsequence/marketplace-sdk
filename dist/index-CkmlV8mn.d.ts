import { CollectibleCardAction$1 as CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PriceFilter, PropertyFilter } from "./create-config-rrEYvm6u.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-BcWwEHtb.js";
import { MarketCollectibleCardProps } from "./types-DFNCsz3n.js";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query318.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query319.FetchNextPageOptions) => Promise<_tanstack_react_query319.InfiniteQueryObserverResult<_tanstack_react_query319.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query322.UseQueryResult<{
...
//# sourceMappingURL=index-CkmlV8mn.d.ts.map