import { ListCollectibleActivitiesReturn, ListCollectiblesReturn, Optional } from "./create-config-DoEY40YQ.js";
import { CollectibleQueryOptions, CountOfCollectablesQueryOptions, ListCollectibleActivitiesQueryOptions, ListCollectiblesPaginatedQueryOptions, ListCollectiblesQueryOptions, UseBalanceOfCollectibleArgs, fetchListCollectibleActivities, fetchListCollectiblesPaginated } from "./listCollectiblesPaginated-CDLuSF7z.js";
import * as _tanstack_react_query378 from "@tanstack/react-query";
import * as _0xsequence_indexer23 from "@0xsequence/indexer";
 ...
 * ```
 */
declare function useBalanceOfCollectible(args: UseBalanceOfCollectibleArgs): _tanstack_react_query378.UseQueryResult<_0xsequence_indexer23.TokenBalance, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectible(params: UseCollectibleParams): _tanstack_react_query378.UseQueryResult<_0xsequence_metadata134.TokenMetadata, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectibleActivities(params: UseListCollectibleActivitiesParams): _tanstack_react_query378.UseQueryResult<ListCollectibleActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollectibles(params: UseListCollectiblesParams): _tanstack_react_query378.UseInfiniteQueryResult<_tanstack_react_query378.InfiniteData<ListCollectiblesReturn, unknown>, Error>;
 ...
 * ```
 */
declare function useListCollectiblesPaginated(params: UseListCollectiblesPaginatedParams): _tanstack_react_query378.UseQueryResult<ListCollectiblesReturn, Error>;
...
//# sourceMappingURL=index-CklYhFHt.d.ts.map