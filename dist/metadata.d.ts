...
declare function collectionBalanceDetailsQueryOptions(params: WithOptionalParams<WithRequired<CollectionBalanceDetailsQueryOptions, 'chainId' | 'filter' | 'config'>>): _tanstack_react_query58.OmitKeyof<_tanstack_react_query58.UseQueryOptions<index_d_exports$1$1.GetTokenBalancesDetailsResponse, Error, index_d_exports$1$1.GetTokenBalancesDetailsResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query58.QueryFunction<index_d_exports$1$1.GetTokenBalancesDetailsResponse, readonly unknown[], never> | undefined;
} & {
...
declare function listCollectionsQueryOptions(params: WithOptionalParams<WithRequired<ListCollectionsQueryOptions, 'marketplaceConfig' | 'config'>>): _tanstack_react_query58.OmitKeyof<_tanstack_react_query58.UseQueryOptions<({
  symbol: string;
  type: string;
  name: string;
  status: _0xsequence_metadata0.ResourceStatus;
  ...
  queryFn?: _tanstack_react_query58.QueryFunction<({
    symbol: string;
    type: string;
    name: string;
    status: _0xsequence_metadata0.ResourceStatus;
...
declare const listCollectionsOptions: ({
  ...
  config,
  query
}: ListCollectionsQueryOptions) => _tanstack_react_query58.UseQueryOptions<({
  symbol: string;
  type: string;
  name: string;
  status: _0xsequence_metadata0.ResourceStatus;
  ...
  initialData?: ({
    ...
    tokenIds: TokenId[];
    customTokenIds: TokenId[];
  })[] | _tanstack_react_query58.InitialDataFunction<({
    symbol: string;
    type: string;
    name: string;
    status: _0xsequence_metadata0.ResourceStatus;
...
declare function getCountOfFilteredOrdersQueryOptions(params: WithOptionalParams<WithRequired<GetCountOfFilteredOrdersQueryOptions, 'chainId' | 'collectionAddress' | 'side' | 'config'>>): _tanstack_react_query58.OmitKeyof<_tanstack_react_query58.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query58.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function floorOrderQueryOptions(params: WithOptionalParams<WithRequired<FloorOrderQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query58.OmitKeyof<_tanstack_react_query58.UseQueryOptions<CollectibleOrder, Error, CollectibleOrder, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query58.QueryFunction<CollectibleOrder, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function listItemsOrdersForCollectionQueryOptions(params: WithOptionalParams<WithRequired<ListItemsOrdersForCollectionQueryOptions, 'chainId' | 'collectionAddress' | 'side' | 'config'>>): _tanstack_react_query58.OmitKeyof<_tanstack_react_query58.UseInfiniteQueryOptions<ListOrdersWithCollectiblesResponse, Error, _tanstack_react_query58.InfiniteData<ListOrdersWithCollectiblesResponse, unknown>, readonly unknown[], Page$2>, "queryFn"> & {
  queryFn?: _tanstack_react_query58.QueryFunction<ListOrdersWithCollectiblesResponse, readonly unknown[], Page$2> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _tanstack_react_query58.InfiniteData<ListOrdersWithCollectiblesResponse, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function countItemsOrdersForCollectionQueryOptions(params: WithOptionalParams<WithRequired<CountItemsOrdersForCollectionQueryOptions, 'chainId' | 'collectionAddress' | 'side' | 'config'>>): _tanstack_react_query58.OmitKeyof<_tanstack_react_query58.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query58.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: number;
...
declare function listItemsOrdersForCollectionPaginatedQueryOptions(params: WithOptionalParams<WithRequired<ListItemsOrdersForCollectionPaginatedQueryOptions, 'collectionAddress' | 'chainId' | 'config' | 'side'>>): _tanstack_react_query58.OmitKeyof<_tanstack_react_query58.UseQueryOptions<ListOrdersWithCollectiblesResponse, Error, ListOrdersWithCollectiblesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query58.QueryFunction<ListOrdersWithCollectiblesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function collectionQueryOptions(params: WithOptionalParams<WithRequired<CollectionQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query58.OmitKeyof<_tanstack_react_query58.UseQueryOptions<ContractInfo$1$1, Error, ContractInfo$1$1, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query58.QueryFunction<ContractInfo$1$1, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
