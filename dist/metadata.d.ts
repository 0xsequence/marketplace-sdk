import { Ct as ChainId, Jt as OrderSide, L as ListOrdersWithCollectiblesRequest, Qt as Page, R as ListOrdersWithCollectiblesResponse, St as Address$1, Tt as TokenId, Ut as ListCollectionActivitiesResponse, Xt as OrderbookKind, Zt as OrdersFilter, _ as GetCountOfFilteredOrdersRequest, dt as ContractInfoExtensions, g as GetCountOfAllOrdersRequest, i as CollectibleOrder, in as SortBy, j as ListCollectionActivitiesRequest, jt as CollectiblesFilter, o as CollectionFilterSettings, ot as index_d_exports$1$1, ut as ContractInfo$2, wt as ProjectId, x as GetFloorOrderRequest } from "./index2.js";
import { J as SdkInfiniteQueryParams, Y as SdkQueryParams, lt as WithOptionalParams, m as SdkConfig, tt as WithRequired, y as MarketplaceConfig } from "./create-config.js";
...
declare function collectionBalanceDetailsQueryOptions(params: WithOptionalParams<WithRequired<CollectionBalanceDetailsQueryOptions, 'chainId' | 'filter' | 'config'>>): _tanstack_react_query99.OmitKeyof<_tanstack_react_query99.UseQueryOptions<index_d_exports$1$1.GetTokenBalancesDetailsResponse, Error, index_d_exports$1$1.GetTokenBalancesDetailsResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query99.QueryFunction<index_d_exports$1$1.GetTokenBalancesDetailsResponse, readonly unknown[], never> | undefined;
} & {
...
declare function fetchListCollections(params: WithRequired<ListCollectionsQueryOptions, 'marketplaceConfig' | 'config'>): Promise<({
  ...
  source: string;
  name: string;
  type: _0xsequence_indexer0.ContractType;
  symbol: string;
  decimals?: number;
  logoURI: string;
  deployed: boolean;
...
declare function listCollectionsQueryOptions(params: WithOptionalParams<WithRequired<ListCollectionsQueryOptions, 'marketplaceConfig' | 'config'>>): _tanstack_react_query99.OmitKeyof<_tanstack_react_query99.UseQueryOptions<({
  chainId: ChainId;
  address: Address$1;
  source: string;
  name: string;
  ...
  queryFn?: _tanstack_react_query99.QueryFunction<({
    chainId: ChainId;
    address: Address$1;
    source: string;
    name: string;
...
declare const listCollectionsOptions: ({
  ...
  config,
  query
}: ListCollectionsQueryOptions) => _tanstack_react_query99.UseQueryOptions<({
  chainId: ChainId;
  address: Address$1;
  source: string;
  name: string;
  ...
  initialData?: ({
    ...
    private: boolean;
    createdAt?: string;
  })[] | _tanstack_react_query99.InitialDataFunction<({
    chainId: ChainId;
    address: Address$1;
    source: string;
    name: string;
...
declare function listCollectionActivitiesQueryOptions(params: WithOptionalParams<WithRequired<ListCollectionActivitiesQueryOptions, 'collectionAddress' | 'chainId' | 'config'>>): _tanstack_react_query99.OmitKeyof<_tanstack_react_query99.UseQueryOptions<ListCollectionActivitiesResponse, Error, ListCollectionActivitiesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query99.QueryFunction<ListCollectionActivitiesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function getCountOfFilteredOrdersQueryOptions(params: WithOptionalParams<WithRequired<GetCountOfFilteredOrdersQueryOptions, 'chainId' | 'collectionAddress' | 'side' | 'config'>>): _tanstack_react_query99.OmitKeyof<_tanstack_react_query99.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query99.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function floorOrderQueryOptions(params: WithOptionalParams<WithRequired<FloorOrderQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query99.OmitKeyof<_tanstack_react_query99.UseQueryOptions<CollectibleOrder, Error, CollectibleOrder, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query99.QueryFunction<CollectibleOrder, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function listItemsOrdersForCollectionQueryOptions(params: WithOptionalParams<WithRequired<ListItemsOrdersForCollectionQueryOptions, 'chainId' | 'collectionAddress' | 'side' | 'config'>>): _tanstack_react_query99.OmitKeyof<_tanstack_react_query99.UseInfiniteQueryOptions<ListOrdersWithCollectiblesResponse, Error, _tanstack_react_query99.InfiniteData<ListOrdersWithCollectiblesResponse, unknown>, readonly unknown[], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query99.QueryFunction<ListOrdersWithCollectiblesResponse, readonly unknown[], Page> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _tanstack_react_query99.InfiniteData<ListOrdersWithCollectiblesResponse, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function countItemsOrdersForCollectionQueryOptions(params: WithOptionalParams<WithRequired<CountItemsOrdersForCollectionQueryOptions, 'chainId' | 'collectionAddress' | 'side' | 'config'>>): _tanstack_react_query99.OmitKeyof<_tanstack_react_query99.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query99.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: number;
...
declare function listItemsOrdersForCollectionPaginatedQueryOptions(params: WithOptionalParams<WithRequired<ListItemsOrdersForCollectionPaginatedQueryOptions, 'collectionAddress' | 'chainId' | 'config' | 'side'>>): _tanstack_react_query99.OmitKeyof<_tanstack_react_query99.UseQueryOptions<ListOrdersWithCollectiblesResponse, Error, ListOrdersWithCollectiblesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query99.QueryFunction<ListOrdersWithCollectiblesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
 ...
 */
declare function fetchCollection(params: WithRequired<CollectionQueryOptions, 'chainId' | 'collectionAddress' | 'config'>): Promise<ContractInfo$2>;
declare function getCollectionQueryKey(params: CollectionQueryOptions): readonly ["collection", string, {
  chainId: number | undefined;
  contractAddress: `0x${string}` | undefined;
}];
declare function collectionQueryOptions(params: WithOptionalParams<WithRequired<CollectionQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query99.OmitKeyof<_tanstack_react_query99.UseQueryOptions<ContractInfo$2, Error, ContractInfo$2, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query99.QueryFunction<ContractInfo$2, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: ContractInfo$2;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
