import { Dn as WithRequired, Et as ListOrdersWithCollectiblesResponse, Kt as SortBy, T as MarketplaceConfig, Tt as ListOrdersWithCollectiblesRequest, _ as SdkConfig, bn as SdkInfiniteQueryParams, bt as ListCollectionActivitiesResponse, lt as GetFloorOrderRequest, vr as Page$1, xn as SdkQueryParams, yt as ListCollectionActivitiesRequest } from "./create-config.js";
import * as _0xsequence_api_client62 from "@0xsequence/api-client";
...
import * as _tanstack_react_query142 from "@tanstack/react-query";
...
declare function collectionBalanceDetailsQueryOptions(params: CollectionBalanceDetailsQueryOptions): _tanstack_react_query142.OmitKeyof<_tanstack_react_query142.UseQueryOptions<Indexer.GetTokenBalancesDetailsResponse, Error, Indexer.GetTokenBalancesDetailsResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query142.QueryFunction<Indexer.GetTokenBalancesDetailsResponse, readonly unknown[], never> | undefined;
} & {
...
declare function fetchListCollections(params: WithRequired<ListCollectionsQueryOptions, 'marketplaceConfig' | 'config'>): Promise<({
  chainId: _0xsequence_api_client62.ChainId;
  address: _0xsequence_api_client62.Address;
  source: string;
  name: string;
  type: string;
  symbol: string;
  ...
  deployed: boolean;
  bytecodeHash: string;
  extensions: _0xsequence_api_client62.ContractInfoExtensions;
  updatedAt: string;
  queuedAt?: string;
  status: string;
  ...
  destinationMarketplace: _0xsequence_api_client62.OrderbookKind;
  filterSettings?: _0xsequence_api_client62.CollectionFilterSettings;
  id: number;
  projectId: _0xsequence_api_client62.ProjectId;
  itemsAddress: _0xsequence_api_client62.Address;
  bannerUrl: string;
  sortOrder?: number;
  private: boolean;
  createdAt?: string;
  ...
  saleAddress: _0xsequence_api_client62.Address;
  tokenIds: _0xsequence_api_client62.TokenId[];
  customTokenIds: _0xsequence_api_client62.TokenId[];
  id: number;
  projectId: _0xsequence_api_client62.ProjectId;
  itemsAddress: _0xsequence_api_client62.Address;
  bannerUrl: string;
...
declare function listCollectionsQueryOptions(params: ListCollectionsQueryOptions): _tanstack_react_query142.OmitKeyof<_tanstack_react_query142.UseQueryOptions<({
  chainId: _0xsequence_api_client62.ChainId;
  address: _0xsequence_api_client62.Address;
  source: string;
  name: string;
  ...
  queryFn?: _tanstack_react_query142.QueryFunction<({
    chainId: _0xsequence_api_client62.ChainId;
    address: _0xsequence_api_client62.Address;
    source: string;
    name: string;
...
declare const listCollectionsOptions: ({
  ...
  config,
  query
}: ListCollectionsQueryOptions) => _tanstack_react_query142.UseQueryOptions<({
  chainId: _0xsequence_api_client62.ChainId;
  address: _0xsequence_api_client62.Address;
  source: string;
  name: string;
  ...
  initialData?: ({
    ...
    private: boolean;
    createdAt?: string;
  })[] | _tanstack_react_query142.InitialDataFunction<({
    chainId: _0xsequence_api_client62.ChainId;
    address: _0xsequence_api_client62.Address;
    source: string;
    name: string;
...
declare function listCollectionActivitiesQueryOptions(params: ListCollectionActivitiesQueryOptions): _tanstack_react_query142.OmitKeyof<_tanstack_react_query142.UseQueryOptions<ListCollectionActivitiesResponse, Error, ListCollectionActivitiesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query142.QueryFunction<ListCollectionActivitiesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function getCountOfFilteredOrdersQueryOptions(params: GetCountOfFilteredOrdersQueryOptions): _tanstack_react_query142.OmitKeyof<_tanstack_react_query142.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query142.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
 ...
 */
declare function fetchFloorOrder(params: WithRequired<FloorOrderQueryOptions, 'chainId' | 'collectionAddress' | 'config'>): Promise<_0xsequence_api_client62.CollectibleOrder>;
declare function getFloorOrderQueryKey(params: FloorOrderQueryOptions): readonly ["collection", "market-floor", {
  readonly chainId: number;
  readonly collectionAddress: "" | `0x${string}`;
  readonly filter: _0xsequence_api_client62.CollectiblesFilter | undefined;
}];
declare function floorOrderQueryOptions(params: FloorOrderQueryOptions): _tanstack_react_query142.OmitKeyof<_tanstack_react_query142.UseQueryOptions<_0xsequence_api_client62.CollectibleOrder, Error, _0xsequence_api_client62.CollectibleOrder, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query142.QueryFunction<_0xsequence_api_client62.CollectibleOrder, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _0xsequence_api_client62.CollectibleOrder;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function getListItemsOrdersForCollectionQueryKey(params: ListItemsOrdersForCollectionQueryOptions): readonly ["collection", string, {
  ...
  side: _0xsequence_api_client62.OrderSide | undefined;
  filter: _0xsequence_api_client62.OrdersFilter | undefined;
}];
declare function listItemsOrdersForCollectionQueryOptions(params: ListItemsOrdersForCollectionQueryOptions): _tanstack_react_query142.OmitKeyof<_tanstack_react_query142.UseInfiniteQueryOptions<ListOrdersWithCollectiblesResponse, Error, _tanstack_react_query142.InfiniteData<ListOrdersWithCollectiblesResponse, unknown>, readonly unknown[], Page$1>, "queryFn"> & {
  queryFn?: _tanstack_react_query142.QueryFunction<ListOrdersWithCollectiblesResponse, readonly unknown[], Page$1> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _tanstack_react_query142.InfiniteData<ListOrdersWithCollectiblesResponse, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function countItemsOrdersForCollectionQueryOptions(params: CountItemsOrdersForCollectionQueryOptions): _tanstack_react_query142.OmitKeyof<_tanstack_react_query142.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query142.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: number;
...
declare function listItemsOrdersForCollectionPaginatedQueryOptions(params: ListItemsOrdersForCollectionPaginatedQueryOptions): _tanstack_react_query142.OmitKeyof<_tanstack_react_query142.UseQueryOptions<ListOrdersWithCollectiblesResponse, Error, ListOrdersWithCollectiblesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query142.QueryFunction<ListOrdersWithCollectiblesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
 ...
 */
declare function fetchCollection(params: WithRequired<CollectionQueryOptions, 'chainId' | 'collectionAddress' | 'config'>): Promise<_0xsequence_api_client62.ContractInfo>;
declare function getCollectionQueryKey(params: CollectionQueryOptions): readonly ["collection", string, {
  chainId: number | undefined;
  contractAddress: `0x${string}` | undefined;
}];
declare function collectionQueryOptions(params: CollectionQueryOptions): _tanstack_react_query142.OmitKeyof<_tanstack_react_query142.UseQueryOptions<_0xsequence_api_client62.ContractInfo, Error, _0xsequence_api_client62.ContractInfo, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query142.QueryFunction<_0xsequence_api_client62.ContractInfo, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _0xsequence_api_client62.ContractInfo;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
