import { $t as OrdersFilter, Ct as ChainId, Gt as ListCollectionActivitiesResponse, L as ListOrdersWithCollectiblesRequest, Nt as CollectiblesFilter, Qt as OrderbookKind, R as ListOrdersWithCollectiblesResponse, St as Address$1, Tt as TokenId, Xt as OrderSide, _ as GetCountOfFilteredOrdersRequest, dt as ContractInfoExtensions, en as Page, g as GetCountOfAllOrdersRequest, i as CollectibleOrder, j as ListCollectionActivitiesRequest, o as CollectionFilterSettings, on as SortBy, ot as index_d_exports$1$1, ut as ContractInfo$1, wt as ProjectId, x as GetFloorOrderRequest } from "./index2.js";
...
declare function collectionBalanceDetailsQueryOptions(params: WithOptionalParams<WithRequired<CollectionBalanceDetailsQueryOptions, 'chainId' | 'filter' | 'config'>>): _tanstack_react_query97.OmitKeyof<_tanstack_react_query97.UseQueryOptions<index_d_exports$1$1.GetTokenBalancesDetailsResponse, Error, index_d_exports$1$1.GetTokenBalancesDetailsResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query97.QueryFunction<index_d_exports$1$1.GetTokenBalancesDetailsResponse, readonly unknown[], never> | undefined;
} & {
...
declare function listCollectionsQueryOptions(params: WithOptionalParams<WithRequired<ListCollectionsQueryOptions, 'marketplaceConfig' | 'config'>>): _tanstack_react_query97.OmitKeyof<_tanstack_react_query97.UseQueryOptions<({
  chainId: ChainId;
  address: Address$1;
  source: string;
  name: string;
  ...
  queryFn?: _tanstack_react_query97.QueryFunction<({
    chainId: ChainId;
    address: Address$1;
    source: string;
    name: string;
...
declare const listCollectionsOptions: ({
  ...
  config,
  query
}: ListCollectionsQueryOptions) => _tanstack_react_query97.UseQueryOptions<({
  chainId: ChainId;
  address: Address$1;
  source: string;
  name: string;
  ...
  initialData?: ({
    ...
    private: boolean;
    createdAt?: string;
  })[] | _tanstack_react_query97.InitialDataFunction<({
    chainId: ChainId;
    address: Address$1;
    source: string;
    name: string;
...
declare function listCollectionActivitiesQueryOptions(params: WithOptionalParams<WithRequired<ListCollectionActivitiesQueryOptions, 'collectionAddress' | 'chainId' | 'config'>>): _tanstack_react_query97.OmitKeyof<_tanstack_react_query97.UseQueryOptions<ListCollectionActivitiesResponse, Error, ListCollectionActivitiesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query97.QueryFunction<ListCollectionActivitiesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function getCountOfFilteredOrdersQueryOptions(params: WithOptionalParams<WithRequired<GetCountOfFilteredOrdersQueryOptions, 'chainId' | 'collectionAddress' | 'side' | 'config'>>): _tanstack_react_query97.OmitKeyof<_tanstack_react_query97.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query97.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function floorOrderQueryOptions(params: WithOptionalParams<WithRequired<FloorOrderQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query97.OmitKeyof<_tanstack_react_query97.UseQueryOptions<CollectibleOrder, Error, CollectibleOrder, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query97.QueryFunction<CollectibleOrder, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function listItemsOrdersForCollectionQueryOptions(params: WithOptionalParams<WithRequired<ListItemsOrdersForCollectionQueryOptions, 'chainId' | 'collectionAddress' | 'side' | 'config'>>): _tanstack_react_query97.OmitKeyof<_tanstack_react_query97.UseInfiniteQueryOptions<ListOrdersWithCollectiblesResponse, Error, _tanstack_react_query97.InfiniteData<ListOrdersWithCollectiblesResponse, unknown>, readonly unknown[], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query97.QueryFunction<ListOrdersWithCollectiblesResponse, readonly unknown[], Page> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _tanstack_react_query97.InfiniteData<ListOrdersWithCollectiblesResponse, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function countItemsOrdersForCollectionQueryOptions(params: WithOptionalParams<WithRequired<CountItemsOrdersForCollectionQueryOptions, 'chainId' | 'collectionAddress' | 'side' | 'config'>>): _tanstack_react_query97.OmitKeyof<_tanstack_react_query97.UseQueryOptions<number, Error, number, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query97.QueryFunction<number, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: number;
...
declare function listItemsOrdersForCollectionPaginatedQueryOptions(params: WithOptionalParams<WithRequired<ListItemsOrdersForCollectionPaginatedQueryOptions, 'collectionAddress' | 'chainId' | 'config' | 'side'>>): _tanstack_react_query97.OmitKeyof<_tanstack_react_query97.UseQueryOptions<ListOrdersWithCollectiblesResponse, Error, ListOrdersWithCollectiblesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query97.QueryFunction<ListOrdersWithCollectiblesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function collectionQueryOptions(params: WithOptionalParams<WithRequired<CollectionQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query97.OmitKeyof<_tanstack_react_query97.UseQueryOptions<ContractInfo$1, Error, ContractInfo$1, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query97.QueryFunction<ContractInfo$1, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
