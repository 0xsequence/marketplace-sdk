...
import { S as StepType, T as WalletKind, _ as OrderSide, d as CollectionStatus, g as OfferType, m as MarketplaceKind, p as ExecuteType, s as isTransactionStep, t as ContractType$1, y as OrderbookKind } from "./dist.js";
...
import { a as TransactionType$2, t as CollectibleCardAction } from "./types.js";
...
import { c as getSequenceNodeGatewayUrl, l as getTrailsApiUrl, m as getQueryClient, n as getIndexerClient, o as getSequenceApiUrl, r as getMarketplaceClient, s as getSequenceIndexerUrl, u as indexerURL } from "./api.js";
...
import { ThemeProvider as ThemeProvider$1 } from "@0xsequence/design-system-v2";
import { TrailsWidget } from "0xtrails/widget";
import { useSupportedChains } from "0xtrails";
import { SequenceIndexer as SequenceIndexer$1 } from "@0xsequence/indexer-v2";
...
const ThemeProvider$2 = ({ children, theme, root }) => {
		...
		children: (analytics) => {
			if (openConnectModal) {
				...
				return /* @__PURE__ */ jsx(MarketplaceSdkContext.Provider, {
					value: context,
					children: /* @__PURE__ */ jsx(ThemeProvider$2, { children: /* @__PURE__ */ jsx("div", {
						id: PROVIDER_ID,
						children
					}) })
				});
			...
			return /* @__PURE__ */ jsx(MarketplaceProviderWithSequenceConnect, {
				config,
				analytics,
				children: /* @__PURE__ */ jsx(ThemeProvider$2, { children })
			});
		}
	});
}
...
function useBuyTransaction(modalProps) {
	...
	const primaryQuery = usePrimarySaleTransactionSteps({
		...
		amounts: isShopProps(modalProps) ? [Number(modalProps.item.quantity) || 1] : [],
		...
		contractType: ContractType$1.ERC1155,
		enabled: transactionType === TransactionType$2.PRIMARY_SALE && !!buyer
	});
...
function useBuyModalContext() {
	...
	const { collectible, collection, currencyAddress, currency, order, collectionAddress, salePrice, marketPriceAmount, isLoading: isBuyModalDataLoading, isMarket, isShop } = useBuyModalData();
	...
	let checkoutMode;
	if (checkoutModeConfig === "trails" && isChainSupported && canBeUsedWithTrails) checkoutMode = "trails";
	else if (checkoutModeConfig === "trails" && isChainSupported && !canBeUsedWithTrails) checkoutMode = "crypto";
	else if (checkoutModeConfig === "trails" && !isChainSupported) checkoutMode = "crypto";
	...
	else if (checkoutModeConfig === "crypto") checkoutMode = "crypto";
...
const useExecuteBundledTransactions = ({ chainId, approvalStep, priceAmount }) => {
	...
	const indexerClientV2 = new SequenceIndexer$1(overrides?.url || indexerURL(chainId, overrides?.env || "production"), overrides?.accessKey || config.projectAccessKey);
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				approvalStep && !isSequenceConnector && /* @__PURE__ */ jsx(Button, {
					...
					disabled: isAnyTransactionPending || isOnCorrectChain && !canApprove,
					variant: "primary",
					size: "lg",
					className: "w-full",
...
const BuyModalContent = () => {
	const { config, modalProps, close, steps, buyStep, isLoading, collection, checkoutMode, formattedAmount, salePrice, isShop, currencyAddress, handleTrailsSuccess, handleTransactionSuccess } = useBuyModalContext();
	...
	return /* @__PURE__ */ jsx(Modal, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				!isLoading && (checkoutMode === "crypto" || isShop && salePrice?.amount === 0n) && steps && steps.length > 0 && /* @__PURE__ */ jsx(CryptoPaymentModal, {
					chainId: modalProps.chainId,
					steps,
					onSuccess: handleTransactionSuccess
				}),
				!isLoading && checkoutMode === "trails" && buyStep && !(isShop && salePrice?.amount === 0n) && /* @__PURE__ */ jsx("div", {
					className: "w-full",
...
const ModalProvider = ({ children }) => {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [children, /* @__PURE__ */ jsx(ThemeProvider$1, { children: /* @__PURE__ */ jsx(SequenceCheckoutProvider, { children: /* @__PURE__ */ jsxs(ShadowRoot, {
