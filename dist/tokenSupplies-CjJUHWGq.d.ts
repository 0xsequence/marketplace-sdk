import { SdkConfig, ValuesOptional } from "./create-config-BpPJGqAC.js";
...
declare function getTokenRangesQueryOptions(params: GetTokenRangesQueryOptions): _tanstack_react_query314.OmitKeyof<_tanstack_react_query314.UseQueryOptions<GetTokenIDRangesReturn, Error, GetTokenIDRangesReturn, (string | GetTokenRangesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query314.QueryFunction<GetTokenIDRangesReturn, (string | GetTokenRangesQueryOptions)[], never> | undefined;
} & {
 ...
 */
declare function listBalancesOptions(args: UseListBalancesArgs, config: SdkConfig): _tanstack_react_query323.OmitKeyof<_tanstack_react_query323.UseInfiniteQueryOptions<GetTokenBalancesReturn, Error, _tanstack_react_query323.InfiniteData<GetTokenBalancesReturn, unknown>, (SdkConfig | "balances" | UseListBalancesArgs | "tokenBalances")[], any>, "queryFn"> & {
  queryFn?: _tanstack_react_query323.QueryFunction<GetTokenBalancesReturn, (SdkConfig | "balances" | UseListBalancesArgs | "tokenBalances")[], any> | undefined;
} & {
  queryKey: (SdkConfig | "balances" | UseListBalancesArgs | "tokenBalances")[] & {
    [dataTagSymbol]: _tanstack_react_query323.InfiniteData<GetTokenBalancesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listTokenMetadataQueryOptions(params: ListTokenMetadataQueryOptions): _tanstack_react_query352.OmitKeyof<_tanstack_react_query352.UseQueryOptions<_0xsequence_metadata135.TokenMetadata[], Error, _0xsequence_metadata135.TokenMetadata[], ("metadata" | "tokens" | ListTokenMetadataQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query352.QueryFunction<_0xsequence_metadata135.TokenMetadata[], ("metadata" | "tokens" | ListTokenMetadataQueryOptions)[], never> | undefined;
} & {
...
declare function searchTokenMetadataQueryOptions(params: SearchTokenMetadataQueryOptions): _tanstack_react_query369.OmitKeyof<_tanstack_react_query369.UseInfiniteQueryOptions<SearchTokenMetadataReturn, Error, _tanstack_react_query369.InfiniteData<SearchTokenMetadataReturn, unknown>, (string | SearchTokenMetadataQueryOptions)[], {
  page: number;
  pageSize: number;
}>, "queryFn"> & {
  queryFn?: _tanstack_react_query369.QueryFunction<SearchTokenMetadataReturn, (string | SearchTokenMetadataQueryOptions)[], {
    page: number;
    pageSize: number;
  }> | undefined;
} & {
  queryKey: (string | SearchTokenMetadataQueryOptions)[] & {
    [dataTagSymbol]: _tanstack_react_query369.InfiniteData<SearchTokenMetadataReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
 ...
 */
declare function fetchTokenSupplies(params: FetchTokenSuppliesParams): Promise<_0xsequence_indexer11.GetTokenSuppliesReturn>;
type TokenSuppliesQueryOptions = ValuesOptional<FetchTokenSuppliesParams> & {
  query?: StandardInfiniteQueryOptions;
};
declare function tokenSuppliesQueryOptions(params: TokenSuppliesQueryOptions): _tanstack_react_query374.OmitKeyof<_tanstack_react_query374.UseInfiniteQueryOptions<_0xsequence_indexer11.GetTokenSuppliesReturn, Error, _tanstack_react_query374.InfiniteData<_0xsequence_indexer11.GetTokenSuppliesReturn, unknown>, (TokenSuppliesQueryOptions | "tokens" | "supplies")[], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query374.QueryFunction<_0xsequence_indexer11.GetTokenSuppliesReturn, (TokenSuppliesQueryOptions | "tokens" | "supplies")[], Page> | undefined;
} & {
  queryKey: (TokenSuppliesQueryOptions | "tokens" | "supplies")[] & {
    [dataTagSymbol]: _tanstack_react_query374.InfiniteData<_0xsequence_indexer11.GetTokenSuppliesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
export { FetchGetTokenRangesParams, FetchListTokenMetadataParams, FetchSearchTokenMetadataParams, FetchTokenSuppliesParams, GetTokenRangesQueryOptions, ListTokenMetadataQueryOptions, SearchTokenMetadataQueryOptions, TokenSuppliesQueryOptions, UseListBalancesArgs, fetchBalances as fetchBalances$1, fetchGetTokenRanges as fetchGetTokenRanges$1, fetchListTokenMetadata as fetchListTokenMetadata$1, fetchSearchTokenMetadata as fetchSearchTokenMetadata$1, fetchTokenSupplies as fetchTokenSupplies$1, getTokenRangesQueryOptions as getTokenRangesQueryOptions$1, listBalancesOptions as listBalancesOptions$1, listTokenMetadataQueryOptions as listTokenMetadataQueryOptions$1, searchTokenMetadataQueryOptions as searchTokenMetadataQueryOptions$1, tokenSuppliesQueryOptions as tokenSuppliesQueryOptions$1 };
//# sourceMappingURL=tokenSupplies-CjJUHWGq.d.ts.map