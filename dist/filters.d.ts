import { in as PropertyFilter } from "./index2.js";
import { Y as SdkQueryParams, lt as WithOptionalParams, tt as WithRequired } from "./create-config.js";
import { Address } from "viem";
import * as _tanstack_react_query436 from "@tanstack/react-query";
...
declare function filtersQueryOptions(params: WithOptionalParams<WithRequired<FiltersQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query436.OmitKeyof<_tanstack_react_query436.UseQueryOptions<PropertyFilter[], Error, PropertyFilter[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query436.QueryFunction<PropertyFilter[], readonly unknown[], never> | undefined;
} & {
