import { nn as PropertyFilter } from "./index2.js";
...
declare function filtersQueryOptions(params: WithOptionalParams<WithRequired<FiltersQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query437.OmitKeyof<_tanstack_react_query437.UseQueryOptions<PropertyFilter[], Error, PropertyFilter[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query437.QueryFunction<PropertyFilter[], readonly unknown[], never> | undefined;
} & {
