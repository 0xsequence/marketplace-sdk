import { CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PropertyFilter } from "./create-config-CpiC1m8h.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-Cg6W8p5u.js";
import { MarketCollectibleCardProps } from "./types-BGNK7dk4.js";
import * as _tanstack_react_query151 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query151.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query151.FetchNextPageOptions) => Promise<_tanstack_react_query151.InfiniteQueryObserverResult<_tanstack_react_query151.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query151.UseQueryResult<{
...
//# sourceMappingURL=index-C3HSy5X3.d.ts.map