 ...
 * ```
 */
declare function useCollection(params: UseCollectionParams): _tanstack_react_query0.UseQueryResult<_0xsequence_metadata0.ContractInfo, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionActiveListingsCurrencies(params: UseCollectionActiveListingsCurrenciesParams): _tanstack_react_query0.UseQueryResult<Currency[], Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionActiveOffersCurrencies(params: UseCollectionActiveOffersCurrenciesParams): _tanstack_react_query0.UseQueryResult<Currency[], Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query0.UseQueryResult<_0xsequence_indexer0.GetTokenBalancesDetailsReturn, Error>;
 ...
 * ```
 */
declare function useCollectionDetails(params: UseCollectionDetailsParams): _tanstack_react_query0.UseQueryResult<Collection, Error>;
//#endregion
...
declare const collectionDetailsPollingOptions: (args: UseCollectionDetailsPolling, config: SdkConfig) => _tanstack_react_query0.OmitKeyof<_tanstack_react_query0.UseQueryOptions<Collection, Error, Collection, readonly ["collections", "detail", {
  chainId: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query0.QueryFunction<Collection, readonly ["collections", "detail", {
    chainId: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare const useCollectionDetailsPolling: (args: UseCollectionDetailsPolling) => _tanstack_react_query0.UseQueryResult<Collection, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectionActivities(params: UseListCollectionActivitiesParams): _tanstack_react_query0.UseQueryResult<ListCollectionActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollections(params?: UseListCollectionsParams): _tanstack_react_query0.UseQueryResult<({
  chainId: number;
  address: string;
  source: string;
  name: string;
...
//# sourceMappingURL=index-BLKpbAmG.d.ts.map