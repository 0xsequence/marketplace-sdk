import { CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PriceFilter, PropertyFilter } from "./create-config-BVC8_JNU.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-Bm4ATDCR.js";
import { MarketCollectibleCardProps } from "./types-C0gFHTJC.js";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query177.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query177.FetchNextPageOptions) => Promise<_tanstack_react_query177.InfiniteQueryObserverResult<_tanstack_react_query177.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query177.UseQueryResult<{
...
//# sourceMappingURL=index-CQ9HtIcn.d.ts.map