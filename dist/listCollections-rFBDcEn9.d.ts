import { Collection, CollectionFilterSettings, ContractType, GetCollectionDetailArgs, ListCollectionActivitiesArgs, ListCollectionActivitiesReturn, MarketplaceConfig, MarketplaceType, OrderbookKind, SdkConfig, SortBy, ValuesOptional } from "./create-config-DjQjhu3-.js";
import { StandardQueryOptions } from "./query-BTe7Wkrs.js";
import * as _tanstack_react_query50 from "@tanstack/react-query";
...
declare function collectionQueryOptions(params: CollectionQueryOptions): _tanstack_react_query50.OmitKeyof<_tanstack_react_query50.UseQueryOptions<_0xsequence_metadata4.ContractInfo, Error, _0xsequence_metadata4.ContractInfo, ("collections" | "detail" | CollectionQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query50.QueryFunction<_0xsequence_metadata4.ContractInfo, ("collections" | "detail" | CollectionQueryOptions)[], never> | undefined;
} & {
...
declare function collectionBalanceDetailsQueryOptions(params: CollectionBalanceDetailsQueryOptions): _tanstack_react_query50.OmitKeyof<_tanstack_react_query50.UseQueryOptions<GetTokenBalancesDetailsReturn, Error, GetTokenBalancesDetailsReturn, (string | CollectionBalanceDetailsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query50.QueryFunction<GetTokenBalancesDetailsReturn, (string | CollectionBalanceDetailsQueryOptions)[], never> | undefined;
} & {
...
declare function collectionDetailsQueryOptions(params: CollectionDetailsQueryOptions): _tanstack_react_query50.OmitKeyof<_tanstack_react_query50.UseQueryOptions<Collection, Error, Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query50.QueryFunction<Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectionActivitiesQueryOptions(params: ListCollectionActivitiesQueryOptions): _tanstack_react_query50.OmitKeyof<_tanstack_react_query50.UseQueryOptions<ListCollectionActivitiesReturn, Error, ListCollectionActivitiesReturn, ("collections" | "collectionActivities" | ListCollectionActivitiesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query50.QueryFunction<ListCollectionActivitiesReturn, ("collections" | "collectionActivities" | ListCollectionActivitiesQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectionsQueryOptions(params: ListCollectionsQueryOptions): _tanstack_react_query50.UseQueryOptions<({
  chainId: number;
  address: string;
  source: string;
  name: string;
  ...
  initialData?: ({
    ...
    itemsAddress: string;
    filterSettings?: CollectionFilterSettings;
  })[] | _tanstack_react_query50.InitialDataFunction<({
    chainId: number;
    address: string;
    source: string;
    name: string;
...
declare const listCollectionsOptions: ({
  ...
  config: SdkConfig;
}) => _tanstack_react_query50.UseQueryOptions<({
  chainId: number;
  address: string;
  source: string;
  name: string;
...
//# sourceMappingURL=listCollections-rFBDcEn9.d.ts.map