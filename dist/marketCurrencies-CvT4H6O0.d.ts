import { Currency, CurrencyStatus, SdkConfig, ValuesOptional } from "./create-config-D5nkCAUU.js";
...
declare function currencyQueryOptions(params: CurrencyQueryOptions): _tanstack_react_query61.UseQueryOptions<Currency | undefined, Error, Currency | undefined, ("currencies" | "details" | CurrencyQueryOptions)[]> & {
  initialData?: Currency | _tanstack_react_query61.InitialDataFunction<Currency> | undefined;
} & {
...
declare function marketCurrenciesQueryOptions(params: MarketCurrenciesQueryOptions): _tanstack_react_query61.OmitKeyof<_tanstack_react_query61.UseQueryOptions<{
  contractAddress: string;
  chainId: number;
  status: CurrencyStatus;
  name: string;
  ...
  queryFn?: _tanstack_react_query61.QueryFunction<{
    contractAddress: string;
    chainId: number;
    status: CurrencyStatus;
    name: string;
...
//# sourceMappingURL=marketCurrencies-CvT4H6O0.d.ts.map