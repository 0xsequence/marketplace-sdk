import { Oi as PropertyFilter$1, _i as PriceFilter, j as Optional, ki as PropertyType } from "./create-config-CrbgqkBr.js";
import { n as FiltersQueryOptions } from "./filters-M7OgDAdg.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query60.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query60.RefetchOptions) => Promise<_tanstack_react_query60.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query60.FetchStatus;
...
//# sourceMappingURL=index-rslna0Zo.d.ts.map