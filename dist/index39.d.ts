import { Qt as OrderbookKind, X as Order, ht as TokenMetadata$1, l as Currency, ut as ContractInfo$1 } from "./index2.js";
...
declare function useMakeOfferModalContext(): {
  ...
  error: Error | null;
  queries: {
    collectible: _tanstack_react_query53.UseQueryResult<TokenMetadata$1, Error>;
    collection: _tanstack_react_query53.UseQueryResult<ContractInfo$1, Error>;
    currencies: _tanstack_react_query53.UseQueryResult<Currency[], Error>;
    lowestListing: _tanstack_react_query53.UseQueryResult<Order | undefined, Error>;
  };
