import { X as Order, Xt as OrderbookKind, ht as TokenMetadata$2, l as Currency, ut as ContractInfo$2 } from "./index2.js";
...
declare function useMakeOfferModalContext(): {
  ...
  collectionAddress: `0x${string}`;
  chainId: number;
  collectible: TokenMetadata$2 | undefined;
  collection: ContractInfo$2 | undefined;
  offer: {
    price: {
      input: string;
      amountRaw: bigint;
  ...
  error: Error | null;
  queries: {
    collectible: _tanstack_react_query50.UseQueryResult<TokenMetadata$2, Error>;
    collection: _tanstack_react_query50.UseQueryResult<ContractInfo$2, Error>;
    currencies: _tanstack_react_query50.UseQueryResult<Currency[], Error>;
    lowestListing: _tanstack_react_query50.UseQueryResult<Order | null, Error>;
  };
