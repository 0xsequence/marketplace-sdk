import { SdkConfig, ValuesOptional } from "./create-config-vcb8Jl8E.js";
 ...
 */
declare function listBalancesOptions(args: UseListBalancesArgs, config: SdkConfig): _tanstack_react_query324.OmitKeyof<_tanstack_react_query324.UseInfiniteQueryOptions<GetTokenBalancesReturn, Error, _tanstack_react_query324.InfiniteData<GetTokenBalancesReturn, unknown>, (SdkConfig | "balances" | "tokenBalances" | UseListBalancesArgs)[], any>, "queryFn"> & {
  queryFn?: _tanstack_react_query324.QueryFunction<GetTokenBalancesReturn, (SdkConfig | "balances" | "tokenBalances" | UseListBalancesArgs)[], any> | undefined;
} & {
...
declare function listTokenMetadataQueryOptions(params: ListTokenMetadataQueryOptions): _tanstack_react_query324.OmitKeyof<_tanstack_react_query324.UseQueryOptions<_0xsequence_metadata135.TokenMetadata[], Error, _0xsequence_metadata135.TokenMetadata[], ("tokens" | "metadata" | ListTokenMetadataQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query324.QueryFunction<_0xsequence_metadata135.TokenMetadata[], ("tokens" | "metadata" | ListTokenMetadataQueryOptions)[], never> | undefined;
} & {
...
declare function tokenSuppliesQueryOptions(params: TokenSuppliesQueryOptions): _tanstack_react_query324.OmitKeyof<_tanstack_react_query324.UseInfiniteQueryOptions<_0xsequence_indexer4.GetTokenSuppliesReturn, Error, _tanstack_react_query324.InfiniteData<_0xsequence_indexer4.GetTokenSuppliesReturn, unknown>, (TokenSuppliesQueryOptions | "tokens" | "supplies")[], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query324.QueryFunction<_0xsequence_indexer4.GetTokenSuppliesReturn, (TokenSuppliesQueryOptions | "tokens" | "supplies")[], Page> | undefined;
} & {
  queryKey: (TokenSuppliesQueryOptions | "tokens" | "supplies")[] & {
    [dataTagSymbol]: _tanstack_react_query324.InfiniteData<_0xsequence_indexer4.GetTokenSuppliesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
//# sourceMappingURL=tokenSupplies-DwUPhTNx.d.ts.map