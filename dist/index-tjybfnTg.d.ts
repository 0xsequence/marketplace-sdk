import { AdditionalFee, BuyModalProps, ContractType, CreateReq, GenerateCancelTransactionArgs, GenerateListingTransactionArgs, GenerateOfferTransactionArgs, GenerateSellTransactionArgs, MarketplaceKind, ModalCallbacks, SdkConfig, Step, TransactionType, WalletKind } from "./create-config-DDGnmsgd.js";
import * as _tanstack_react_query345 from "@tanstack/react-query";
...
declare function useBuyTransaction(modalProps: BuyModalProps): {
  ...
  error: Error | null;
  isError: boolean;
  refetch: (options?: _tanstack_react_query345.RefetchOptions) => Promise<_tanstack_react_query345.QueryObserverResult<Step[], Error>>;
};
//#endregion
...
declare const useGenerateCancelTransaction: (params: UseGenerateCancelTransactionArgs) => {
  generateCancelTransaction: _tanstack_react_query345.UseMutateFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  generateCancelTransactionAsync: _tanstack_react_query345.UseMutateAsyncFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateListingTransaction: (params: UseGenerateListingTransactionArgs) => {
  generateListingTransaction: _tanstack_react_query345.UseMutateFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateListingTransactionAsync: _tanstack_react_query345.UseMutateAsyncFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateOfferTransaction: (params: UseGenerateOfferTransactionArgs) => {
  generateOfferTransaction: _tanstack_react_query345.UseMutateFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateOfferTransactionAsync: _tanstack_react_query345.UseMutateAsyncFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateSellTransaction: (params: UseGenerateSellTransactionArgs) => {
  generateSellTransaction: _tanstack_react_query345.UseMutateFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateSellTransactionAsync: _tanstack_react_query345.UseMutateAsyncFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare function useMarketTransactionSteps({
  ...
  additionalFees,
  enabled
}: UseMarketTransactionStepsParams): _tanstack_react_query345.UseQueryResult<Step[], Error>;
//#endregion
...
declare function usePrimarySaleTransactionSteps({
  ...
  contractType,
  enabled
}: UsePrimarySaleTransactionStepsParams): _tanstack_react_query345.UseQueryResult<Step[], Error>;
//#endregion
...
//#endregion
export { CreateReqWithDateExpiry$1 as CreateReqWithDateExpiry, GenerateListingTransactionProps, GenerateOfferTransactionProps, TransactionStep, TransferTokensParams, UseGenerateListingTransactionArgs, UseGenerateOfferTransactionArgs, UseMarketTransactionStepsParams, UsePrimarySaleTransactionStepsParams, generateCancelTransaction, generateListingTransaction, generateOfferTransaction, generateSellTransaction, useBuyTransaction, useCancelOrder, useCancelTransactionSteps, useGenerateCancelTransaction, useGenerateListingTransaction, useGenerateOfferTransaction, useGenerateSellTransaction, useMarketTransactionSteps, useOrderSteps, usePrimarySaleTransactionSteps, useProcessStep, useTransactionExecution, useTransactionType, useTransferTokens };
//# sourceMappingURL=index-tjybfnTg.d.ts.map