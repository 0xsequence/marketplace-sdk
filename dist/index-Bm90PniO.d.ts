import { CheckoutOptionsItem, CheckoutOptionsMarketplaceReturn, CheckoutOptionsSalesContractReturn, CollectiblePrimarySaleItem, ContractType, GetCountOfPrimarySaleItemsReturn, ListPrimarySaleItemsReturn, MarketplaceKind, MarketplaceSdkContext, Optional, PrimarySaleItem, QueryArg, SdkConfig, TokenMetadata as TokenMetadata$1 } from "./create-config-BJwAgEA2.js";
import { CollectiblesResponse, UseInventoryArgs } from "./index-CmwAQKld.js";
import { CheckoutOptionsQueryOptions, CheckoutOptionsSalesContractQueryOptions, fetchCheckoutOptions, fetchCheckoutOptionsSalesContract } from "./index-C4OcZd8X.js";
import { ListPrimarySaleItemsQueryOptions, UseCountOfPrimarySaleItemsArgs } from "./index-T6d_rRqP.js";
import { ComparePricesQueryOptions, ComparePricesReturn, ConvertPriceToUSDQueryOptions, ConvertPriceToUSDReturn } from "./index-C-iWLKd5.js";
import * as react0 from "react";
import * as _tanstack_react_query169 from "@tanstack/react-query";
import { skipToken } from "@tanstack/react-query";
import * as _0xsequence_indexer21 from "@0xsequence/indexer";
...
declare function useCountOfPrimarySaleItems(args: UseCountOfPrimarySaleItemsArgs): _tanstack_react_query169.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useGetCountOfPrimarySaleItems(params: UseGetCountParams): _tanstack_react_query169.UseQueryResult<GetCountOfPrimarySaleItemsReturn, Error>;
//#endregion
...
declare function useList721ShopCardData({
  ...
  isLoading: boolean;
  tokenSuppliesData: _tanstack_react_query169.InfiniteData<_0xsequence_indexer21.GetTokenSuppliesReturn, unknown> | undefined;
};
//#endregion
...
declare function useInventory(args: UseInventoryArgs): _tanstack_react_query169.UseQueryResult<CollectiblesResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCheckoutOptions(params: UseCheckoutOptionsParams): _tanstack_react_query169.UseQueryResult<CheckoutOptionsMarketplaceReturn, Error>;
 ...
 * ```
 */
declare function useCheckoutOptionsSalesContract(params: UseCheckoutOptionsSalesContractParams | typeof skipToken): _tanstack_react_query169.UseQueryResult<CheckoutOptionsSalesContractReturn, Error>;
 ...
 * ```
 */
declare function useComparePrices(params: UseComparePricesParams): _tanstack_react_query169.UseQueryResult<ComparePricesReturn, Error>;
 ...
 * ```
 */
declare function useConvertPriceToUSD(params: UseConvertPriceToUSDParams): _tanstack_react_query169.UseQueryResult<ConvertPriceToUSDReturn, Error>;
...
declare const useEnsureCorrectChain: () => {
  ...
  ensureCorrectChainAsync: (targetChainId: number) => Promise<void | {
    ...
    contracts?: {
      [x: string]: viem59.ChainContract | {
        [sourceId: number]: viem59.ChainContract | undefined;
      } | undefined;
      ensRegistry?: viem59.ChainContract | undefined;
      ensUniversalResolver?: viem59.ChainContract | undefined;
      multicall3?: viem59.ChainContract | undefined;
      erc6492Verifier?: viem59.ChainContract | undefined;
    } | undefined;
    ...
    fees?: viem59.ChainFees<viem59.ChainFormatters | undefined> | undefined;
    formatters?: viem59.ChainFormatters | undefined;
    serializers?: viem59.ChainSerializers<viem59.ChainFormatters | undefined, viem59.TransactionSerializable> | undefined;
  }>;
...
declare const useGetReceiptFromHash: () => {
  waitForReceipt: (transactionHash: Hex) => Promise<viem59.TransactionReceipt>;
};
//#endregion
...
declare function useRoyalty(args: UseRoyaltyArgs): {
  ...
  error: viem59.ReadContractErrorType;
  isError: true;
  isPending: false;
  isLoading: false;
  ...
  failureCount: number;
  failureReason: viem59.ReadContractErrorType | null;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query169.RefetchOptions) => Promise<_tanstack_react_query169.QueryObserverResult<readonly [`0x${string}`, bigint], viem59.ReadContractErrorType>>;
  fetchStatus: _tanstack_react_query169.FetchStatus;
  promise: Promise<readonly [`0x${string}`, bigint]>;
  queryKey: _tanstack_react_query169.QueryKey;
} | {
  data: {
    percentage: bigint;
    recipient: Address;
 ...
 * ```
 */
declare function useListPrimarySaleItems(params: UseListPrimarySaleItemsParams): _tanstack_react_query169.UseInfiniteQueryResult<_tanstack_react_query169.InfiniteData<ListPrimarySaleItemsReturn, unknown>, Error>;
//#endregion
...
//# sourceMappingURL=index-Bm90PniO.d.ts.map