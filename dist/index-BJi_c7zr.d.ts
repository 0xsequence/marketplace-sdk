import { CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PriceFilter, PropertyFilter } from "./create-config-sLNrdjHZ.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-CG0EPovX.js";
import { MarketCollectibleCardProps } from "./types-5uPqvcoQ.js";
import * as _tanstack_react_query148 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query148.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query148.FetchNextPageOptions) => Promise<_tanstack_react_query148.InfiniteQueryObserverResult<_tanstack_react_query148.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query148.UseQueryResult<{
...
//# sourceMappingURL=index-BJi_c7zr.d.ts.map