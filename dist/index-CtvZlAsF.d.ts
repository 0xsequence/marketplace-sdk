import { CollectiblePrimarySaleItem, GetCountOfPrimarySaleItemsArgs, GetCountOfPrimarySaleItemsReturn, GetPrimarySaleItemArgs, ListPrimarySaleItemsReturn, Page, PrimarySaleItemsFilter, SdkConfig, ValuesOptional } from "./create-config-rrEYvm6u.js";
import { StandardQueryOptions } from "./query-brXxOcH0.js";
import * as _tanstack_react_query344 from "@tanstack/react-query";
import * as _tanstack_react_query357 from "@tanstack/react-query";
...
declare function countOfPrimarySaleItemsOptions(args: UseCountOfPrimarySaleItemsArgs, config: SdkConfig): _tanstack_react_query344.OmitKeyof<_tanstack_react_query344.UseQueryOptions<number, Error, number, readonly ["primarySaleItemsCount", {
  chainId: string;
  primarySaleContractAddress: `0x${string}`;
  filter: PrimarySaleItemsFilter | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query344.QueryFunction<number, readonly ["primarySaleItemsCount", {
    chainId: string;
    primarySaleContractAddress: `0x${string}`;
    filter: PrimarySaleItemsFilter | undefined;
  }], never> | undefined;
...
declare function primarySaleItemQueryOptions(params: PrimarySaleItemQueryOptions): _tanstack_react_query357.OmitKeyof<_tanstack_react_query357.UseQueryOptions<CollectiblePrimarySaleItem, Error, CollectiblePrimarySaleItem, readonly ["primarySaleItem", {
  chainId: string;
  primarySaleContractAddress: string | undefined;
  tokenId: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query357.QueryFunction<CollectiblePrimarySaleItem, readonly ["primarySaleItem", {
    chainId: string;
    primarySaleContractAddress: string | undefined;
    tokenId: string | undefined;
  }], never> | undefined;
...
declare const listPrimarySaleItemsQueryOptions: (params: ListPrimarySaleItemsQueryOptions) => _tanstack_react_query361.OmitKeyof<_tanstack_react_query361.UseInfiniteQueryOptions<ListPrimarySaleItemsReturn, Error, _tanstack_react_query361.InfiniteData<ListPrimarySaleItemsReturn, unknown>, readonly ["listPrimarySaleItems", {
  chainId: string;
  primarySaleContractAddress: `0x${string}` | undefined;
  filter: PrimarySaleItemsFilter | undefined;
}], {
  ...
  queryFn?: _tanstack_react_query361.QueryFunction<ListPrimarySaleItemsReturn, readonly ["listPrimarySaleItems", {
    chainId: string;
    primarySaleContractAddress: `0x${string}` | undefined;
    filter: PrimarySaleItemsFilter | undefined;
  }], {
...
declare const primarySaleItemsCountQueryOptions: (args: PrimarySaleItemsCountQueryOptions) => _tanstack_react_query378.OmitKeyof<_tanstack_react_query378.UseQueryOptions<GetCountOfPrimarySaleItemsReturn, Error, GetCountOfPrimarySaleItemsReturn, readonly ["primarySaleItemsCount", {
  chainId: string;
  primarySaleContractAddress: `0x${string}` | undefined;
  filter: PrimarySaleItemsFilter | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query378.QueryFunction<GetCountOfPrimarySaleItemsReturn, readonly ["primarySaleItemsCount", {
    chainId: string;
    primarySaleContractAddress: `0x${string}` | undefined;
    filter: PrimarySaleItemsFilter | undefined;
  }], never> | undefined;
...
//# sourceMappingURL=index-CtvZlAsF.d.ts.map