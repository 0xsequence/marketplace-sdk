import { Optional, PriceFilter, PropertyFilter, PropertyType } from "./create-config-CsagtMvq.js";
import { FiltersQueryOptions } from "./filters-C4MMcUOP.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query253.UseQueryResult<PropertyFilter$1[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query253.RefetchOptions) => Promise<_tanstack_react_query253.QueryObserverResult<PropertyFilter$1[], Error>>;
  fetchStatus: _tanstack_react_query253.FetchStatus;
...
//# sourceMappingURL=index-DBYvpZWU.d.ts.map