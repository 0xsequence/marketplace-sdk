import { SdkConfig, ValuesOptional } from "./create-config-DDGnmsgd.js";
import { StandardInfiniteQueryOptions, StandardQueryOptions } from "./query-BG-MA1MB.js";
import * as _tanstack_react_query271 from "@tanstack/react-query";
...
declare function getTokenRangesQueryOptions(params: GetTokenRangesQueryOptions): _tanstack_react_query271.OmitKeyof<_tanstack_react_query271.UseQueryOptions<GetTokenIDRangesReturn, Error, GetTokenIDRangesReturn, (string | GetTokenRangesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query271.QueryFunction<GetTokenIDRangesReturn, (string | GetTokenRangesQueryOptions)[], never> | undefined;
} & {
 ...
 */
declare function listBalancesOptions(args: UseListBalancesArgs, config: SdkConfig): _tanstack_react_query271.OmitKeyof<_tanstack_react_query271.UseInfiniteQueryOptions<GetTokenBalancesReturn, Error, _tanstack_react_query271.InfiniteData<GetTokenBalancesReturn, unknown>, (SdkConfig | "balances" | "tokenBalances" | UseListBalancesArgs)[], any>, "queryFn"> & {
  queryFn?: _tanstack_react_query271.QueryFunction<GetTokenBalancesReturn, (SdkConfig | "balances" | "tokenBalances" | UseListBalancesArgs)[], any> | undefined;
} & {
  queryKey: (SdkConfig | "balances" | "tokenBalances" | UseListBalancesArgs)[] & {
    [dataTagSymbol]: _tanstack_react_query271.InfiniteData<GetTokenBalancesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listTokenMetadataQueryOptions(params: ListTokenMetadataQueryOptions): _tanstack_react_query271.OmitKeyof<_tanstack_react_query271.UseQueryOptions<_0xsequence_metadata130.TokenMetadata[], Error, _0xsequence_metadata130.TokenMetadata[], ("tokens" | "metadata" | ListTokenMetadataQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query271.QueryFunction<_0xsequence_metadata130.TokenMetadata[], ("tokens" | "metadata" | ListTokenMetadataQueryOptions)[], never> | undefined;
} & {
...
declare function searchTokenMetadataQueryOptions(params: SearchTokenMetadataQueryOptions): _tanstack_react_query271.OmitKeyof<_tanstack_react_query271.UseInfiniteQueryOptions<SearchTokenMetadataReturn, Error, _tanstack_react_query271.InfiniteData<SearchTokenMetadataReturn, unknown>, (string | SearchTokenMetadataQueryOptions)[], {
  page: number;
  pageSize: number;
}>, "queryFn"> & {
  queryFn?: _tanstack_react_query271.QueryFunction<SearchTokenMetadataReturn, (string | SearchTokenMetadataQueryOptions)[], {
    page: number;
    pageSize: number;
  }> | undefined;
} & {
  queryKey: (string | SearchTokenMetadataQueryOptions)[] & {
    [dataTagSymbol]: _tanstack_react_query271.InfiniteData<SearchTokenMetadataReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function tokenSuppliesQueryOptions(params: TokenSuppliesQueryOptions): _tanstack_react_query271.OmitKeyof<_tanstack_react_query271.UseInfiniteQueryOptions<_0xsequence_indexer2.GetTokenSuppliesReturn, Error, _tanstack_react_query271.InfiniteData<_0xsequence_indexer2.GetTokenSuppliesReturn, unknown>, ("tokens" | "supplies" | TokenSuppliesQueryOptions)[], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query271.QueryFunction<_0xsequence_indexer2.GetTokenSuppliesReturn, ("tokens" | "supplies" | TokenSuppliesQueryOptions)[], Page> | undefined;
} & {
  queryKey: ("tokens" | "supplies" | TokenSuppliesQueryOptions)[] & {
    [dataTagSymbol]: _tanstack_react_query271.InfiniteData<_0xsequence_indexer2.GetTokenSuppliesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
//# sourceMappingURL=tokenSupplies-DbT2e8U4.d.ts.map