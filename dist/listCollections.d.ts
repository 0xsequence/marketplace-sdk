import { An as GetCollectionActiveListingsCurrenciesReturn, G as SdkConfig, K as CardType, Lt as ContractType, Mn as GetCollectionActiveOffersCurrenciesReturn, Mt as Collection, Or as ListCollectionActivitiesArgs, Pn as GetCollectionDetailArgs, a as CollectionFilterSettings, c as MarketplaceConfig, ii as OrderbookKind, j as ValuesOptional, jn as GetCollectionActiveOffersCurrenciesArgs, kn as GetCollectionActiveListingsCurrenciesArgs, kr as ListCollectionActivitiesReturn, qt as Currency, wi as SortBy } from "./create-config.js";
...
declare function collectionQueryOptions(params: CollectionQueryOptions): _tanstack_react_query320.OmitKeyof<_tanstack_react_query320.UseQueryOptions<_0xsequence_metadata130.ContractInfo, Error, _0xsequence_metadata130.ContractInfo, readonly ["collections", "detail", {
  chainID: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query320.QueryFunction<_0xsequence_metadata130.ContractInfo, readonly ["collections", "detail", {
    chainID: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare function collectionActiveListingsCurrenciesQueryOptions(params: CollectionActiveListingsCurrenciesQueryOptions): _tanstack_react_query320.OmitKeyof<_tanstack_react_query320.UseQueryOptions<Currency[], Error, Currency[], readonly ["collections", "activeListingsCurrencies", {
  chainId: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query320.QueryFunction<Currency[], readonly ["collections", "activeListingsCurrencies", {
    chainId: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare function collectionActiveOffersCurrenciesQueryOptions(params: CollectionActiveOffersCurrenciesQueryOptions): _tanstack_react_query320.OmitKeyof<_tanstack_react_query320.UseQueryOptions<Currency[], Error, Currency[], readonly ["collections", "activeOffersCurrencies", {
  chainId: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query320.QueryFunction<Currency[], readonly ["collections", "activeOffersCurrencies", {
    chainId: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare function collectionBalanceDetailsQueryOptions(params: CollectionBalanceDetailsQueryOptions): _tanstack_react_query320.OmitKeyof<_tanstack_react_query320.UseQueryOptions<GetTokenBalancesDetailsReturn, Error, GetTokenBalancesDetailsReturn, readonly ["balances", "collectionBalanceDetails", {
  chainId: number;
  filter: CollectionBalanceFilter;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query320.QueryFunction<GetTokenBalancesDetailsReturn, readonly ["balances", "collectionBalanceDetails", {
    chainId: number;
    filter: CollectionBalanceFilter;
  }], never> | undefined;
} & {
...
declare function collectionDetailsQueryOptions(params: CollectionDetailsQueryOptions): _tanstack_react_query320.OmitKeyof<_tanstack_react_query320.UseQueryOptions<Collection, Error, Collection, readonly ["collections", "detail", {
  chainId: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query320.QueryFunction<Collection, readonly ["collections", "detail", {
    chainId: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare function listCollectionActivitiesQueryOptions(params: ListCollectionActivitiesQueryOptions): _tanstack_react_query320.OmitKeyof<_tanstack_react_query320.UseQueryOptions<ListCollectionActivitiesReturn, Error, ListCollectionActivitiesReturn, readonly ["collections", "collectionActivities", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  page: {
    page: number;
  ...
  queryFn?: _tanstack_react_query320.QueryFunction<ListCollectionActivitiesReturn, readonly ["collections", "collectionActivities", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    page: {
      page: number;
...
declare function listCollectionsQueryOptions(params: ListCollectionsQueryOptions): _tanstack_react_query320.UseQueryOptions<({
  chainId: number;
  address: string;
  source: string;
  name: string;
  ...
  initialData?: ({
    ...
    sortOrder?: number;
    private: boolean;
  })[] | _tanstack_react_query320.InitialDataFunction<({
    chainId: number;
    address: string;
    source: string;
    name: string;
...
declare const listCollectionsOptions: ({
  ...
  config: SdkConfig;
}) => _tanstack_react_query320.UseQueryOptions<({
  chainId: number;
  address: string;
  source: string;
  name: string;
