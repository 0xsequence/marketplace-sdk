import { _ as SdkConfig, _n as Optional, xn as SdkQueryParams } from "./create-config.js";
...
import * as _0xsequence_api_client318 from "@0xsequence/api-client";
 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query417.UseQueryResult<_0xsequence_api_client318.GetTokenBalancesDetailsResponse, Error>;
 ...
 * ```
 */
declare function useCollectionList(params?: UseCollectionListParams): _tanstack_react_query417.UseQueryResult<({
  chainId: _0xsequence_api_client318.ChainId;
  address: _0xsequence_api_client318.Address;
  source: string;
  name: string;
  type: string;
  symbol: string;
  ...
  deployed: boolean;
  bytecodeHash: string;
  extensions: _0xsequence_api_client318.ContractInfoExtensions;
  updatedAt: string;
  queuedAt?: string;
  status: string;
  ...
  destinationMarketplace: _0xsequence_api_client318.OrderbookKind;
  filterSettings?: _0xsequence_api_client318.CollectionFilterSettings;
  id: number;
  projectId: _0xsequence_api_client318.ProjectId;
  itemsAddress: _0xsequence_api_client318.Address;
  bannerUrl: string;
  sortOrder?: number;
  private: boolean;
  createdAt?: string;
  ...
  saleAddress: _0xsequence_api_client318.Address;
  tokenIds: _0xsequence_api_client318.TokenId[];
  customTokenIds: _0xsequence_api_client318.TokenId[];
  id: number;
  projectId: _0xsequence_api_client318.ProjectId;
  itemsAddress: _0xsequence_api_client318.Address;
  bannerUrl: string;
 ...
 * ```
 */
declare function useCollectionMarketActivities(params: UseCollectionMarketActivitiesParams): _tanstack_react_query417.UseQueryResult<_0xsequence_api_client318.ListCollectionActivitiesResponse, Error>;
...
declare const collectionMarketDetailPollingOptions: (args: UseCollectionMarketDetailPollingParams, config: SdkConfig) => _tanstack_react_query417.OmitKeyof<_tanstack_react_query417.UseQueryOptions<_0xsequence_api_client318.Collection, Error, _0xsequence_api_client318.Collection, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query417.QueryFunction<_0xsequence_api_client318.Collection, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _0xsequence_api_client318.Collection;
    [dataTagErrorSymbol]: Error;
  };
};
declare const useCollectionMarketDetailPolling: (args: UseCollectionMarketDetailPollingParams) => _tanstack_react_query417.UseQueryResult<_0xsequence_api_client318.Collection, Error>;
//#endregion
...
declare function useCollectionMarketFilteredCount(params: UseCollectionMarketFilteredCountParams): _tanstack_react_query417.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionMarketFloor(params: UseCollectionMarketFloorParams): _tanstack_react_query417.UseQueryResult<_0xsequence_api_client318.CollectibleOrder, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionMarketItems(params: UseCollectionMarketItemsParams): _tanstack_react_query417.UseInfiniteQueryResult<_tanstack_react_query417.InfiniteData<_0xsequence_api_client318.ListOrdersWithCollectiblesResponse, unknown>, Error>;
 ...
 * ```
 */
declare function useCollectionMarketItemsCount(params: UseCollectionMarketItemsCountParams): _tanstack_react_query417.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionMarketItemsPaginated(params: UseCollectionMarketItemsPaginatedParams): _tanstack_react_query417.UseQueryResult<_0xsequence_api_client318.ListOrdersWithCollectiblesResponse, Error>;
 ...
 * ```
 */
declare function useCollectionMetadata(params: UseCollectionMetadataParams): _tanstack_react_query417.UseQueryResult<_0xsequence_api_client318.ContractInfo, Error>;
//#endregion
...
declare function collectionActiveListingsCurrenciesQueryOptions(params: CollectionActiveListingsCurrenciesQueryOptions): _tanstack_react_query417.OmitKeyof<_tanstack_react_query417.UseQueryOptions<Currency[], Error, Currency[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query417.QueryFunction<Currency[], readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
 ...
 * ```
 */
declare function useCollectionActiveListingsCurrencies(params: UseCollectionActiveListingsCurrenciesParams): _tanstack_react_query417.UseQueryResult<_0xsequence_api_client318.Currency[], Error>;
//#endregion
...
declare function collectionActiveOffersCurrenciesQueryOptions(params: CollectionActiveOffersCurrenciesQueryOptions): _tanstack_react_query417.OmitKeyof<_tanstack_react_query417.UseQueryOptions<Currency[], Error, Currency[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query417.QueryFunction<Currency[], readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: Currency[];
 ...
 * ```
 */
declare function useCollectionActiveOffersCurrencies(params: UseCollectionActiveOffersCurrenciesParams): _tanstack_react_query417.UseQueryResult<_0xsequence_api_client318.Currency[], Error>;
//#endregion
