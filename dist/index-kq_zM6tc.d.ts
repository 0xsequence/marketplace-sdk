import { At as ContractType, G as SdkConfig, Wr as MetadataStatus, ni as Page$1 } from "./create-config-BO68TZC5.js";
...
declare function inventoryOptions(args: UseInventoryArgs, config: SdkConfig): _tanstack_react_query200.OmitKeyof<_tanstack_react_query200.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, (string | number)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query200.QueryFunction<CollectiblesResponse, (string | number)[], never> | undefined;
} & {
...
//# sourceMappingURL=index-kq_zM6tc.d.ts.map