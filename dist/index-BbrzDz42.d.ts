import { ListCollectibleActivitiesReturn, ListCollectiblesReturn, Optional } from "./create-config-DrQDberp.js";
import { CollectibleQueryOptions, CountOfCollectablesQueryOptions, ListCollectibleActivitiesQueryOptions, ListCollectiblesPaginatedQueryOptions, ListCollectiblesQueryOptions, UseBalanceOfCollectibleArgs, fetchListCollectibleActivities, fetchListCollectiblesPaginated } from "./listCollectiblesPaginated-BWhNDyUY.js";
 ...
 * ```
 */
declare function useBalanceOfCollectible(args: UseBalanceOfCollectibleArgs): _tanstack_react_query44.UseQueryResult<_0xsequence_indexer0.TokenBalance, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectible(params: UseCollectibleParams): _tanstack_react_query44.UseQueryResult<_0xsequence_metadata4.TokenMetadata, Error>;
//#endregion
 ...
 * ```
 */
declare function useCountOfCollectables(params: UseCountOfCollectablesParams): _tanstack_react_query44.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectibleActivities(params: UseListCollectibleActivitiesParams): _tanstack_react_query44.UseQueryResult<ListCollectibleActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollectibles(params: UseListCollectiblesParams): _tanstack_react_query44.UseInfiniteQueryResult<_tanstack_react_query44.InfiniteData<ListCollectiblesReturn, unknown>, Error>;
 ...
 * ```
 */
declare function useListCollectiblesPaginated(params: UseListCollectiblesPaginatedParams): _tanstack_react_query44.UseQueryResult<ListCollectiblesReturn, Error>;
...
//# sourceMappingURL=index-BbrzDz42.d.ts.map