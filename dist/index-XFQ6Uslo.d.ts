import { AdditionalFee, BuyModalProps, ContractType, CreateReq, GenerateCancelTransactionArgs, GenerateListingTransactionArgs, GenerateOfferTransactionArgs, GenerateSellTransactionArgs, MarketplaceKind, ModalCallbacks, SdkConfig, Step, TransactionType$2 as TransactionType, WalletKind } from "./create-config-BpPJGqAC.js";
...
declare function useBuyTransaction(modalProps: BuyModalProps): {
  ...
  error: Error | null;
  isError: boolean;
  refetch: (options?: _tanstack_react_query384.RefetchOptions) => Promise<_tanstack_react_query384.QueryObserverResult<Step[], Error>>;
};
//#endregion
...
declare const useGenerateCancelTransaction: (params: UseGenerateCancelTransactionArgs) => {
  generateCancelTransaction: _tanstack_react_query0.UseMutateFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  generateCancelTransactionAsync: _tanstack_react_query0.UseMutateAsyncFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateListingTransaction: (params: UseGenerateListingTransactionArgs) => {
  generateListingTransaction: _tanstack_react_query8.UseMutateFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateListingTransactionAsync: _tanstack_react_query8.UseMutateAsyncFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateOfferTransaction: (params: UseGenerateOfferTransactionArgs) => {
  generateOfferTransaction: _tanstack_react_query16.UseMutateFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateOfferTransactionAsync: _tanstack_react_query16.UseMutateAsyncFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateSellTransaction: (params: UseGenerateSellTransactionArgs) => {
  generateSellTransaction: _tanstack_react_query24.UseMutateFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateSellTransactionAsync: _tanstack_react_query24.UseMutateAsyncFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare function useMarketTransactionSteps({
  ...
  additionalFees,
  enabled
}: UseMarketTransactionStepsParams): _tanstack_react_query32.UseQueryResult<Step[], Error>;
//#endregion
...
declare function usePrimarySaleTransactionSteps({
  ...
  contractType,
  enabled
}: UsePrimarySaleTransactionStepsParams): _tanstack_react_query33.UseQueryResult<Step[], Error>;
//#endregion
...
//# sourceMappingURL=index-XFQ6Uslo.d.ts.map