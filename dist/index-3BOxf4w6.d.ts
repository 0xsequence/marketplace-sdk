import { A as Optional, Ai as TokenMetadata$1, Gn as GetCountOfPrimarySaleItemsReturn, J as MarketplaceSdkContext, Mt as CollectiblePrimarySaleItem, Rr as ListPrimarySaleItemsReturn, Vt as ContractType, Y as SdkConfig, ii as PrimarySaleItem, j as QueryArg, kt as CheckoutOptionsSalesContractReturn, wt as CheckoutOptionsItem } from "./create-config-Dz-QylqB.js";
import { E as CheckoutOptionsSalesContractQueryOptions, S as ComparePricesReturn, _ as ConvertPriceToUSDReturn, g as ConvertPriceToUSDQueryOptions, k as fetchCheckoutOptionsSalesContract, l as CollectiblesResponse, o as ListPrimarySaleItemsQueryOptions, p as UseCountOfPrimarySaleItemsArgs, u as UseInventoryArgs, x as ComparePricesQueryOptions } from "./index-D6ynyDEk.js";
import * as react0 from "react";
import * as _tanstack_react_query226 from "@tanstack/react-query";
...
declare function useCountOfPrimarySaleItems(args: UseCountOfPrimarySaleItemsArgs): _tanstack_react_query226.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useGetCountOfPrimarySaleItems(params: UseGetCountParams): _tanstack_react_query226.UseQueryResult<GetCountOfPrimarySaleItemsReturn, Error>;
//#endregion
...
declare function useList721ShopCardData({
  ...
  isLoading: boolean;
  tokenSuppliesData: _tanstack_react_query226.InfiniteData<_0xsequence_indexer4.GetTokenSuppliesReturn, unknown> | undefined;
};
//#endregion
...
declare function useInventory(args: UseInventoryArgs): _tanstack_react_query226.UseQueryResult<CollectiblesResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCheckoutOptionsSalesContract(params: UseCheckoutOptionsSalesContractParams | typeof skipToken): _tanstack_react_query226.UseQueryResult<CheckoutOptionsSalesContractReturn, Error>;
 ...
 * ```
 */
declare function useComparePrices(params: UseComparePricesParams): _tanstack_react_query226.UseQueryResult<ComparePricesReturn, Error>;
 ...
 * ```
 */
declare function useConvertPriceToUSD(params: UseConvertPriceToUSDParams): _tanstack_react_query226.UseQueryResult<ConvertPriceToUSDReturn, Error>;
...
declare function useRoyalty(args: UseRoyaltyArgs): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query226.RefetchOptions) => Promise<_tanstack_react_query226.QueryObserverResult<readonly [`0x${string}`, bigint], viem29.ReadContractErrorType>>;
  fetchStatus: _tanstack_react_query226.FetchStatus;
  promise: Promise<readonly [`0x${string}`, bigint]>;
  queryKey: _tanstack_react_query226.QueryKey;
} | {
  data: {
    percentage: bigint;
    recipient: Address;
...
declare function MarketplaceProvider({
  ...
  children,
  openConnectModal
}: MarketplaceSdkProviderProps): react_jsx_runtime11.JSX.Element;
 ...
 * ```
 */
declare function useListPrimarySaleItems(params: UseListPrimarySaleItemsParams): _tanstack_react_query226.UseInfiniteQueryResult<_tanstack_react_query226.InfiniteData<ListPrimarySaleItemsReturn, unknown>, Error>;
//#endregion
...
//# sourceMappingURL=index-3BOxf4w6.d.ts.map