...
import { AddEthereumChainParameter, Address, BaseError, BaseErrorType, Chain, Client, EIP1193RequestFn, Hash, Hex, ProviderConnectInfo, ProviderMessage, PublicClient, Transport, TypedDataDomain } from "viem";
import { SequenceIndexer } from "@0xsequence/indexer";
import * as MetadataGen from "@0xsequence/metadata";
import { Filter as Filter$2, Metadata, PropertyFilter as PropertyFilter$1 } from "@0xsequence/metadata";
...
import * as _tanstack_react_query441 from "@tanstack/react-query";
...
interface MarketplaceClient$1 {
  listCurrencies(req: ListCurrenciesRequest$1, headers?: object, signal?: AbortSignal): Promise<ListCurrenciesResponse>;
  ...
  getHighestPriceOfferForCollectible(req: GetHighestPriceOfferForCollectibleRequest$1, headers?: object, signal?: AbortSignal): Promise<GetHighestPriceOfferForCollectibleResponse>;
  getLowestPriceListingForCollectible(req: GetLowestPriceListingForCollectibleRequest$1, headers?: object, signal?: AbortSignal): Promise<GetLowestPriceListingForCollectibleResponse>;
  ...
  listListingsForCollectible(req: ListListingsForCollectibleRequest, headers?: object, signal?: AbortSignal): Promise<ListListingsForCollectibleResponse$1>;
  listOffersForCollectible(req: ListOffersForCollectibleRequest$1, headers?: object, signal?: AbortSignal): Promise<ListOffersForCollectibleResponse$1>;
  listOrdersWithCollectibles(req: ListOrdersWithCollectiblesRequest$1, headers?: object, signal?: AbortSignal): Promise<ListOrdersWithCollectiblesResponse$1>;
  ...
  generateSellTransaction(req: GenerateSellTransactionRequest$1, headers?: object, signal?: AbortSignal): Promise<GenerateSellTransactionResponse>;
  generateListingTransaction(req: GenerateListingTransactionRequest$1, headers?: object, signal?: AbortSignal): Promise<GenerateListingTransactionResponse>;
  generateOfferTransaction(req: GenerateOfferTransactionRequest$1, headers?: object, signal?: AbortSignal): Promise<GenerateOfferTransactionResponse>;
  generateCancelTransaction(req: GenerateCancelTransactionRequest$1, headers?: object, signal?: AbortSignal): Promise<GenerateCancelTransactionResponse>;
  /**
   ...
   */
  listCollectibles(req: ListCollectiblesRequest$1, headers?: object, signal?: AbortSignal): Promise<ListCollectiblesResponse$1>;
  ...
  getFloorOrder(req: GetFloorOrderRequest$1, headers?: object, signal?: AbortSignal): Promise<GetFloorOrderResponse>;
  /**
   * Not Implemented
   */
  listCollectionActivities(req: ListCollectionActivitiesRequest$1, headers?: object, signal?: AbortSignal): Promise<ListCollectionActivitiesResponse>;
  /**
   * Not Implemented
   */
  listCollectibleActivities(req: ListCollectibleActivitiesRequest$1, headers?: object, signal?: AbortSignal): Promise<ListCollectibleActivitiesResponse>;
  ...
  checkoutOptionsMarketplace(req: CheckoutOptionsMarketplaceRequest$1, headers?: object, signal?: AbortSignal): Promise<CheckoutOptionsMarketplaceResponse>;
  ...
  listPrimarySaleItems(req: ListPrimarySaleItemsRequest$1, headers?: object, signal?: AbortSignal): Promise<ListPrimarySaleItemsResponse$1>;
  getCountOfPrimarySaleItems(req: GetCountOfPrimarySaleItemsRequest$1, headers?: object, signal?: AbortSignal): Promise<GetCountOfPrimarySaleItemsResponse>;
}
...
interface GetHighestPriceOfferForCollectibleRequest$1 {
  chainId: string;
  contractAddress: string;
  tokenId: bigint;
  filter?: OrderFilter;
...
interface GetLowestPriceListingForCollectibleRequest$1 {
  chainId: string;
  contractAddress: string;
  tokenId: bigint;
  filter?: OrderFilter;
...
interface ListListingsForCollectibleResponse$1 {
  listings: Array<Order$1>;
  page?: Page;
}
interface ListOffersForCollectibleRequest$1 {
  chainId: string;
  contractAddress: string;
  tokenId: bigint;
  filter?: OrderFilter;
...
interface ListOffersForCollectibleResponse$1 {
  offers: Array<Order$1>;
  page?: Page;
}
interface ListOrdersWithCollectiblesRequest$1 {
  chainId: string;
  side: OrderSide;
  contractAddress: string;
  filter?: OrdersFilter;
...
interface ListOrdersWithCollectiblesResponse$1 {
  collectibles: Array<CollectibleOrder$1>;
  page?: Page;
}
...
interface GenerateSellTransactionRequest$1 {
  chainId: string;
  collectionAddress: string;
  seller: string;
  marketplace: MarketplaceKind;
...
interface GenerateListingTransactionRequest$1 {
  chainId: string;
  collectionAddress: string;
  owner: string;
  contractType: ContractType$2;
...
interface GenerateOfferTransactionRequest$1 {
  chainId: string;
  collectionAddress: string;
  maker: string;
  contractType: ContractType$2;
...
interface GenerateCancelTransactionRequest$1 {
  chainId: string;
  collectionAddress: string;
  maker: string;
  marketplace: MarketplaceKind;
...
interface ListCollectiblesRequest$1 {
  chainId: string;
  side: OrderSide;
  contractAddress: string;
...
interface ListCollectiblesResponse$1 {
  collectibles: Array<CollectibleOrder$1>;
  page?: Page;
}
...
interface GetFloorOrderRequest$1 {
  chainId: string;
  contractAddress: string;
  filter?: CollectiblesFilter;
}
...
interface ListCollectionActivitiesRequest$1 {
  chainId: string;
  contractAddress: string;
  page?: Page;
}
...
interface ListCollectibleActivitiesRequest$1 {
  chainId: string;
  contractAddress: string;
  tokenId: bigint;
  page?: Page;
...
interface CheckoutOptionsMarketplaceRequest$1 {
  chainId: string;
  wallet: string;
...
interface ListPrimarySaleItemsRequest$1 {
  chainId: string;
  primarySaleContractAddress: string;
  filter?: PrimarySaleItemsFilter;
  page?: Page;
}
interface ListPrimarySaleItemsResponse$1 {
  primarySaleItems: Array<CollectiblePrimarySaleItem>;
  page?: Page;
}
interface GetCountOfPrimarySaleItemsRequest$1 {
  chainId: string;
  primarySaleContractAddress: string;
  filter?: PrimarySaleItemsFilter;
}
...
declare class Marketplace implements MarketplaceClient$1 {
  ...
  constructor(hostname: string, fetch: Fetch$3);
  private url;
  queryKey: {
    listCurrencies: (req: ListCurrenciesRequest$1) => readonly ["Marketplace", "listCurrencies", ListCurrenciesRequest$1];
    ...
    getHighestPriceOfferForCollectible: (req: GetHighestPriceOfferForCollectibleRequest$1) => readonly ["Marketplace", "getHighestPriceOfferForCollectible", GetHighestPriceOfferForCollectibleRequest$1];
    getLowestPriceListingForCollectible: (req: GetLowestPriceListingForCollectibleRequest$1) => readonly ["Marketplace", "getLowestPriceListingForCollectible", GetLowestPriceListingForCollectibleRequest$1];
    ...
    listOffersForCollectible: (req: ListOffersForCollectibleRequest$1) => readonly ["Marketplace", "listOffersForCollectible", ListOffersForCollectibleRequest$1];
    listOrdersWithCollectibles: (req: ListOrdersWithCollectiblesRequest$1) => readonly ["Marketplace", "listOrdersWithCollectibles", ListOrdersWithCollectiblesRequest$1];
    ...
    generateSellTransaction: (req: GenerateSellTransactionRequest$1) => readonly ["Marketplace", "generateSellTransaction", GenerateSellTransactionRequest$1];
    generateListingTransaction: (req: GenerateListingTransactionRequest$1) => readonly ["Marketplace", "generateListingTransaction", GenerateListingTransactionRequest$1];
    generateOfferTransaction: (req: GenerateOfferTransactionRequest$1) => readonly ["Marketplace", "generateOfferTransaction", GenerateOfferTransactionRequest$1];
    generateCancelTransaction: (req: GenerateCancelTransactionRequest$1) => readonly ["Marketplace", "generateCancelTransaction", GenerateCancelTransactionRequest$1];
    execute: (req: ExecuteRequest) => readonly ["Marketplace", "execute", ExecuteRequest];
    listCollectibles: (req: ListCollectiblesRequest$1) => readonly ["Marketplace", "listCollectibles", ListCollectiblesRequest$1];
    ...
    getFloorOrder: (req: GetFloorOrderRequest$1) => readonly ["Marketplace", "getFloorOrder", GetFloorOrderRequest$1];
    listCollectionActivities: (req: ListCollectionActivitiesRequest$1) => readonly ["Marketplace", "listCollectionActivities", ListCollectionActivitiesRequest$1];
    listCollectibleActivities: (req: ListCollectibleActivitiesRequest$1) => readonly ["Marketplace", "listCollectibleActivities", ListCollectibleActivitiesRequest$1];
    ...
    checkoutOptionsMarketplace: (req: CheckoutOptionsMarketplaceRequest$1) => readonly ["Marketplace", "checkoutOptionsMarketplace", CheckoutOptionsMarketplaceRequest$1];
    ...
    listPrimarySaleItems: (req: ListPrimarySaleItemsRequest$1) => readonly ["Marketplace", "listPrimarySaleItems", ListPrimarySaleItemsRequest$1];
    getCountOfPrimarySaleItems: (req: GetCountOfPrimarySaleItemsRequest$1) => readonly ["Marketplace", "getCountOfPrimarySaleItems", GetCountOfPrimarySaleItemsRequest$1];
  };
  listCurrencies: (req: ListCurrenciesRequest$1, headers?: object, signal?: AbortSignal) => Promise<ListCurrenciesResponse>;
  getCollectionDetail: (req: GetCollectionDetailRequest, headers?: object, signal?: AbortSignal) => Promise<GetCollectionDetailResponse>;
  getCollectionActiveListingsCurrencies: (req: GetCollectionActiveListingsCurrenciesRequest, headers?: object, signal?: AbortSignal) => Promise<GetCollectionActiveListingsCurrenciesResponse>;
...
type Fetch$3 = (input: RequestInfo, init?: RequestInit) => Promise<Response>;
//#endregion
//#region ../api/dist/builder.msw.d.ts
//#region src/adapters/builder/builder.gen.d.ts
declare namespace builder_gen_d_exports {
  export { AlreadyCollaboratorError, CollectionFilterSettings$2 as CollectionFilterSettings, EmailTemplateExistsError, FeatureNotIncludedError, Fetch$2 as Fetch, FilterCondition, InvalidArgumentError$2 as InvalidArgumentError, InvalidNetworkError, InvalidTierError, InvitationExpiredError, LookupMarketplaceArgs$1 as LookupMarketplaceArgs, LookupMarketplaceReturn$1 as LookupMarketplaceReturn, MarketCollection$1 as MarketCollection, Marketplace$2 as Marketplace, MarketplacePage$1 as MarketplacePage, MarketplaceService, MarketplaceSettings$1 as MarketplaceSettings, MarketplaceSocials$1 as MarketplaceSocials, MarketplaceWallet$1 as MarketplaceWallet, MarketplaceWalletEcosystem$1 as MarketplaceWalletEcosystem, MarketplaceWalletEmbedded$1 as MarketplaceWalletEmbedded, MarketplaceWalletType, MetadataFilterRule$2 as MetadataFilterRule, MethodNotFoundError$2 as MethodNotFoundError, NotFoundError$2 as NotFoundError, OpenIdProvider$1 as OpenIdProvider, PermissionDeniedError$2 as PermissionDeniedError, ProjectNotFoundError$2 as ProjectNotFoundError, RequestConflictError$2 as RequestConflictError, ServiceDisabledError, SessionExpiredError$2 as SessionExpiredError, ShopCollection$1 as ShopCollection, SubscriptionLimitError, TimeoutError$4 as TimeoutError, UnauthorizedError$2 as UnauthorizedError, UserNotFoundError, WebrpcBadMethodError, WebrpcBadRequestError, WebrpcBadResponseError, WebrpcBadRouteError, WebrpcClientDisconnectedError, WebrpcEndpointError, WebrpcError, WebrpcErrorCodes, WebrpcHeader$2 as WebrpcHeader, WebrpcHeaderValue$2 as WebrpcHeaderValue, WebrpcInternalErrorError, WebrpcRequestFailedError, WebrpcServerPanicError, WebrpcStreamFinishedError, WebrpcStreamLostError, errors$2 as errors, webrpcErrorByCode };
}
declare const WebrpcHeader$2 = "Webrpc";
declare const WebrpcHeaderValue$2 = "webrpc@v0.26.0;gen-typescript@v0.17.0;sequence-builder@v0.1.0";
...
interface LookupMarketplaceReturn$1 {
  ...
  marketCollections: Array<MarketCollection$1>;
  shopCollections: Array<ShopCollection$1>;
}
...
interface MarketCollection$1 {
  ...
  filterSettings?: CollectionFilterSettings$2;
  sortOrder?: number;
  private: boolean;
  createdAt?: string;
  updatedAt?: string;
}
interface CollectionFilterSettings$2 {
  filterOrder: Array<string>;
  exclusions: Array<MetadataFilterRule$2>;
}
interface MetadataFilterRule$2 {
  key: string;
  condition: FilterCondition;
  value?: string;
}
interface ShopCollection$1 {
  id: number;
  projectId: number;
  chainId: number;
  itemsAddress: string;
...
interface MarketplaceService {
   ...
   * Public Methods
   */
  lookupMarketplace(args: LookupMarketplaceArgs$1, headers?: object, signal?: AbortSignal): Promise<LookupMarketplaceReturn$1>;
}
...
declare class UnauthorizedError$2 extends WebrpcError {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class PermissionDeniedError$2 extends WebrpcError {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class SessionExpiredError$2 extends WebrpcError {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class MethodNotFoundError$2 extends WebrpcError {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class RequestConflictError$2 extends WebrpcError {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class ServiceDisabledError extends WebrpcError {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class TimeoutError$4 extends WebrpcError {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class InvalidArgumentError$2 extends WebrpcError {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class NotFoundError$2 extends WebrpcError {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class UserNotFoundError extends WebrpcError {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class ProjectNotFoundError$2 extends WebrpcError {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
...
type Fetch$2 = (input: RequestInfo, init?: RequestInit) => Promise<Response>;
declare class MarketplaceService {
  protected hostname: string;
  protected fetch: Fetch$2;
  protected path: string;
  constructor(hostname: string, fetch: Fetch$2);
  private url;
  lookupMarketplace: (args: LookupMarketplaceArgs$1, headers?: object, signal?: AbortSignal) => Promise<LookupMarketplaceReturn$1>;
}
//#endregion
...
//#endregion
//#endregion
//#region ../node_modules/.pnpm/@0xsequence+indexer@3.0.0-beta.4/node_modules/@0xsequence/indexer/dist/indexer.gen.d.ts
declare const WebrpcHeader$1 = "Webrpc";
declare const WebrpcHeaderValue$1 = "webrpc@v0.21.1;gen-typescript@v0.15.1;sequence-indexer@v0.4.0";
declare const WebRPCVersion$1 = "v1";
declare const WebRPCSchemaVersion$1 = "v0.4.0";
declare const WebRPCSchemaHash$1 = "546b527de7002f409ffa602ad35b5a3abe979088";
type WebrpcGenVersions$1 = {
...
declare function VersionFromHeader$1(headers: Headers): WebrpcGenVersions$1;
declare enum ResourceStatus$2 {
  NOT_AVAILABLE = "NOT_AVAILABLE",
  REFRESHING = "REFRESHING",
  AVAILABLE = "AVAILABLE",
}
interface ContractInfo$3 {
  chainId: number;
  address: string;
  source: string;
  name: string;
  ...
  deployed: boolean;
  bytecodeHash: string;
  extensions: ContractInfoExtensions$2;
  updatedAt: string;
  queuedAt?: string;
  status: ResourceStatus$2;
}
interface ContractInfoExtensions$2 {
  link: string;
  description: string;
...
declare enum EventLogType$1 {
  UNKNOWN = "UNKNOWN",
  BLOCK_ADDED = "BLOCK_ADDED",
  BLOCK_REMOVED = "BLOCK_REMOVED",
}
declare enum EventLogDataType$1 {
  EVENT = "EVENT",
...
declare enum TxnTransferType$1 {
  UNKNOWN = "UNKNOWN",
  SEND = "SEND",
  RECEIVE = "RECEIVE",
}
...
declare enum TransactionType$5 {
...
declare enum ContractVerificationStatus$2 {
  VERIFIED = "VERIFIED",
...
interface RuntimeStatus$1 {
  ...
  commitHash: string;
  chainID: number;
  checks: RuntimeChecks$1;
}
interface GatewayBackendResponseTime$1 {
  percentiles: {
    [key: string]: number;
  };
  average: number;
}
interface GatewayBackendRuntimeStatus$1 {
  name: string;
  chainId: number;
  responseTime: GatewayBackendResponseTime$1;
}
interface GatewayRuntimeStatus$1 {
  healthOK: boolean;
  startTime: string;
  uptime: number;
  ver: string;
  branch: string;
  commitHash: string;
  backends: Array<GatewayBackendRuntimeStatus$1>;
}
interface WALWriterRuntimeStatus$1 {
  healthOK: boolean;
  startTime: string;
  uptime: number;
  ver: string;
...
interface RuntimeChecks$1 {
  ...
  bloomStatus: BloomStatus$1;
  bond: Bond$1;
  diskUsage: DiskUsage$1;
}
interface DiskUsage$1 {
...
interface BloomStatus$1 {
  enabled: boolean;
  initialized: boolean;
  bloomInitElapsedTime: string;
}
interface EtherBalance$1 {
  accountAddress: string;
  balanceWei: string;
}
interface NativeTokenBalance$2 {
  accountAddress: string;
  chainId: number;
  balance: string;
  error: string;
}
interface IndexState$1 {
  chainId: string;
  lastBlockNum: number;
  lastBlockHash: string;
}
interface IndexedBlock$1 {
  blockNumber: number;
...
interface EventLog$1 {
  ...
  txnIndex: number;
  txnLogIndex: number;
  logDataType: EventLogDataType$1;
  ts: string;
  txnInfo?: TxnInfo$1;
  rawLog?: {
    [key: string]: any;
  };
  event?: EventDecoded$1;
}
interface EventDecoded$1 {
  topicHash: string;
  eventSig: string;
  types: Array<string>;
  names: Array<string>;
...
interface TokenBalance$2 {
  ...
  isSummary: boolean;
  contractInfo?: ContractInfo$3;
  tokenMetadata?: TokenMetadata$4;
}
interface OrderbookOrder$1 {
  orderId: string;
...
interface OrderbookOrderFilter$1 {
  isListing?: boolean;
...
interface Transaction$4 {
  txnHash: string;
  blockNumber: number;
  blockHash: string;
  chainId: number;
  metaTxnID?: string;
  transfers?: Array<TxnTransfer$1>;
  timestamp: string;
}
interface TxnTransfer$1 {
  transferType: TxnTransferType$1;
  contractAddress: string;
  contractType: ContractType$1;
  from: string;
  to: string;
  ...
  contractInfo?: ContractInfo$3;
  tokenMetadata?: {
    [key: string]: TokenMetadata$4;
  };
}
interface TransactionHistoryFilter$1 {
  accountAddress?: string;
  contractAddress?: string;
...
interface TransactionReceipt$3 {
  txnHash: string;
  txnStatus: TransactionStatus$1;
  txnIndex: number;
  txnType: TransactionType$5;
  blockHash: string;
  blockNumber: number;
  gasUsed: number;
...
interface WebhookListener$1 {
  id: number;
  projectID: number;
  url: string;
  filters: EventFilter$1;
  name: string;
  updatedAt: string;
  active: boolean;
}
...
interface TokenBalanceFilter$1 {
  contractAddress: string;
  sinceBlockNumber: number;
}
interface MetadataOptions$1 {
  verifiedOnly?: boolean;
  unverifiedOnly?: boolean;
  includeContracts?: Array<string>;
}
interface TokenBalancesFilter$1 {
  accountAddresses: Array<string>;
  contractStatus?: ContractVerificationStatus$2;
  contractTypes?: Array<string>;
  contractWhitelist?: Array<string>;
  contractBlacklist?: Array<string>;
  omitNativeBalances: boolean;
}
interface TokenBalancesByContractFilter$1 {
  contractAddresses: Array<string>;
  accountAddresses?: Array<string>;
  contractStatus?: ContractVerificationStatus$2;
}
interface GatewayEtherBalance$1 {
  chainId: number;
  error: string;
  result: EtherBalance$1;
}
interface GatewayNativeTokenBalance$1 {
  chainId: number;
  error: string;
  result: NativeTokenBalance$2;
}
interface GatewayNativeTokenBalances$1 {
  chainId: number;
  error: string;
  results: Array<NativeTokenBalance$2>;
}
interface GatewayTokenBalance$1 {
  chainId: number;
  error: string;
  results: Array<TokenBalance$2>;
}
interface Indexer {
  ping(headers?: object, signal?: AbortSignal): Promise<PingReturn$1>;
  version(headers?: object, signal?: AbortSignal): Promise<VersionReturn$1>;
  runtimeStatus(headers?: object, signal?: AbortSignal): Promise<RuntimeStatusReturn$1>;
  ...
  getNativeTokenBalance(args: GetNativeTokenBalanceArgs$1, headers?: object, signal?: AbortSignal): Promise<GetNativeTokenBalanceReturn$1>;
  getTokenBalancesSummary(args: GetTokenBalancesSummaryArgs$1, headers?: object, signal?: AbortSignal): Promise<GetTokenBalancesSummaryReturn$1>;
  getTokenBalancesDetails(args: GetTokenBalancesDetailsArgs$1, headers?: object, signal?: AbortSignal): Promise<GetTokenBalancesDetailsReturn$1>;
  getTokenBalancesByContract(args: GetTokenBalancesByContractArgs$1, headers?: object, signal?: AbortSignal): Promise<GetTokenBalancesByContractReturn$1>;
  getTokenBalances(args: GetTokenBalancesArgs$1, headers?: object, signal?: AbortSignal): Promise<GetTokenBalancesReturn$1>;
  ...
  getBalanceUpdates(args: GetBalanceUpdatesArgs$1, headers?: object, signal?: AbortSignal): Promise<GetBalanceUpdatesReturn$1>;
...
interface PingArgs$1 {}
interface PingReturn$1 {
  status: boolean;
}
interface VersionArgs$1 {}
interface VersionReturn$1 {
  version: Version$1;
}
interface RuntimeStatusArgs$1 {}
interface RuntimeStatusReturn$1 {
  status: RuntimeStatus$1;
}
interface GetChainIDArgs {}
interface GetChainIDReturn {
  chainID: number;
}
interface GetEtherBalanceArgs {
  accountAddress?: string;
}
interface GetEtherBalanceReturn {
  balance: EtherBalance$1;
}
interface GetNativeTokenBalanceArgs$1 {
  accountAddress?: string;
}
interface GetNativeTokenBalanceReturn$1 {
  balance: NativeTokenBalance$2;
}
interface GetTokenBalancesSummaryArgs$1 {
  filter: TokenBalancesFilter$1;
  omitMetadata?: boolean;
  page?: Page$4;
}
interface GetTokenBalancesSummaryReturn$1 {
  page: Page$4;
  nativeBalances: Array<NativeTokenBalance$2>;
  balances: Array<TokenBalance$2>;
}
interface GetTokenBalancesDetailsArgs$1 {
  filter: TokenBalancesFilter$1;
  omitMetadata?: boolean;
  page?: Page$4;
}
interface GetTokenBalancesDetailsReturn$1 {
  page: Page$4;
  nativeBalances: Array<NativeTokenBalance$2>;
  balances: Array<TokenBalance$2>;
}
interface GetTokenBalancesByContractArgs$1 {
  filter: TokenBalancesByContractFilter$1;
  omitMetadata?: boolean;
  page?: Page$4;
}
interface GetTokenBalancesByContractReturn$1 {
  page: Page$4;
  balances: Array<TokenBalance$2>;
}
interface GetTokenBalancesArgs$1 {
  accountAddress?: string;
  contractAddress?: string;
  tokenID?: string;
...
interface GetTokenBalancesReturn$1 {
  page: Page$4;
  balances: Array<TokenBalance$2>;
}
interface GetTokenSuppliesArgs {
  contractAddress: string;
  includeMetadata?: boolean;
  metadataOptions?: MetadataOptions$1;
  page?: Page$4;
}
interface GetTokenSuppliesReturn {
  page: Page$4;
  contractType: ContractType$1;
  tokenIDs: Array<TokenSupply$2>;
}
interface GetTokenSuppliesMapArgs {
  tokenMap: {
...
interface GetTokenSuppliesMapReturn {
  supplies: {
    [key: string]: Array<TokenSupply$2>;
  };
}
interface GetTokenIDsArgs {
  contractAddress: string;
  page?: Page$4;
}
interface GetTokenIDsReturn {
  page: Page$4;
  contractType: ContractType$1;
  tokenIDs: Array<string>;
}
interface GetTokenIDRangesArgs {
  contractAddress: string;
}
interface GetTokenIDRangesReturn {
  contractType: ContractType$1;
  tokenIDRanges: Array<TokenIDRange$2>;
  moreRanges: boolean;
}
interface GetBalanceUpdatesArgs$1 {
  contractAddress: string;
  lastBlockNumber: number;
  lastBlockHash?: string;
  page?: Page$4;
}
interface GetBalanceUpdatesReturn$1 {
  page: Page$4;
  balances: Array<TokenBalance$2>;
}
interface GetTransactionHistoryArgs {
  filter: TransactionHistoryFilter$1;
  page?: Page$4;
  includeMetadata?: boolean;
  metadataOptions?: MetadataOptions$1;
}
interface GetTransactionHistoryReturn {
  page: Page$4;
  transactions: Array<Transaction$4>;
}
interface FetchTransactionReceiptArgs {
  txnHash: string;
  maxBlockWait?: number;
}
interface FetchTransactionReceiptReturn {
  receipt: TransactionReceipt$3;
}
interface FetchTransactionReceiptWithFilterArgs {
  filter: TransactionFilter$1;
  maxBlockWait?: number;
}
interface FetchTransactionReceiptWithFilterReturn {
  receipt: TransactionReceipt$3;
}
interface SubscribeReceiptsArgs {
  filter: TransactionFilter$1;
}
interface SubscribeReceiptsReturn {
  receipt: TransactionReceipt$3;
}
interface SubscribeEventsArgs {
  filter: EventFilter$1;
}
interface SubscribeEventsReturn {
  log: EventLog$1;
}
interface SubscribeBalanceUpdatesArgs {
  contractAddress: string;
}
interface SubscribeBalanceUpdatesReturn {
  balance: TokenBalance$2;
}
interface SyncBalanceArgs {
  accountAddress: string;
  contractAddress: string;
  tokenID?: string;
}
interface SyncBalanceReturn {}
interface GetAllWebhookListenersArgs {
  projectId?: number;
}
interface GetAllWebhookListenersReturn {
  listeners: Array<WebhookListener$1>;
}
interface GetWebhookListenerArgs {
  id: number;
  projectId?: number;
}
interface GetWebhookListenerReturn {
  listener: WebhookListener$1;
}
interface AddWebhookListenerArgs {
  url: string;
  filters: EventFilter$1;
  projectId?: number;
}
interface AddWebhookListenerReturn {
  status: boolean;
  listener: WebhookListener$1;
}
interface UpdateWebhookListenerArgs {
  listener: WebhookListener$1;
  projectId?: number;
}
interface UpdateWebhookListenerReturn {
  status: boolean;
}
interface RemoveWebhookListenerArgs {
  id: number;
  projectId?: number;
}
interface RemoveWebhookListenerReturn {
  status: boolean;
}
interface RemoveAllWebhookListenersArgs {
  projectId?: number;
}
interface RemoveAllWebhookListenersReturn {
  status: boolean;
}
interface ToggleWebhookListenerArgs {
  id: number;
  projectId?: number;
}
interface ToggleWebhookListenerReturn {
  webhookListener: WebhookListener$1;
}
interface PauseAllWebhookListenersArgs {
  projectId?: number;
}
interface PauseAllWebhookListenersReturn {
  status: boolean;
}
interface ResumeAllWebhookListenersArgs {
  projectId?: number;
}
interface ResumeAllWebhookListenersReturn {
  status: boolean;
}
interface GetOrderbookOrdersArgs {
  page?: Page$4;
  orderbookContractAddress: string;
  collectionAddress: string;
  currencyAddresses: Array<string>;
  filter: OrderbookOrderFilter$1;
  orderStatuses: Array<OrderStatus$3>;
  filters: Array<OrderbookOrderFilter$1>;
  beforeExpiryTimestamp: number;
  blockNumberAfter: number;
  createdAtAfter: number;
}
interface GetOrderbookOrdersReturn {
  page?: Page$4;
  orders: Array<OrderbookOrder$1>;
}
interface GetTopOrdersArgs {
  orderbookContractAddress: string;
  collectionAddress: string;
  currencyAddresses: Array<string>;
  tokenIDs: Array<string>;
  isListing: boolean;
  priceSort: SortOrder$2;
  excludeUser?: string;
}
interface GetTopOrdersReturn {
  orders: Array<OrderbookOrder$1>;
}
declare class Indexer implements Indexer {
  protected hostname: string;
...
declare class WebrpcError$3 extends Error {
  name: string;
  code: number;
  message: string;
  status: number;
  ...
  msg: string;
  constructor(name: string, code: number, message: string, status: number, cause?: string);
  static new(payload: any): WebrpcError$3;
}
declare class WebrpcEndpointError$2 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcRequestFailedError$2 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcBadRouteError$2 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcBadMethodError$2 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcBadRequestError$2 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcBadResponseError$2 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcServerPanicError$2 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcInternalErrorError$2 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcClientDisconnectedError$2 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcStreamLostError$2 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcStreamFinishedError$2 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class UnauthorizedError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class PermissionDeniedError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class SessionExpiredError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class MethodNotFoundError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class RequestConflictError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class AbortedError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class GeoblockedError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class RateLimitedError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class ProjectNotFoundError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class AccessKeyNotFoundError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class AccessKeyMismatchError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class InvalidOriginError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class InvalidServiceError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class UnauthorizedUserError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class QuotaExceededError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class RateLimitError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class NoDefaultKeyError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class MaxAccessKeysError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class AtLeastOneKeyError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class TimeoutError$3 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class InvalidArgumentError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class UnavailableError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class QueryFailedError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class ResourceExhaustedError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class NotFoundError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class MetadataCallFailedError$1 extends WebrpcError$3 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare enum errors$1 {
  WebrpcEndpoint = "WebrpcEndpoint",
  WebrpcRequestFailed = "WebrpcRequestFailed",
  WebrpcBadRoute = "WebrpcBadRoute",
  WebrpcBadMethod = "WebrpcBadMethod",
...
interface WebrpcStreamOptions<T$1> extends WebrpcOptions {
  onMessage: (message: T$1) => void;
  onError: (error: WebrpcError$3, reconnect: () => void) => void;
  onOpen?: () => void;
  onClose?: () => void;
}
interface WebrpcOptions {
  headers?: HeadersInit;
  signal?: AbortSignal;
}
declare namespace indexergw_gen_d_exports {
  export { AbortedError, AccessKeyMismatchError, AccessKeyNotFoundError, Asset$2 as Asset, AtLeastOneKeyError, BloomStatus, Bond, ContractInfo$2 as ContractInfo, ContractInfoExtensions$1 as ContractInfoExtensions, ContractType$3 as ContractType, ContractVerificationStatus$1 as ContractVerificationStatus, DiskUsage, EtherBalance, EventDecoded, EventFilter, EventLog, EventLogDataType, EventLogType, Fetch, GatewayBackendResponseTime, GatewayBackendRuntimeStatus, GatewayEtherBalance, GatewayNativeTokenBalance, GatewayNativeTokenBalances, GatewayRuntimeStatus, GatewayTokenBalance, GeoblockedError, GetBalanceUpdatesArgs, GetBalanceUpdatesReturn, GetNativeTokenBalanceArgs, GetNativeTokenBalanceReturn, GetTokenBalancesArgs, GetTokenBalancesByContractArgs, GetTokenBalancesByContractReturn, GetTokenBalancesDetailsArgs, GetTokenBalancesDetailsReturn, GetTokenBalancesReturn, GetTokenBalancesSummaryArgs, GetTokenBalancesSummaryReturn, IndexState, IndexedBlock, IndexerGateway, InvalidArgumentError, InvalidOriginError, InvalidServiceError, MaxAccessKeysError, MetadataCallFailedError, MetadataOptions, MethodNotFoundError, NativeTokenBalance$1 as NativeTokenBalance, NoDefaultKeyError, NotFoundError, OrderStatus$2 as OrderStatus, OrderbookOrder, OrderbookOrderFilter, Page$3 as Page, PebbleMetrics, PermissionDeniedError, PingArgs, PingReturn, ProjectNotFoundError, QueryFailedError, QuotaExceededError, RateLimitError, RateLimitedError, RequestConflictError, ResourceExhaustedError, ResourceStatus$3 as ResourceStatus, RuntimeChecks, RuntimeStatus, RuntimeStatusArgs, RuntimeStatusReturn, SessionExpiredError, SortBy$1 as SortBy, SortOrder$1 as SortOrder, TimeoutError$2 as TimeoutError, TokenBalance, TokenBalanceFilter, TokenBalancesByContractFilter, TokenBalancesFilter, TokenHistory, TokenIDRange$1 as TokenIDRange, TokenMetadata$3 as TokenMetadata, TokenSupply, Transaction$3 as Transaction, TransactionFilter, TransactionHistoryFilter, TransactionLog, TransactionReceipt$2 as TransactionReceipt, TransactionStatus$2 as TransactionStatus, TransactionType$6 as TransactionType, TxnInfo, TxnTransfer, TxnTransferType, UnauthorizedError, UnauthorizedUserError, UnavailableError, Version, VersionArgs, VersionFromHeader, VersionReturn, WALWriterRuntimeStatus, WebRPCSchemaHash, WebRPCSchemaVersion, WebRPCVersion, WebhookListener, WebrpcBadMethodError$1 as WebrpcBadMethodError, WebrpcBadRequestError$1 as WebrpcBadRequestError, WebrpcBadResponseError$1 as WebrpcBadResponseError, WebrpcBadRouteError$1 as WebrpcBadRouteError, WebrpcClientDisconnectedError$1 as WebrpcClientDisconnectedError, WebrpcEndpointError$1 as WebrpcEndpointError, WebrpcError$2 as WebrpcError, WebrpcHeader, WebrpcHeaderValue, WebrpcInternalErrorError$1 as WebrpcInternalErrorError, WebrpcRequestFailedError$1 as WebrpcRequestFailedError, WebrpcServerPanicError$1 as WebrpcServerPanicError, WebrpcStreamFinishedError$1 as WebrpcStreamFinishedError, WebrpcStreamLostError$1 as WebrpcStreamLostError, errors };
}
declare const WebrpcHeader = "Webrpc";
declare const WebrpcHeaderValue = "webrpc@v0.21.1;gen-typescript@v0.15.1;sequence-indexer@v0.4.0";
declare const WebRPCVersion = "v1";
declare const WebRPCSchemaVersion = "v0.4.0";
declare const WebRPCSchemaHash = "5be4a3e78d9c7e0cc378c675ec01c518e83772e3";
...
interface ContractInfo$2 {
  ...
  deployed: boolean;
  bytecodeHash: string;
  extensions: ContractInfoExtensions$1;
  updatedAt: string;
  queuedAt?: string;
  status: ResourceStatus$3;
}
interface ContractInfoExtensions$1 {
  link: string;
  description: string;
  categories: Array<string>;
  ogImage: string;
...
declare enum EventLogType {
  UNKNOWN = "UNKNOWN",
  BLOCK_ADDED = "BLOCK_ADDED",
  BLOCK_REMOVED = "BLOCK_REMOVED",
}
declare enum EventLogDataType {
  EVENT = "EVENT",
  TOKEN_TRANSFER = "TOKEN_TRANSFER",
  NATIVE_TOKEN_TRANSFER = "NATIVE_TOKEN_TRANSFER",
  SEQUENCE_TXN = "SEQUENCE_TXN",
...
declare enum TransactionType$6 {
  LegacyTxnType = "LegacyTxnType",
  AccessListTxnType = "AccessListTxnType",
  DynamicFeeTxnType = "DynamicFeeTxnType",
}
...
declare enum ContractVerificationStatus$1 {
  VERIFIED = "VERIFIED",
  UNVERIFIED = "UNVERIFIED",
  ALL = "ALL",
}
...
interface GatewayBackendRuntimeStatus {
  name: string;
  chainId: number;
...
interface WALWriterRuntimeStatus {
  healthOK: boolean;
  startTime: string;
  uptime: number;
  ver: string;
...
interface EtherBalance {
  accountAddress: string;
  balanceWei: string;
}
interface NativeTokenBalance$1 {
  accountAddress: string;
  chainId: number;
  balance: string;
  error: string;
...
interface OrderbookOrderFilter {
  isListing?: boolean;
  userAddresses?: Array<string>;
  tokenIds: Array<string>;
  excludeUserAddresses?: Array<string>;
...
interface TransactionReceipt$2 {
  txnHash: string;
  txnStatus: TransactionStatus$2;
  txnIndex: number;
  txnType: TransactionType$6;
  blockHash: string;
  blockNumber: number;
  gasUsed: number;
  effectiveGasPrice: string;
...
interface TokenBalancesFilter {
  accountAddresses: Array<string>;
  contractStatus?: ContractVerificationStatus$1;
  contractTypes?: Array<string>;
  contractWhitelist?: Array<string>;
  contractBlacklist?: Array<string>;
  omitNativeBalances: boolean;
}
interface TokenBalancesByContractFilter {
  contractAddresses: Array<string>;
  accountAddresses?: Array<string>;
  contractStatus?: ContractVerificationStatus$1;
}
interface GatewayEtherBalance {
  chainId: number;
  error: string;
  result: EtherBalance;
}
interface GatewayNativeTokenBalance {
  chainId: number;
  error: string;
  result: NativeTokenBalance$1;
}
interface GatewayNativeTokenBalances {
  chainId: number;
  error: string;
  results: Array<NativeTokenBalance$1>;
}
...
interface GetNativeTokenBalanceReturn {
...
interface GetTokenBalancesReturn {
  page: Page$3;
...
interface GetTokenBalancesSummaryReturn {
  page: Page$3;
...
interface GetTokenBalancesDetailsReturn {
  page: Page$3;
  nativeBalances: Array<GatewayNativeTokenBalances>;
  balances: Array<GatewayTokenBalance>;
}
...
interface GetTokenBalancesByContractReturn {
  page: Page$3;
  balances: Array<GatewayTokenBalance>;
}
interface GetBalanceUpdatesArgs {
  chainIds?: Array<number>;
  networks?: Array<string>;
  testnets?: boolean;
  contractAddress: string;
...
interface GetBalanceUpdatesReturn {
  page: Page$3;
  balances: Array<GatewayTokenBalance>;
}
interface PingArgs {}
...
interface VersionReturn {
  version: Version;
}
interface RuntimeStatusArgs {}
interface RuntimeStatusReturn {
  status: GatewayRuntimeStatus;
}
declare class IndexerGateway implements IndexerGateway {
  protected hostname: string;
...
declare class WebrpcError$2 extends Error {
  name: string;
  code: number;
  message: string;
  status: number;
  ...
  msg: string;
  constructor(name: string, code: number, message: string, status: number, cause?: string);
  static new(payload: any): WebrpcError$2;
}
declare class WebrpcEndpointError$1 extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcRequestFailedError$1 extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcBadRouteError$1 extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcBadMethodError$1 extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcBadRequestError$1 extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcBadResponseError$1 extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcServerPanicError$1 extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcInternalErrorError$1 extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcClientDisconnectedError$1 extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcStreamLostError$1 extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class WebrpcStreamFinishedError$1 extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class UnauthorizedError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class PermissionDeniedError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class SessionExpiredError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class MethodNotFoundError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class RequestConflictError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class AbortedError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class GeoblockedError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class RateLimitedError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class ProjectNotFoundError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class AccessKeyNotFoundError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class AccessKeyMismatchError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class InvalidOriginError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class InvalidServiceError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class UnauthorizedUserError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class QuotaExceededError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class RateLimitError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class NoDefaultKeyError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class MaxAccessKeysError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class AtLeastOneKeyError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class TimeoutError$2 extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class InvalidArgumentError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class UnavailableError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class QueryFailedError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class ResourceExhaustedError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class NotFoundError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare class MetadataCallFailedError extends WebrpcError$2 {
  constructor(name?: string, code?: number, message?: string, status?: number, cause?: string);
}
declare enum errors {
  WebrpcEndpoint = "WebrpcEndpoint",
...
declare namespace index_d_exports$1 {
  export { AbortedError$1 as AbortedError, AccessKeyMismatchError$1 as AccessKeyMismatchError, AccessKeyNotFoundError$1 as AccessKeyNotFoundError, AddWebhookListenerArgs, AddWebhookListenerReturn, Asset$3 as Asset, AtLeastOneKeyError$1 as AtLeastOneKeyError, BloomStatus$1 as BloomStatus, Bond$1 as Bond, ContractInfo$3 as ContractInfo, ContractInfoExtensions$2 as ContractInfoExtensions, ContractType$1 as ContractType, ContractVerificationStatus$2 as ContractVerificationStatus, DiskUsage$1 as DiskUsage, EtherBalance$1 as EtherBalance, EventDecoded$1 as EventDecoded, EventFilter$1 as EventFilter, EventLog$1 as EventLog, EventLogDataType$1 as EventLogDataType, EventLogType$1 as EventLogType, Fetch$1 as Fetch, FetchTransactionReceiptArgs, FetchTransactionReceiptReturn, FetchTransactionReceiptWithFilterArgs, FetchTransactionReceiptWithFilterReturn, GatewayBackendResponseTime$1 as GatewayBackendResponseTime, GatewayBackendRuntimeStatus$1 as GatewayBackendRuntimeStatus, GatewayEtherBalance$1 as GatewayEtherBalance, GatewayNativeTokenBalance$1 as GatewayNativeTokenBalance, GatewayNativeTokenBalances$1 as GatewayNativeTokenBalances, GatewayRuntimeStatus$1 as GatewayRuntimeStatus, GatewayTokenBalance$1 as GatewayTokenBalance, GeoblockedError$1 as GeoblockedError, GetAllWebhookListenersArgs, GetAllWebhookListenersReturn, GetBalanceUpdatesArgs$1 as GetBalanceUpdatesArgs, GetBalanceUpdatesReturn$1 as GetBalanceUpdatesReturn, GetChainIDArgs, GetChainIDReturn, GetEtherBalanceArgs, GetEtherBalanceReturn, GetNativeTokenBalanceArgs$1 as GetNativeTokenBalanceArgs, GetNativeTokenBalanceReturn$1 as GetNativeTokenBalanceReturn, GetOrderbookOrdersArgs, GetOrderbookOrdersReturn, GetTokenBalancesArgs$1 as GetTokenBalancesArgs, GetTokenBalancesByContractArgs$1 as GetTokenBalancesByContractArgs, GetTokenBalancesByContractReturn$1 as GetTokenBalancesByContractReturn, GetTokenBalancesDetailsArgs$1 as GetTokenBalancesDetailsArgs, GetTokenBalancesDetailsReturn$1 as GetTokenBalancesDetailsReturn, GetTokenBalancesReturn$1 as GetTokenBalancesReturn, GetTokenBalancesSummaryArgs$1 as GetTokenBalancesSummaryArgs, GetTokenBalancesSummaryReturn$1 as GetTokenBalancesSummaryReturn, GetTokenIDRangesArgs, GetTokenIDRangesReturn, GetTokenIDsArgs, GetTokenIDsReturn, GetTokenSuppliesArgs, GetTokenSuppliesMapArgs, GetTokenSuppliesMapReturn, GetTokenSuppliesReturn, GetTopOrdersArgs, GetTopOrdersReturn, GetTransactionHistoryArgs, GetTransactionHistoryReturn, GetWebhookListenerArgs, GetWebhookListenerReturn, IndexState$1 as IndexState, IndexedBlock$1 as IndexedBlock, Indexer, indexergw_gen_d_exports as IndexerGateway, InvalidArgumentError$1 as InvalidArgumentError, InvalidOriginError$1 as InvalidOriginError, InvalidServiceError$1 as InvalidServiceError, MaxAccessKeysError$1 as MaxAccessKeysError, MetadataCallFailedError$1 as MetadataCallFailedError, MetadataOptions$1 as MetadataOptions, MethodNotFoundError$1 as MethodNotFoundError, NativeTokenBalance$2 as NativeTokenBalance, NoDefaultKeyError$1 as NoDefaultKeyError, NotFoundError$1 as NotFoundError, OrderStatus$3 as OrderStatus, OrderbookOrder$1 as OrderbookOrder, OrderbookOrderFilter$1 as OrderbookOrderFilter, Page$4 as Page, PauseAllWebhookListenersArgs, PauseAllWebhookListenersReturn, PebbleMetrics$1 as PebbleMetrics, PermissionDeniedError$1 as PermissionDeniedError, PingArgs$1 as PingArgs, PingReturn$1 as PingReturn, ProjectNotFoundError$1 as ProjectNotFoundError, QueryFailedError$1 as QueryFailedError, QuotaExceededError$1 as QuotaExceededError, RateLimitError$1 as RateLimitError, RateLimitedError$1 as RateLimitedError, RemoveAllWebhookListenersArgs, RemoveAllWebhookListenersReturn, RemoveWebhookListenerArgs, RemoveWebhookListenerReturn, RequestConflictError$1 as RequestConflictError, ResourceExhaustedError$1 as ResourceExhaustedError, ResourceStatus$2 as ResourceStatus, ResumeAllWebhookListenersArgs, ResumeAllWebhookListenersReturn, RuntimeChecks$1 as RuntimeChecks, RuntimeStatus$1 as RuntimeStatus, RuntimeStatusArgs$1 as RuntimeStatusArgs, RuntimeStatusReturn$1 as RuntimeStatusReturn, SequenceIndexer$1 as SequenceIndexer, SequenceIndexerGateway, SessionExpiredError$1 as SessionExpiredError, SortBy$2 as SortBy, SortOrder$2 as SortOrder, SubscribeBalanceUpdatesArgs, SubscribeBalanceUpdatesReturn, SubscribeEventsArgs, SubscribeEventsReturn, SubscribeReceiptsArgs, SubscribeReceiptsReturn, SyncBalanceArgs, SyncBalanceReturn, TimeoutError$3 as TimeoutError, ToggleWebhookListenerArgs, ToggleWebhookListenerReturn, TokenBalance$2 as TokenBalance, TokenBalanceFilter$1 as TokenBalanceFilter, TokenBalancesByContractFilter$1 as TokenBalancesByContractFilter, TokenBalancesFilter$1 as TokenBalancesFilter, TokenHistory$1 as TokenHistory, TokenIDRange$2 as TokenIDRange, TokenMetadata$4 as TokenMetadata, TokenSupply$2 as TokenSupply, Transaction$4 as Transaction, TransactionFilter$1 as TransactionFilter, TransactionHistoryFilter$1 as TransactionHistoryFilter, TransactionLog$1 as TransactionLog, TransactionReceipt$3 as TransactionReceipt, TransactionStatus$1 as TransactionStatus, TransactionType$5 as TransactionType, TxnInfo$1 as TxnInfo, TxnTransfer$1 as TxnTransfer, TxnTransferType$1 as TxnTransferType, UnauthorizedError$1 as UnauthorizedError, UnauthorizedUserError$1 as UnauthorizedUserError, UnavailableError$1 as UnavailableError, UpdateWebhookListenerArgs, UpdateWebhookListenerReturn, Version$1 as Version, VersionArgs$1 as VersionArgs, VersionFromHeader$1 as VersionFromHeader, VersionReturn$1 as VersionReturn, WALWriterRuntimeStatus$1 as WALWriterRuntimeStatus, WebRPCSchemaHash$1 as WebRPCSchemaHash, WebRPCSchemaVersion$1 as WebRPCSchemaVersion, WebRPCVersion$1 as WebRPCVersion, WebhookListener$1 as WebhookListener, WebrpcBadMethodError$2 as WebrpcBadMethodError, WebrpcBadRequestError$2 as WebrpcBadRequestError, WebrpcBadResponseError$2 as WebrpcBadResponseError, WebrpcBadRouteError$2 as WebrpcBadRouteError, WebrpcClientDisconnectedError$2 as WebrpcClientDisconnectedError, WebrpcEndpointError$2 as WebrpcEndpointError, WebrpcError$3 as WebrpcError, WebrpcHeader$1 as WebrpcHeader, WebrpcHeaderValue$1 as WebrpcHeaderValue, WebrpcInternalErrorError$2 as WebrpcInternalErrorError, WebrpcOptions, WebrpcRequestFailedError$2 as WebrpcRequestFailedError, WebrpcServerPanicError$2 as WebrpcServerPanicError, WebrpcStreamFinishedError$2 as WebrpcStreamFinishedError, WebrpcStreamLostError$2 as WebrpcStreamLostError, WebrpcStreamOptions, errors$1 as errors };
}
declare class SequenceIndexer$1 extends Indexer {
...
declare class SequenceIndexerGateway extends IndexerGateway {
  projectAccessKey?: string | undefined;
  jwtAuth?: string | undefined;
  constructor(hostname: string, projectAccessKey?: string | undefined, jwtAuth?: string | undefined);
  _fetch: (input: RequestInfo, init?: RequestInit) => Promise<Response>;
...
//#endregion
//#region ../api/dist/indexer.msw.d.ts
//#region src/adapters/indexer/types.d.ts
interface ContractInfo$1$1 {
  chainId: ChainId;
  address: Address$1$1;
  name?: string;
  type?: string;
...
interface TokenBalance$1 {
  contractType: string;
  contractAddress: Address$1$1;
  accountAddress: Address$1$1;
  tokenId: TokenId;
  balance: Amount;
  blockHash?: string;
  blockNumber?: number;
...
//#endregion
//#region ../api/dist/metadata.msw.d.ts
...
interface Currency extends Omit<Currency$1, 'contractAddress'> {
  contractAddress: Address;
}
interface PrimarySaleItem extends Omit<PrimarySaleItem$1, 'currencyAddress' | 'itemAddress'> {
...
interface Order extends Omit<Order$1, 'priceCurrencyAddress'> {
  priceCurrencyAddress: Address;
}
interface CollectibleOrder extends Omit<CollectibleOrder$1, 'order' | 'listing' | 'offer'> {
  order?: Order;
  listing?: Order;
  offer?: Order;
}
type StepBase = Omit<Step$1, 'to'> & {
  to: Address;
};
type Signature = Omit<Signature$2, 'domain'> & {
...
type Step = SignatureStep | TransactionStep | UnknownStep;
declare function isSignatureStep(step: Step): step is SignatureStep;
declare function isTransactionStep(step: Step): step is TransactionStep;
//#endregion
...
type ListCollectibleListingsResponse = Omit<ListListingsForCollectibleResponse$1, 'listings'> & {
  listings: Order[];
};
type ListListingsForCollectibleResponse = ListCollectibleListingsResponse;
type ListCollectibleOffersResponse = Omit<ListOffersForCollectibleResponse$1, 'offers'> & {
  offers: Order[];
};
/**
 ...
 */
type ListOffersForCollectibleResponse = ListCollectibleOffersResponse;
type ListOrdersWithCollectiblesResponse = Omit<ListOrdersWithCollectiblesResponse$1, 'collectibles'> & {
  collectibles: CollectibleOrder[];
};
type ListCollectiblesResponse = Omit<ListCollectiblesResponse$1, 'collectibles'> & {
  collectibles: CollectibleOrder[];
};
type ListCurrenciesResponse$1 = Omit<ListCurrenciesResponse, 'currencies'> & {
  currencies: Currency[];
};
type ListPrimarySaleItemsResponse = Omit<ListPrimarySaleItemsResponse$1, 'primarySaleItems'> & {
...
type GenerateListingTransactionRequest = Omit<GenerateListingTransactionRequest$1, 'chainId' | 'contractType' | 'listing'> & {
  chainId: ChainId;
  contractType: ContractType$1;
  listing: CreateReq;
};
type GenerateOfferTransactionRequest = Omit<GenerateOfferTransactionRequest$1, 'chainId' | 'contractType' | 'offer'> & {
  chainId: ChainId;
  contractType: ContractType$1;
  offer: CreateReq;
};
...
type GenerateSellTransactionRequest = Omit<GenerateSellTransactionRequest$1, 'chainId' | 'ordersData'> & {
  chainId: ChainId;
  ordersData: Array<OrderData>;
};
type GenerateCancelTransactionRequest = Omit<GenerateCancelTransactionRequest$1, 'chainId'> & {
  chainId: ChainId;
};
...
type ListCurrenciesRequest = Omit<ListCurrenciesRequest$1, 'chainId'> & {
  chainId: ChainId;
};
...
type GetLowestPriceListingForCollectibleRequest = Omit<GetLowestPriceListingForCollectibleRequest$1, 'chainId' | 'contractAddress' | 'tokenId'> & {
  chainId: ChainId;
  collectionAddress: Address$1$1;
  tokenId: TokenId;
};
type GetHighestPriceOfferForCollectibleRequest = Omit<GetHighestPriceOfferForCollectibleRequest$1, 'chainId' | 'contractAddress' | 'tokenId'> & {
  chainId: ChainId;
  collectionAddress: Address$1$1;
  tokenId: TokenId;
};
...
type ListOffersForCollectibleRequest = Omit<ListOffersForCollectibleRequest$1, 'chainId' | 'contractAddress' | 'tokenId'> & {
  chainId: ChainId;
  collectionAddress: Address$1$1;
  tokenId: TokenId;
};
type ListOrdersWithCollectiblesRequest = Omit<ListOrdersWithCollectiblesRequest$1, 'chainId' | 'contractAddress'> & {
  chainId: ChainId;
  collectionAddress: Address$1$1;
};
type GetFloorOrderRequest = Omit<GetFloorOrderRequest$1, 'chainId' | 'contractAddress'> & {
  chainId: ChainId;
  collectionAddress: Address$1$1;
};
type ListCollectiblesRequest = Omit<ListCollectiblesRequest$1, 'chainId' | 'contractAddress'> & {
  chainId: ChainId;
  collectionAddress: Address$1$1;
};
type ListCollectibleActivitiesRequest = Omit<ListCollectibleActivitiesRequest$1, 'chainId' | 'contractAddress'> & {
  chainId: ChainId;
  collectionAddress: Address$1$1;
};
type ListCollectionActivitiesRequest = Omit<ListCollectionActivitiesRequest$1, 'chainId' | 'contractAddress'> & {
  chainId: ChainId;
  collectionAddress: Address$1$1;
};
type ListPrimarySaleItemsRequest = Omit<ListPrimarySaleItemsRequest$1, 'chainId'> & {
  chainId: ChainId;
};
...
type GetCountOfPrimarySaleItemsRequest = Omit<GetCountOfPrimarySaleItemsRequest$1, 'chainId'> & {
  chainId: ChainId;
};
type CheckoutOptionsMarketplaceRequest = Omit<CheckoutOptionsMarketplaceRequest$1, 'chainId' | 'wallet'> & {
  chainId: ChainId;
} & ({
  wallet: string;
  walletAddress?: never;
...
declare class MarketplaceClient {
  ...
  readonly generateListingTransaction: (req: GenerateListingTransactionRequest) => Promise<GenerateListingTransactionResponse$1>;
  readonly generateOfferTransaction: (req: GenerateOfferTransactionRequest) => Promise<GenerateOfferTransactionResponse$1>;
  readonly generateSellTransaction: (req: GenerateSellTransactionRequest) => Promise<GenerateSellTransactionResponse$1>;
  readonly generateCancelTransaction: (req: GenerateCancelTransactionRequest) => Promise<GenerateCancelTransactionResponse$1>;
  ...
  readonly listCurrencies: (req: ListCurrenciesRequest) => Promise<ListCurrenciesResponse$1>;
  ...
  readonly getLowestPriceListingForCollectible: (req: GetLowestPriceListingForCollectibleRequest) => Promise<GetCollectibleLowestListingResponse$1>;
  readonly getHighestPriceOfferForCollectible: (req: GetHighestPriceOfferForCollectibleRequest) => Promise<GetCollectibleHighestOfferResponse$1>;
  readonly listListingsForCollectible: (req: ListListingsForCollectibleRequest$1) => Promise<ListCollectibleListingsResponse>;
  readonly listOffersForCollectible: (req: ListOffersForCollectibleRequest) => Promise<ListCollectibleOffersResponse>;
  readonly listOrdersWithCollectibles: (req: ListOrdersWithCollectiblesRequest) => Promise<ListOrdersWithCollectiblesResponse>;
  readonly getFloorOrder: (req: GetFloorOrderRequest) => Promise<GetFloorOrderResponse$1>;
  readonly getOrders: (req: GetOrdersRequest$1) => Promise<GetOrdersResponse$1>;
  readonly listCollectibles: (req: ListCollectiblesRequest) => Promise<ListCollectiblesResponse>;
  readonly listCollectibleActivities: (req: ListCollectibleActivitiesRequest) => Promise<ListCollectibleActivitiesResponse>;
  readonly listCollectionActivities: (req: ListCollectionActivitiesRequest) => Promise<ListCollectionActivitiesResponse>;
  readonly listPrimarySaleItems: (req: ListPrimarySaleItemsRequest) => Promise<ListPrimarySaleItemsResponse>;
  readonly getPrimarySaleItem: (req: GetPrimarySaleItemRequest$1) => Promise<GetPrimarySaleItemResponse$1>;
  readonly getCountOfPrimarySaleItems: (req: GetCountOfPrimarySaleItemsRequest) => Promise<GetCountOfPrimarySaleItemsResponse>;
  ...
  readonly checkoutOptionsMarketplace: (req: CheckoutOptionsMarketplaceRequest) => Promise<CheckoutOptionsMarketplaceResponse>;
...
interface MarketCollection extends BaseMarketplaceCollection {
...
interface ShopCollection extends BaseMarketplaceCollection {
  marketplaceCollectionType: 'shop';
  saleAddress: Address$1$1;
  name: string;
  tokenIds: TokenId[];
  customTokenIds: TokenId[];
}
type MarketplaceCollection = MarketCollection | ShopCollection;
...
declare function toLookupMarketplaceReturn(data: LookupMarketplaceReturn$1): LookupMarketplaceReturn;
declare function toMarketCollection(data: MarketCollection$1): MarketCollection;
declare function toShopCollection(data: ShopCollection$1): ShopCollection;
declare function fromLookupMarketplaceReturn(data: LookupMarketplaceReturn): LookupMarketplaceReturn$1;
declare function fromMarketCollection(data: MarketCollection): MarketCollection$1;
declare function fromShopCollection(data: ShopCollection): ShopCollection$1;
declare namespace index_d_exports {
  export { builder_gen_d_exports as BuilderAPI, CollectionFilterSettings$1 as CollectionFilterSettings, FilterCondition, LookupMarketplaceArgs, LookupMarketplaceReturn, MarketCollection, MarketPage, Marketplace$1 as Marketplace, MarketplaceCollection, MarketplacePage, MarketplaceService$1 as MarketplaceService, MarketplaceSettings, MarketplaceSocials, MarketplaceWallet, MarketplaceWalletEcosystem, MarketplaceWalletEmbedded, MarketplaceWalletType, MetadataFilterRule$1 as MetadataFilterRule, OpenIdProvider, ShopCollection, ShopPage, WebrpcBadMethodError, WebrpcBadRequestError, WebrpcBadResponseError, WebrpcBadRouteError, WebrpcClientDisconnectedError, WebrpcEndpointError, WebrpcError, WebrpcInternalErrorError, WebrpcRequestFailedError, WebrpcServerPanicError, WebrpcStreamFinishedError, WebrpcStreamLostError, fromLookupMarketplaceReturn, fromMarketCollection, fromShopCollection, toLookupMarketplaceReturn, toMarketCollection, toShopCollection };
}
//#endregion
...
declare class IndexerClient {
   ...
   */
  getTokenBalancesDetails(args: GetTokenBalancesDetailsArgs$1): Promise<GetTokenBalancesDetailsResponse>;
  /**
   * Get token balances by contract with normalized types (bigint)
   */
  getTokenBalancesByContract(args: GetTokenBalancesByContractArgs$1): Promise<GetTokenBalancesByContractResponse>;
  /**
   * Get native token balance with normalized types (bigint)
   */
  getNativeTokenBalance(args: GetNativeTokenBalanceArgs$1): Promise<GetNativeTokenBalanceResponse>;
  /**
   ...
   * Access the underlying raw client for any methods not wrapped
   */
  get raw(): SequenceIndexer$1;
}
//#endregion
//#region src/adapters/indexer/transforms.d.ts
declare function toContractInfo$1(raw: ContractInfo$3): ContractInfo$1$1;
declare function toTokenMetadata$1(raw: TokenMetadata$4): TokenMetadata$1$1;
declare function toNativeTokenBalance(raw: NativeTokenBalance$2): NativeTokenBalance;
declare function toTokenBalance(raw: TokenBalance$2): TokenBalance$1;
declare function toTokenSupply(raw: TokenSupply$2, contractAddress?: Address$1$1): TokenSupply$1;
declare function toTransactionReceipt(raw: TransactionReceipt$3): TransactionReceipt$1;
declare function toTokenIDRange(raw: TokenIDRange$2): TokenIDRange;
declare function toPage(raw: Page$4 | undefined): Page$1 | undefined;
declare function toGetTokenBalancesResponse(raw: GetTokenBalancesReturn$1): GetTokenBalancesResponse;
declare function toGetTokenSuppliesResponse(raw: GetTokenSuppliesReturn, contractAddress: Address$1$1): GetTokenSuppliesResponse;
declare function toGetTokenIDRangesResponse(raw: GetTokenIDRangesReturn, contractAddress: Address$1$1): GetTokenIDRangesResponse;
declare function toGetTokenBalancesArgs(req: GetTokenBalancesRequest): GetTokenBalancesArgs$1;
declare function toGetTokenSuppliesArgs(req: GetTokenSuppliesRequest): GetTokenSuppliesArgs;
declare function toGetTokenIDRangesArgs(req: GetTokenIDRangesRequest): GetTokenIDRangesArgs;
declare namespace index_d_exports$1$1 {
  export { ContractInfo$1$1 as ContractInfo, ContractType$1 as ContractType, GetNativeTokenBalanceResponse, GetTokenBalancesByContractResponse, GetTokenBalancesDetailsResponse, GetTokenBalancesRequest, GetTokenBalancesResponse, GetTokenIDRangesRequest, GetTokenIDRangesResponse, GetTokenSuppliesRequest, GetTokenSuppliesResponse, index_d_exports$1 as IndexerAPI, IndexerClient, NativeTokenBalance, Page$1 as Page, ResourceStatus$2 as ResourceStatus, TokenBalance$1 as TokenBalance, TokenIDRange, TokenMetadata$1$1 as TokenMetadata, TokenSupply$1 as TokenSupply, TransactionReceipt$1 as TransactionReceipt, TransactionStatus$1 as TransactionStatus, TransactionType$5 as TransactionType, toContractInfo$1 as toContractInfo, toGetTokenBalancesArgs, toGetTokenBalancesResponse, toGetTokenIDRangesArgs, toGetTokenIDRangesResponse, toGetTokenSuppliesArgs, toGetTokenSuppliesResponse, toNativeTokenBalance, toPage, toTokenBalance, toTokenIDRange, toTokenMetadata$1 as toTokenMetadata, toTokenSupply, toTransactionReceipt };
}
//#endregion
...
declare function toContractInfo(raw: MetadataGen.ContractInfo): ContractInfo$1;
declare function toAsset(raw: MetadataGen.Asset): Asset$1;
declare function toTokenMetadata(raw: MetadataGen.TokenMetadata): TokenMetadata$1;
...
declare namespace index_d_exports$3 {
  export { Asset$1 as Asset, ContractInfo$1 as ContractInfo, ContractInfoExtensionBridgeInfo, ContractInfoExtensions, Filter$2 as Filter, GetContractInfoArgs, GetContractInfoBatchArgs, GetContractInfoBatchReturn, GetContractInfoReturn, GetTokenMetadataArgs, GetTokenMetadataBatchArgs, GetTokenMetadataBatchReturn, GetTokenMetadataPropertyFiltersArgs, GetTokenMetadataPropertyFiltersReturn, GetTokenMetadataReturn, MetadataGen as MetadataAPI, MetadataClient, Page$2 as Page, PropertyFilter$1 as PropertyFilter, RefreshTokenMetadataArgs, RefreshTokenMetadataReturn, SearchTokenMetadataArgs, SearchTokenMetadataReturn, TokenMetadata$1 as TokenMetadata, toAsset, toContractInfo, toGetContractInfoArgs, toGetContractInfoBatchArgs, toGetContractInfoBatchReturn, toGetContractInfoReturn, toGetTokenMetadataArgs, toGetTokenMetadataBatchArgs, toGetTokenMetadataBatchReturn, toGetTokenMetadataPropertyFiltersArgs, toGetTokenMetadataPropertyFiltersReturn, toGetTokenMetadataReturn, toRefreshTokenMetadataArgs, toSearchTokenMetadataArgs, toSearchTokenMetadataReturn, toTokenMetadata };
}
//#endregion
...
declare const marketplaceConfigOptions: (config: SdkConfig) => _tanstack_react_query441.OmitKeyof<_tanstack_react_query441.UseQueryOptions<MarketplaceConfig, Error, MarketplaceConfig, readonly ["marketplace", string, {}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query441.QueryFunction<MarketplaceConfig, readonly ["marketplace", string, {}], never> | undefined;
} & {
...
//#endregion
//#region ../node_modules/.pnpm/@xstate+store@3.11.2_react@19.2.0/node_modules/@xstate/store/dist/declarations/src/store.d.ts
declare global {
...
declare function buildQueryOptions<TParams extends BaseQueryParams, TData, const TKeys extends ReadonlyArray<RequiredKeys<TParams>>>(config: {
  ...
  fetcher: (params: TParams) => Promise<TData>;
  customValidation?: (params: WithOptionalParams<TParams>) => boolean;
}, params: WithOptionalParams<TParams>): _tanstack_react_query441.OmitKeyof<_tanstack_react_query441.UseQueryOptions<TData, Error, TData, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query441.QueryFunction<TData, readonly unknown[], never> | undefined;
} & {
...
declare function buildInfiniteQueryOptions<TParams extends BaseInfiniteQueryParams, TResponse, const TKeys extends ReadonlyArray<RequiredKeys<TParams>>>(config: {
  ...
  getPageInfo: (response: TResponse) => Page | undefined;
  customValidation?: (params: WithOptionalInfiniteParams<TParams>) => boolean;
}, params: WithOptionalInfiniteParams<TParams>): _tanstack_react_query441.OmitKeyof<_tanstack_react_query441.UseInfiniteQueryOptions<TResponse, Error, _tanstack_react_query441.InfiniteData<TResponse, unknown>, readonly unknown[], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query441.QueryFunction<TResponse, readonly unknown[], Page> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _tanstack_react_query441.InfiniteData<TResponse, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
//#endregion
//#region ../node_modules/.pnpm/@0xsequence+connect@5.4.8_67672e4d785404fa219ca98bedd40a18/node_modules/@0xsequence/connect/dist/cjs/types.d.ts
interface LogoProps {
  className?: string;
...
//#endregion
//#region ../node_modules/.pnpm/abitype@1.1.0_typescript@5.9.3_zod@3.25.76/node_modules/abitype/dist/types/register.d.ts
...
type ResolvedRegister$1 = {
   ...
   * @default `0x${string}`
   */
  addressType: Register$2 extends {
    addressType: infer type;
  } ? type : Register$2 extends {
    AddressType: infer type;
  } ? type : DefaultRegister$2['addressType'];
  /**
   * TypeScript type to use for `int<M>` and `uint<M>` values, where `M > 48`
   * @default bigint
   */
  bigIntType: Register$2 extends {
    bigIntType: infer type;
  } ? type : Register$2 extends {
    BigIntType: infer type;
  } ? type : DefaultRegister$2['bigIntType'];
  /**
   * TypeScript type to use for `bytes` values
   * @default { inputs: `0x${string}`; outputs: `0x${string}`; }
   */
  bytesType: Register$2 extends {
  ...
  } ? type : DefaultRegister$2['bytesType'];
  /**
   * TypeScript type to use for `int<M>` and `uint<M>` values, where `M <= 48`
   * @default number
   */
  intType: Register$2 extends {
    intType: infer type;
  } ? type : Register$2 extends {
    IntType: infer type;
  } ? type : DefaultRegister$2['intType'];
  /**
   ...
   * @default false
   */
  arrayMaxDepth: Register$2 extends {
    arrayMaxDepth: infer type extends number | false;
  } ? type : Register$2 extends {
    ArrayMaxDepth: infer type extends number | false;
  } ? type : DefaultRegister$2['arrayMaxDepth'];
  /**
   * Lower bound for fixed array length
   * @default 1
   */
  fixedArrayMinLength: Register$2 extends {
    fixedArrayMinLength: infer type extends number;
  } ? type : Register$2 extends {
    FixedArrayMinLength: infer type extends number;
  } ? type : DefaultRegister$2['fixedArrayMinLength'];
  /**
   * Upper bound for fixed array length
   * @default 99
   */
  fixedArrayMaxLength: Register$2 extends {
    fixedArrayMaxLength: infer type extends number;
  } ? type : Register$2 extends {
    FixedArrayMaxLength: infer type extends number;
  } ? type : DefaultRegister$2['fixedArrayMaxLength'];
  /**
   ...
   * @default false
   */
  strictAbiType: Register$2 extends {
    strictAbiType: infer type extends boolean;
  } ? type : Register$2 extends {
    StrictAbiType: infer type extends boolean;
  } ? type : DefaultRegister$2['strictAbiType'];
...
type DefaultRegister$2 = {
  ...
  strictAbiType: false;
  /** @deprecated Use `arrayMaxDepth` instead */
  ArrayMaxDepth: DefaultRegister$2['arrayMaxDepth'];
  /** @deprecated Use `fixedArrayMinLength` instead */
  FixedArrayMinLength: DefaultRegister$2['fixedArrayMinLength'];
  /** @deprecated Use `fixedArrayMaxLength` instead */
  FixedArrayMaxLength: DefaultRegister$2['fixedArrayMaxLength'];
  /** @deprecated Use `addressType` instead */
  AddressType: DefaultRegister$2['addressType'];
  /** @deprecated Use `bytesType` instead */
  BytesType: {
    inputs: DefaultRegister$2['bytesType']['inputs'];
    outputs: DefaultRegister$2['bytesType']['outputs'];
  };
  /** @deprecated Use `bigIntType` instead */
  BigIntType: DefaultRegister$2['bigIntType'];
  /** @deprecated Use `intType` instead */
  IntType: DefaultRegister$2['intType'];
  /** @deprecated Use `strictAbiType` instead */
  StrictAbiType: DefaultRegister$2['strictAbiType'];
};
//#endregion
//#region ../node_modules/.pnpm/abitype@1.1.0_typescript@5.9.3_zod@3.25.76/node_modules/abitype/dist/types/types.d.ts
/**
 ...
 * //   ^? type Result = [1, 2, 3]
 */
type Range<start extends number, stop extends number, result$1 extends number[] = [], padding extends 0[] = [], current extends number = [...padding, ...result$1]['length'] & number> = current extends stop ? current extends start ? [current] : result$1 extends [] ? [] : [...result$1, current] : current extends start ? Range<start, stop, [current], padding> : result$1 extends [] ? Range<start, stop, [], [...padding, 0]> : Range<start, stop, [...result$1, current], padding>;
/**
...
//#endregion
//#region ../node_modules/.pnpm/abitype@1.1.0_typescript@5.9.3_zod@3.25.76/node_modules/abitype/dist/types/abi.d.ts
type Address$1 = ResolvedRegister$1['addressType'];
...
//#endregion
//#region ../node_modules/.pnpm/abitype@1.1.0_typescript@5.9.3_zod@3.25.76/node_modules/abitype/dist/types/narrow.d.ts
/**
...
//#endregion
//#region ../node_modules/.pnpm/abitype@1.1.0_typescript@5.9.3_zod@3.25.76/node_modules/abitype/dist/types/utils.d.ts
/**
 ...
 */
type AbiParametersToPrimitiveTypes<abiParameters extends readonly AbiParameter[], abiParameterKind extends AbiParameterKind = AbiParameterKind> = Pretty<{ [key in keyof abiParameters]: AbiParameterToPrimitiveType<abiParameters[key], abiParameterKind> }>;
/**
...
//#endregion
//#region ../node_modules/.pnpm/ox@0.9.6_typescript@5.9.3_zod@3.25.76/node_modules/ox/_types/core/Hex.d.ts
/** Root type for a Hex string. */
type Hex$2 = `0x${string}`;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/utils.d.ts
type ErrorType$2<name$1 extends string = 'Error'> = Error & {
  name: name$1;
};
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/utils.d.ts
 ...
 * //   ^? true
 */
type IsNarrowable<T$1, U$1> = IsNever<(T$1 extends U$1 ? true : false) & (U$1 extends T$1 ? false : true)> extends true ? false : true;
/**
 ...
 */
type Assign<T$1, U$1> = Assign_<T$1, U$1> & U$1;
type Assign_<T$1, U$1> = { [K in keyof T$1 as K extends keyof U$1 ? U$1[K] extends void ? never : K : K]: K extends keyof U$1 ? U$1[K] : T$1[K] };
type NoInfer$1<type$1> = [type$1][type$1 extends any ? 0 : never];
...
type LastInUnion<U$1> = UnionToIntersection<U$1 extends unknown ? (x: U$1) => 0 : never> extends ((x: infer l) => 0) ? l : never;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/account.d.ts
type DeriveAccount<account$1 extends Account$1 | undefined, accountOverride extends Account$1 | Address$1 | undefined> = accountOverride extends Account$1 | Address$1 ? accountOverride : account$1;
type GetAccountParameter<account$1 extends Account$1 | undefined = Account$1 | undefined, accountOverride extends Account$1 | Address$1 | undefined = Account$1 | Address$1, required extends boolean = true, nullish extends boolean = false> = MaybeRequired<{
  account?: accountOverride | Account$1 | Address$1 | (nullish extends true ? null : never) | undefined;
}, IsUndefined<account$1> extends true ? required extends true ? true : false : false>;
type ParseAccount<accountOrAddress extends Account$1 | Address$1 | null | undefined = Account$1 | Address$1 | null | undefined> = accountOrAddress extends Address$1 ? Prettify<JsonRpcAccount<accountOrAddress>> : accountOrAddress;
//#endregion
//#region ../node_modules/.pnpm/abitype@1.2.0_typescript@5.9.3_zod@3.25.76/node_modules/abitype/dist/types/register.d.ts
...
type ResolvedRegister$2 = {
  ...
  /** @deprecated Use `addressType` instead */
  AddressType: ResolvedRegister$2['addressType'];
  /** @deprecated Use `addressType` instead */
  BigIntType: ResolvedRegister$2['bigIntType'];
  /** @deprecated Use `bytesType` instead */
  BytesType: ResolvedRegister$2['bytesType'];
  /** @deprecated Use `intType` instead */
  IntType: ResolvedRegister$2['intType'];
  /** @deprecated Use `arrayMaxDepth` instead */
  ArrayMaxDepth: ResolvedRegister$2['arrayMaxDepth'];
  /** @deprecated Use `fixedArrayMinLength` instead */
  FixedArrayMinLength: ResolvedRegister$2['fixedArrayMinLength'];
  /** @deprecated Use `fixedArrayMaxLength` instead */
  FixedArrayMaxLength: ResolvedRegister$2['fixedArrayMaxLength'];
  /** @deprecated Use `strictAbiType` instead */
  StrictAbiType: ResolvedRegister$2['strictAbiType'];
};
...
//#endregion
//#region ../node_modules/.pnpm/abitype@1.2.0_typescript@5.9.3_zod@3.25.76/node_modules/abitype/dist/types/abi.d.ts
type Address$2 = ResolvedRegister$2['addressType'];
//#endregion
//#region ../node_modules/.pnpm/ox@0.9.6_typescript@5.9.3_zod@3.25.76/node_modules/ox/_types/core/Address.d.ts
/** Root type for Address. */
type Address$3 = Address$2;
//#endregion
//#region ../node_modules/.pnpm/ox@0.9.6_typescript@5.9.3_zod@3.25.76/node_modules/ox/_types/core/Withdrawal.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/ox@0.9.6_typescript@5.9.3_zod@3.25.76/node_modules/ox/_types/core/BlockOverrides.d.ts
/**
 * Block overrides.
 */
...
//#endregion
//#region ../node_modules/.pnpm/ox@0.9.6_typescript@5.9.3_zod@3.25.76/node_modules/ox/_types/core/RpcResponse.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/misc.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/authorization.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/eip4844.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/fee.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/kzg.d.ts
type Kzg = {
  /**
...
type GetTransactionRequestKzgParameter<request$1 extends unknown | undefined = undefined> = MaybeRequired<{
  ...
  account: LocalAccount<string, Address$1>;
  blobs: TransactionRequestEIP4844['blobs'];
} ? true : false>;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/contract.d.ts
...
type ContractFunctionReturnType<abi$1 extends Abi | readonly unknown[] = Abi, mutability extends AbiStateMutability = AbiStateMutability, functionName$1 extends ContractFunctionName<abi$1, mutability> = ContractFunctionName<abi$1, mutability>, args$1 extends ContractFunctionArgs<abi$1, mutability, functionName$1> = ContractFunctionArgs<abi$1, mutability, functionName$1>> = abi$1 extends Abi ? Abi extends abi$1 ? unknown : AbiParametersToPrimitiveTypes<ExtractAbiFunctionForArgs<abi$1, mutability, functionName$1, args$1>['outputs']> extends infer types ? types extends readonly [] ? void : types extends readonly [infer type] ? type : types : never : unknown;
...
type GetValue<abi$1 extends Abi | readonly unknown[], functionName$1 extends string, valueType = TransactionRequest['value'], abiFunction$1 extends AbiFunction = (abi$1 extends Abi ? ExtractAbiFunction<abi$1, functionName$1> : AbiFunction), _Narrowable extends boolean = IsNarrowable<abi$1, Abi>> = _Narrowable extends true ? abiFunction$1['stateMutability'] extends 'payable' ? {
  value?: NoInfer$1<valueType> | undefined;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/log.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/transaction.d.ts
type AccessList = readonly {
  address: Address$1;
  storageKeys: readonly Hex$1[];
}[];
type TransactionType$2 = 'legacy' | 'eip1559' | 'eip2930' | 'eip4844' | 'eip7702' | (string & {});
type TransactionReceipt<quantity = bigint, index$1 = number, status$1 = 'success' | 'reverted', type$1 = TransactionType$2> = {
  ...
  contractAddress: Address$1 | null | undefined;
...
type TransactionSerialized<type$1 extends TransactionType$2 = TransactionType$2, result$1 = (type$1 extends 'eip1559' ? TransactionSerializedEIP1559 : never) | (type$1 extends 'eip2930' ? TransactionSerializedEIP2930 : never) | (type$1 extends 'eip4844' ? TransactionSerializedEIP4844 : never) | (type$1 extends 'eip7702' ? TransactionSerializedEIP7702 : never) | (type$1 extends 'legacy' ? TransactionSerializedLegacy : never)> = IsNever<result$1> extends true ? TransactionSerializedGeneric : result$1;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/withdrawal.d.ts
type Withdrawal = {
  address: Hex$1;
  amount: Hex$1;
  index: Hex$1;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/block.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/proof.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/rpc.d.ts
...
type RpcTransactionReceipt = TransactionReceipt<Quantity, Index, Status, TransactionType$3>;
...
type RpcStateOverride = {
  [address: Address$1]: RpcAccountStateOverride;
};
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/account-abstraction/types/entryPointVersion.d.ts
/** @link https://github.com/eth-infinitism/account-abstraction/releases */
type EntryPointVersion = '0.6' | '0.7' | '0.8';
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/account-abstraction/types/userOperation.d.ts
/** @link https://eips.ethereum.org/EIPS/eip-4337#-eth_estimateuseroperationgas */
type EstimateUserOperationGasReturnType<entryPointVersion extends EntryPointVersion = EntryPointVersion, uint256 = bigint> = OneOf$1<(entryPointVersion extends '0.8' ? {
...
type UserOperation<entryPointVersion extends EntryPointVersion = EntryPointVersion, uint256 = bigint, uint32 = number> = OneOf$1<(entryPointVersion extends '0.8' ? {
  /** Authorization data. */
...
type UserOperationReceipt<_entryPointVersion extends EntryPointVersion = EntryPointVersion, uint256 = bigint, int32 = number, status$1 = 'success' | 'reverted'> = {
  ...
  receipt: TransactionReceipt<uint256, int32, status$1>;
  sender: Address$1;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/account-abstraction/types/rpc.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/base.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/request.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/rpc.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/promise/createBatchScheduler.d.ts
type CreateBatchSchedulerErrorType = ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/promise/withRetry.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/rpc/socket.d.ts
type GetSocketRpcClientErrorType = CreateBatchSchedulerErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/buildRequest.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/experimental/erc7895/actions/addSubAccount.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/siwe/types.d.ts
/**
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/register.d.ts
interface Register {}
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/capabilities.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/eip1193.d.ts
...
{
  Method: 'eth_estimateUserOperationGas';
  Parameters: [userOperation: RpcUserOperation, entrypoint: Address$1] | [userOperation: RpcUserOperation, entrypoint: Address$1, stateOverrideSet: RpcStateOverride];
...
{
  Method: 'eth_sendUserOperation';
  Parameters: [userOperation: RpcUserOperation, entrypoint: Address$1];
  ReturnType: Hash$1;
},
/**
 ...
 */
{
  ...
  Parameters: [address: Address$1, block: RpcBlockNumber | BlockTag | RpcBlockIdentifier];
  ReturnType: Quantity;
},
/**
 ...
 */
{
  ...
  address: Address$1, /** An array of storage-keys that should be proofed and included. */
 ...
 */
{
  ...
  Parameters: [address: Address$1, index: Quantity, block: RpcBlockNumber | BlockTag | RpcBlockIdentifier];
  ReturnType: Hex$1;
},
/**
 ...
 */
{
  ...
  Parameters: [sender: Address$1, nonce: Quantity];
  ReturnType: RpcTransaction | null;
},
/**
 ...
 */
{
  ...
  address: Address$1, /** Data to sign */
  data: Hex$1];
  ReturnType: Hex$1;
},
/**
 ...
 */
{
  ...
  Parameters: [/** Address to use for signing */
  address: Address$1, /** Message to sign containing type information, a domain separator, and data */
  message: string];
  ReturnType: Hex$1;
},
/**
 ...
 */
{
  ...
  Parameters?: readonly [] | readonly [Address$1 | undefined] | readonly [Address$1 | undefined, readonly Hex$1[] | undefined] | undefined;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/clients/transports/createTransport.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/typedData.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/nonceManager.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/account-abstraction/accounts/types.d.ts
type Call$1 = {
  to: Hex$1;
  data?: Hex$1 | undefined;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/accounts/utils/parseAccount.d.ts
type ParseAccountErrorType = ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/data/isHex.d.ts
type IsHexErrorType = ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/data.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/data/pad.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/encoding.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/data/size.d.ts
type SizeErrorType = IsHexErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/encoding/fromHex.d.ts
...
type HexToNumberErrorType = HexToBigIntErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/encoding/toHex.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/encoding/toBytes.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/hash/keccak256.d.ts
type Keccak256ErrorType = IsHexErrorType | ToBytesErrorType | ToHexErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/abi.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/address/isAddress.d.ts
type IsAddressErrorType = ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/cursor.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/cursor.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/data/slice.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/hash/hashSignature.d.ts
type HashSignatureErrorType = Keccak256ErrorType | ToBytesErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/hash/normalizeSignature.d.ts
type NormalizeSignatureErrorType = ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/hash/toSignature.d.ts
type ToSignatureErrorType = NormalizeSignatureErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/hash/toSignatureHash.d.ts
type ToSignatureHashErrorType = HashSignatureErrorType | ToSignatureErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/hash/toFunctionSelector.d.ts
type ToFunctionSelectorErrorType = ToSignatureHashErrorType | SliceErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/abi/getAbiItem.d.ts
...
/** @internal */
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/data/concat.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/address.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/abi/encodeAbiParameters.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/abi/formatAbiItem.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/abi/encodeFunctionData.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/chain.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/stateOverride.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/node.d.ts
/**
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/errors/getNodeError.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/formatters/transactionRequest.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/transaction/assertRequest.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/call.d.ts
type CallParameters<chain$1 extends Chain$1 | undefined = Chain$1 | undefined> = UnionOmit<FormattedCall<chain$1>, 'from'> & {
  /** Account attached to the call (msg.sender). */
  account?: Account$1 | Address$1 | undefined;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/abi/decodeErrorResult.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/contract.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/errors/getContractError.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/readContract.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/ens/getEnsAddress.d.ts
type GetEnsAddressParameters = Prettify<Pick<ReadContractParameters, 'blockNumber' | 'blockTag'> & {
   ...
   */
  universalResolverAddress?: Address$1 | undefined;
}>;
type GetEnsAddressReturnType = Address$1 | null;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/ens.d.ts
type AssetGateway = 'ipfs' | 'arweave';
type AssetGatewayUrls = { [_key in AssetGateway]?: string | undefined };
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/ens/getEnsText.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/ens/getEnsAvatar.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/ens/getEnsName.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/ens/getEnsResolver.d.ts
...
type GetEnsResolverReturnType = Address$1;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/filter.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/createContractEventFilter.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/signature/recoverAddress.d.ts
type RecoverAddressErrorType = ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/encoding/toRlp.d.ts
type ToRlpErrorType = CreateCursorErrorType | BytesToHexErrorType | HexToBytesErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/authorization/hashAuthorization.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/authorization/recoverAuthorizationAddress.d.ts
type RecoverAuthorizationAddressErrorType = HashAuthorizationErrorType | RecoverAddressErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/estimateGas.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/errors/getEstimateGasError.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/block.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/formatters/transaction.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/formatters/block.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getBlock.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getTransactionCount.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/account.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/prepareTransactionRequest.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/estimateGas.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/estimateContractGas.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getLogs.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getContractEvents.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/chain/assertCurrentChain.d.ts
type AssertCurrentChainErrorType = ChainNotFoundErrorType | ChainMismatchErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/errors/getTransactionError.d.ts
type GetTransactionErrorReturnType<cause$1 = ErrorType$2> = Omit<TransactionExecutionErrorType, 'cause'> & {
  cause: cause$1 | GetNodeErrorReturnType;
};
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getChainId.d.ts
type GetChainIdReturnType = number;
type GetChainIdErrorType = HexToNumberErrorType | RequestErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/accounts/utils/sign.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/accounts/utils/signAuthorization.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getTransaction.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/formatters/transactionReceipt.d.ts
type FormattedTransactionReceipt<chain$1 extends Chain$1 | undefined = undefined> = ExtractChainFormatterReturnType<chain$1, 'transactionReceipt', TransactionReceipt>;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getTransactionReceipt.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/clients/transports/fallback.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/transport.d.ts
type GetTransportConfig<transport$1 extends Transport$2> = ReturnType<transport$1>['config'];
type GetPollOptions<transport$1 extends Transport$2> = (HasTransportType<transport$1, 'webSocket' | 'ipc'> extends true ? {
  batch?: undefined;
  /**
...
type HasTransportType<transport$1 extends Transport$2, type$1 extends string> = GetTransportConfig<transport$1>['type'] extends type$1 ? true : transport$1 extends FallbackTransport<infer transports extends readonly Transport$2[]> ? Some<{ [key in keyof transports]: GetTransportConfig<transports[key]>['type'] }, type$1> : false;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getBlockNumber.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/watchBlockNumber.d.ts
...
type WatchBlockNumberParameters<transport$1 extends Transport$2 = Transport$2> = {
  /** The callback to call when a new block number is received. */
  onBlockNumber: OnBlockNumberFn;
  /** The callback to call when an error occurred when trying to get for a new block. */
  onError?: ((error: Error) => void) | undefined;
} & ((HasTransportType<transport$1, 'webSocket' | 'ipc'> extends true ? {
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/waitForTransactionReceipt.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/ccip.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/createAccessList.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/createBlockFilter.d.ts
type CreateBlockFilterReturnType = Filter<'block'>;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/createEventFilter.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/createPendingTransactionFilter.d.ts
type CreatePendingTransactionFilterReturnType = Filter<'transaction'>;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/fee.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getGasPrice.d.ts
type GetGasPriceReturnType = bigint;
type GetGasPriceErrorType = RequestErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/estimateMaxPriorityFeePerGas.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/fillTransaction.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getBalance.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getBlobBaseFee.d.ts
type GetBlobBaseFeeReturnType = bigint;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getBlockTransactionCount.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getCode.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getEip712Domain.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getFeeHistory.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getFilterChanges.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getFilterLogs.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getProof.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getStorageAt.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/getTransactionConfirmations.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/multicall.d.ts
...
type MulticallResults<contracts extends readonly unknown[] = readonly ContractFunctionParameters[], allowFailure extends boolean = true, options extends {
  ...
  extraProperties: {};
  mutability: AbiStateMutability;
}, result$1 extends any[] = []> = contracts extends readonly [] ? readonly [] : contracts extends readonly [infer contract] ? [...result$1, MulticallResponse<GetMulticallContractReturnType<contract, options['mutability']>, options['error'], allowFailure, options['extraProperties']>] : contracts extends readonly [infer contract, ...infer rest] ? MulticallResults<[...rest], allowFailure, options, [...result$1, MulticallResponse<GetMulticallContractReturnType<contract, options['mutability']>, options['error'], allowFailure, options['extraProperties']>]> : readonly unknown[] extends contracts ? MulticallResponse<unknown, options['error'], allowFailure, options['extraProperties']>[] : contracts extends readonly (infer contract extends ContractFunctionParameters)[] ? MulticallResponse<GetMulticallContractReturnType<contract, options['mutability']>, options['error'], allowFailure, options['extraProperties']>[] : MulticallResponse<unknown, options['error'], allowFailure, options['extraProperties']>[];
type MulticallResponse<result$1 = unknown, error$1 = unknown, allowFailure extends boolean = true, extraProperties extends Record<string, unknown> | undefined = {}> = allowFailure extends true ? (extraProperties & {
  error?: undefined;
  result: result$1;
  status: 'success';
}) | (extraProperties & {
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/multicall.d.ts
type MulticallParameters<contracts extends readonly unknown[] = readonly ContractFunctionParameters[], allowFailure extends boolean = true, options extends {
  ...
  multicallAddress?: Address$1 | undefined;
};
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/calls.d.ts
...
type Calls<calls extends readonly unknown[], extraProperties extends Record<string, unknown> = {}, result$1 extends readonly any[] = []> = calls extends readonly [] ? readonly [] : calls extends readonly [infer call] ? readonly [...result$1, Prettify<Call<call, extraProperties>>] : calls extends readonly [infer call, ...infer rest] ? Calls<[...rest], extraProperties, [...result$1, Prettify<Call<call, extraProperties>>]> : readonly unknown[] extends calls ? calls : calls extends readonly (infer call extends OneOf$1<Call<unknown, extraProperties>>)[] ? readonly Prettify<call>[] : readonly OneOf$1<Call>[];
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/simulateBlocks.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/simulateCalls.d.ts
type SimulateCallsParameters<calls extends readonly unknown[] = readonly unknown[], account$1 extends Account$1 | Address$1 | undefined = Account$1 | Address$1 | undefined> = Omit<SimulateBlocksParameters, 'blocks' | 'returnFullTransactions'> & {
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/uninstallFilter.d.ts
type UninstallFilterParameters = {
  filter: Filter<any>;
};
type UninstallFilterReturnType = boolean;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/verifyHash.d.ts
type VerifyHashParameters = Pick<CallParameters, 'blockNumber' | 'blockTag'> & {
  ...
  erc6492VerifierAddress?: Address$1 | undefined;
  ...
  universalSignatureVerifierAddress?: Address$1 | undefined;
} & OneOf$1<{
  factory: Address$1;
  factoryData: Hex$1;
} | {}>;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/verifyMessage.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/verifyTypedData.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/watchBlocks.d.ts
...
type WatchBlocksParameters<transport$1 extends Transport$2 = Transport$2, chain$1 extends Chain$1 | undefined = Chain$1, includeTransactions extends boolean = false, blockTag$1 extends BlockTag = 'latest'> = {
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/watchContractEvent.d.ts
...
type WatchContractEventParameters<abi$1 extends Abi | readonly unknown[] = Abi, eventName$1 extends ContractEventName<abi$1> | undefined = ContractEventName<abi$1>, strict$1 extends boolean | undefined = undefined, transport$1 extends Transport$2 = Transport$2> = {
  /** The address of the contract. */
  address?: Address$1 | Address$1[] | undefined;
  /** Contract ABI. */
  abi: abi$1;
   ...
   */
  strict?: strict$1 | boolean | undefined;
} & GetPollOptions<transport$1>;
type WatchContractEventReturnType = () => void;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/watchEvent.d.ts
...
type WatchEventParameters<abiEvent extends AbiEvent | undefined = undefined, abiEvents extends readonly AbiEvent[] | readonly unknown[] | undefined = (abiEvent extends AbiEvent ? [abiEvent] : undefined), strict$1 extends boolean | undefined = undefined, transport$1 extends Transport$2 = Transport$2, _eventName extends string | undefined = MaybeAbiEventName<abiEvent>> = {
  /** The address of the contract. */
  address?: Address$1 | Address$1[] | undefined;
  /** Block to start listening from. */
  fromBlock?: BlockNumber<bigint> | undefined;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/watchPendingTransactions.d.ts
type OnTransactionsParameter = Hash$1[];
type OnTransactionsFn = (transactions: OnTransactionsParameter) => void;
type WatchPendingTransactionsParameters<transport$1 extends Transport$2 = Transport$2> = {
  /** The callback to call when an error occurred when trying to get for a new block. */
  onError?: ((error: Error) => void) | undefined;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/siwe/validateSiweMessage.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/siwe/verifySiweMessage.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/sendRawTransaction.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/clients/decorators/public.d.ts
type PublicActions<transport$1 extends Transport$2 = Transport$2, chain$1 extends Chain$1 | undefined = Chain$1 | undefined, account$1 extends Account$1 | undefined = Account$1 | undefined> = {
  /**
   ...
   * })
   */
  fillTransaction: <chainOverride extends Chain$1 | undefined = undefined, accountOverride extends Account$1 | Address$1 | undefined = undefined>(args: FillTransactionParameters<chain$1, account$1, chainOverride, accountOverride>) => Promise<FillTransactionReturnType<chain$1, chainOverride>>;
  /**
   ...
   * })
   */
  watchBlocks: <includeTransactions extends boolean = false, blockTag$1 extends BlockTag = 'latest'>(args: WatchBlocksParameters<transport$1, chain$1, includeTransactions, blockTag$1>) => WatchBlocksReturnType;
  /**
   ...
   * })
   */
  watchContractEvent: <const abi$1 extends Abi | readonly unknown[], eventName$1 extends ContractEventName<abi$1>, strict$1 extends boolean | undefined = undefined>(args: WatchContractEventParameters<abi$1, eventName$1, strict$1, transport$1>) => WatchContractEventReturnType;
  /**
   ...
   * })
   */
  watchPendingTransactions: (args: WatchPendingTransactionsParameters<transport$1>) => WatchPendingTransactionsReturnType;
};
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/addChain.d.ts
type AddChainParameters = {
  /** The chain to add to the wallet. */
  chain: Chain$1;
};
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/deployContract.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/getAddresses.d.ts
type GetAddressesReturnType = Address$1[];
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/getCallsStatus.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/getCapabilities.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/getPermissions.d.ts
type GetPermissionsReturnType = WalletPermission[];
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/prepareAuthorization.d.ts
type PrepareAuthorizationParameters<account$1 extends Account$1 | undefined = Account$1 | undefined> = GetAccountParameter<account$1> & PartialBy<AuthorizationRequest, 'chainId' | 'nonce'> & {
   ...
   */
  executor?: 'self' | Account$1 | Address$1 | undefined;
};
type PrepareAuthorizationReturnType = Authorization;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/requestAddresses.d.ts
type RequestAddressesReturnType = Address$1[];
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/requestPermissions.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/sendCalls.d.ts
...
} & GetAccountParameter<account$1, Account$1 | Address$1, false, true>;
type SendCallsReturnType = Prettify<{
  capabilities?: ExtractCapabilities<'sendCalls', 'ReturnType'> | undefined;
  id: string;
}>;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/waitForCallsStatus.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/sendCallsSync.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/showCallsStatus.d.ts
type ShowCallsStatusParameters = {
  id: string;
};
type ShowCallsStatusReturnType = void;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/signAuthorization.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/signMessage.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/signTransaction.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/signTypedData.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/switchChain.d.ts
type SwitchChainParameters = {
  /** ID of Chain to switch to */
  id: Chain$1['id'];
};
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/watchAsset.d.ts
type WatchAssetParameters = WatchAssetParams;
type WatchAssetReturnType = boolean;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/writeContractSync.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/clients/decorators/wallet.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/sendRawTransactionSync.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/sendTransactionSync.d.ts
type SendTransactionSyncRequest<chain$1 extends Chain$1 | undefined = Chain$1 | undefined, chainOverride extends Chain$1 | undefined = Chain$1 | undefined, _derivedChain extends Chain$1 | undefined = DeriveChain<chain$1, chainOverride>> = UnionOmit<FormattedTransactionRequest<_derivedChain>, 'from'> & GetTransactionRequestKzgParameter;
type SendTransactionSyncParameters<chain$1 extends Chain$1 | undefined = Chain$1 | undefined, account$1 extends Account$1 | undefined = Account$1 | undefined, chainOverride extends Chain$1 | undefined = Chain$1 | undefined, request$1 extends SendTransactionSyncRequest<chain$1, chainOverride> = SendTransactionSyncRequest<chain$1, chainOverride>> = request$1 & GetAccountParameter<account$1, Account$1 | Address$1, true, true> & GetChainParameter<chain$1, chainOverride> & GetTransactionRequestKzgParameter<request$1> & {
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/writeContract.d.ts
type WriteContractParameters<abi$1 extends Abi | readonly unknown[] = Abi, functionName$1 extends ContractFunctionName<abi$1, 'nonpayable' | 'payable'> = ContractFunctionName<abi$1, 'nonpayable' | 'payable'>, args$1 extends ContractFunctionArgs<abi$1, 'nonpayable' | 'payable', functionName$1> = ContractFunctionArgs<abi$1, 'nonpayable' | 'payable', functionName$1>, chain$1 extends Chain$1 | undefined = Chain$1 | undefined, account$1 extends Account$1 | undefined = Account$1 | undefined, chainOverride extends Chain$1 | undefined = Chain$1 | undefined, allFunctionNames$1 = ContractFunctionName<abi$1, 'nonpayable' | 'payable'>, derivedChain extends Chain$1 | undefined = DeriveChain<chain$1, chainOverride>> = ContractFunctionParameters<abi$1, 'nonpayable' | 'payable', functionName$1, args$1, false, allFunctionNames$1> & GetChainParameter<chain$1, chainOverride> & Prettify<GetAccountParameter<account$1, Account$1 | Address$1, true, true> & GetMutabilityAwareValue<abi$1, 'nonpayable' | 'payable', functionName$1, FormattedTransactionRequest<derivedChain>['value'], args$1> & {
  /** Data to append to the end of the calldata. Useful for adding a ["domain" tag](https://opensea.notion.site/opensea/Seaport-Order-Attributions-ec2d69bf455041a5baa490941aad307f). */
  dataSuffix?: Hex$1 | undefined;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/simulateContract.d.ts
...
type SimulateContractParameters<abi$1 extends Abi | readonly unknown[] = Abi, functionName$1 extends ContractFunctionName<abi$1, 'nonpayable' | 'payable'> = ContractFunctionName<abi$1, 'nonpayable' | 'payable'>, args$1 extends ContractFunctionArgs<abi$1, 'nonpayable' | 'payable', functionName$1> = ContractFunctionArgs<abi$1, 'nonpayable' | 'payable', functionName$1>, chain$1 extends Chain$1 | undefined = Chain$1 | undefined, chainOverride extends Chain$1 | undefined = Chain$1 | undefined, accountOverride extends Account$1 | Address$1 | null | undefined = undefined, derivedChain extends Chain$1 | undefined = DeriveChain<chain$1, chainOverride>> = {
  account?: accountOverride | null | undefined;
  chain?: chainOverride | undefined;
  /** Data to append to the end of the calldata. Useful for adding a ["domain" tag](https://opensea.notion.site/opensea/Seaport-Order-Attributions-ec2d69bf455041a5baa490941aad307f). */
  dataSuffix?: Hex$1 | undefined;
} & ContractFunctionParameters<abi$1, 'nonpayable' | 'payable', functionName$1, args$1> & UnionOmit<CallParameters<derivedChain>, 'account' | 'batch' | 'code' | 'to' | 'data' | 'factory' | 'factoryData' | 'value'> & GetMutabilityAwareValue<abi$1, 'nonpayable' | 'payable', functionName$1, CallParameters<derivedChain> extends CallParameters ? CallParameters<derivedChain>['value'] : CallParameters['value'], args$1>;
...
out chain$1 extends Chain$1 | undefined = Chain$1 | undefined, out account$1 extends Account$1 | undefined = Account$1 | undefined, out chainOverride extends Chain$1 | undefined = Chain$1 | undefined, out accountOverride extends Account$1 | Address$1 | null | undefined = Account$1 | Address$1 | null | undefined, in out minimizedAbi extends Abi = readonly [ExtractAbiFunctionForArgs<abi$1 extends Abi ? abi$1 : Abi, 'nonpayable' | 'payable', functionName$1, args$1>], out resolvedAccount extends Account$1 | null | undefined = (accountOverride extends Account$1 | Address$1 | null ? ParseAccount<accountOverride> : account$1)> = {
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/transaction/getTransactionType.d.ts
type GetTransactionType<transaction$1 extends OneOf$1<TransactionSerializableGeneric | TransactionRequestGeneric> = TransactionSerializableGeneric, result$1 = (transaction$1 extends LegacyProperties ? 'legacy' : never) | (transaction$1 extends EIP1559Properties ? 'eip1559' : never) | (transaction$1 extends EIP2930Properties ? 'eip2930' : never) | (transaction$1 extends EIP4844Properties ? 'eip4844' : never) | (transaction$1 extends EIP7702Properties ? 'eip7702' : never) | (transaction$1['type'] extends TransactionSerializableGeneric['type'] ? Extract<transaction$1['type'], string> : never)> = IsNever<keyof transaction$1> extends true ? string : IsNever<result$1> extends false ? result$1 : string;
type BaseProperties = {
  accessList?: undefined;
  authorizationList?: undefined;
  blobs?: undefined;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/accounts/utils/signTransaction.d.ts
type SignTransactionErrorType = Keccak256ErrorType | SignErrorType | ErrorType$2;
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/wallet/sendTransaction.d.ts
type SendTransactionRequest<chain$1 extends Chain$1 | undefined = Chain$1 | undefined, chainOverride extends Chain$1 | undefined = Chain$1 | undefined, _derivedChain extends Chain$1 | undefined = DeriveChain<chain$1, chainOverride>> = UnionOmit<FormattedTransactionRequest<_derivedChain>, 'from'> & GetTransactionRequestKzgParameter;
type SendTransactionParameters<chain$1 extends Chain$1 | undefined = Chain$1 | undefined, account$1 extends Account$1 | undefined = Account$1 | undefined, chainOverride extends Chain$1 | undefined = Chain$1 | undefined, request$1 extends SendTransactionRequest<chain$1, chainOverride> = SendTransactionRequest<chain$1, chainOverride>> = request$1 & GetAccountParameter<account$1, Account$1 | Address$1, true, true> & GetChainParameter<chain$1, chainOverride> & GetTransactionRequestKzgParameter<request$1>;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/errors/transaction.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/utils/transaction/serializeTransaction.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/accounts/types.d.ts
type Account$1<address$1 extends Address$1 = Address$1> = OneOf$1<JsonRpcAccount<address$1> | LocalAccount<string, address$1> | SmartAccount>;
type CustomSource = {
  address: Address$1;
  nonceManager?: NonceManager | undefined;
  sign?: ((parameters: {
...
type JsonRpcAccount<address$1 extends Address$1 = Address$1> = {
  address: address$1;
  type: 'json-rpc';
};
type LocalAccount<source extends string = string, address$1 extends Address$1 = Address$1> = Prettify<CustomSource & {
  address: address$1;
  publicKey: Hex$1;
  source: source;
  type: 'local';
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/clients/createClient.d.ts
type ClientConfig$1<transport$1 extends Transport$2 = Transport$2, chain$1 extends Chain$1 | undefined = Chain$1 | undefined, accountOrAddress extends Account$1 | Address$1 | undefined = Account$1 | Address$1 | undefined, rpcSchema extends RpcSchema | undefined = undefined> = {
  /** The Account to use for the Client. This will be used for Actions that require an account as an argument. */
  account?: accountOrAddress | Account$1 | Address$1 | undefined;
...
type ExtendableProtectedActions<transport$1 extends Transport$2 = Transport$2, chain$1 extends Chain$1 | undefined = Chain$1 | undefined, account$1 extends Account$1 | undefined = Account$1 | undefined> = Pick<PublicActions<transport$1, chain$1, account$1>, 'call' | 'createContractEventFilter' | 'createEventFilter' | 'estimateContractGas' | 'estimateGas' | 'getBlock' | 'getBlockNumber' | 'getChainId' | 'getContractEvents' | 'getEnsText' | 'getFilterChanges' | 'getGasPrice' | 'getLogs' | 'getTransaction' | 'getTransactionCount' | 'getTransactionReceipt' | 'prepareTransactionRequest' | 'readContract' | 'sendRawTransaction' | 'simulateContract' | 'uninstallFilter' | 'watchBlockNumber' | 'watchContractEvent'> & Pick<WalletActions<chain$1, account$1>, 'sendTransaction' | 'writeContract'>;
type Client$1<transport$1 extends Transport$2 = Transport$2, chain$1 extends Chain$1 | undefined = Chain$1 | undefined, account$1 extends Account$1 | undefined = Account$1 | undefined, rpcSchema extends RpcSchema | undefined = undefined, extended extends Extended | undefined = Extended | undefined> = Client_Base<transport$1, chain$1, account$1, rpcSchema> & (extended extends Extended ? extended : unknown) & {
  extend: <const client extends Extended & ExactPartial$1<ExtendableProtectedActions<transport$1, chain$1, account$1>>>(fn: (client: Client$1<transport$1, chain$1, account$1, rpcSchema, extended>) => client) => Client$1<transport$1, chain$1, account$1, rpcSchema, Prettify<client> & (extended extends Extended ? extended : unknown)>;
};
type Client_Base<transport$1 extends Transport$2 = Transport$2, chain$1 extends Chain$1 | undefined = Chain$1 | undefined, account$1 extends Account$1 | undefined = Account$1 | undefined, rpcSchema extends RpcSchema | undefined = undefined> = {
  ...
  /** The RPC transport */
  transport: ReturnType<transport$1>['config'] & ReturnType<transport$1>['value'];
  /** The type of client. */
  type: string;
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/actions/public/estimateFeesPerGas.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/viem@2.41.2_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_types/types/chain.d.ts
type Chain$1<formatters$1 extends ChainFormatters | undefined = ChainFormatters | undefined, custom extends Record<string, unknown> | undefined = Record<string, unknown> | undefined> = {
...
} & ChainConfig<formatters$1, custom>;
...
type ChainConfig<formatters$1 extends ChainFormatters | undefined = ChainFormatters | undefined, custom extends Record<string, unknown> | undefined = Record<string, unknown> | undefined> = {
  /** Custom chain data. */
...
//#endregion
//#region ../node_modules/.pnpm/zustand@5.0.0_@types+react@19.2.6_react@19.2.0_use-sync-external-store@1.4.0_react@19.2.0_/node_modules/zustand/esm/vanilla.d.mts
...
//#endregion
//#region ../node_modules/.pnpm/@wagmi+core@2.22.0_@tanstack+query-core@5.90.10_@types+react@19.2.6_react@19.2.0_typescript@5_klg6kvfwmm2oy52t7g6v4hpsle/node_modules/@wagmi/core/dist/types/createEmitter.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/@wagmi+core@2.22.0_@tanstack+query-core@5.90.10_@types+react@19.2.6_react@19.2.0_typescript@5_klg6kvfwmm2oy52t7g6v4hpsle/node_modules/@wagmi/core/dist/types/types/utils.d.ts
/** Combines members of an intersection into a readable type. */
...
//#endregion
//#region ../node_modules/.pnpm/@wagmi+core@2.22.0_@tanstack+query-core@5.90.10_@types+react@19.2.6_react@19.2.0_typescript@5_klg6kvfwmm2oy52t7g6v4hpsle/node_modules/@wagmi/core/dist/types/createStorage.d.ts
type StorageItemMap = {
...
//#endregion
//#region ../node_modules/.pnpm/@wagmi+core@2.22.0_@tanstack+query-core@5.90.10_@types+react@19.2.6_react@19.2.0_typescript@5_klg6kvfwmm2oy52t7g6v4hpsle/node_modules/@wagmi/core/dist/types/connectors/createConnector.d.ts
...
type CreateConnectorFn$1<provider$1 = unknown, properties extends Record<string, unknown> = Record<string, unknown>, storageItem extends Record<string, unknown> = Record<string, unknown>> = (config: {
...
//#endregion
//#region ../node_modules/.pnpm/@wagmi+core@2.22.0_@tanstack+query-core@5.90.10_@types+react@19.2.6_react@19.2.0_typescript@5_klg6kvfwmm2oy52t7g6v4hpsle/node_modules/@wagmi/core/dist/types/createConfig.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/@wagmi+core@2.22.0_@tanstack+query-core@5.90.10_@types+react@19.2.6_react@19.2.0_typescript@5_klg6kvfwmm2oy52t7g6v4hpsle/node_modules/@wagmi/core/dist/types/errors/base.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/@wagmi+core@2.22.0_@tanstack+query-core@5.90.10_@types+react@19.2.6_react@19.2.0_typescript@5_klg6kvfwmm2oy52t7g6v4hpsle/node_modules/@wagmi/core/dist/types/errors/config.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/@wagmi+core@2.22.0_@tanstack+query-core@5.90.10_@types+react@19.2.6_react@19.2.0_typescript@5_klg6kvfwmm2oy52t7g6v4hpsle/node_modules/@wagmi/core/dist/types/actions/getConnectorClient.d.ts
...
//#endregion
//#region ../node_modules/.pnpm/@wagmi+core@2.22.0_@tanstack+query-core@5.90.10_@types+react@19.2.6_react@19.2.0_typescript@5_klg6kvfwmm2oy52t7g6v4hpsle/node_modules/@wagmi/core/dist/types/actions/writeContract.d.ts
type WriteContractErrorType$1 = GetConnectorClientErrorType | BaseErrorType$1 | ErrorType$1 | WriteContractErrorType;
//#endregion
//#region ../node_modules/.pnpm/zustand@5.0.3_@types+react@19.2.6_react@19.2.0_use-sync-external-store@1.4.0_react@19.2.0_/node_modules/zustand/esm/middleware/redux.d.mts
type Write$3<T$1, U$1> = Omit<T$1, keyof U$1> & U$1;
type StoreRedux<A> = {
  dispatch: (a: A) => A;
...
//#endregion
//#region ../node_modules/.pnpm/zustand@5.0.3_@types+react@19.2.6_react@19.2.0_use-sync-external-store@1.4.0_react@19.2.0_/node_modules/zustand/esm/middleware/devtools.d.mts
declare module '../vanilla.mjs' {
  interface StoreMutators<S, A> {
    'zustand/devtools': WithDevtools<S>;
  }
}
type Cast<T$1, U$1> = T$1 extends U$1 ? T$1 : U$1;
type Write$2<T$1, U$1> = Omit<T$1, keyof U$1> & U$1;
...
//#endregion
//#region ../node_modules/.pnpm/zustand@5.0.3_@types+react@19.2.6_react@19.2.0_use-sync-external-store@1.4.0_react@19.2.0_/node_modules/zustand/esm/middleware/subscribeWithSelector.d.mts
type Write$1<T$1, U$1> = Omit<T$1, keyof U$1> & U$1;
...
type StoreSubscribeWithSelector<T$1> = {
  subscribe: {
    ...
    <U$1>(selector: (state: T$1) => U$1, listener: (selectedState: U$1, previousSelectedState: U$1) => void, options?: {
      equalityFn?: (a: U$1, b: U$1) => boolean;
      fireImmediately?: boolean;
    }): () => void;
  };
};
//#endregion
//#region ../node_modules/.pnpm/zustand@5.0.3_@types+react@19.2.6_react@19.2.0_use-sync-external-store@1.4.0_react@19.2.0_/node_modules/zustand/esm/middleware/persist.d.mts
type StorageValue<S> = {
  state: S;
  version?: number;
};
...
type Write<T$1, U$1> = Omit<T$1, keyof U$1> & U$1;
...
type OpaqueType<T$1 extends string, U$1> = U$1 & Tag<T$1, U$1>;
...
interface JSONRPCResponse<T$1 = any, U$1 = any> {
  jsonrpc: '2.0';
  id: number;
  result?: T$1;
  error?: {
...
type ShopBuyModalProps = BuyModalBaseProps & {
  ...
  item: Partial<CheckoutOptionsItem> & {
    tokenId: bigint;
  };
  quantityRemaining: bigint;
  salePrice: {
...
interface MarketTransactionParams extends BaseTransactionParams {
  transactionType: TransactionType$1.MARKET_BUY;
  collectionAddress: Address;
  marketplace: MarketplaceKind;
  orderId: string;
...
interface PrimarySaleTransactionParams extends BaseTransactionParams {
  transactionType: TransactionType$1.PRIMARY_SALE;
  collectionAddress: Address;
  salesContractAddress: Address;
  tokenIds: string[];
  amounts: number[];
...
//#endregion
export { TransactionType$4 as $, FilterCondition as $n, GetCountOfPrimarySaleItemsRequest as $t, BuyModalProps as A, Step as An, PropertyFilter as Ar, SequenceMarketplace as At, CancelInput as B, SearchTokenMetadataReturn as Bn, CollectionFilterSettings$1 as Bt, Price as C, Order as Cn, OrderStatus$1 as Cr, getSequenceApiUrl as Ct, Event$2 as D, ShopPage as Dn, PostRequest as Dr, indexerURL as Dt, DatabeatAnalytics as E, ShopCollection as En, Page as Er, getTrailsApiUrl as Et, clamp as F, isTransactionStep as Fn, TransactionCrypto as Fr, ApprovalStep as Ft, Optional as G, GetTokenIDRangesResponse as Gn, GenerateOfferTransactionRequest as Gt, CollectionType as H, ContractInfo$1$1 as Hn, Currency as Ht, serializeBigInts as I, ContractInfo$1 as In, TransactionOnRampProvider as Ir, CheckoutOptionsItem as It, SdkInfiniteQueryParams as J, ContractType$1 as Jn, GetCountOfAllCollectiblesRequest$1 as Jt, QueryArg as K, GetTokenSuppliesResponse as Kn, GenerateSellTransactionRequest as Kt, AllRequired as L, ContractInfoExtensions as Ln, WalletKind as Lr, CheckoutOptionsMarketplaceRequest as Lt, getEcosystemConnector as M, index_d_exports$1$1 as Mn, SortBy as Mr, fetchMarketplaceConfig as Mt, getWaasConnectors as N, index_d_exports$3 as Nn, SortOrder as Nr, marketplaceConfigOptions as Nt, EventTypes as O, Signature as On, PriceFilter as Or, marketplaceApiURL as Ot, WriteContractErrorType$1 as P, isSignatureStep as Pn, StepType as Pr, BuilderAPI as Pt, TransactionSteps as Q, TokenId as Qn, GetCountOfOffersForCollectibleRequest$1 as Qt, ApiArgs as R, Filter$2 as Rn, CollectibleOrder as Rt, MetadataFilterRule as S, MarketplaceWallet as Sn, OrderSide as Sr, getSequenceApiClient as St, isShopCollection as T, PrimarySaleItem as Tn, OrdersFilter as Tr, getSequenceNodeGatewayUrl as Tt, ListingInput as U, GetTokenBalancesDetailsResponse as Un, GenerateCancelTransactionRequest as Ut, CollectableId as V, TokenMetadata$1 as Vn, CreateReq as Vt, OfferInput as W, GetTokenBalancesResponse as Wn, GenerateListingTransactionRequest as Wt, SellInput as X, ChainId as Xn, GetCountOfFilteredOrdersRequest$1 as Xt, SdkQueryParams as Y, Address$1$1 as Yn, GetCountOfAllOrdersRequest$1 as Yt, Transaction$2 as Z, ProjectId as Zn, GetCountOfListingsForCollectibleRequest$1 as Zt, CollectionFilterSettings as _, ListPrimarySaleItemsRequest as _n, ListCollectionActivitiesResponse as _r, DEFAULT_NETWORK as _t, NATIVE_TOKEN_ADDRESS as a, ListCollectibleListingsResponse as an, CollectiblesFilter as ar, InfiniteQueryBuilderConfig as at, MarketplaceWalletOptions as b, MarketPage as bn, OfferType as br, getMarketplaceClient as bt, TransactionStepsParams as c, ListCollectiblesResponse as cn, CurrencyStatus as cr, WithOptionalInfiniteParams as ct, CheckoutMode as d, ListListingsForCollectibleRequest$1 as dn, GetCollectibleHighestOfferResponse as dr, buildQueryOptions as dt, GetFloorOrderRequest as en, AdditionalFee as er, ValuesOptional as et, Env as f, ListListingsForCollectibleResponse as fn, GetCountOfListingsForCollectibleResponse as fr, requiredParamsFor as ft, CollectibleCardAction as g, ListOrdersWithCollectiblesResponse as gn, ListCollectibleListingsRequest as gr, getProviderEl as gt, CardType as h, ListOrdersWithCollectiblesRequest as hn, ListCollectibleActivitiesResponse as hr, PROVIDER_ID as ht, MarketTransactionParams as i, ListCollectibleActivitiesRequest as in, Collectible as ir, EnsureAllRequiredKeys as it, getConnectors as j, TransactionStep as jn, PropertyType$1 as jr, getQueryClient as jt, useAnalytics as k, SignatureStep as kn, PrimarySaleItemsFilter as kr, sequenceApiUrl as kt, TransactionType$1 as l, ListCollectionActivitiesRequest as ln, ExecuteType as lr, WithOptionalParams as lt, SdkConfig as m, ListOffersForCollectibleResponse as mn, GetCountOfPrimarySaleItemsResponse as mr, StandardQueryOptions as mt, getWagmiChainsAndTransports as n, GetLowestPriceListingForCollectibleRequest as nn, CheckoutOptions as nr, BaseInfiniteQueryParams as nt, PrimarySaleTransactionParams as o, ListCollectibleOffersResponse as on, Collection as or, QueryBuilderConfig as ot, MarketplaceSdkContext as p, ListOffersForCollectibleRequest as pn, GetCountOfOffersForCollectibleResponse as pr, StandardInfiniteQueryOptions as pt, QueryKeyArgs as q, TokenBalance$1 as qn, GetCollectionDetailRequest$1 as qt, BaseTransactionParams as r, GetPrimarySaleItemResponse$1 as rn, CheckoutOptionsSalesContractResponse as rr, BaseQueryParams as rt, TransactionParams as s, ListCollectiblesRequest as sn, CollectionStatus as sr, RequiredKeys as st, createWagmiConfig as t, GetHighestPriceOfferForCollectibleRequest as tn, Asset as tr, WithRequired as tt, ApiConfig as u, ListCurrenciesRequest as un, GetCollectibleHighestOfferRequest as ur, buildInfiniteQueryOptions as ut, EcosystemWalletSettings as v, ListPrimarySaleItemsResponse as vn, MarketplaceKind as vr, getBuilderClient as vt, isMarketCollection as w, OrderData as wn, OrderbookKind as wr, getSequenceIndexerUrl as wt, MarketplaceWalletWaasSettings as x, MarketplaceCollection as xn, OrderFilter as xr, getMetadataClient as xt, MarketplaceConfig as y, MarketCollection as yn, MetadataStatus as yr, getIndexerClient as yt, BuyInput as z, Page$2 as zn, CollectiblePrimarySaleItem$1 as zt };
