...
declare const WebrpcHeaderValue = "webrpc@v0.25.4;gen-typescript@v0.17.0;marketplace-api@v0.0.0-1ecb14ce28259b0a60c8b90d3e247aced7bcdfad;marketplace-sdk@v1.2.1";
...
declare const marketplaceConfigOptions: (config: SdkConfig) => _tanstack_react_query401.OmitKeyof<_tanstack_react_query401.UseQueryOptions<MarketplaceConfig, Error, MarketplaceConfig, ("configs" | "marketplace")[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query401.QueryFunction<MarketplaceConfig, ("configs" | "marketplace")[], never> | undefined;
} & {
...
//#endregion
export { EventTypes as $, WebRPCVersion as $i, GetHighestPriceListingForCollectibleArgs as $n, Order as $r, DeletePrimarySaleContractArgs as $t, TransactionType as A, SupportedMarketplacesReturn as Ai, GetCollectionActiveListingsCurrenciesReturn as An, ListCollectionsArgs as Ar, CollectibleStatus as At, marketplaceApiURL as B, TransactionNFTCheckoutProvider as Bi, GetCountOfAllOrdersReturn as Bn, ListOffersForCollectibleReturn as Br, CreateCurrenciesArgs as Bt, OfferInput as C, Signature as Ci, GetCollectibleHighestOfferReturn as Cn, ListCollectiblesReturn as Cr, CheckoutOptionsMarketplaceReturn as Ct, RequiredKeys as D, Step as Di, GetCollectibleLowestOfferReturn as Dn, ListCollectiblesWithLowestListingReturn as Dr, CollectibleOrder as Dt, QueryKeyArgs as E, SourceKind as Ei, GetCollectibleLowestOfferArgs as En, ListCollectiblesWithLowestListingArgs as Er, Collectible as Et, getBuilderClient as F, SyncOrdersArgs as Fi, GetCollectionDetailReturn as Fn, ListListingsForCollectibleArgs as Fr, CollectionPriority as Ft, SdkConfig as G, UpdateCollectionReturn as Gi, GetCountOfListingsForCollectibleArgs as Gn, ListPrimarySaleItemsReturn as Gr, CreatePrimarySaleContractReturn as Gt, ApiConfig as H, TransactionSwapProvider as Hi, GetCountOfFilteredCollectiblesReturn as Hn, ListOrdersWithCollectiblesArgs as Hr, CreateCurrencyArgs as Ht, getIndexerClient as I, SyncOrdersReturn as Ii, GetCollectionReturn as In, ListListingsForCollectibleReturn as Ir, CollectionStatus as It, MarketCollection$1 as J, UserNotFoundError as Ji, GetCountOfOffersForCollectibleReturn as Jn, MetadataStatus as Jr, CurrencyStatus as Jt, CardType as K, UpdateCurrencyArgs as Ki, GetCountOfListingsForCollectibleReturn as Kn, Marketplace as Kr, CreateReq as Kt, getMarketplaceClient as L, TimeoutError as Li, GetCountOfAllCollectiblesArgs as Ln, ListListingsReturn as Lr, ContractType as Lt, PROVIDER_ID as M, SyncCollectionReturn as Mi, GetCollectionActiveOffersCurrenciesReturn as Mn, ListCurrenciesArgs as Mr, Collection as Mt, getProviderEl as N, SyncOrderArgs as Ni, GetCollectionArgs as Nn, ListCurrenciesReturn as Nr, CollectionConfig as Nt, SellInput as O, StepType as Oi, GetCollectibleReturn as On, ListCollectionActivitiesArgs as Or, CollectiblePrimarySaleItem as Ot, DEFAULT_NETWORK as P, SyncOrderReturn as Pi, GetCollectionDetailArgs as Pn, ListListingsArgs as Pr, CollectionLastSynced as Pt, Event$1 as Q, WebRPCSchemaVersion as Qi, GetFloorOrderReturn as Qn, OfferType as Qr, DeleteCurrencyReturn as Qt, getMetadataClient as R, TokenMetadata$1 as Ri, GetCountOfAllCollectiblesReturn as Rn, ListOffersArgs as Rr, CreateCollectionArgs as Rt, ListingInput as S, SessionExpiredError as Si, GetCollectibleHighestOfferArgs as Sn, ListCollectiblesArgs as Sr, CheckoutOptionsMarketplaceOrder as St, QueryArg as T, SortOrder as Ti, GetCollectibleLowestListingReturn as Tn, ListCollectiblesWithHighestOfferReturn as Tr, CheckoutOptionsSalesContractReturn as Tt, Env as U, UnauthorizedError as Ui, GetCountOfFilteredOrdersArgs as Un, ListOrdersWithCollectiblesReturn as Ur, CreateCurrencyReturn as Ut, sequenceApiUrl as V, TransactionOnRampProvider as Vi, GetCountOfFilteredCollectiblesArgs as Vn, ListOffersReturn as Vr, CreateCurrenciesReturn as Vt, MarketplaceSdkContext as W, UpdateCollectionArgs as Wi, GetCountOfFilteredOrdersReturn as Wn, ListPrimarySaleItemsArgs as Wr, CreatePrimarySaleContractArgs as Wt, ShopCollection$1 as X, WalletKind as Xi, GetCountOfPrimarySaleItemsReturn as Xn, NotFoundError as Xr, DeleteCollectionReturn as Xt, Price as Y, VersionFromHeader as Yi, GetCountOfPrimarySaleItemsArgs as Yn, MethodNotFoundError as Yr, DeleteCollectionArgs as Yt, DatabeatAnalytics as Z, WebRPCSchemaHash as Zi, GetFloorOrderArgs as Zn, NotImplementedError as Zr, DeleteCurrencyArgs as Zt, ApiArgs as _, getQueryClient as _a, ProjectLimitReachedError as _i, GenerateSellTransactionArgs as _n, ListCollectibleActivitiesReturn as _r, Admin as _t, CollectionFilterSettings as a, WebrpcEndpointError as aa, OrdersFilter as ai, ExecuteType as an, GetLowestPriceOfferForCollectibleArgs as ar, collectableKeys as at, CollectableId as b, MarketplaceWallet as ba, PropertyFilter$1 as bi, GetCollectibleHighestListingArgs as bn, ListCollectibleOffersArgs as br, CheckoutOptionsItem as bt, MarketplaceConfig as c, WebrpcHeader as ca, PostRequest as ci, Filter$1 as cn, GetOrdersInput as cr, currencyKeys as ct, MarketplaceWalletWaasSettings as d, WebrpcRequestFailedError as da, PrimarySaleContractStatus as di, GenerateCancelTransactionArgs as dn, GetPrimarySaleItemReturn as dr, SequenceMarketplace as dt, WebrpcBadMethodError as ea, OrderData as ei, DeletePrimarySaleContractReturn as en, GetHighestPriceListingForCollectibleReturn as er, useAnalytics as et, MetadataFilterRule as f, WebrpcServerPanicError as fa, PrimarySaleItem as fi, GenerateCancelTransactionReturn as fn, InvalidArgumentError as fr, Activity as ft, getWaasConnectors as g, webrpcErrorByCode as ga, Project as gi, GenerateOfferTransactionReturn as gn, ListCollectibleActivitiesArgs as gr, AdditionalFee as gt, getEcosystemConnector as h, errors as ha, PrimarySaleVersion as hi, GenerateOfferTransactionArgs as hn, ItemsContractStatus as hr, AddCollectiblesReturn as ht, marketplaceConfigOptions as i, WebrpcClientDisconnectedError as ia, OrderbookKind as ii, ExecuteReturn as in, GetLowestPriceListingForCollectibleReturn as ir, checkoutKeys as it, ValuesOptional as j, SyncCollectionArgs as ji, GetCollectionActiveOffersCurrenciesArgs as jn, ListCollectionsReturn as jr, CollectiblesFilter as jt, TransactionSteps as k, SupportedMarketplacesArgs as ki, GetCollectionActiveListingsCurrenciesArgs as kn, ListCollectionActivitiesReturn as kr, CollectibleSource as kt, MarketplaceSocials as l, WebrpcHeaderValue as la, PriceFilter as li, GenerateBuyTransactionArgs as ln, GetOrdersReturn as lr, tokenKeys as lt, getConnectors as m, WebrpcStreamLostError as ma, PrimarySaleItemsFilter as mi, GenerateListingTransactionReturn as mn, ItemsContract as mr, AddCollectiblesArgs as mt, getWagmiChainsAndTransports as n, WebrpcBadResponseError as na, OrderSide as ni, ExecuteArgs as nn, GetHighestPriceOfferForCollectibleReturn as nr, ModalCallbacks as nt, EcosystemWalletSettings as o, WebrpcError as oa, Page$2 as oi, FeeBreakdown as on, GetLowestPriceOfferForCollectibleReturn as or, collectionKeys as ot, ShopPage as p, WebrpcStreamFinishedError as pa, PrimarySaleItemDetailType as pi, GenerateListingTransactionArgs as pn, InvalidTierError as pr, ActivityAction as pt, CollectibleCardAction as q, UpdateCurrencyReturn as qi, GetCountOfOffersForCollectibleArgs as qn, MarketplaceKind as qr, Currency as qt, fetchMarketplaceConfig as r, WebrpcBadRouteError as ra, OrderStatus as ri, ExecuteInput as rn, GetLowestPriceListingForCollectibleArgs as rr, balanceQueries as rt, MarketPage as s, WebrpcErrorCodes as sa, PermissionDeniedError as si, Fetch as sn, GetOrdersArgs as sr, configKeys as st, createWagmiConfig as t, WebrpcBadRequestError as ta, OrderFilter as ti, Domain as tn, GetHighestPriceOfferForCollectibleArgs as tr, BuyModalProps as tt, MarketplaceWalletOptions as u, WebrpcInternalErrorError as ua, PrimarySaleContract as ui, GenerateBuyTransactionReturn as un, GetPrimarySaleItemArgs as ur, tokenSuppliesKeys as ut, BuyInput as v, BuilderAPI as va, ProjectNotFoundError as vi, GenerateSellTransactionReturn as vn, ListCollectibleListingsArgs as vr, Asset as vt, Optional as w, SortBy as wi, GetCollectibleLowestListingArgs as wn, ListCollectiblesWithHighestOfferArgs as wr, CheckoutOptionsSalesContractArgs as wt, CollectionType as x, PropertyType as xi, GetCollectibleHighestListingReturn as xn, ListCollectibleOffersReturn as xr, CheckoutOptionsMarketplaceArgs as xt, CancelInput as y, FilterCondition as ya, ProjectStatus as yi, GetCollectibleArgs as yn, ListCollectibleListingsReturn as yr, CheckoutOptions as yt, getSequenceApiClient as z, TransactionCrypto as zi, GetCountOfAllOrdersArgs as zn, ListOffersForCollectibleArgs as zr, CreateCollectionReturn as zt };
