...
import { $ as ShopCollection, At as CheckoutOptions, Dt as MarketplaceWalletType, Et as FilterCondition, G as MarketplaceCollection, H as MarketCollection, J as MetadataClient, K as MarketplaceSettings, Kt as MarketplaceKind, Ot as AdditionalFee, Qt as OrderbookKind, T as IndexerClient, U as MarketPage, V as LookupMarketplaceReturn, W as MarketplaceClient, Y as OpenIdProvider, at as index_d_exports, c as CreateReq, en as Page, et as ShopPage, l as Currency, rt as Step, s as ContractType$1, un as TransactionOnRampProvider } from "./index2.js";
...
declare const marketplaceConfigOptions: (config: SdkConfig) => _tanstack_react_query440.OmitKeyof<_tanstack_react_query440.UseQueryOptions<MarketplaceConfig, Error, MarketplaceConfig, readonly ["marketplace", string, {}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query440.QueryFunction<MarketplaceConfig, readonly ["marketplace", string, {}], never> | undefined;
} & {
...
declare function buildQueryOptions<TParams extends BaseQueryParams, TData, const TKeys extends ReadonlyArray<RequiredKeys<TParams>>>(config: {
  ...
  fetcher: (params: TParams) => Promise<TData>;
  customValidation?: (params: WithOptionalParams<TParams>) => boolean;
}, params: WithOptionalParams<TParams>): _tanstack_react_query440.OmitKeyof<_tanstack_react_query440.UseQueryOptions<TData, Error, TData, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query440.QueryFunction<TData, readonly unknown[], never> | undefined;
} & {
...
declare function buildInfiniteQueryOptions<TParams extends BaseInfiniteQueryParams, TResponse, const TKeys extends ReadonlyArray<RequiredKeys<TParams>>>(config: {
  ...
  getPageInfo: (response: TResponse) => Page | undefined;
  customValidation?: (params: WithOptionalInfiniteParams<TParams>) => boolean;
}, params: WithOptionalInfiniteParams<TParams>): _tanstack_react_query440.OmitKeyof<_tanstack_react_query440.UseInfiniteQueryOptions<TResponse, Error, _tanstack_react_query440.InfiniteData<TResponse, unknown>, readonly unknown[], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query440.QueryFunction<TResponse, readonly unknown[], Page> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _tanstack_react_query440.InfiniteData<TResponse, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
//#endregion
//#region ../node_modules/.pnpm/@0xsequence+connect@5.4.8_a69235c0bbd73fcc10d6c91178aa9b49/node_modules/@0xsequence/connect/dist/cjs/types.d.ts
interface LogoProps {
  className?: string;
...
//#endregion
export { TransactionType$4 as $, BuyModalProps as A, SequenceMarketplace as At, CancelInput as B, Price as C, getSequenceApiUrl as Ct, Event$2 as D, indexerURL as Dt, DatabeatAnalytics as E, getTrailsApiUrl as Et, clamp as F, Optional as G, CollectionType as H, serializeBigInts as I, SdkInfiniteQueryParams as J, QueryArg as K, AllRequired as L, getEcosystemConnector as M, fetchMarketplaceConfig as Mt, getWaasConnectors as N, marketplaceConfigOptions as Nt, EventTypes as O, marketplaceApiURL as Ot, WriteContractErrorType$1 as P, BuilderAPI as Pt, TransactionSteps as Q, ApiArgs as R, MetadataFilterRule as S, getSequenceApiClient as St, isShopCollection as T, getSequenceNodeGatewayUrl as Tt, ListingInput as U, CollectableId as V, OfferInput as W, SellInput as X, SdkQueryParams as Y, Transaction$2 as Z, CollectionFilterSettings as _, DEFAULT_NETWORK as _t, NATIVE_TOKEN_ADDRESS as a, InfiniteQueryBuilderConfig as at, MarketplaceWalletOptions as b, getMarketplaceClient as bt, TransactionStepsParams as c, WithOptionalInfiniteParams as ct, CheckoutMode as d, buildQueryOptions as dt, ValuesOptional as et, Env as f, requiredParamsFor as ft, CollectibleCardAction as g, getProviderEl as gt, CardType as h, PROVIDER_ID as ht, MarketTransactionParams as i, EnsureAllRequiredKeys as it, getConnectors as j, getQueryClient as jt, useAnalytics as k, sequenceApiUrl as kt, TransactionType$1 as l, WithOptionalParams as lt, SdkConfig as m, StandardQueryOptions as mt, getWagmiChainsAndTransports as n, BaseInfiniteQueryParams as nt, PrimarySaleTransactionParams as o, QueryBuilderConfig as ot, MarketplaceSdkContext as p, StandardInfiniteQueryOptions as pt, QueryKeyArgs as q, BaseTransactionParams as r, BaseQueryParams as rt, TransactionParams as s, RequiredKeys as st, createWagmiConfig as t, WithRequired as tt, ApiConfig as u, buildInfiniteQueryOptions as ut, EcosystemWalletSettings as v, getBuilderClient as vt, isMarketCollection as w, getSequenceIndexerUrl as wt, MarketplaceWalletWaasSettings as x, getMetadataClient as xt, MarketplaceConfig as y, getIndexerClient as yt, BuyInput as z };
