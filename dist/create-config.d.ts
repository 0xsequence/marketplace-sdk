import { t as ActionButton } from "./types.js";
...
import { Address as Address$1, Chain, Hash, Hex, Transport } from "viem";
...
declare const marketplaceConfigOptions: (config: SdkConfig) => _tanstack_react_query439.OmitKeyof<_tanstack_react_query439.UseQueryOptions<MarketplaceConfig, Error, MarketplaceConfig, readonly ["marketplace", string, {}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query439.QueryFunction<MarketplaceConfig, readonly ["marketplace", string, {}], never> | undefined;
} & {
...
declare function buildQueryOptions<TParams extends BaseQueryParams, TData, const TKeys extends ReadonlyArray<RequiredKeys<TParams>>>(config: {
  ...
  fetcher: (params: TParams) => Promise<TData>;
  customValidation?: (params: WithOptionalParams<TParams>) => boolean;
}, params: WithOptionalParams<TParams>): _tanstack_react_query439.OmitKeyof<_tanstack_react_query439.UseQueryOptions<TData, Error, TData, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query439.QueryFunction<TData, readonly unknown[], never> | undefined;
} & {
...
declare function buildInfiniteQueryOptions<TParams extends BaseInfiniteQueryParams, TResponse, const TKeys extends ReadonlyArray<RequiredKeys<TParams>>>(config: {
  ...
  getPageInfo: (response: TResponse) => Page$2 | undefined;
  customValidation?: (params: WithOptionalInfiniteParams<TParams>) => boolean;
}, params: WithOptionalInfiniteParams<TParams>): _tanstack_react_query439.OmitKeyof<_tanstack_react_query439.UseInfiniteQueryOptions<TResponse, Error, _tanstack_react_query439.InfiniteData<TResponse, unknown>, readonly unknown[], Page$2>, "queryFn"> & {
  queryFn?: _tanstack_react_query439.QueryFunction<TResponse, readonly unknown[], Page$2> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _tanstack_react_query439.InfiniteData<TResponse, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
