import { BuyModalProps, CollectionType, ModalCallbacks, Order, OrderbookKind, TokenMetadata } from "./create-config-DmCoYOfk.js";
...
declare const ModalProvider: ({
  children
}: ModalProviderProps) => react_jsx_runtime23.JSX.Element;
//#endregion
...
declare function Media({
  ...
  fallbackContent,
  shouldListenForLoad
}: MediaProps): react_jsx_runtime23.JSX.Element;
//#endregion
...
//# sourceMappingURL=index-BZTMGare.d.ts.map