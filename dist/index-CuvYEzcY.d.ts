import { A as Optional } from "./create-config-Dz-QylqB.js";
import { _ as GetTokenRangesQueryOptions, n as TokenSuppliesQueryOptions, o as SearchTokenMetadataQueryOptions, p as UseListBalancesArgs, u as ListTokenMetadataQueryOptions, v as fetchGetTokenRanges } from "./tokenSupplies-BP3rNT6e.js";
 ...
 * ```
 */
declare function useGetTokenRanges(params: UseGetTokenRangesParams): _tanstack_react_query63.UseQueryResult<_0xsequence_indexer1.GetTokenIDRangesReturn, Error>;
 ...
 * ```
 */
declare function useListBalances(args: UseListBalancesArgs): _tanstack_react_query63.UseInfiniteQueryResult<_tanstack_react_query63.InfiniteData<_0xsequence_indexer1.GetTokenBalancesReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useListTokenMetadata(params: UseListTokenMetadataParams): _tanstack_react_query63.UseQueryResult<_0xsequence_metadata4.TokenMetadata[], Error>;
//#endregion
...
declare function useSearchTokenMetadata(params: UseSearchTokenMetadataParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query63.FetchNextPageOptions) => Promise<_tanstack_react_query63.InfiniteQueryObserverResult<_tanstack_react_query63.InfiniteData<_0xsequence_metadata4.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query63.FetchPreviousPageOptions) => Promise<_tanstack_react_query63.InfiniteQueryObserverResult<_tanstack_react_query63.InfiniteData<_0xsequence_metadata4.SearchTokenMetadataReturn, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query63.RefetchOptions) => Promise<_tanstack_react_query63.QueryObserverResult<_tanstack_react_query63.InfiniteData<_0xsequence_metadata4.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchStatus: _tanstack_react_query63.FetchStatus;
  promise: Promise<_tanstack_react_query63.InfiniteData<_0xsequence_metadata4.SearchTokenMetadataReturn, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata4.TokenMetadata[];
    page: _0xsequence_metadata4.Page;
  } | undefined;
  error: Error;
  isError: true;
  isPending: false;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata4.TokenMetadata[];
    page: _0xsequence_metadata4.Page | undefined;
  } | undefined;
  isLoading: boolean;
  isFetching: boolean;
  error: Error | null;
 ...
 * ```
 */
declare function useTokenSupplies(params: UseTokenSuppliesParams): _tanstack_react_query63.UseInfiniteQueryResult<_tanstack_react_query63.InfiniteData<_0xsequence_indexer1.GetTokenSuppliesReturn, unknown>, Error>;
//#endregion
...
//# sourceMappingURL=index-CuvYEzcY.d.ts.map