import { ContractType, MetadataStatus, Page as Page$1, SdkConfig } from "./create-config-gz6zNqhE.js";
...
declare function inventoryOptions(args: UseInventoryArgs, config: SdkConfig): _tanstack_react_query220.OmitKeyof<_tanstack_react_query220.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, (string | number)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query220.QueryFunction<CollectiblesResponse, (string | number)[], never> | undefined;
} & {
...
//# sourceMappingURL=index-H9BiulZ6.d.ts.map