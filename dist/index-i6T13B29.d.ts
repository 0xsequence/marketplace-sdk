import { CheckoutOptionsItem, CheckoutOptionsSalesContractReturn, CollectiblePrimarySaleItem, ContractType, GetCountOfPrimarySaleItemsReturn, ListPrimarySaleItemsReturn, MarketplaceSdkContext, Optional, PrimarySaleItem, QueryArg, SdkConfig, TokenMetadata as TokenMetadata$1 } from "./create-config-CcodGlRp.js";
import { CheckoutOptionsSalesContractQueryOptions, CollectiblesResponse, ComparePricesQueryOptions, ComparePricesReturn, ConvertPriceToUSDQueryOptions, ConvertPriceToUSDReturn, ListPrimarySaleItemsQueryOptions, UseCountOfPrimarySaleItemsArgs, UseInventoryArgs, fetchCheckoutOptionsSalesContract } from "./index-j707npJV.js";
...
declare function useCountOfPrimarySaleItems(args: UseCountOfPrimarySaleItemsArgs): _tanstack_react_query281.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useGetCountOfPrimarySaleItems(params: UseGetCountParams): _tanstack_react_query281.UseQueryResult<GetCountOfPrimarySaleItemsReturn, Error>;
//#endregion
...
declare function useList721ShopCardData({
  ...
  isLoading: boolean;
  tokenSuppliesData: _tanstack_react_query281.InfiniteData<_0xsequence_indexer7.GetTokenSuppliesReturn, unknown> | undefined;
};
//#endregion
...
declare function useInventory(args: UseInventoryArgs): _tanstack_react_query281.UseQueryResult<CollectiblesResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCheckoutOptionsSalesContract(params: UseCheckoutOptionsSalesContractParams | typeof skipToken): _tanstack_react_query281.UseQueryResult<CheckoutOptionsSalesContractReturn, Error>;
 ...
 * ```
 */
declare function useComparePrices(params: UseComparePricesParams): _tanstack_react_query281.UseQueryResult<ComparePricesReturn, Error>;
 ...
 * ```
 */
declare function useConvertPriceToUSD(params: UseConvertPriceToUSDParams): _tanstack_react_query281.UseQueryResult<ConvertPriceToUSDReturn, Error>;
...
declare function useRoyalty(args: UseRoyaltyArgs): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query281.RefetchOptions) => Promise<_tanstack_react_query281.QueryObserverResult<readonly [`0x${string}`, bigint], viem32.ReadContractErrorType>>;
  fetchStatus: _tanstack_react_query281.FetchStatus;
  promise: Promise<readonly [`0x${string}`, bigint]>;
  queryKey: _tanstack_react_query281.QueryKey;
} | {
  data: {
    percentage: bigint;
    recipient: Address;
 ...
 * ```
 */
declare function useListPrimarySaleItems(params: UseListPrimarySaleItemsParams): _tanstack_react_query281.UseInfiniteQueryResult<_tanstack_react_query281.InfiniteData<ListPrimarySaleItemsReturn, unknown>, Error>;
//#endregion
...
//# sourceMappingURL=index-i6T13B29.d.ts.map