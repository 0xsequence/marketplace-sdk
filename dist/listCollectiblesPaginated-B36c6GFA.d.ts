import { CollectiblesFilter, ListCollectibleActivitiesArgs, ListCollectibleActivitiesReturn, ListCollectiblesArgs, ListCollectiblesReturn, MarketplaceType, OrderSide, Page, SdkConfig, SortBy, ValuesOptional } from "./create-config-Co40OaTJ.js";
import { StandardInfiniteQueryOptions, StandardQueryOptions } from "./query-BTe7Wkrs.js";
import * as _tanstack_react_query241 from "@tanstack/react-query";
 ...
 */
declare function balanceOfCollectibleOptions(args: UseBalanceOfCollectibleArgs, config: SdkConfig): _tanstack_react_query241.UseQueryOptions<_0xsequence_indexer4.TokenBalance, Error, _0xsequence_indexer4.TokenBalance, (UseBalanceOfCollectibleArgs | "collectable" | "details" | "userBalances")[]> & {
  initialData?: _0xsequence_indexer4.TokenBalance | _tanstack_react_query241.InitialDataFunction<_0xsequence_indexer4.TokenBalance> | undefined;
} & {
...
declare function collectibleQueryOptions(params: CollectibleQueryOptions): _tanstack_react_query241.OmitKeyof<_tanstack_react_query241.UseQueryOptions<_0xsequence_metadata81.TokenMetadata, Error, _0xsequence_metadata81.TokenMetadata, ("collectable" | "details" | CollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query241.QueryFunction<_0xsequence_metadata81.TokenMetadata, ("collectable" | "details" | CollectibleQueryOptions)[], never> | undefined;
} & {
...
declare function countOfCollectablesQueryOptions(params: CountOfCollectablesQueryOptions): _tanstack_react_query241.OmitKeyof<_tanstack_react_query241.UseQueryOptions<number, Error, number, ("collectable" | "counts" | CountOfCollectablesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query241.QueryFunction<number, ("collectable" | "counts" | CountOfCollectablesQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectibleActivitiesQueryOptions(params: ListCollectibleActivitiesQueryOptions): _tanstack_react_query241.OmitKeyof<_tanstack_react_query241.UseQueryOptions<ListCollectibleActivitiesReturn, Error, ListCollectibleActivitiesReturn, ("collectable" | "collectibleActivities" | ListCollectibleActivitiesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query241.QueryFunction<ListCollectibleActivitiesReturn, ("collectable" | "collectibleActivities" | ListCollectibleActivitiesQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectiblesQueryOptions(params: ListCollectiblesQueryOptions): _tanstack_react_query241.OmitKeyof<_tanstack_react_query241.UseInfiniteQueryOptions<ListCollectiblesReturn, Error, _tanstack_react_query241.InfiniteData<ListCollectiblesReturn, unknown>, ("collectable" | "list" | ListCollectiblesQueryOptions)[], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query241.QueryFunction<ListCollectiblesReturn, ("collectable" | "list" | ListCollectiblesQueryOptions)[], Page> | undefined;
} & {
  queryKey: ("collectable" | "list" | ListCollectiblesQueryOptions)[] & {
    [dataTagSymbol]: _tanstack_react_query241.InfiniteData<ListCollectiblesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listCollectiblesPaginatedQueryOptions(params: ListCollectiblesPaginatedQueryOptions): _tanstack_react_query241.OmitKeyof<_tanstack_react_query241.UseQueryOptions<ListCollectiblesReturn, Error, ListCollectiblesReturn, (string | ListCollectiblesPaginatedQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query241.QueryFunction<ListCollectiblesReturn, (string | ListCollectiblesPaginatedQueryOptions)[], never> | undefined;
} & {
...
//# sourceMappingURL=listCollectiblesPaginated-B36c6GFA.d.ts.map