...
import * as _0xsequence_api_client19 from "@0xsequence/api-client";
...
declare function useCreateListingModalContext(): {
  ...
  item: {
    ...
    tokenId: bigint;
    orderbookKind: _0xsequence_api_client19.OrderbookKind | undefined;
  };
  listing: {
    price: {
      input: string;
      amountRaw: bigint;
      currency: _0xsequence_api_client19.Currency | null;
    };
    quantity: {
      input: string;
      parsed: bigint;
  ...
  currencies: {
    available: _0xsequence_api_client19.Currency[];
    selected: _0xsequence_api_client19.Currency | null;
  ...
  error: Error | null;
  queries: {
    collectible: _tanstack_react_query54.UseQueryResult<_0xsequence_api_client19.TokenMetadata, Error>;
    collection: _tanstack_react_query54.UseQueryResult<_0xsequence_api_client19.ContractInfo, Error>;
    currencies: _tanstack_react_query54.UseQueryResult<_0xsequence_api_client19.Currency[], Error>;
    collectibleBalance: _tanstack_react_query54.UseQueryResult<_0xsequence_api_client19.IndexerTokenBalance, Error>;
  };
...
declare const CreateListingModal: () => react_jsx_runtime53.JSX.Element | null;
//#endregion
