import { X as Order, l as Currency, s as ContractType } from "./index2.js";
import { h as CardType } from "./create-config.js";
...
declare function CardSaleDetails({
  ...
  unlimitedSupply,
  className
}: CardSaleDetailsProps): react_jsx_runtime27.JSX.Element;
//#endregion
...
declare function CardSkeleton({
  type,
  isShop
}: CardSkeletonProps): react_jsx_runtime27.JSX.Element;
//#endregion
