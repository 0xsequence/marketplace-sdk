import { Ft as CollectibleOrder, Gt as ContractType, Oi as PropertyFilter, _i as PriceFilter, fi as OrderbookKind, j as Optional, jr as ListCollectiblesReturn, nn as CurrencyStatus, tn as Currency, tt as CollectibleCardAction } from "./create-config-CrbgqkBr.js";
import { n as MarketCurrenciesQueryOptions, o as CurrencyQueryOptions } from "./marketCurrencies-DWLh6xfA.js";
import { r as MarketCollectibleCardProps } from "./types-Dd27DMLp.js";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query371.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query371.FetchNextPageOptions) => Promise<_tanstack_react_query371.InfiniteQueryObserverResult<_tanstack_react_query371.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query371.UseQueryResult<{
...
//# sourceMappingURL=index-De9MGbZX.d.ts.map