import { CardType, Collection, CollectionFilterSettings, ContractType, GetCollectionDetailArgs, ListCollectionActivitiesArgs, ListCollectionActivitiesReturn, MarketplaceConfig, OrderbookKind, SdkConfig, SortBy, ValuesOptional } from "./create-config-DDGnmsgd.js";
...
declare function collectionQueryOptions(params: CollectionQueryOptions): _tanstack_react_query265.OmitKeyof<_tanstack_react_query265.UseQueryOptions<_0xsequence_metadata81.ContractInfo, Error, _0xsequence_metadata81.ContractInfo, ("collections" | "detail" | CollectionQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query265.QueryFunction<_0xsequence_metadata81.ContractInfo, ("collections" | "detail" | CollectionQueryOptions)[], never> | undefined;
} & {
...
//# sourceMappingURL=listCollections-CffepKzs.d.ts.map