import { Optional, PropertyFilter, PropertyType } from "./create-config-D5nkCAUU.js";
import { FiltersQueryOptions } from "./filters-BdoFVoid.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query0.UseQueryResult<PropertyFilter$1[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query0.RefetchOptions) => Promise<_tanstack_react_query0.QueryObserverResult<PropertyFilter$1[], Error>>;
...
//# sourceMappingURL=index-OFNDjS8P.d.ts.map