import { Optional } from "./create-config-CsagtMvq.js";
import { GetTokenRangesQueryOptions, ListTokenMetadataQueryOptions, SearchTokenMetadataQueryOptions, TokenSuppliesQueryOptions, UseListBalancesArgs, fetchGetTokenRanges$1 as fetchGetTokenRanges } from "./tokenSupplies-D-4hvHwH.js";
 ...
 * ```
 */
declare function useGetTokenRanges(params: UseGetTokenRangesParams): _tanstack_react_query96.UseQueryResult<_0xsequence_indexer8.GetTokenIDRangesReturn, Error>;
 ...
 * ```
 */
declare function useListBalances(args: UseListBalancesArgs): _tanstack_react_query97.UseInfiniteQueryResult<_tanstack_react_query97.InfiniteData<_0xsequence_indexer9.GetTokenBalancesReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useListTokenMetadata(params: UseListTokenMetadataParams): _tanstack_react_query99.UseQueryResult<_0xsequence_metadata4.TokenMetadata[], Error>;
//#endregion
...
declare function useSearchTokenMetadata(params: UseSearchTokenMetadataParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query100.FetchNextPageOptions) => Promise<_tanstack_react_query100.InfiniteQueryObserverResult<_tanstack_react_query100.InfiniteData<_0xsequence_metadata5.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query100.FetchPreviousPageOptions) => Promise<_tanstack_react_query100.InfiniteQueryObserverResult<_tanstack_react_query100.InfiniteData<_0xsequence_metadata5.SearchTokenMetadataReturn, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query100.RefetchOptions) => Promise<_tanstack_react_query100.QueryObserverResult<_tanstack_react_query100.InfiniteData<_0xsequence_metadata5.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchStatus: _tanstack_react_query100.FetchStatus;
  promise: Promise<_tanstack_react_query100.InfiniteData<_0xsequence_metadata5.SearchTokenMetadataReturn, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata5.TokenMetadata[];
    page: _0xsequence_metadata5.Page;
  } | undefined;
  error: Error;
  isError: true;
  isPending: false;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata5.TokenMetadata[];
    page: _0xsequence_metadata5.Page | undefined;
  } | undefined;
  isLoading: boolean;
  isFetching: boolean;
  error: Error | null;
 ...
 * ```
 */
declare function useTokenSupplies(params: UseTokenSuppliesParams): _tanstack_react_query250.UseInfiniteQueryResult<_tanstack_react_query250.InfiniteData<_0xsequence_indexer10.GetTokenSuppliesReturn, unknown>, Error>;
//#endregion
...
//# sourceMappingURL=index-DR4gqU5b.d.ts.map