import { Optional, PropertyFilter, PropertyType } from "./create-config-Sy3PDbP4.js";
import { FiltersQueryOptions } from "./filters-DpkVKIkM.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query186.UseQueryResult<PropertyFilter$1[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query186.RefetchOptions) => Promise<_tanstack_react_query186.QueryObserverResult<PropertyFilter$1[], Error>>;
  fetchStatus: _tanstack_react_query186.FetchStatus;
...
//# sourceMappingURL=index--icMjN9v.d.ts.map