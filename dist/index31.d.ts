...
declare function tokenSuppliesQueryOptions(params: TokenSuppliesQueryOptions): _tanstack_react_query89.OmitKeyof<_tanstack_react_query89.UseInfiniteQueryOptions<GetTokenSuppliesResponse, Error, _tanstack_react_query89.InfiniteData<GetTokenSuppliesResponse, unknown>, readonly ["token", string, {
  chainId: number;
  collectionAddress: string;
  includeMetadata: boolean | undefined;
  metadataOptions: MetadataOptions$1 | undefined;
}], _0xsequence_indexer9.Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query89.QueryFunction<GetTokenSuppliesResponse, readonly ["token", string, {
    chainId: number;
    collectionAddress: string;
    includeMetadata: boolean | undefined;
    metadataOptions: MetadataOptions$1 | undefined;
  ...
  queryKey: readonly ["token", string, {
    ...
    [dataTagSymbol]: _tanstack_react_query89.InfiniteData<GetTokenSuppliesResponse, unknown>;
