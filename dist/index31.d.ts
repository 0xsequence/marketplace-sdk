...
declare function tokenSuppliesQueryOptions(params: TokenSuppliesQueryOptions): _tanstack_react_query339.OmitKeyof<_tanstack_react_query339.UseInfiniteQueryOptions<GetTokenSuppliesResponse, Error, _tanstack_react_query339.InfiniteData<GetTokenSuppliesResponse, unknown>, readonly ["token", string, {
  chainId: number;
  collectionAddress: string;
  includeMetadata: boolean | undefined;
  metadataOptions: MetadataOptions$1 | undefined;
}], _0xsequence_indexer9.Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query339.QueryFunction<GetTokenSuppliesResponse, readonly ["token", string, {
    chainId: number;
    collectionAddress: string;
    includeMetadata: boolean | undefined;
    metadataOptions: MetadataOptions$1 | undefined;
  }], _0xsequence_indexer9.Page> | undefined;
} & {
  queryKey: readonly ["token", string, {
    ...
    [dataTagSymbol]: _tanstack_react_query339.InfiniteData<GetTokenSuppliesResponse, unknown>;
