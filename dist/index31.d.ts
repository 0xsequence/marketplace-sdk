...
import { J as SdkInfiniteQueryParams, tt as WithRequired } from "./create-config.js";
...
declare function tokenSuppliesQueryOptions(params: TokenSuppliesQueryOptions): _tanstack_react_query58.OmitKeyof<_tanstack_react_query58.UseInfiniteQueryOptions<index_d_exports$1.GetTokenSuppliesResponse, Error, _tanstack_react_query58.InfiniteData<index_d_exports$1.GetTokenSuppliesResponse, unknown>, readonly ["token", string, {
  chainId: number;
  collectionAddress: string;
  includeMetadata: boolean | undefined;
  metadataOptions: {
  ...
  queryFn?: _tanstack_react_query58.QueryFunction<index_d_exports$1.GetTokenSuppliesResponse, readonly ["token", string, {
    chainId: number;
    collectionAddress: string;
    includeMetadata: boolean | undefined;
    metadataOptions: {
  ...
  queryKey: readonly ["token", string, {
    ...
    [dataTagSymbol]: _tanstack_react_query58.InfiniteData<index_d_exports$1.GetTokenSuppliesResponse, unknown>;
