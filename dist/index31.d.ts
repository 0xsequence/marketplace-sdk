...
declare function tokenSuppliesQueryOptions(params: TokenSuppliesQueryOptions): _tanstack_react_query58.OmitKeyof<_tanstack_react_query58.UseInfiniteQueryOptions<GetTokenSuppliesResponse, Error, _tanstack_react_query58.InfiniteData<GetTokenSuppliesResponse, unknown>, readonly ["token", string, {
  chainId: number;
  collectionAddress: string;
  includeMetadata: boolean | undefined;
  metadataOptions: MetadataOptions$1 | undefined;
}], _0xsequence_indexer0.Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query58.QueryFunction<GetTokenSuppliesResponse, readonly ["token", string, {
    chainId: number;
    collectionAddress: string;
    includeMetadata: boolean | undefined;
    metadataOptions: MetadataOptions$1 | undefined;
  ...
  queryKey: readonly ["token", string, {
    ...
    [dataTagSymbol]: _tanstack_react_query58.InfiniteData<GetTokenSuppliesResponse, unknown>;
