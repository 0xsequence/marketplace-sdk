import { CardType, CollectiblesFilter, ListCollectibleActivitiesArgs, ListCollectibleActivitiesReturn, ListCollectiblesArgs, ListCollectiblesReturn, OrderSide, Page as Page$2, SdkConfig, SortBy, ValuesOptional } from "./create-config-DmCoYOfk.js";
import { StandardInfiniteQueryOptions, StandardQueryOptions } from "./query-BG-MA1MB.js";
import * as _tanstack_react_query39 from "@tanstack/react-query";
 ...
 */
declare function balanceOfCollectibleOptions(args: UseBalanceOfCollectibleArgs, config: SdkConfig): _tanstack_react_query39.UseQueryOptions<_0xsequence_indexer4.TokenBalance, Error, _0xsequence_indexer4.TokenBalance, ("details" | UseBalanceOfCollectibleArgs | "collectable" | "userBalances")[]> & {
  initialData?: _0xsequence_indexer4.TokenBalance | _tanstack_react_query39.InitialDataFunction<_0xsequence_indexer4.TokenBalance> | undefined;
} & {
  queryKey: ("details" | UseBalanceOfCollectibleArgs | "collectable" | "userBalances")[] & {
...
declare function collectibleQueryOptions(params: CollectibleQueryOptions): _tanstack_react_query39.OmitKeyof<_tanstack_react_query39.UseQueryOptions<_0xsequence_metadata0.TokenMetadata, Error, _0xsequence_metadata0.TokenMetadata, ("details" | "collectable" | CollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query39.QueryFunction<_0xsequence_metadata0.TokenMetadata, ("details" | "collectable" | CollectibleQueryOptions)[], never> | undefined;
} & {
...
declare function countOfCollectablesQueryOptions(params: CountOfCollectablesQueryOptions): _tanstack_react_query39.OmitKeyof<_tanstack_react_query39.UseQueryOptions<number, Error, number, ("collectable" | "counts" | CountOfCollectablesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query39.QueryFunction<number, ("collectable" | "counts" | CountOfCollectablesQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectibleActivitiesQueryOptions(params: ListCollectibleActivitiesQueryOptions): _tanstack_react_query39.OmitKeyof<_tanstack_react_query39.UseQueryOptions<ListCollectibleActivitiesReturn, Error, ListCollectibleActivitiesReturn, ("collectable" | "collectibleActivities" | ListCollectibleActivitiesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query39.QueryFunction<ListCollectibleActivitiesReturn, ("collectable" | "collectibleActivities" | ListCollectibleActivitiesQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectiblesQueryOptions(params: ListCollectiblesQueryOptions): _tanstack_react_query39.OmitKeyof<_tanstack_react_query39.UseInfiniteQueryOptions<ListCollectiblesReturn, Error, _tanstack_react_query39.InfiniteData<ListCollectiblesReturn, unknown>, ("collectable" | "list" | ListCollectiblesQueryOptions)[], Page$2>, "queryFn"> & {
  queryFn?: _tanstack_react_query39.QueryFunction<ListCollectiblesReturn, ("collectable" | "list" | ListCollectiblesQueryOptions)[], Page$2> | undefined;
} & {
  queryKey: ("collectable" | "list" | ListCollectiblesQueryOptions)[] & {
    [dataTagSymbol]: _tanstack_react_query39.InfiniteData<ListCollectiblesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listCollectiblesPaginatedQueryOptions(params: ListCollectiblesPaginatedQueryOptions): _tanstack_react_query39.OmitKeyof<_tanstack_react_query39.UseQueryOptions<ListCollectiblesReturn, Error, ListCollectiblesReturn, (string | ListCollectiblesPaginatedQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query39.QueryFunction<ListCollectiblesReturn, (string | ListCollectiblesPaginatedQueryOptions)[], never> | undefined;
} & {
...
//# sourceMappingURL=listCollectiblesPaginated-C8o8wefA.d.ts.map