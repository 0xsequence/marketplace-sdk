import { ListCollectibleActivitiesReturn, ListCollectiblesReturn, Optional } from "./create-config-Cvi1W2a1.js";
import { CollectibleQueryOptions, CountOfCollectablesQueryOptions, ListCollectibleActivitiesQueryOptions, ListCollectiblesPaginatedQueryOptions, ListCollectiblesQueryOptions, UseBalanceOfCollectibleArgs, fetchListCollectibleActivities, fetchListCollectiblesPaginated } from "./listCollectiblesPaginated-DOJ4oQrG.js";
 ...
 * ```
 */
declare function useBalanceOfCollectible(args: UseBalanceOfCollectibleArgs): _tanstack_react_query14.UseQueryResult<xtrails0.TokenBalance, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectible(params: UseCollectibleParams): _tanstack_react_query14.UseQueryResult<_0xsequence_metadata4.TokenMetadata, Error>;
//#endregion
 ...
 * ```
 */
declare function useCountOfCollectables(params: UseCountOfCollectablesParams): _tanstack_react_query14.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectibleActivities(params: UseListCollectibleActivitiesParams): _tanstack_react_query14.UseQueryResult<ListCollectibleActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollectibles(params: UseListCollectiblesParams): _tanstack_react_query14.UseInfiniteQueryResult<_tanstack_react_query14.InfiniteData<ListCollectiblesReturn, unknown>, Error>;
 ...
 * ```
 */
declare function useListCollectiblesPaginated(params: UseListCollectiblesPaginatedParams): _tanstack_react_query14.UseQueryResult<ListCollectiblesReturn, Error>;
...
//# sourceMappingURL=index-B13q_fHh.d.ts.map