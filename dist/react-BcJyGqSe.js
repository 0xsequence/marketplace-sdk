...
function useAutoSelectFeeOption(args) {
	...
	const isInternalMode = "chainId" in args && !("pendingFeeOptionConfirmation" in args);
	const { pendingFeeOptionConfirmation, confirmPendingFeeOption } = useWaasFeeOptions$1(isInternalMode ? args.chainId : 1, sdkConfig, isInternalMode ? args.waasFeeOptionsConfig : void 0);
	const _pendingFeeOptionConfirmation = isInternalMode ? pendingFeeOptionConfirmation : args.pendingFeeOptionConfirmation;
	const enabled = args.enabled ?? true;
	const chainId = isInternalMode ? args.chainId : args.pendingFeeOptionConfirmation.chainId;
...
//# sourceMappingURL=react-BcJyGqSe.js.map