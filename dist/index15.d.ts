...
import * as _0xsequence_api_client226 from "@0xsequence/api-client";
import { AdditionalFee, MarketplaceKind, Step } from "@0xsequence/api-client";
import * as viem41 from "viem";
...
declare function useBuyTransaction(modalProps: BuyModalProps): {
  data: _0xsequence_api_client226.Step[] | undefined;
  isLoading: boolean;
  error: Error | null;
  isError: boolean;
  refetch: (options?: _tanstack_react_query197.RefetchOptions) => Promise<_tanstack_react_query197.QueryObserverResult<_0xsequence_api_client226.Step[], Error>>;
};
//#endregion
...
declare const useGenerateCancelTransaction: (params: UseGenerateCancelTransactionRequest) => {
  generateCancelTransaction: _tanstack_react_query197.UseMutateFunction<Step[], Error, GenerateCancelTransactionRequestWithNumberChainId, unknown>;
  generateCancelTransactionAsync: _tanstack_react_query197.UseMutateAsyncFunction<Step[], Error, GenerateCancelTransactionRequestWithNumberChainId, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateListingTransaction: (params: UseGenerateListingTransactionRequest) => {
  generateListingTransaction: _tanstack_react_query197.UseMutateFunction<Step$2[], Error, Omit<GenerateListingTransactionRequestWithNumberChainId, "chainId">, unknown>;
  generateListingTransactionAsync: _tanstack_react_query197.UseMutateAsyncFunction<Step$2[], Error, Omit<GenerateListingTransactionRequestWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateOfferTransaction: (params: UseGenerateOfferTransactionRequest) => {
  generateOfferTransaction: _tanstack_react_query197.UseMutateFunction<Step$1[], Error, Omit<GenerateOfferTransactionRequestWithNumberChainId, "chainId">, unknown>;
  generateOfferTransactionAsync: _tanstack_react_query197.UseMutateAsyncFunction<Step$1[], Error, Omit<GenerateOfferTransactionRequestWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateSellTransaction: (params: UseGenerateSellTransactionRequest) => {
  generateSellTransaction: _tanstack_react_query197.UseMutateFunction<Step[], Error, Omit<GenerateSellTransactionRequestWithNumberChainId, "chainId">, unknown>;
  generateSellTransactionAsync: _tanstack_react_query197.UseMutateAsyncFunction<Step[], Error, Omit<GenerateSellTransactionRequestWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
//#endregion
export { useGenerateCancelTransaction as C, useBuyTransaction as D, useCancelOrder as E, generateCancelTransaction as S, TransactionStep as T, CreateReqWithDateExpiry$1 as _, useProcessStep as a, generateListingTransaction as b, useOrderSteps as c, generateSellTransaction as d, useGenerateSellTransaction as f, useGenerateOfferTransaction as g, generateOfferTransaction as h, useTransactionExecution as i, UseMarketTransactionStepsParams as l, UseGenerateOfferTransactionRequest as m, useTransferTokens as n, UsePrimarySaleTransactionStepsParams as o, GenerateOfferTransactionProps as p, useTransactionType as r, usePrimarySaleTransactionSteps as s, TransferTokensParams as t, useMarketTransactionSteps as u, GenerateListingTransactionProps as v, useCancelTransactionSteps as w, useGenerateListingTransaction as x, UseGenerateListingTransactionRequest as y };
