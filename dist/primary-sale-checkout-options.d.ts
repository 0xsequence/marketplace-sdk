...
declare function primarySaleCheckoutOptionsQueryOptions(params: WithOptionalParams<WithRequired<PrimarySaleCheckoutOptionsQueryOptions, 'chainId' | 'walletAddress' | 'contractAddress' | 'collectionAddress' | 'items' | 'config'>>): _tanstack_react_query134.OmitKeyof<_tanstack_react_query134.UseQueryOptions<CheckoutOptionsSalesContractResponse, Error, CheckoutOptionsSalesContractResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query134.QueryFunction<CheckoutOptionsSalesContractResponse, readonly unknown[], never> | undefined;
} & {
