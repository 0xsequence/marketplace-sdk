import { CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PriceFilter, PropertyFilter } from "./create-config-BQet0plq.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-BST9ouuY.js";
import { MarketCollectibleCardProps } from "./types-79PqylCI.js";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query185.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query185.FetchNextPageOptions) => Promise<_tanstack_react_query185.InfiniteQueryObserverResult<_tanstack_react_query185.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query185.UseQueryResult<{
...
//# sourceMappingURL=index-CMVW2nak.d.ts.map