import { Currency, CurrencyStatus, SdkConfig, ValuesOptional } from "./create-config-D6v7S2xr.js";
import { StandardQueryOptions } from "./query-BG-MA1MB.js";
import * as _tanstack_react_query255 from "@tanstack/react-query";
...
declare function currencyQueryOptions(params: CurrencyQueryOptions): _tanstack_react_query255.UseQueryOptions<Currency | undefined, Error, Currency | undefined, ("currencies" | "details" | CurrencyQueryOptions)[]> & {
  initialData?: Currency | _tanstack_react_query255.InitialDataFunction<Currency> | undefined;
} & {
...
declare function marketCurrenciesQueryOptions(params: MarketCurrenciesQueryOptions): _tanstack_react_query255.OmitKeyof<_tanstack_react_query255.UseQueryOptions<{
  contractAddress: string;
  chainId: number;
  status: CurrencyStatus;
  name: string;
  ...
  queryFn?: _tanstack_react_query255.QueryFunction<{
    contractAddress: string;
    chainId: number;
    status: CurrencyStatus;
    name: string;
...
//# sourceMappingURL=marketCurrencies-Cn2wp54y.d.ts.map