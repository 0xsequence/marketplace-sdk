import { $ as SdkConfig, $r as ListPrimarySaleItemsReturn, Gt as ContractType, It as CollectiblePrimarySaleItem, Ki as TokenMetadata$1, M as QueryArg, Nt as CheckoutOptionsSalesContractReturn, Ot as CheckoutOptionsItem, Q as MarketplaceSdkContext, bi as PrimarySaleItem, ir as GetCountOfPrimarySaleItemsReturn, j as Optional } from "./create-config-Cws5O44a.js";
import { n as UseInventoryArgs, t as CollectiblesResponse } from "./index-k2qQX2Fw.js";
import { i as fetchCheckoutOptionsSalesContract, t as CheckoutOptionsSalesContractQueryOptions } from "./index-pFqdPUE4.js";
import { f as PrimarySaleItemQueryOptions, g as UseCountOfPrimarySaleItemsArgs, s as ListPrimarySaleItemsQueryOptions } from "./index-CnUozvTD.js";
import { c as ComparePricesReturn, n as ConvertPriceToUSDReturn, s as ComparePricesQueryOptions, t as ConvertPriceToUSDQueryOptions } from "./index-BnbMVXYh.js";
import * as react0 from "react";
import * as _tanstack_react_query224 from "@tanstack/react-query";
...
declare function useCountOfPrimarySaleItems(args: UseCountOfPrimarySaleItemsArgs): _tanstack_react_query224.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useGetCountOfPrimarySaleItems(params: UseGetCountParams): _tanstack_react_query224.UseQueryResult<GetCountOfPrimarySaleItemsReturn, Error>;
//#endregion
...
declare function useList721ShopCardData({
  ...
  isLoading: boolean;
  tokenSuppliesData: _tanstack_react_query224.InfiniteData<_0xsequence_indexer12.GetTokenSuppliesReturn, unknown> | undefined;
};
//#endregion
...
declare function useInventory(args: UseInventoryArgs): _tanstack_react_query224.UseQueryResult<CollectiblesResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCheckoutOptionsSalesContract(params: UseCheckoutOptionsSalesContractParams | typeof skipToken): _tanstack_react_query224.UseQueryResult<CheckoutOptionsSalesContractReturn, Error>;
 ...
 * ```
 */
declare function useComparePrices(params: UseComparePricesParams): _tanstack_react_query224.UseQueryResult<ComparePricesReturn, Error>;
 ...
 * ```
 */
declare function useConvertPriceToUSD(params: UseConvertPriceToUSDParams): _tanstack_react_query224.UseQueryResult<ConvertPriceToUSDReturn, Error>;
...
declare function useRoyalty(args: UseRoyaltyArgs): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query224.RefetchOptions) => Promise<_tanstack_react_query224.QueryObserverResult<readonly [`0x${string}`, bigint], viem2.ReadContractErrorType>>;
  fetchStatus: _tanstack_react_query224.FetchStatus;
  promise: Promise<readonly [`0x${string}`, bigint]>;
  queryKey: _tanstack_react_query224.QueryKey;
} | {
  data: {
    percentage: bigint;
    recipient: Address;
 ...
 * ```
 */
declare function useListPrimarySaleItems(params: UseListPrimarySaleItemsParams): _tanstack_react_query224.UseInfiniteQueryResult<_tanstack_react_query224.InfiniteData<ListPrimarySaleItemsReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function usePrimarySaleItem(params: UsePrimarySaleItemParams): _tanstack_react_query224.UseQueryResult<CollectiblePrimarySaleItem, Error>;
//#endregion
...
//# sourceMappingURL=index-COysN7eF.d.ts.map