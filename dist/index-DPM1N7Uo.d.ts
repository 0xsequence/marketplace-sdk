import { GetCountOfPrimarySaleItemsArgs, GetCountOfPrimarySaleItemsReturn, ListPrimarySaleItemsReturn, Page, PrimarySaleItemsFilter, SdkConfig, ValuesOptional } from "./create-config-gz6zNqhE.js";
...
declare function countOfPrimarySaleItemsOptions(args: UseCountOfPrimarySaleItemsArgs, config: SdkConfig): _tanstack_react_query294.OmitKeyof<_tanstack_react_query294.UseQueryOptions<number, Error, number, readonly ["primarySaleItemsCount", {
  chainId: string;
  primarySaleContractAddress: `0x${string}`;
  filter: PrimarySaleItemsFilter | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query294.QueryFunction<number, readonly ["primarySaleItemsCount", {
    chainId: string;
    primarySaleContractAddress: `0x${string}`;
    filter: PrimarySaleItemsFilter | undefined;
  }], never> | undefined;
...
declare const listPrimarySaleItemsQueryOptions: (params: ListPrimarySaleItemsQueryOptions) => _tanstack_react_query294.OmitKeyof<_tanstack_react_query294.UseInfiniteQueryOptions<ListPrimarySaleItemsReturn, Error, _tanstack_react_query294.InfiniteData<ListPrimarySaleItemsReturn, unknown>, readonly ["listPrimarySaleItems", {
  chainId: string;
  primarySaleContractAddress: `0x${string}` | undefined;
  filter: PrimarySaleItemsFilter | undefined;
}], {
  ...
  queryFn?: _tanstack_react_query294.QueryFunction<ListPrimarySaleItemsReturn, readonly ["listPrimarySaleItems", {
    chainId: string;
    primarySaleContractAddress: `0x${string}` | undefined;
    filter: PrimarySaleItemsFilter | undefined;
  }], {
  ...
  queryKey: readonly ["listPrimarySaleItems", {
    ...
    [dataTagSymbol]: _tanstack_react_query294.InfiniteData<ListPrimarySaleItemsReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare const primarySaleItemsCountQueryOptions: (args: PrimarySaleItemsCountQueryOptions) => _tanstack_react_query294.OmitKeyof<_tanstack_react_query294.UseQueryOptions<GetCountOfPrimarySaleItemsReturn, Error, GetCountOfPrimarySaleItemsReturn, readonly ["primarySaleItemsCount", {
  chainId: string;
  primarySaleContractAddress: `0x${string}` | undefined;
  filter: PrimarySaleItemsFilter | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query294.QueryFunction<GetCountOfPrimarySaleItemsReturn, readonly ["primarySaleItemsCount", {
    chainId: string;
    primarySaleContractAddress: `0x${string}` | undefined;
    filter: PrimarySaleItemsFilter | undefined;
  }], never> | undefined;
...
//# sourceMappingURL=index-DPM1N7Uo.d.ts.map