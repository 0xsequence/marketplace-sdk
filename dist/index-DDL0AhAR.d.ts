import { CollectibleOrder, ListCollectibleListingsReturn, ListCollectibleOffersReturn, Optional, Order, OrderFilter, Page, SdkConfig } from "./create-config-Sy3PDbP4.js";
import { CountListingsForCollectibleQueryOptions, CountOffersForCollectibleQueryOptions, FloorOrderQueryOptions, HighestOfferQueryOptions, ListListingsForCollectibleQueryOptions, LowestListingQueryOptions, fetchListListingsForCollectible } from "./lowestListing-DBZJlcun.js";
 ...
 * ```
 */
declare function useCountListingsForCollectible(params: UseCountListingsForCollectibleParams): _tanstack_react_query371.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCountOffersForCollectible(params: UseCountOffersForCollectibleParams): _tanstack_react_query371.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useFloorOrder(params: UseFloorOrderParams): _tanstack_react_query371.UseQueryResult<CollectibleOrder, Error>;
//#endregion
 ...
 * ```
 */
declare function useHighestOffer(params: UseHighestOfferParams): _tanstack_react_query371.UseQueryResult<Order | null, Error>;
//#endregion
 ...
 * ```
 */
declare function useListListingsForCollectible(params: UseListListingsForCollectibleParams): _tanstack_react_query371.UseQueryResult<ListCollectibleListingsReturn, Error>;
...
declare const listOffersForCollectibleOptions: (args: UseListOffersForCollectibleArgs, config: SdkConfig) => _tanstack_react_query371.OmitKeyof<_tanstack_react_query371.UseQueryOptions<ListCollectibleOffersReturn, Error, ListCollectibleOffersReturn, (SdkConfig | "collectable" | "offers" | UseListOffersForCollectibleArgs)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query371.QueryFunction<ListCollectibleOffersReturn, (SdkConfig | "collectable" | "offers" | UseListOffersForCollectibleArgs)[], never> | undefined;
} & {
...
declare const useListOffersForCollectible: (args: UseListOffersForCollectibleArgs) => _tanstack_react_query371.UseQueryResult<ListCollectibleOffersReturn, Error>;
//#endregion
 ...
 * ```
 */
declare function useLowestListing(params: UseLowestListingParams): _tanstack_react_query371.UseQueryResult<Order | null | undefined, Error>;
//#endregion
...
//# sourceMappingURL=index-DDL0AhAR.d.ts.map