import { $ as SdkConfig, Gt as ContractType, mi as Page$1, ni as MetadataStatus } from "./create-config-CrbgqkBr.js";
...
declare function inventoryOptions(args: UseInventoryArgs, config: SdkConfig): _tanstack_react_query10.OmitKeyof<_tanstack_react_query10.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, (string | number)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query10.QueryFunction<CollectiblesResponse, (string | number)[], never> | undefined;
} & {
...
//# sourceMappingURL=index-DWkdkymr.d.ts.map