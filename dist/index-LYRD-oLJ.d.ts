import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-D6v7S2xr.js";
import { FiltersQueryOptions } from "./filters-cMT8Iy9q.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query320.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query320.RefetchOptions) => Promise<_tanstack_react_query320.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query320.FetchStatus;
...
//# sourceMappingURL=index-LYRD-oLJ.d.ts.map