import { Optional } from "./create-config-rrEYvm6u.js";
import { GetTokenRangesQueryOptions, ListTokenMetadataQueryOptions, SearchTokenMetadataQueryOptions, TokenSuppliesQueryOptions, UseListBalancesArgs, fetchGetTokenRanges$1 as fetchGetTokenRanges } from "./tokenSupplies-BUV8uPEw.js";
import * as _tanstack_react_query242 from "@tanstack/react-query";
import * as _tanstack_react_query243 from "@tanstack/react-query";
import * as _tanstack_react_query245 from "@tanstack/react-query";
...
import * as _0xsequence_metadata123 from "@0xsequence/metadata";
 ...
 * ```
 */
declare function useGetTokenRanges(params: UseGetTokenRangesParams): _tanstack_react_query242.UseQueryResult<_0xsequence_indexer8.GetTokenIDRangesReturn, Error>;
 ...
 * ```
 */
declare function useListBalances(args: UseListBalancesArgs): _tanstack_react_query243.UseInfiniteQueryResult<_tanstack_react_query243.InfiniteData<_0xsequence_indexer9.GetTokenBalancesReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useListTokenMetadata(params: UseListTokenMetadataParams): _tanstack_react_query245.UseQueryResult<_0xsequence_metadata123.TokenMetadata[], Error>;
//#endregion
...
declare function useSearchTokenMetadata(params: UseSearchTokenMetadataParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query64.FetchNextPageOptions) => Promise<_tanstack_react_query64.InfiniteQueryObserverResult<_tanstack_react_query64.InfiniteData<_0xsequence_metadata48.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query64.FetchPreviousPageOptions) => Promise<_tanstack_react_query64.InfiniteQueryObserverResult<_tanstack_react_query64.InfiniteData<_0xsequence_metadata48.SearchTokenMetadataReturn, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query64.RefetchOptions) => Promise<_tanstack_react_query64.QueryObserverResult<_tanstack_react_query64.InfiniteData<_0xsequence_metadata48.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchStatus: _tanstack_react_query64.FetchStatus;
  promise: Promise<_tanstack_react_query64.InfiniteData<_0xsequence_metadata48.SearchTokenMetadataReturn, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata48.TokenMetadata[];
    page: _0xsequence_metadata48.Page;
  } | undefined;
  error: Error;
  isError: true;
  isPending: false;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata48.TokenMetadata[];
    page: _0xsequence_metadata48.Page | undefined;
  } | undefined;
  isLoading: boolean;
  isFetching: boolean;
  error: Error | null;
 ...
 * ```
 */
declare function useTokenSupplies(params: UseTokenSuppliesParams): _tanstack_react_query246.UseInfiniteQueryResult<_tanstack_react_query246.InfiniteData<_0xsequence_indexer10.GetTokenSuppliesReturn, unknown>, Error>;
//#endregion
export { UseGetTokenRangesParams, UseGetTokenRangesProps, UseGetTokenRangesReturn, UseListTokenMetadataParams, UseSearchTokenMetadataParams, UseTokenSuppliesParams, useGetTokenRanges as useGetTokenRanges$1, useListBalances as useListBalances$1, useListTokenMetadata as useListTokenMetadata$1, useSearchTokenMetadata as useSearchTokenMetadata$1, useTokenSupplies as useTokenSupplies$1 };
//# sourceMappingURL=index-Duws7JTV.d.ts.map