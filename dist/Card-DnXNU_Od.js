import { s as ContractType } from "./marketplace.gen-CbSVdSOZ.js";
import { t as CollectibleCardAction } from "./types-Bm9DM-SP.js";
import { C as cn$1, f as fromBigIntString, w as compareAddress, x as toNumber } from "./utils-Dr-4WqI6.js";
import { t as BellIcon_default } from "./BellIcon-BrJcPZYR.js";
...
const CardBadge = forwardRef(({ type, balance, decimals, className,...props }, ref) => {
...
const formatPriceNumber = (amount, decimals) => {
	const numericPrice = toNumber(fromBigIntString(amount, decimals));
...
function getShopCardState(params) {
	...
	const isOutOfStock = !unlimitedSupply && (quantityRemaining === "0" || quantityRemaining === void 0);
	const isMissingStockInfo = quantityInitial === void 0 || quantityRemaining === void 0;
	return {
		isOutOfStock,
		isMissingStockInfo,
		showActionButton: !!salesContractAddress && collectionType === ContractType.ERC1155 && (unlimitedSupply || quantityRemaining !== void 0 && Number(quantityRemaining) > 0),
...
//# sourceMappingURL=Card-DnXNU_Od.js.map