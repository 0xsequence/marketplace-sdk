import { A as Optional, Qt as CurrencyStatus, Vt as ContractType, Z as CollectibleCardAction, Zr as OrderbookKind, Zt as Currency, fi as PropertyFilter, jt as CollectibleOrder, ti as PriceFilter, vr as ListCollectiblesReturn } from "./create-config-Dz-QylqB.js";
import { a as CurrencyQueryOptions, n as MarketCurrenciesQueryOptions } from "./marketCurrencies-DsdpyebE.js";
import { r as MarketCollectibleCardProps } from "./types-r5uhCWsm.js";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query231.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query231.FetchNextPageOptions) => Promise<_tanstack_react_query231.InfiniteQueryObserverResult<_tanstack_react_query231.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query231.UseQueryResult<{
...
//# sourceMappingURL=index-DwdtWafi.d.ts.map