import { CollectibleOrder, ListCollectibleListingsReturn, ListCollectibleOffersReturn, Optional, Order } from "./create-config-BpPJGqAC.js";
import { CountListingsForCollectibleQueryOptions, CountOffersForCollectibleQueryOptions, FloorOrderQueryOptions, HighestOfferQueryOptions, ListListingsForCollectibleQueryOptions, ListOffersForCollectibleQueryOptions, LowestListingQueryOptions, fetchListListingsForCollectible$1 as fetchListListingsForCollectible } from "./lowestListing-BXj8rsb_.js";
import * as _tanstack_react_query261 from "@tanstack/react-query";
import * as _tanstack_react_query262 from "@tanstack/react-query";
import * as _tanstack_react_query263 from "@tanstack/react-query";
import * as _tanstack_react_query264 from "@tanstack/react-query";
import * as _tanstack_react_query265 from "@tanstack/react-query";
import * as _tanstack_react_query266 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useCountListingsForCollectible(params: UseCountListingsForCollectibleParams): _tanstack_react_query261.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCountOffersForCollectible(params: UseCountOffersForCollectibleParams): _tanstack_react_query262.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useFloorOrder(params: UseFloorOrderParams): _tanstack_react_query263.UseQueryResult<CollectibleOrder, Error>;
//#endregion
 ...
 * ```
 */
declare function useHighestOffer(params: UseHighestOfferParams): _tanstack_react_query264.UseQueryResult<Order | null, Error>;
//#endregion
 ...
 * ```
 */
declare function useListOffersForCollectible(params: UseListOffersForCollectibleParams): _tanstack_react_query266.UseQueryResult<ListCollectibleOffersReturn, Error>;
 ...
 * ```
 */
declare function useLowestListing(params: UseLowestListingParams): _tanstack_react_query267.UseQueryResult<Order | null | undefined, Error>;
//#endregion
export { UseCountListingsForCollectibleParams, UseCountOffersForCollectibleParams, UseFloorOrderParams, UseHighestOfferParams, UseListListingsForCollectibleArgs, UseListListingsForCollectibleParams, UseListListingsForCollectibleReturn, UseListOffersForCollectibleArgs, UseListOffersForCollectibleParams, UseLowestListingParams, useCountListingsForCollectible as useCountListingsForCollectible$1, useCountOffersForCollectible as useCountOffersForCollectible$1, useFloorOrder as useFloorOrder$1, useHighestOffer as useHighestOffer$1, useListListingsForCollectible as useListListingsForCollectible$1, useListOffersForCollectible as useListOffersForCollectible$1, useLowestListing as useLowestListing$1 };
//# sourceMappingURL=index-V7xcSsxD.d.ts.map