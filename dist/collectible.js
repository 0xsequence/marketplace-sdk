...
function balanceOfCollectibleOptions(params) {
	return buildQueryOptions({
		...
		customValidation: (p) => !!p.collectionAddress && isAddress(p.collectionAddress) && !!p.tokenId && p.tokenId > 0n && !!p.userAddress && isAddress(p.userAddress)
	}, params);
}
