import { CardType, CollectiblesFilter, ListCollectibleActivitiesArgs, ListCollectibleActivitiesReturn, ListCollectiblesArgs, ListCollectiblesReturn, OrderSide, Page as Page$1, SdkConfig, SortBy, ValuesOptional } from "./create-config-vcb8Jl8E.js";
 ...
 */
declare function balanceOfCollectibleOptions(args: UseBalanceOfCollectibleArgs, config: SdkConfig): _tanstack_react_query278.UseQueryOptions<xtrails0.TokenBalance, Error, xtrails0.TokenBalance, ("details" | "collectable" | "userBalances" | UseBalanceOfCollectibleArgs)[]> & {
  initialData?: xtrails0.TokenBalance | _tanstack_react_query278.InitialDataFunction<xtrails0.TokenBalance> | undefined;
} & {
...
declare function collectibleQueryOptions(params: CollectibleQueryOptions): _tanstack_react_query278.OmitKeyof<_tanstack_react_query278.UseQueryOptions<_0xsequence_metadata81.TokenMetadata, Error, _0xsequence_metadata81.TokenMetadata, ("details" | "collectable" | CollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query278.QueryFunction<_0xsequence_metadata81.TokenMetadata, ("details" | "collectable" | CollectibleQueryOptions)[], never> | undefined;
} & {
...
declare function countOfCollectablesQueryOptions(params: CountOfCollectablesQueryOptions): _tanstack_react_query278.OmitKeyof<_tanstack_react_query278.UseQueryOptions<number, Error, number, ("collectable" | "counts" | CountOfCollectablesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query278.QueryFunction<number, ("collectable" | "counts" | CountOfCollectablesQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectibleActivitiesQueryOptions(params: ListCollectibleActivitiesQueryOptions): _tanstack_react_query278.OmitKeyof<_tanstack_react_query278.UseQueryOptions<ListCollectibleActivitiesReturn, Error, ListCollectibleActivitiesReturn, ("collectable" | "collectibleActivities" | ListCollectibleActivitiesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query278.QueryFunction<ListCollectibleActivitiesReturn, ("collectable" | "collectibleActivities" | ListCollectibleActivitiesQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectiblesQueryOptions(params: ListCollectiblesQueryOptions): _tanstack_react_query278.OmitKeyof<_tanstack_react_query278.UseInfiniteQueryOptions<ListCollectiblesReturn, Error, _tanstack_react_query278.InfiniteData<ListCollectiblesReturn, unknown>, ("collectable" | "list" | ListCollectiblesQueryOptions)[], Page$1>, "queryFn"> & {
  queryFn?: _tanstack_react_query278.QueryFunction<ListCollectiblesReturn, ("collectable" | "list" | ListCollectiblesQueryOptions)[], Page$1> | undefined;
} & {
  queryKey: ("collectable" | "list" | ListCollectiblesQueryOptions)[] & {
    [dataTagSymbol]: _tanstack_react_query278.InfiniteData<ListCollectiblesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listCollectiblesPaginatedQueryOptions(params: ListCollectiblesPaginatedQueryOptions): _tanstack_react_query278.OmitKeyof<_tanstack_react_query278.UseQueryOptions<ListCollectiblesReturn, Error, ListCollectiblesReturn, (string | ListCollectiblesPaginatedQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query278.QueryFunction<ListCollectiblesReturn, (string | ListCollectiblesPaginatedQueryOptions)[], never> | undefined;
} & {
...
//# sourceMappingURL=listCollectiblesPaginated-CwIpkaAh.d.ts.map