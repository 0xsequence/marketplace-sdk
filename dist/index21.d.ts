import { K as QueryArg } from "./create-config.js";
import { t as FeeOption } from "./waas-types.js";
import * as viem28 from "viem";
import { Address, Hex, PublicClient } from "viem";
import * as _tanstack_react_query334 from "@tanstack/react-query";
...
declare function royaltyQueryOptions(params: FetchRoyaltyParams, query?: UseRoyaltyArgs['query']): _tanstack_react_query334.OmitKeyof<_tanstack_react_query334.UseQueryOptions<RoyaltyInfo | null, Error, RoyaltyInfo | null, readonly ["royalty-percentage", {
  chainId: string;
  contractAddress: `0x${string}`;
  tokenId: bigint;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query334.QueryFunction<RoyaltyInfo | null, readonly ["royalty-percentage", {
    chainId: string;
    contractAddress: `0x${string}`;
    tokenId: bigint;
  }], never> | undefined;
 ...
 * ```
 */
declare function useRoyalty(args: UseRoyaltyArgs): _tanstack_react_query334.UseQueryResult<RoyaltyInfo | null, Error>;
//#endregion
