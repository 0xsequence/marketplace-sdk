 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query366.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query366.RefetchOptions) => Promise<_tanstack_react_query366.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query366.FetchStatus;
