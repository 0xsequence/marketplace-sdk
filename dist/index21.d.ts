import { X as Order, nn as PropertyFilter } from "./index2.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query217.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query217.RefetchOptions) => Promise<_tanstack_react_query217.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query217.FetchStatus;
