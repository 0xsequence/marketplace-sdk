import { X as Order, in as PropertyFilter } from "./index2.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query181.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query181.RefetchOptions) => Promise<_tanstack_react_query181.QueryObserverResult<PropertyFilter[], Error>>;
