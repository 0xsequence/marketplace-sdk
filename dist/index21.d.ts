import { Z as Order, gn as PropertyFilter } from "./index2.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query67.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query67.RefetchOptions) => Promise<_tanstack_react_query67.QueryObserverResult<PropertyFilter[], Error>>;
