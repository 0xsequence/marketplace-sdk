import { CheckoutOptionsItem, CheckoutOptionsSalesContractReturn, CollectiblePrimarySaleItem, ContractType, GetCountOfPrimarySaleItemsReturn, ListPrimarySaleItemsReturn, MarketplaceSdkContext, Optional, PrimarySaleItem, QueryArg, SdkConfig, TokenMetadata as TokenMetadata$1 } from "./create-config-BQet0plq.js";
import { CheckoutOptionsSalesContractQueryOptions, CollectiblesResponse, ComparePricesQueryOptions, ComparePricesReturn, ConvertPriceToUSDQueryOptions, ConvertPriceToUSDReturn, ListPrimarySaleItemsQueryOptions, UseCountOfPrimarySaleItemsArgs, UseInventoryArgs, fetchCheckoutOptionsSalesContract } from "./index-DW8Lt6mi.js";
...
import * as viem37 from "viem";
import { Address, Hex } from "viem";

//#region src/react/hooks/data/primary-sales/useCountOfPrimarySaleItems.d.ts
declare function useCountOfPrimarySaleItems(args: UseCountOfPrimarySaleItemsArgs): _tanstack_react_query353.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useGetCountOfPrimarySaleItems(params: UseGetCountParams): _tanstack_react_query353.UseQueryResult<GetCountOfPrimarySaleItemsReturn, Error>;
//#endregion
...
declare function useList721ShopCardData({
  ...
  saleDetailsError: viem37.ReadContractErrorType | null;
  saleDetails: {
    supplyCap: bigint;
    cost: bigint;
    paymentToken: `0x${string}`;
  ...
  isLoading: boolean;
  tokenSuppliesData: _tanstack_react_query353.InfiniteData<_0xsequence_indexer8.GetTokenSuppliesReturn, unknown> | undefined;
};
//#endregion
...
declare function useInventory(args: UseInventoryArgs): _tanstack_react_query353.UseQueryResult<CollectiblesResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCheckoutOptionsSalesContract(params: UseCheckoutOptionsSalesContractParams | typeof skipToken): _tanstack_react_query353.UseQueryResult<CheckoutOptionsSalesContractReturn, Error>;
 ...
 * ```
 */
declare function useComparePrices(params: UseComparePricesParams): _tanstack_react_query353.UseQueryResult<ComparePricesReturn, Error>;
 ...
 * ```
 */
declare function useConvertPriceToUSD(params: UseConvertPriceToUSDParams): _tanstack_react_query353.UseQueryResult<ConvertPriceToUSDReturn, Error>;
...
declare const useEnsureCorrectChain: () => {
  ...
  ensureCorrectChainAsync: (targetChainId: number) => Promise<void | {
    ...
    contracts?: {
      [x: string]: viem37.ChainContract | {
        [sourceId: number]: viem37.ChainContract | undefined;
      } | undefined;
      ensRegistry?: viem37.ChainContract | undefined;
      ensUniversalResolver?: viem37.ChainContract | undefined;
      multicall3?: viem37.ChainContract | undefined;
      erc6492Verifier?: viem37.ChainContract | undefined;
    } | undefined;
    ...
    fees?: viem37.ChainFees<viem37.ChainFormatters | undefined> | undefined;
    formatters?: viem37.ChainFormatters | undefined;
    serializers?: viem37.ChainSerializers<viem37.ChainFormatters | undefined, viem37.TransactionSerializable> | undefined;
  }>;
...
declare const useGetReceiptFromHash: () => {
  waitForReceipt: (transactionHash: Hex) => Promise<viem37.TransactionReceipt>;
};
//#endregion
...
declare function useRoyalty(args: UseRoyaltyArgs): {
  ...
  error: viem37.ReadContractErrorType;
  isError: true;
  isPending: false;
  isLoading: false;
  ...
  failureCount: number;
  failureReason: viem37.ReadContractErrorType | null;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query353.RefetchOptions) => Promise<_tanstack_react_query353.QueryObserverResult<readonly [`0x${string}`, bigint], viem37.ReadContractErrorType>>;
  fetchStatus: _tanstack_react_query353.FetchStatus;
  promise: Promise<readonly [`0x${string}`, bigint]>;
  queryKey: _tanstack_react_query353.QueryKey;
} | {
  data: {
    percentage: bigint;
    recipient: Address;
...
declare function MarketplaceProvider({
  ...
  children,
  openConnectModal
}: MarketplaceSdkProviderProps): react_jsx_runtime30.JSX.Element;
 ...
 * ```
 */
declare function useListPrimarySaleItems(params: UseListPrimarySaleItemsParams): _tanstack_react_query353.UseInfiniteQueryResult<_tanstack_react_query353.InfiniteData<ListPrimarySaleItemsReturn, unknown>, Error>;
//#endregion
export { MarketplaceProvider, MarketplaceQueryClientProvider, MarketplaceSdkContext$1 as MarketplaceSdkContext, MarketplaceSdkProviderProps, UseCheckoutOptionsSalesContractArgs, UseCheckoutOptionsSalesContractParams, UseCheckoutOptionsSalesContractReturn, UseComparePricesArgs, UseComparePricesParams, UseComparePricesReturn, UseConvertPriceToUSDArgs, UseConvertPriceToUSDParams, UseConvertPriceToUSDReturn, UseGetCountParams, UseListPrimarySaleItemsParams, UseRoyaltyArgs, useAutoSelectFeeOption, useCheckoutOptionsSalesContract, useComparePrices, useConvertPriceToUSD, useCountOfPrimarySaleItems, useEnsureCorrectChain, useErc721SaleDetails, useGetCountOfPrimarySaleItems, useGetReceiptFromHash, useInventory, useList1155ShopCardData, useList721ShopCardData, useListPrimarySaleItems, useRoyalty };
//# sourceMappingURL=index-DGyLx-sg.d.ts.map