import { CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PropertyFilter } from "./create-config-D5nkCAUU.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-CvT4H6O0.js";
import { MarketCollectibleCardProps } from "./types-DyKDM4DE.js";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query378.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query378.FetchNextPageOptions) => Promise<_tanstack_react_query378.InfiniteQueryObserverResult<_tanstack_react_query378.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query378.UseQueryResult<{
...
//# sourceMappingURL=index-BzdlQJsO.d.ts.map