import { Currency, CurrencyStatus, SdkConfig, ValuesOptional } from "./create-config-BpPJGqAC.js";
...
declare function currencyQueryOptions(params: CurrencyQueryOptions): _tanstack_react_query306.UseQueryOptions<Currency | undefined, Error, Currency | undefined, ("details" | "currencies" | CurrencyQueryOptions)[]> & {
  initialData?: Currency | _tanstack_react_query306.InitialDataFunction<Currency> | undefined;
} & {
...
declare function marketCurrenciesQueryOptions(params: MarketCurrenciesQueryOptions): _tanstack_react_query358.OmitKeyof<_tanstack_react_query358.UseQueryOptions<{
  contractAddress: string;
  chainId: number;
  status: CurrencyStatus;
  name: string;
  ...
  queryFn?: _tanstack_react_query358.QueryFunction<{
    contractAddress: string;
    chainId: number;
    status: CurrencyStatus;
    name: string;
...
//#endregion
export { CurrencyQueryOptions, FetchCurrencyParams, FetchMarketCurrenciesParams, MarketCurrenciesQueryOptions, currencyQueryOptions as currencyQueryOptions$1, fetchCurrency as fetchCurrency$1, fetchMarketCurrencies as fetchMarketCurrencies$1, marketCurrenciesQueryOptions as marketCurrenciesQueryOptions$1 };
//# sourceMappingURL=marketCurrencies-CrwTRa90.d.ts.map