import { ContractType, Currency, Order } from "./create-config-DmCoYOfk.js";
...
declare const FooterName: ({
  ...
  quantityRemaining,
  balance
}: FooterNameProps) => react_jsx_runtime32.JSX.Element;
//#endregion
...
declare const PriceDisplay: ({
  ...
  showCurrencyIcon,
  className
}: PriceDisplayProps) => react_jsx_runtime32.JSX.Element;
//#endregion
...
declare const SaleDetailsPill: ({
  ...
  collectionType,
  unlimitedSupply
}: SaleDetailsPillProps) => react_jsx_runtime32.JSX.Element;
//#endregion
...
declare const TokenTypeBalancePill: ({
  ...
  type,
  decimals
}: TokenTypeBalancePillProps) => react_jsx_runtime32.JSX.Element;
//#endregion
export { FooterName, PriceDisplay, SaleDetailsPill, TokenTypeBalancePill, formatPrice };
//# sourceMappingURL=index-CiYeKnsq.d.ts.map