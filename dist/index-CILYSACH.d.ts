import { Optional, PropertyFilter, PropertyType } from "./create-config-DjQjhu3-.js";
import { FiltersQueryOptions } from "./filters-DED8QsHU.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query122.UseQueryResult<PropertyFilter$1[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query122.RefetchOptions) => Promise<_tanstack_react_query122.QueryObserverResult<PropertyFilter$1[], Error>>;
...
//# sourceMappingURL=index-CILYSACH.d.ts.map