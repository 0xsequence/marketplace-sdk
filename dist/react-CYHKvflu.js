...
import { balanceQueries, collectableKeys, getIndexerClient, getMarketplaceClient, getQueryClient } from "./api-lja0wRc1.js";
import { CollectionStatus, ContractType, ExecuteType, MarketplaceKind, OfferType, OrderSide, OrderbookKind, PropertyType, StepType, WalletKind } from "./marketplace.gen-D9PUMxel.js";
...
import { CollectibleCardAction, TransactionType as TransactionType$1 } from "./types-BCL_V2_Y.js";
...
import { ERC1155_ABI, ERC20_ABI, ERC721_ABI } from "./token-Cv7l2ZaL.js";
import { calculateEarningsAfterFees, cn as cn$1, compareAddress, formatPrice, truncateMiddle } from "./utils-0_QdfbSM.js";
import { marketplaceConfigOptions } from "./marketplaceConfig-CGF5eie1.js";
import { SalesContractVersion, useSalesContractABI } from "./contracts-DRgB8292.js";
import { balanceOfCollectibleOptions, checkoutOptionsSalesContractQueryOptions, collectibleQueryOptions, collectionBalanceDetailsQueryOptions, collectionDetailsQueryOptions, collectionQueryOptions, comparePricesQueryOptions, convertPriceToUSDQueryOptions, countListingsForCollectibleQueryOptions, countOfCollectablesQueryOptions, countOfPrimarySaleItemsOptions, countOffersForCollectibleQueryOptions, currencyQueryOptions, filtersQueryOptions, floorOrderQueryOptions, getTokenRangesQueryOptions, highestOfferQueryOptions, inventoryOptions, listBalancesOptions, listCollectibleActivitiesQueryOptions, listCollectiblesPaginatedQueryOptions, listCollectiblesQueryOptions, listCollectionActivitiesQueryOptions, listCollectionsQueryOptions, listListingsForCollectibleQueryOptions, listOffersForCollectibleQueryOptions, listPrimarySaleItemsQueryOptions, listTokenMetadataQueryOptions, lowestListingQueryOptions, marketCurrenciesQueryOptions, primarySaleItemsCountQueryOptions, searchTokenMetadataQueryOptions, tokenSuppliesQueryOptions } from "./queries-aSY57bkC.js";
import { waitForTransactionReceipt } from "./waitForTransactionReceipt-Bd-hvxWr.js";
import { CalendarIcon_default, CartIcon_default, InfoIcon_default } from "./CartIcon-BD19Ojv9.js";
import { FooterName, PriceDisplay, SaleDetailsPill, TokenTypeBalancePill } from "./components-BnN7hELF.js";
...
import { AddIcon, Button, CheckmarkIcon, ChevronDownIcon, ChevronLeftIcon, ChevronUpIcon, CloseIcon, Divider, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuPortal, DropdownMenuRoot, DropdownMenuTrigger, ExternalLinkIcon, IconButton, Image, Modal, NetworkImage, NumericInput, Select, Skeleton, Spinner, SubtractIcon, Text, TextInput, ThemeProvider, TokenImage, Tooltip, WarningIcon, cn } from "@0xsequence/design-system";
...
function useListMarketCardData({ collectionAddress, chainId, orderbookKind, collectionType, filterOptions, searchText, showListedOnly = false, priceFilters, onCollectibleClick, onCannotPerformAction, prioritizeOwnerActions, assetSrcPrefixUrl }) {
...
const useSelectWaasFeeOptionsStore = () => {
	...
	const id = useSelector(selectWaasFeeOptionsStore, (state) => state.context.id);
...
function useOrders(params) {
	const defaultConfig = useConfig();
	const { config = defaultConfig,...rest } = params;
	const queryOptions$1 = ordersQueryOptions({
		config,
		...rest
	});
	return useQuery({ ...queryOptions$1 });
						...
						children: [
							...
							showFullError && /* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs(Text, {
									...
									children: [error.message, error.stack && /* @__PURE__ */ jsxs(Fragment, { children: ["\n\nStack trace:\n", error.stack] })]
								})
							})
						]
					})]
...
//#endregion
//#region src/react/ui/modals/BuyModal/components/hook/useExecutePurchaseWithWaas.ts
...
const useExecutePurchaseWithWaas = ({ chainId, approvalStep, priceAmount }) => {
	const config = useConfig();
	...
	const executePurchaseWithWaas = async ({ step, onBalanceInsufficientForFeeOption, onTransactionFailed }) => {
		setIsExecuting(true);
		if (!isWaaS) throw new Error("executeWithWaas is only available for Sequence WaaS connector");
		...
		const transactions = [...approvalData ? [approvalData] : [], purchaseData];
...
const FallbackPurchaseUI = ({ chainId, steps: steps$2, onSuccess }) => {
	...
	const { collectible, currencyAddress, currency, order, salePrice, isMarket, collection, isLoading: isLoadingBuyModalData } = useBuyModalData();
	const sdkConfig = useConfig();
	...
	const { executePurchaseWithWaas, isExecuting: isExecutingWithWaas } = useExecutePurchaseWithWaas({
		chainId,
		approvalStep,
		priceAmount
	});
	...
	const canBuy = hasSufficientBalance && !isLoadingBalance && !isLoadingBuyModalData && isOnCorrectChain;
	const buyButtonLabel = isExecuting || isExecutingWithWaas ? /* @__PURE__ */ jsxs("div", {
		className: "flex items-center gap-2",
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(Tooltip, {
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx(NetworkImage, {
											chainId,
											size: "xs"
										}), /* @__PURE__ */ jsx(Text, {
				...
				approvalStep && !isWaaS && /* @__PURE__ */ jsx(Button, {
				...
				canBuy && /* @__PURE__ */ jsx(Button, {
					onClick: () => {
						setError(null);
						return isWaaS ? executePurchaseWithWaas({
							step: buyStep,
...
//#endregion
//#region src/react/ui/modals/BuyModal/components/useWaasFeeOptions.tsx
var Deferred = class {
	_resolve = () => {};
	_reject = () => {};
	...
	*/
	function confirmPendingFeeOption(id, feeTokenAddress) {
		if (sharedDeferred && sharedPendingConfirmation?.id === id) {
			...
			sharedDeferred = void 0;
			notifyListeners(void 0);
		}
	}
	/**
	...
	*/
	function rejectPendingFeeOption(id) {
		if (sharedDeferred && sharedPendingConfirmation?.id === id) {
			...
			sharedDeferred = void 0;
			sharedPendingConfirmation = void 0;
			notifyListeners(void 0);
		}
	}
	useEffect(() => {
	...
	useEffect(() => {
		...
		waasProvider.feeConfirmationHandler = { async confirmFeeOption(id, options$1, chainId$1) {
			...
			if (!skipFeeBalanceCheck) {
				const optionsWithBalances = await Promise.all(options$1.map(async (option) => {
...
const BuyModalContent = () => {
	...
	const { collectible, currencyAddress, currency, order, collectionAddress, salePrice, isLoading: isBuyModalDataLoading, isMarket } = useBuyModalData();
	const [pendingFeeOptionConfirmation, _, rejectPendingFeeOption] = useWaasFeeOptions$1(modalProps.chainId, config);
