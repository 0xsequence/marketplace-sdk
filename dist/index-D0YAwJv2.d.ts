import { CollectibleOrder, ListCollectibleListingsReturn, ListCollectibleOffersReturn, Optional, Order } from "./create-config-sLNrdjHZ.js";
import { CountListingsForCollectibleQueryOptions, CountOffersForCollectibleQueryOptions, FloorOrderQueryOptions, HighestOfferQueryOptions, ListListingsForCollectibleQueryOptions, ListOffersForCollectibleQueryOptions, LowestListingQueryOptions, fetchListListingsForCollectible } from "./lowestListing-gTQQiDt3.js";
 ...
 * ```
 */
declare function useCountListingsForCollectible(params: UseCountListingsForCollectibleParams): _tanstack_react_query343.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCountOffersForCollectible(params: UseCountOffersForCollectibleParams): _tanstack_react_query343.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useFloorOrder(params: UseFloorOrderParams): _tanstack_react_query343.UseQueryResult<CollectibleOrder, Error>;
//#endregion
 ...
 * ```
 */
declare function useHighestOffer(params: UseHighestOfferParams): _tanstack_react_query343.UseQueryResult<Order | null, Error>;
//#endregion
 ...
 * ```
 */
declare function useListListingsForCollectible(params: UseListListingsForCollectibleParams): _tanstack_react_query343.UseQueryResult<ListCollectibleListingsReturn, Error>;
 ...
 * ```
 */
declare function useListOffersForCollectible(params: UseListOffersForCollectibleParams): _tanstack_react_query343.UseQueryResult<ListCollectibleOffersReturn, Error>;
 ...
 * ```
 */
declare function useLowestListing(params: UseLowestListingParams): _tanstack_react_query343.UseQueryResult<Order | null | undefined, Error>;
//#endregion
...
//# sourceMappingURL=index-D0YAwJv2.d.ts.map