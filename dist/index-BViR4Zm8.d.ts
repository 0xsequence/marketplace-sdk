import { BuyModalProps, CollectionType, ModalCallbacks, Order, OrderbookKind, TokenMetadata } from "./create-config-BpPJGqAC.js";
...
declare const ModalProvider: ({
  children
}: ModalProviderProps) => react_jsx_runtime1.JSX.Element;
//#endregion
...
declare function Media({
  ...
  fallbackContent,
  shouldListenForLoad
}: MediaProps): react_jsx_runtime2.JSX.Element;
//#endregion
...
//# sourceMappingURL=index-BViR4Zm8.d.ts.map