...
import * as _tanstack_react_query234 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useTokenBalances(args: UseListBalancesArgs): _tanstack_react_query234.UseInfiniteQueryResult<_tanstack_react_query234.InfiniteData<_0xsequence_api_client228.GetTokenBalancesResponse, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useTokenMetadata(params: UseTokenMetadataParams): _tanstack_react_query234.UseQueryResult<_0xsequence_api_client228.TokenMetadata[], Error>;
//#endregion
...
declare function useTokenMetadataSearch(params: UseTokenMetadataSearchParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query234.FetchNextPageOptions) => Promise<_tanstack_react_query234.InfiniteQueryObserverResult<_tanstack_react_query234.InfiniteData<_0xsequence_api_client228.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query234.FetchPreviousPageOptions) => Promise<_tanstack_react_query234.InfiniteQueryObserverResult<_tanstack_react_query234.InfiniteData<_0xsequence_api_client228.SearchTokenMetadataReturn, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query234.RefetchOptions) => Promise<_tanstack_react_query234.QueryObserverResult<_tanstack_react_query234.InfiniteData<_0xsequence_api_client228.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchStatus: _tanstack_react_query234.FetchStatus;
  promise: Promise<_tanstack_react_query234.InfiniteData<_0xsequence_api_client228.SearchTokenMetadataReturn, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
 ...
 * ```
 */
declare function useTokenRanges(params: UseTokenRangesParams): _tanstack_react_query234.UseQueryResult<_0xsequence_api_client228.GetTokenIDRangesResponse, Error>;
