import { u as MarketplaceWalletType } from "./dist.js";
...
function commonConnectors(marketplaceConfig, sdkConfig, ssr) {
	const wallets = [];
	...
	if (walletConnectProjectId && walletOptions.connectors.includes("walletconnect") && !ssr) wallets.push(walletConnect({ projectId: walletConnectProjectId }));
