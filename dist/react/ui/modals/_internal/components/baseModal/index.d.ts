...
declare const BaseModal: ({
  ...
  children,
  disableAnimation
}: BaseModalProps) => react_jsx_runtime38.JSX.Element;
//#endregion
...
declare function ActionModal<T extends Record<string, UseQueryResult>>({
  ...
  errorComponent,
  ...baseProps
}: ActionModalProps<T>): react_jsx_runtime38.JSX.Element;
//#endregion
...
declare class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render(): string | number | bigint | boolean | Iterable<ReactNode> | Promise<string | number | bigint | boolean | react30.ReactPortal | react30.ReactElement<unknown, string | react30.JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | react_jsx_runtime38.JSX.Element | null | undefined;
}
//#endregion
...
declare const ErrorModal: ({
  ...
  onRetry,
  onErrorAction
}: ErrorModalProps) => react_jsx_runtime38.JSX.Element;
//#endregion
...
declare const LoadingModal: ({
  ...
  disableAnimation,
  message
}: LoadingModalProps) => react_jsx_runtime38.JSX.Element;
//#endregion
