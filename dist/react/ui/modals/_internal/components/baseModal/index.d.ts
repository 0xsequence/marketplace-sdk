...
declare const BaseModal: ({
  ...
  disableAnimation,
  transactionType
}: BaseModalProps) => react_jsx_runtime25.JSX.Element;
//#endregion
...
declare function ActionModal<T extends Record<string, UseQueryResult>>({
  ...
  errorComponent,
  ...baseProps
}: ActionModalProps<T>): react_jsx_runtime25.JSX.Element;
//#endregion
...
declare class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render(): string | number | bigint | boolean | react_jsx_runtime25.JSX.Element | Iterable<ReactNode> | Promise<string | number | bigint | boolean | react14.ReactPortal | react14.ReactElement<unknown, string | react14.JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined;
}
//#endregion
...
declare const ErrorModal: ({
  ...
  onRetry,
  onErrorAction
}: ErrorModalProps) => react_jsx_runtime25.JSX.Element;
//#endregion
...
declare const LoadingModal: ({
  ...
  disableAnimation,
  message
}: LoadingModalProps) => react_jsx_runtime25.JSX.Element;
//#endregion
