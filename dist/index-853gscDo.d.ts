...
declare function checkoutOptionsQueryOptions(params: CheckoutOptionsQueryOptions): _tanstack_react_query27.OmitKeyof<_tanstack_react_query27.UseQueryOptions<CheckoutOptionsMarketplaceReturn, Error, CheckoutOptionsMarketplaceReturn, (string | CheckoutOptionsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query27.QueryFunction<CheckoutOptionsMarketplaceReturn, (string | CheckoutOptionsQueryOptions)[], never> | undefined;
} & {
...
declare function checkoutOptionsSalesContractQueryOptions(params: CheckoutOptionsSalesContractQueryOptions): _tanstack_react_query27.OmitKeyof<_tanstack_react_query27.UseQueryOptions<CheckoutOptionsSalesContractReturn, Error, CheckoutOptionsSalesContractReturn, (string | CheckoutOptionsSalesContractQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query27.QueryFunction<CheckoutOptionsSalesContractReturn, (string | CheckoutOptionsSalesContractQueryOptions)[], never> | undefined;
} & {
...
declare function comparePricesQueryOptions(params: ComparePricesQueryOptions): _tanstack_react_query27.OmitKeyof<_tanstack_react_query27.UseQueryOptions<ComparePricesReturn, Error, ComparePricesReturn, (string | ComparePricesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query27.QueryFunction<ComparePricesReturn, (string | ComparePricesQueryOptions)[], never> | undefined;
} & {
...
declare function convertPriceToUSDQueryOptions(params: ConvertPriceToUSDQueryOptions): _tanstack_react_query27.OmitKeyof<_tanstack_react_query27.UseQueryOptions<ConvertPriceToUSDReturn, Error, ConvertPriceToUSDReturn, (string | ConvertPriceToUSDQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query27.QueryFunction<ConvertPriceToUSDReturn, (string | ConvertPriceToUSDQueryOptions)[], never> | undefined;
} & {
...
declare function countOfPrimarySaleItemsOptions(args: UseCountOfPrimarySaleItemsArgs, config: SdkConfig): _tanstack_react_query27.OmitKeyof<_tanstack_react_query27.UseQueryOptions<number, Error, number, (string | UseCountOfPrimarySaleItemsArgs)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query27.QueryFunction<number, (string | UseCountOfPrimarySaleItemsArgs)[], never> | undefined;
} & {
...
declare function inventoryOptions(args: UseInventoryArgs, config: SdkConfig): _tanstack_react_query27.OmitKeyof<_tanstack_react_query27.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, (string | number)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query27.QueryFunction<CollectiblesResponse, (string | number)[], never> | undefined;
} & {
...
declare const listPrimarySaleItemsQueryOptions: (params: ListPrimarySaleItemsQueryOptions) => _tanstack_react_query27.OmitKeyof<_tanstack_react_query27.UseInfiniteQueryOptions<ListPrimarySaleItemsReturn, Error, _tanstack_react_query27.InfiniteData<ListPrimarySaleItemsReturn, unknown>, (string | ListPrimarySaleItemsQueryOptions)[], {
  page: number;
  pageSize: number;
}>, "queryFn"> & {
  queryFn?: _tanstack_react_query27.QueryFunction<ListPrimarySaleItemsReturn, (string | ListPrimarySaleItemsQueryOptions)[], {
    page: number;
    pageSize: number;
  }> | undefined;
} & {
  queryKey: (string | ListPrimarySaleItemsQueryOptions)[] & {
    [dataTagSymbol]: _tanstack_react_query27.InfiniteData<ListPrimarySaleItemsReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare const primarySaleItemsCountQueryOptions: (args: PrimarySaleItemsCountQueryOptions) => _tanstack_react_query27.OmitKeyof<_tanstack_react_query27.UseQueryOptions<GetCountOfPrimarySaleItemsReturn, Error, GetCountOfPrimarySaleItemsReturn, (string | PrimarySaleItemsCountQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query27.QueryFunction<GetCountOfPrimarySaleItemsReturn, (string | PrimarySaleItemsCountQueryOptions)[], never> | undefined;
} & {
...
//# sourceMappingURL=index-853gscDo.d.ts.map