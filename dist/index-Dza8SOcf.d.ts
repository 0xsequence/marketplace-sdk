import { ListCollectibleActivitiesReturn, ListCollectiblesReturn, Optional } from "./create-config-rrEYvm6u.js";
 ...
 * ```
 */
declare function useBalanceOfCollectible(args: UseBalanceOfCollectibleArgs): _tanstack_react_query409.UseQueryResult<_0xsequence_indexer25.TokenBalance, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectible(params: UseCollectibleParams): _tanstack_react_query410.UseQueryResult<_0xsequence_metadata139.TokenMetadata, Error>;
//#endregion
 ...
 * ```
 */
declare function useCountOfCollectables(params: UseCountOfCollectablesParams): _tanstack_react_query411.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectibleActivities(params: UseListCollectibleActivitiesParams): _tanstack_react_query412.UseQueryResult<ListCollectibleActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollectibles(params: UseListCollectiblesParams): _tanstack_react_query413.UseInfiniteQueryResult<_tanstack_react_query413.InfiniteData<ListCollectiblesReturn, unknown>, Error>;
 ...
 * ```
 */
declare function useListCollectiblesPaginated(params: UseListCollectiblesPaginatedParams): _tanstack_react_query415.UseQueryResult<ListCollectiblesReturn, Error>;
...
//# sourceMappingURL=index-Dza8SOcf.d.ts.map