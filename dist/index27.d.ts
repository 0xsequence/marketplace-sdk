import { Mt as Collection, m as GetCollectionDetailRequest } from "./index2.js";
...
declare function collectionMarketDetailQueryOptions(params: WithOptionalParams<WithRequired<MarketCollectionDetailQueryOptions, 'collectionAddress' | 'chainId' | 'config'>>): _tanstack_react_query119.OmitKeyof<_tanstack_react_query119.UseQueryOptions<Collection, Error, Collection, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query119.QueryFunction<Collection, readonly unknown[], never> | undefined;
} & {
