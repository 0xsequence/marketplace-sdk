import { Pt as Collection, m as GetCollectionDetailRequest } from "./index2.js";
...
declare function collectionMarketDetailQueryOptions(params: WithOptionalParams<WithRequired<MarketCollectionDetailQueryOptions, 'collectionAddress' | 'chainId' | 'config'>>): _tanstack_react_query108.OmitKeyof<_tanstack_react_query108.UseQueryOptions<Collection, Error, Collection, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query108.QueryFunction<Collection, readonly unknown[], never> | undefined;
} & {
