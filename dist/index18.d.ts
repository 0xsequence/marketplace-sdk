...
declare function useBuyTransaction(options: UseBuyTransactionOptions): {
  ...
  error: Error | null;
  isError: boolean;
  refetch: (options?: _tanstack_react_query110.RefetchOptions) => Promise<_tanstack_react_query110.QueryObserverResult<{
    steps: Step[];
    canBeUsedWithTrails: boolean;
  }, Error>>;
};
...
declare const useGenerateCancelTransaction: (params: UseGenerateCancelTransactionRequest) => {
  generateCancelTransaction: _tanstack_react_query110.UseMutateFunction<Step[], Error, GenerateCancelTransactionRequestWithNumberChainId, unknown>;
  generateCancelTransactionAsync: _tanstack_react_query110.UseMutateAsyncFunction<Step[], Error, GenerateCancelTransactionRequestWithNumberChainId, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateListingTransaction: (params: UseGenerateListingTransactionRequest) => {
  generateListingTransaction: _tanstack_react_query110.UseMutateFunction<Step[], Error, Omit<GenerateListingTransactionRequestWithNumberChainId, "chainId">, unknown>;
  generateListingTransactionAsync: _tanstack_react_query110.UseMutateAsyncFunction<Step[], Error, Omit<GenerateListingTransactionRequestWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateOfferTransaction: (params: UseGenerateOfferTransactionRequest) => {
  generateOfferTransaction: _tanstack_react_query110.UseMutateFunction<Step[], Error, Omit<GenerateOfferTransactionRequestWithNumberChainId, "chainId">, unknown>;
  generateOfferTransactionAsync: _tanstack_react_query110.UseMutateAsyncFunction<Step[], Error, Omit<GenerateOfferTransactionRequestWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateSellTransaction: (params: UseGenerateSellTransactionRequest) => {
  generateSellTransaction: _tanstack_react_query110.UseMutateFunction<Step[], Error, Omit<GenerateSellTransactionRequestWithNumberChainId, "chainId">, unknown>;
  generateSellTransactionAsync: _tanstack_react_query110.UseMutateAsyncFunction<Step[], Error, Omit<GenerateSellTransactionRequestWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare function useMarketTransactionSteps({
  ...
  additionalFees,
  enabled
}: UseMarketTransactionStepsParams): _tanstack_react_query110.UseQueryResult<{
  steps: Step[];
  canBeUsedWithTrails: boolean;
}, Error>;
//#endregion
...
declare function usePrimarySaleTransactionSteps({
  ...
  contractType,
  enabled
}: UsePrimarySaleTransactionStepsParams): _tanstack_react_query110.UseQueryResult<{
  steps: Step[];
  canBeUsedWithTrails: boolean;
}, Error>;
//#endregion
