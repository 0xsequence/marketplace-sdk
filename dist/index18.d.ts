 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query178.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query178.RefetchOptions) => Promise<_tanstack_react_query178.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query178.FetchStatus;
