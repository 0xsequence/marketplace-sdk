...
declare function ordersQueryOptions(params: OrdersQueryOptions): _tanstack_react_query308.OmitKeyof<_tanstack_react_query308.UseQueryOptions<GetOrdersReturn, Error, GetOrdersReturn, (string | OrdersQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query308.QueryFunction<GetOrdersReturn, (string | OrdersQueryOptions)[], never> | undefined;
} & {
