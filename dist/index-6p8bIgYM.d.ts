import { CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PriceFilter, PropertyFilter } from "./create-config-goz-zUX1.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-DUXjOUcP.js";
import { MarketCollectibleCardProps } from "./types-y4GXtQVw.js";
import * as _tanstack_react_query183 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query183.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query183.FetchNextPageOptions) => Promise<_tanstack_react_query183.InfiniteQueryObserverResult<_tanstack_react_query183.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query183.UseQueryResult<{
...
//# sourceMappingURL=index-6p8bIgYM.d.ts.map