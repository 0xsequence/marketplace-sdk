import { Ct as CheckoutOptionsMarketplaceReturn, G as SdkConfig, Tt as CheckoutOptionsSalesContractReturn, bt as CheckoutOptionsItem, j as ValuesOptional, qr as MarketplaceKind, wt as CheckoutOptionsSalesContractArgs, xt as CheckoutOptionsMarketplaceArgs } from "./create-config.js";
...
declare function checkoutOptionsQueryOptions(params: CheckoutOptionsQueryOptions): _tanstack_react_query410.OmitKeyof<_tanstack_react_query410.UseQueryOptions<CheckoutOptionsMarketplaceReturn, Error, CheckoutOptionsMarketplaceReturn, readonly ["checkouts", "options", {
  chainId: string;
  wallet: `0x${string}` | undefined;
  orders: {
    contractAddress: string;
  ...
  queryFn?: _tanstack_react_query410.QueryFunction<CheckoutOptionsMarketplaceReturn, readonly ["checkouts", "options", {
    chainId: string;
    wallet: `0x${string}` | undefined;
    orders: {
      contractAddress: string;
...
declare function checkoutOptionsSalesContractQueryOptions(params: CheckoutOptionsSalesContractQueryOptions): _tanstack_react_query410.OmitKeyof<_tanstack_react_query410.UseQueryOptions<CheckoutOptionsSalesContractReturn, Error, CheckoutOptionsSalesContractReturn, readonly ["checkouts", "options", "salesContract", {
  chainId: string;
  wallet: `0x${string}` | undefined;
  contractAddress: string | undefined;
  collectionAddress: string | undefined;
  ...
  queryFn?: _tanstack_react_query410.QueryFunction<CheckoutOptionsSalesContractReturn, readonly ["checkouts", "options", "salesContract", {
    chainId: string;
    wallet: `0x${string}` | undefined;
    contractAddress: string | undefined;
    collectionAddress: string | undefined;
