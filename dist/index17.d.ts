 ...
 * ```
 */
declare function useTokenBalances(params: UseListBalancesParams): _tanstack_react_query250.UseInfiniteQueryResult<_tanstack_react_query250.InfiniteData<GetTokenBalancesResponse, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useTokenMetadata(params: UseTokenMetadataParams): _tanstack_react_query250.UseQueryResult<TokenMetadata$1[], Error>;
//#endregion
...
declare function useTokenMetadataSearch(params: UseTokenMetadataSearchParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query250.FetchNextPageOptions) => Promise<_tanstack_react_query250.InfiniteQueryObserverResult<_tanstack_react_query250.InfiniteData<SearchTokenMetadataReturn$1, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query250.FetchPreviousPageOptions) => Promise<_tanstack_react_query250.InfiniteQueryObserverResult<_tanstack_react_query250.InfiniteData<SearchTokenMetadataReturn$1, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query250.RefetchOptions) => Promise<_tanstack_react_query250.QueryObserverResult<_tanstack_react_query250.InfiniteData<SearchTokenMetadataReturn$1, unknown>, Error>>;
  fetchStatus: _tanstack_react_query250.FetchStatus;
  promise: Promise<_tanstack_react_query250.InfiniteData<SearchTokenMetadataReturn$1, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
 ...
 * ```
 */
declare function useTokenRanges(params: UseTokenRangesParams): _tanstack_react_query250.UseQueryResult<GetTokenIDRangesResponse, Error>;
