 ...
 * ```
 */
declare function useTokenBalances(params: UseListBalancesParams): _tanstack_react_query231.UseInfiniteQueryResult<_tanstack_react_query231.InfiniteData<GetTokenBalancesResponse, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useTokenMetadata(params: UseTokenMetadataParams): _tanstack_react_query231.UseQueryResult<TokenMetadata$1[], Error>;
//#endregion
...
declare function useTokenMetadataSearch(params: UseTokenMetadataSearchParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query231.FetchNextPageOptions) => Promise<_tanstack_react_query231.InfiniteQueryObserverResult<_tanstack_react_query231.InfiniteData<SearchTokenMetadataReturn$1, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query231.FetchPreviousPageOptions) => Promise<_tanstack_react_query231.InfiniteQueryObserverResult<_tanstack_react_query231.InfiniteData<SearchTokenMetadataReturn$1, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query231.RefetchOptions) => Promise<_tanstack_react_query231.QueryObserverResult<_tanstack_react_query231.InfiniteData<SearchTokenMetadataReturn$1, unknown>, Error>>;
  fetchStatus: _tanstack_react_query231.FetchStatus;
  promise: Promise<_tanstack_react_query231.InfiniteData<SearchTokenMetadataReturn$1, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
 ...
 * ```
 */
declare function useTokenRanges(params: UseTokenRangesParams): _tanstack_react_query231.UseQueryResult<GetTokenIDRangesResponse, Error>;
