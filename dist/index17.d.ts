 ...
 * ```
 */
declare function useTokenBalances(params: UseListBalancesParams): _tanstack_react_query130.UseInfiniteQueryResult<_tanstack_react_query130.InfiniteData<GetTokenBalancesResponse, unknown>, Error>;
//#endregion
...
declare function useTokenMetadataSearch(params: UseTokenMetadataSearchParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query130.FetchNextPageOptions) => Promise<_tanstack_react_query130.InfiniteQueryObserverResult<_tanstack_react_query130.InfiniteData<SearchTokenMetadataReturn$1, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query130.FetchPreviousPageOptions) => Promise<_tanstack_react_query130.InfiniteQueryObserverResult<_tanstack_react_query130.InfiniteData<SearchTokenMetadataReturn$1, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query130.RefetchOptions) => Promise<_tanstack_react_query130.QueryObserverResult<_tanstack_react_query130.InfiniteData<SearchTokenMetadataReturn$1, unknown>, Error>>;
  fetchStatus: _tanstack_react_query130.FetchStatus;
  promise: Promise<_tanstack_react_query130.InfiniteData<SearchTokenMetadataReturn$1, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
  ...
  data: {
    ...
    page: _0xsequence_metadata19.Page;
  } | undefined;
  error: Error;
  isError: true;
  isPending: false;
  ...
  data: {
    tokenMetadata: TokenMetadata$1[];
    page: _0xsequence_metadata19.Page | undefined;
  } | undefined;
  isLoading: boolean;
  isFetching: boolean;
  error: Error | null;
