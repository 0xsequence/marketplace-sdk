import { ht as TokenMetadata$2, mt as SearchTokenMetadataReturn, pt as Page, vt as GetTokenBalancesResponse, yt as GetTokenIDRangesResponse } from "./index2.js";
import { G as Optional } from "./create-config.js";
 ...
 * ```
 */
declare function useTokenBalances(params: UseListBalancesParams): _tanstack_react_query237.UseInfiniteQueryResult<_tanstack_react_query237.InfiniteData<GetTokenBalancesResponse, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useTokenMetadata(params: UseTokenMetadataParams): _tanstack_react_query237.UseQueryResult<TokenMetadata$2[], Error>;
//#endregion
...
declare function useTokenMetadataSearch(params: UseTokenMetadataSearchParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query237.FetchNextPageOptions) => Promise<_tanstack_react_query237.InfiniteQueryObserverResult<_tanstack_react_query237.InfiniteData<SearchTokenMetadataReturn, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query237.FetchPreviousPageOptions) => Promise<_tanstack_react_query237.InfiniteQueryObserverResult<_tanstack_react_query237.InfiniteData<SearchTokenMetadataReturn, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query237.RefetchOptions) => Promise<_tanstack_react_query237.QueryObserverResult<_tanstack_react_query237.InfiniteData<SearchTokenMetadataReturn, unknown>, Error>>;
  fetchStatus: _tanstack_react_query237.FetchStatus;
  promise: Promise<_tanstack_react_query237.InfiniteData<SearchTokenMetadataReturn, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
 ...
 * ```
 */
declare function useTokenRanges(params: UseTokenRangesParams): _tanstack_react_query237.UseQueryResult<GetTokenIDRangesResponse, Error>;
