import { ContractType, Currency, Order } from "./create-config-rrEYvm6u.js";
...
declare const FooterName: ({
  ...
  quantityRemaining,
  balance
}: FooterNameProps) => react_jsx_runtime7.JSX.Element;
//#endregion
...
declare const SaleDetailsPill: ({
  ...
  collectionType,
  unlimitedSupply
}: SaleDetailsPillProps) => react_jsx_runtime9.JSX.Element;
//#endregion
...
declare const TokenTypeBalancePill: ({
  ...
  type,
  decimals
}: TokenTypeBalancePillProps) => react_jsx_runtime12.JSX.Element;
//#endregion
...
//# sourceMappingURL=index-Bntdhb1W.d.ts.map