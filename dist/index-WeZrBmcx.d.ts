import { Br as MarketplaceKind, Hi as WalletKind, Vt as ContractType, Xt as CreateReq, Y as SdkConfig, at as BuyModalProps, bn as GenerateSellTransactionArgs, bt as AdditionalFee, gn as GenerateListingTransactionArgs, l as TransactionType, mn as GenerateCancelTransactionArgs, ot as ModalCallbacks, vn as GenerateOfferTransactionArgs, yi as Step } from "./create-config-Dz-QylqB.js";
import * as _tanstack_react_query236 from "@tanstack/react-query";
...
declare function useBuyTransaction(modalProps: BuyModalProps): {
  ...
  error: Error | null;
  isError: boolean;
  refetch: (options?: _tanstack_react_query236.RefetchOptions) => Promise<_tanstack_react_query236.QueryObserverResult<Step[], Error>>;
};
//#endregion
...
declare const useGenerateCancelTransaction: (params: UseGenerateCancelTransactionArgs) => {
  generateCancelTransaction: _tanstack_react_query236.UseMutateFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  generateCancelTransactionAsync: _tanstack_react_query236.UseMutateAsyncFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateListingTransaction: (params: UseGenerateListingTransactionArgs) => {
  generateListingTransaction: _tanstack_react_query236.UseMutateFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateListingTransactionAsync: _tanstack_react_query236.UseMutateAsyncFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateOfferTransaction: (params: UseGenerateOfferTransactionArgs) => {
  generateOfferTransaction: _tanstack_react_query236.UseMutateFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateOfferTransactionAsync: _tanstack_react_query236.UseMutateAsyncFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateSellTransaction: (params: UseGenerateSellTransactionArgs) => {
  generateSellTransaction: _tanstack_react_query236.UseMutateFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateSellTransactionAsync: _tanstack_react_query236.UseMutateAsyncFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare function useMarketTransactionSteps({
  ...
  additionalFees,
  enabled
}: UseMarketTransactionStepsParams): _tanstack_react_query236.UseQueryResult<Step[], Error>;
//#endregion
...
declare function usePrimarySaleTransactionSteps({
  ...
  contractType,
  enabled
}: UsePrimarySaleTransactionStepsParams): _tanstack_react_query236.UseQueryResult<Step[], Error>;
//#endregion
...
//# sourceMappingURL=index-WeZrBmcx.d.ts.map