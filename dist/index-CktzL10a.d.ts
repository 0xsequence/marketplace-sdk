import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-DcoJTklJ.js";
import { FiltersQueryOptions } from "./filters-i3yXLoNe.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query9.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query9.RefetchOptions) => Promise<_tanstack_react_query9.QueryObserverResult<PropertyFilter[], Error>>;
...
//# sourceMappingURL=index-CktzL10a.d.ts.map