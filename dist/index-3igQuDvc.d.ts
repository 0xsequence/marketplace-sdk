import { At as ContractType, Bt as Currency, Yr as Order } from "./create-config-BO68TZC5.js";
...
declare function CardSaleDetails({
  ...
  unlimitedSupply,
  className
}: CardSaleDetailsProps): react_jsx_runtime2.JSX.Element;
//#endregion
...
declare function CardSkeleton({
  type,
  isShop
}: CardSkeletonProps): react_jsx_runtime2.JSX.Element;
//#endregion
...
//# sourceMappingURL=index-3igQuDvc.d.ts.map