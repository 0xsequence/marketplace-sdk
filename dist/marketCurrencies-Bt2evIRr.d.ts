import { Currency, CurrencyStatus, SdkConfig, ValuesOptional } from "./create-config-gz6zNqhE.js";
...
declare function currencyQueryOptions(params: CurrencyQueryOptions): _tanstack_react_query393.UseQueryOptions<Currency | undefined, Error, Currency | undefined, readonly ["currencies", "details", {
  chainId: string;
  currencyAddress: `0x${string}`;
}]> & {
  initialData?: Currency | _tanstack_react_query393.InitialDataFunction<Currency> | undefined;
} & {
...
declare function marketCurrenciesQueryOptions(params: MarketCurrenciesQueryOptions): _tanstack_react_query393.OmitKeyof<_tanstack_react_query393.UseQueryOptions<{
  contractAddress: string;
  chainId: number;
  status: CurrencyStatus;
  name: string;
  ...
  queryFn?: _tanstack_react_query393.QueryFunction<{
    contractAddress: string;
    chainId: number;
    status: CurrencyStatus;
    name: string;
...
//# sourceMappingURL=marketCurrencies-Bt2evIRr.d.ts.map