import { Yr as Order, w as Optional } from "./create-config-BO68TZC5.js";
import { n as FiltersQueryOptions } from "./filters-vtyWzhVe.js";
 ...
 */
declare function useCollectibleCardOfferState(highestOffer?: Order, balance?: string): CollectibleCardOfferState | null;
//#endregion
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query293.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query293.RefetchOptions) => Promise<_tanstack_react_query293.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query293.FetchStatus;
...
//# sourceMappingURL=index-CcW5iu33.d.ts.map