...
declare function useMakeOfferModalContext(): {
  ...
  error: Error | null;
  queries: {
    collectible: _tanstack_react_query53.UseQueryResult<TokenMetadata$1 | undefined, Error>;
    ...
    lowestListing: _tanstack_react_query53.UseQueryResult<Order | null, Error>;
  };
