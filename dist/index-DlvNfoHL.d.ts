import { CardType, Collection, CollectionFilterSettings, ContractType, ListCollectionActivitiesReturn, Optional, OrderbookKind, SdkConfig } from "./create-config-BpPJGqAC.js";
import { CollectionBalanceDetailsQueryOptions, CollectionBalanceFilter, CollectionDetailsQueryOptions, CollectionQueryOptions, ListCollectionActivitiesQueryOptions, ListCollectionsQueryOptions, fetchCollectionBalanceDetails$1 as fetchCollectionBalanceDetails, fetchListCollectionActivities$1 as fetchListCollectionActivities } from "./listCollections-Dtf99rMM.js";
...
import * as _tanstack_react_query91 from "@tanstack/react-query";
import * as _tanstack_react_query95 from "@tanstack/react-query";
import * as _tanstack_react_query96 from "@tanstack/react-query";
import * as _0xsequence_indexer0 from "@0xsequence/indexer";
import * as _0xsequence_metadata0 from "@0xsequence/metadata";
import * as _0xsequence_metadata1 from "@0xsequence/metadata";
 ...
 * ```
 */
declare function useCollection(params: UseCollectionParams): _tanstack_react_query88.UseQueryResult<_0xsequence_metadata0.ContractInfo, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query89.UseQueryResult<_0xsequence_indexer0.GetTokenBalancesDetailsReturn, Error>;
 ...
 * ```
 */
declare function useCollectionDetails(params: UseCollectionDetailsParams): _tanstack_react_query90.UseQueryResult<Collection, Error>;
//#endregion
...
declare const collectionDetailsPollingOptions: (args: UseCollectionDetailsPolling, config: SdkConfig) => _tanstack_react_query91.OmitKeyof<_tanstack_react_query91.UseQueryOptions<Collection, Error, Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query91.QueryFunction<Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[], never> | undefined;
} & {
...
declare const useCollectionDetailsPolling: (args: UseCollectionDetailsPolling) => _tanstack_react_query91.UseQueryResult<Collection, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectionActivities(params: UseListCollectionActivitiesParams): _tanstack_react_query95.UseQueryResult<ListCollectionActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollections(params?: UseListCollectionsParams): _tanstack_react_query96.UseQueryResult<({
  chainId: number;
  address: string;
  source: string;
  name: string;
  ...
  deployed: boolean;
  bytecodeHash: string;
  extensions: _0xsequence_metadata1.ContractInfoExtensions;
  updatedAt: string;
  queuedAt?: string;
  status: _0xsequence_metadata1.ResourceStatus;
  cardType: CardType;
...
//#endregion
export { UseCollectionBalanceDetailsArgs, UseCollectionBalanceDetailsParams, UseCollectionBalanceDetailsReturn, UseCollectionDetailsParams, UseCollectionParams, UseListCollectionActivitiesArgs, UseListCollectionActivitiesParams, UseListCollectionActivitiesReturn, UseListCollectionsParams, collectionDetailsPollingOptions as collectionDetailsPollingOptions$1, useCollection as useCollection$1, useCollectionBalanceDetails as useCollectionBalanceDetails$1, useCollectionDetails as useCollectionDetails$1, useCollectionDetailsPolling as useCollectionDetailsPolling$1, useListCollectionActivities as useListCollectionActivities$1, useListCollections as useListCollections$1 };
//# sourceMappingURL=index-DlvNfoHL.d.ts.map