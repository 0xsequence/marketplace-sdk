import { j as Optional } from "./create-config-BA_ne-vj.js";
import { S as fetchGetTokenRanges, f as ListTokenMetadataQueryOptions, g as UseListBalancesArgs, n as TokenSuppliesQueryOptions, s as SearchTokenMetadataQueryOptions, x as GetTokenRangesQueryOptions } from "./tokenSupplies-6f6EH5_N.js";
 ...
 * ```
 */
declare function useGetTokenRanges(params: UseGetTokenRangesParams): _tanstack_react_query205.UseQueryResult<_0xsequence_indexer0.GetTokenIDRangesReturn, Error>;
 ...
 * ```
 */
declare function useListBalances(args: UseListBalancesArgs): _tanstack_react_query205.UseInfiniteQueryResult<_tanstack_react_query205.InfiniteData<_0xsequence_indexer0.GetTokenBalancesReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useListTokenMetadata(params: UseListTokenMetadataParams): _tanstack_react_query205.UseQueryResult<_0xsequence_metadata53.TokenMetadata[], Error>;
//#endregion
...
declare function useSearchTokenMetadata(params: UseSearchTokenMetadataParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query205.FetchNextPageOptions) => Promise<_tanstack_react_query205.InfiniteQueryObserverResult<_tanstack_react_query205.InfiniteData<_0xsequence_metadata53.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query205.FetchPreviousPageOptions) => Promise<_tanstack_react_query205.InfiniteQueryObserverResult<_tanstack_react_query205.InfiniteData<_0xsequence_metadata53.SearchTokenMetadataReturn, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query205.RefetchOptions) => Promise<_tanstack_react_query205.QueryObserverResult<_tanstack_react_query205.InfiniteData<_0xsequence_metadata53.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchStatus: _tanstack_react_query205.FetchStatus;
  promise: Promise<_tanstack_react_query205.InfiniteData<_0xsequence_metadata53.SearchTokenMetadataReturn, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata53.TokenMetadata[];
    page: _0xsequence_metadata53.Page;
  } | undefined;
  error: Error;
  isError: true;
  isPending: false;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata53.TokenMetadata[];
    page: _0xsequence_metadata53.Page | undefined;
  } | undefined;
  isLoading: boolean;
  isFetching: boolean;
  error: Error | null;
 ...
 * ```
 */
declare function useTokenSupplies(params: UseTokenSuppliesParams): _tanstack_react_query205.UseInfiniteQueryResult<_tanstack_react_query205.InfiniteData<_0xsequence_indexer0.GetTokenSuppliesReturn, unknown>, Error>;
//#endregion
...
//# sourceMappingURL=index-CIe91-3g.d.ts.map