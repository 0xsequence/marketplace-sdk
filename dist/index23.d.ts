...
declare const ModalProvider: ({
  children
}: ModalProviderProps) => react_jsx_runtime57.JSX.Element;
//#endregion
...
declare function MarketCardPresentation({
  ...
  classNames
}: MarketCardPresentationProps): react_jsx_runtime57.JSX.Element;
//#endregion
...
declare function ShopCardPresentation({
  ...
  hideQuantitySelector,
  classNames
}: ShopCardPresentationProps): react_jsx_runtime57.JSX.Element;
//#endregion
...
declare function Media({
  ...
  fallbackContent,
  shouldListenForLoad
}: MediaProps): react_jsx_runtime57.JSX.Element;
//#endregion
...
declare const TransferModal: () => react_jsx_runtime57.JSX.Element | null;
//#endregion
