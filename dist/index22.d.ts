...
declare const useEnsureCorrectChain: () => {
  ...
  ensureCorrectChainAsync: (targetChainId: number) => Promise<void | {
    ...
    verifyHash?: ((client: viem30.Client, parameters: viem30.VerifyHashActionParameters) => Promise<viem30.VerifyHashActionReturnType>) | undefined;
  }>;
...
declare function royaltyQueryOptions(params: FetchRoyaltyParams, query?: UseRoyaltyArgs['query']): _tanstack_react_query359.OmitKeyof<_tanstack_react_query359.UseQueryOptions<RoyaltyInfo | null, Error, RoyaltyInfo | null, readonly ["royalty-percentage", {
  chainId: string;
  contractAddress: `0x${string}`;
  tokenId: bigint;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query359.QueryFunction<RoyaltyInfo | null, readonly ["royalty-percentage", {
    chainId: string;
    contractAddress: `0x${string}`;
    tokenId: bigint;
  }], never> | undefined;
 ...
 * ```
 */
declare function useRoyalty(args: UseRoyaltyArgs): _tanstack_react_query359.UseQueryResult<RoyaltyInfo | null, Error>;
//#endregion
