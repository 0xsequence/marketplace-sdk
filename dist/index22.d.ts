import { G as Optional, Ht as Currency } from "./create-config.js";
import { _ as ComparePricesQueryOptions, d as ConvertPriceToUSDQueryOptions, f as ConvertPriceToUSDReturn, n as MarketCurrenciesQueryOptions, o as CurrencyQueryOptions, v as ComparePricesReturn } from "./index27.js";
 ...
 * ```
 */
declare function useCurrencyComparePrices(params: UseCurrencyComparePricesParams): _tanstack_react_query331.UseQueryResult<ComparePricesReturn, Error>;
 ...
 * ```
 */
declare function useCurrencyConvertToUSD(params: UseCurrencyConvertToUSDParams): _tanstack_react_query331.UseQueryResult<ConvertPriceToUSDReturn, Error>;
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query331.UseQueryResult<Currency | undefined, Error>;
//#endregion
 ...
 * ```
 */
declare function useCurrencyList(params: UseCurrencyListParams): _tanstack_react_query331.UseQueryResult<Currency[], Error>;
//#endregion
