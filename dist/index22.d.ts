...
declare function royaltyQueryOptions(params: FetchRoyaltyParams, query?: UseRoyaltyArgs['query']): _tanstack_react_query177.OmitKeyof<_tanstack_react_query177.UseQueryOptions<RoyaltyInfo | null, Error, RoyaltyInfo | null, readonly ["royalty-percentage", {
  chainId: string;
  contractAddress: `0x${string}`;
  tokenId: bigint;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query177.QueryFunction<RoyaltyInfo | null, readonly ["royalty-percentage", {
    chainId: string;
    contractAddress: `0x${string}`;
    tokenId: bigint;
  }], never> | undefined;
 ...
 * ```
 */
declare function useRoyalty(args: UseRoyaltyArgs): _tanstack_react_query177.UseQueryResult<RoyaltyInfo | null, Error>;
//#endregion
