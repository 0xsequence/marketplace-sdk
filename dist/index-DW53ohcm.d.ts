...
declare function comparePricesQueryOptions(params: ComparePricesQueryOptions): _tanstack_react_query233.OmitKeyof<_tanstack_react_query233.UseQueryOptions<ComparePricesReturn, Error, ComparePricesReturn, readonly ["currencies", "conversion", "compare", {
  chainId: number;
  priceAmountRaw: string;
  priceCurrencyAddress: `0x${string}`;
  compareToPriceAmountRaw: string;
  ...
  queryFn?: _tanstack_react_query233.QueryFunction<ComparePricesReturn, readonly ["currencies", "conversion", "compare", {
    chainId: number;
    priceAmountRaw: string;
    priceCurrencyAddress: `0x${string}`;
    compareToPriceAmountRaw: string;
...
declare function convertPriceToUSDQueryOptions(params: ConvertPriceToUSDQueryOptions): _tanstack_react_query233.OmitKeyof<_tanstack_react_query233.UseQueryOptions<ConvertPriceToUSDReturn, Error, ConvertPriceToUSDReturn, readonly ["currencies", "conversion", "usd", {
  chainId: number;
  currencyAddress: `0x${string}`;
  amountRaw: string;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query233.QueryFunction<ConvertPriceToUSDReturn, readonly ["currencies", "conversion", "usd", {
    chainId: number;
    currencyAddress: `0x${string}`;
    amountRaw: string;
  }], never> | undefined;
...
//# sourceMappingURL=index-DW53ohcm.d.ts.map