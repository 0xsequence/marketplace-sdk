import { Optional, PriceFilter, PropertyFilter, PropertyType } from "./create-config-BpPJGqAC.js";
import { FiltersQueryOptions } from "./filters-DxYaUjJZ.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query36.UseQueryResult<PropertyFilter$1[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query36.RefetchOptions) => Promise<_tanstack_react_query36.QueryObserverResult<PropertyFilter$1[], Error>>;
...
//#endregion
export { UseFilterReturn, UseFiltersArgs, UseFiltersParams, useFilterState as useFilterState$1, useFilters as useFilters$1, useFiltersProgressive as useFiltersProgressive$1, useOpenConnectModal as useOpenConnectModal$1 };
//# sourceMappingURL=index-C7GRJ-Zz.d.ts.map