import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-BJwAgEA2.js";
import { FiltersQueryOptions } from "./filters-DNqMwR1I.js";
import * as _tanstack_react_query150 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query150.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query150.RefetchOptions) => Promise<_tanstack_react_query150.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query150.FetchStatus;
...
//# sourceMappingURL=index-xkT23Uwa.d.ts.map