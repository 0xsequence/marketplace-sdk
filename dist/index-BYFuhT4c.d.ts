import { Optional, PriceFilter, PropertyFilter, PropertyType } from "./create-config-rrEYvm6u.js";
import { FiltersQueryOptions } from "./filters-Ch0i9_pG.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query259.UseQueryResult<PropertyFilter$1[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query259.RefetchOptions) => Promise<_tanstack_react_query259.QueryObserverResult<PropertyFilter$1[], Error>>;
  fetchStatus: _tanstack_react_query259.FetchStatus;
...
//# sourceMappingURL=index-BYFuhT4c.d.ts.map