...
declare class CollectableKeys {
  ...
  static listPrimarySaleItems: readonly ["collectable", "listPrimarySaleItems"];
...
declare class BalanceQueries {
  ...
  static inventory: readonly ["balances", "inventory"];
}
...
declare const marketplaceConfigOptions: (config: SdkConfig) => _tanstack_react_query20.OmitKeyof<_tanstack_react_query20.UseQueryOptions<MarketplaceConfig, Error, MarketplaceConfig, ("configs" | "marketplace")[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query20.QueryFunction<MarketplaceConfig, ("configs" | "marketplace")[], never> | undefined;
} & {
