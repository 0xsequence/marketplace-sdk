import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-Cvi1W2a1.js";
import { FiltersQueryOptions } from "./filters-DVoYRiYa.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query28.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query28.RefetchOptions) => Promise<_tanstack_react_query28.QueryObserverResult<PropertyFilter[], Error>>;
...
//# sourceMappingURL=index-B85Dcgij.d.ts.map