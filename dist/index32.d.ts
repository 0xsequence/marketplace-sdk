import { Cn as Order, Ht as Currency, Jn as ContractType, g as CollectibleCardAction, h as CardType, wr as OrderbookKind } from "./create-config.js";
...
declare const ModalProvider: ({
  children
}: ModalProviderProps) => react_jsx_runtime54.JSX.Element;
//#endregion
...
declare function MarketCardPresentation({
  ...
  classNames
}: MarketCardPresentationProps): react_jsx_runtime54.JSX.Element;
//#endregion
...
declare function ShopCardPresentation({
  ...
  hideQuantitySelector,
  classNames
}: ShopCardPresentationProps): react_jsx_runtime54.JSX.Element;
//#endregion
...
declare function Media({
  ...
  fallbackContent,
  shouldListenForLoad
}: MediaProps): react_jsx_runtime54.JSX.Element;
//#endregion
