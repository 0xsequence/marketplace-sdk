import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-BVC8_JNU.js";
import { FiltersQueryOptions } from "./filters-DxtmebjP.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query134.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query134.RefetchOptions) => Promise<_tanstack_react_query134.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query134.FetchStatus;
...
//# sourceMappingURL=index-DRBN9swi.d.ts.map