import { Bn as SearchTokenMetadataReturn, Er as Page, J as SdkInfiniteQueryParams, Mn as index_d_exports$1, Rn as Filter, Vn as TokenMetadata$1, Y as SdkQueryParams, lt as WithOptionalParams, tt as WithRequired } from "./create-config.js";
 ...
 */
declare function listBalancesOptions(params: ListBalancesQueryOptions): _tanstack_react_query4.OmitKeyof<_tanstack_react_query4.UseInfiniteQueryOptions<index_d_exports$1.GetTokenBalancesResponse, Error, _tanstack_react_query4.InfiniteData<index_d_exports$1.GetTokenBalancesResponse, unknown>, readonly ["token", string, {
  chainId: number | undefined;
  accountAddress: `0x${string}` | undefined;
  contractAddress: `0x${string}` | undefined;
  tokenId: bigint | undefined;
  ...
  queryFn?: _tanstack_react_query4.QueryFunction<index_d_exports$1.GetTokenBalancesResponse, readonly ["token", string, {
    chainId: number | undefined;
    accountAddress: `0x${string}` | undefined;
    contractAddress: `0x${string}` | undefined;
    tokenId: bigint | undefined;
  ...
  queryKey: readonly ["token", string, {
    ...
    [dataTagSymbol]: _tanstack_react_query4.InfiniteData<index_d_exports$1.GetTokenBalancesResponse, unknown>;
...
declare function listTokenMetadataQueryOptions(params: WithOptionalParams<WithRequired<ListTokenMetadataQueryOptions, 'chainId' | 'contractAddress' | 'tokenIds' | 'config'>>): _tanstack_react_query4.OmitKeyof<_tanstack_react_query4.UseQueryOptions<TokenMetadata$1[], Error, TokenMetadata$1[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query4.QueryFunction<TokenMetadata$1[], readonly unknown[], never> | undefined;
} & {
...
declare function searchTokenMetadataQueryOptions(params: SearchTokenMetadataQueryOptions): _tanstack_react_query4.OmitKeyof<_tanstack_react_query4.UseInfiniteQueryOptions<SearchTokenMetadataReturn, Error, _tanstack_react_query4.InfiniteData<SearchTokenMetadataReturn, unknown>, readonly ["token", string, {
  chainId: number;
  collectionAddress: string;
  filter: Filter | undefined;
}], {
  ...
  queryFn?: _tanstack_react_query4.QueryFunction<SearchTokenMetadataReturn, readonly ["token", string, {
    chainId: number;
    collectionAddress: string;
    filter: Filter | undefined;
  }], {
  ...
  queryKey: readonly ["token", string, {
    ...
    [dataTagSymbol]: _tanstack_react_query4.InfiniteData<SearchTokenMetadataReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function getTokenRangesQueryOptions(params: WithOptionalParams<WithRequired<GetTokenRangesQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query4.OmitKeyof<_tanstack_react_query4.UseQueryOptions<index_d_exports$1.GetTokenIDRangesResponse, Error, index_d_exports$1.GetTokenIDRangesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query4.QueryFunction<index_d_exports$1.GetTokenIDRangesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
