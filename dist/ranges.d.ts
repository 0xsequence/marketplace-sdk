...
import * as _0xsequence_metadata19 from "@0xsequence/metadata";
 ...
 */
declare function listBalancesOptions(params: WithOptionalInfiniteParams<WithRequired<ListBalancesQueryOptions, 'chainId' | 'accountAddress' | 'config'>>): _tanstack_react_query94.OmitKeyof<_tanstack_react_query94.UseInfiniteQueryOptions<GetTokenBalancesResponse, Error, _tanstack_react_query94.InfiniteData<GetTokenBalancesResponse, unknown>, readonly unknown[], Page$2>, "queryFn"> & {
  queryFn?: _tanstack_react_query94.QueryFunction<GetTokenBalancesResponse, readonly unknown[], Page$2> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _tanstack_react_query94.InfiniteData<GetTokenBalancesResponse, unknown>;
...
declare function listTokenMetadataQueryOptions(params: WithOptionalParams<WithRequired<ListTokenMetadataQueryOptions, 'chainId' | 'contractAddress' | 'tokenIds' | 'config'>>): _tanstack_react_query94.OmitKeyof<_tanstack_react_query94.UseQueryOptions<TokenMetadata$1[], Error, TokenMetadata$1[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query94.QueryFunction<TokenMetadata$1[], readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function getSearchTokenMetadataQueryKey(params: SearchTokenMetadataQueryOptions): readonly ["token", string, {
  ...
  filter: _0xsequence_metadata19.Filter | undefined;
}];
declare function searchTokenMetadataQueryOptions(params: SearchTokenMetadataQueryOptions): _tanstack_react_query94.OmitKeyof<_tanstack_react_query94.UseInfiniteQueryOptions<SearchTokenMetadataReturn$1, Error, _tanstack_react_query94.InfiniteData<SearchTokenMetadataReturn$1, unknown>, readonly ["token", string, {
  chainId: number;
  collectionAddress: string;
  filter: _0xsequence_metadata19.Filter | undefined;
}], {
  ...
  queryFn?: _tanstack_react_query94.QueryFunction<SearchTokenMetadataReturn$1, readonly ["token", string, {
    chainId: number;
    collectionAddress: string;
    filter: _0xsequence_metadata19.Filter | undefined;
  }], {
  ...
  queryKey: readonly ["token", string, {
    ...
    [dataTagSymbol]: _tanstack_react_query94.InfiniteData<SearchTokenMetadataReturn$1, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function getTokenRangesQueryOptions(params: WithOptionalParams<WithRequired<GetTokenRangesQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query94.OmitKeyof<_tanstack_react_query94.UseQueryOptions<GetTokenIDRangesResponse, Error, GetTokenIDRangesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query94.QueryFunction<GetTokenIDRangesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
