import { Dn as WithRequired, bn as SdkInfiniteQueryParams, xn as SdkQueryParams } from "./create-config.js";
 ...
 */
declare function listBalancesOptions(params: ListBalancesQueryOptions): _tanstack_react_query71.OmitKeyof<_tanstack_react_query71.UseInfiniteQueryOptions<Indexer.GetTokenBalancesResponse, Error, _tanstack_react_query71.InfiniteData<Indexer.GetTokenBalancesResponse, unknown>, readonly ["token", string, {
  chainId: number | undefined;
  accountAddress: `0x${string}` | undefined;
  contractAddress: `0x${string}` | undefined;
  tokenId: bigint | undefined;
  ...
  queryFn?: _tanstack_react_query71.QueryFunction<Indexer.GetTokenBalancesResponse, readonly ["token", string, {
    chainId: number | undefined;
    accountAddress: `0x${string}` | undefined;
    contractAddress: `0x${string}` | undefined;
    tokenId: bigint | undefined;
  ...
  queryKey: readonly ["token", string, {
    ...
    [dataTagSymbol]: _tanstack_react_query71.InfiniteData<Indexer.GetTokenBalancesResponse, unknown>;
...
declare function listTokenMetadataQueryOptions(params: ListTokenMetadataQueryOptions): _tanstack_react_query71.OmitKeyof<_tanstack_react_query71.UseQueryOptions<_0xsequence_api_client28.TokenMetadata[], Error, _0xsequence_api_client28.TokenMetadata[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query71.QueryFunction<_0xsequence_api_client28.TokenMetadata[], readonly unknown[], never> | undefined;
} & {
...
declare function searchTokenMetadataQueryOptions(params: SearchTokenMetadataQueryOptions): _tanstack_react_query71.OmitKeyof<_tanstack_react_query71.UseInfiniteQueryOptions<SearchTokenMetadataReturn, Error, _tanstack_react_query71.InfiniteData<SearchTokenMetadataReturn, unknown>, readonly ["token", string, {
  chainId: number;
  collectionAddress: string;
  filter: Filter | undefined;
}], {
  ...
  queryFn?: _tanstack_react_query71.QueryFunction<SearchTokenMetadataReturn, readonly ["token", string, {
    chainId: number;
    collectionAddress: string;
    filter: Filter | undefined;
  }], {
  ...
  queryKey: readonly ["token", string, {
    ...
    [dataTagSymbol]: _tanstack_react_query71.InfiniteData<SearchTokenMetadataReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function getTokenRangesQueryOptions(params: GetTokenRangesQueryOptions): _tanstack_react_query71.OmitKeyof<_tanstack_react_query71.UseQueryOptions<Indexer.GetTokenIDRangesResponse, Error, Indexer.GetTokenIDRangesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query71.QueryFunction<Indexer.GetTokenIDRangesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
