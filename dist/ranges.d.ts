 ...
 */
declare function listBalancesOptions(params: WithOptionalInfiniteParams<WithRequired<ListBalancesQueryOptions, 'chainId' | 'accountAddress' | 'config'>>): _tanstack_react_query63.OmitKeyof<_tanstack_react_query63.UseInfiniteQueryOptions<GetTokenBalancesResponse, Error, _tanstack_react_query63.InfiniteData<GetTokenBalancesResponse, unknown>, readonly unknown[], Page$2>, "queryFn"> & {
  queryFn?: _tanstack_react_query63.QueryFunction<GetTokenBalancesResponse, readonly unknown[], Page$2> | undefined;
} & {
  queryKey: readonly unknown[] & {
    [dataTagSymbol]: _tanstack_react_query63.InfiniteData<GetTokenBalancesResponse, unknown>;
...
declare function searchTokenMetadataQueryOptions(params: SearchTokenMetadataQueryOptions): _tanstack_react_query63.OmitKeyof<_tanstack_react_query63.UseInfiniteQueryOptions<SearchTokenMetadataReturn$1, Error, _tanstack_react_query63.InfiniteData<SearchTokenMetadataReturn$1, unknown>, readonly ["token", string, {
  chainId: number;
  collectionAddress: string;
  filter: _0xsequence_metadata0.Filter | undefined;
}], {
  ...
  queryFn?: _tanstack_react_query63.QueryFunction<SearchTokenMetadataReturn$1, readonly ["token", string, {
    chainId: number;
    collectionAddress: string;
    filter: _0xsequence_metadata0.Filter | undefined;
  }], {
  ...
  queryKey: readonly ["token", string, {
    ...
    [dataTagSymbol]: _tanstack_react_query63.InfiniteData<SearchTokenMetadataReturn$1, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function getTokenRangesQueryOptions(params: WithOptionalParams<WithRequired<GetTokenRangesQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query63.OmitKeyof<_tanstack_react_query63.UseQueryOptions<GetTokenIDRangesResponse, Error, GetTokenIDRangesResponse, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query63.QueryFunction<GetTokenIDRangesResponse, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
