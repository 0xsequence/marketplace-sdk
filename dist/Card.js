...
import { d as cn$1, f as compareAddress } from "./utils.js";
...
const CardFooter = forwardRef(({ children, show = true, className, ...props }, ref) => {
	...
	return /* @__PURE__ */ jsx("div", {
		ref,
		className: cn$1("absolute -bottom-16 flex w-full origin-bottom items-center justify-center bg-overlay-light p-2 backdrop-blur transition-transform duration-200 ease-in-out group-hover:translate-y-[-64px]", className ?? ""),
		...props,
		children
	});
});
...
const PriceDisplay = ({ amount, currency, showCurrencyIcon = true, className }) => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		}), isFree ? /* @__PURE__ */ jsx(Text, {
			className: "font-bold text-sm text-text-100",
			children: "Free"
		}) : amount !== void 0 && currency !== void 0 ? formatPrice(amount, currency, className) : null]
	});
};

//#endregion
//#region src/react/ui/components/marketplace-collectible-card/Card/card-price.tsx
const CardPrice = forwardRef(({ amount, currency, showCurrencyIcon = true, type, className, ...props }, ref) => {
	if (type === "market" && (!amount || !currency)) return /* @__PURE__ */ jsx("div", {
		ref,
		...props,
		children: /* @__PURE__ */ jsx(Text, {
...
const CardTitle = forwardRef(({ children, className, as: Comp = "h3", highestOffer, onOfferClick, balance, maxLength, ...props }, ref) => {
	...
	const name = typeof children === "string" ? children : typeof children === "number" ? String(children) : "";
