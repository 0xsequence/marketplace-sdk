...
import { balanceQueries, collectableKeys, getMarketplaceClient, getQueryClient, getSequenceApiClient, marketplaceApiURL } from "./api-B7vWX1bJ.js";
import { CollectionStatus, ContractType, ExecuteType, OfferType, OrderSide, OrderbookKind, PropertyType, StepType, WalletKind } from "./marketplace.gen-DwVxJ4kk.js";
...
import { calculateEarningsAfterFees, calculateTotalOfferCost, cn as cn$1, compareAddress, formatPriceWithFee, truncateMiddle, validateOpenseaOfferDecimals } from "./utils-CKn03Ijp.js";
...
import { balanceOfCollectibleOptions, collectibleQueryOptions, countOfCollectablesQueryOptions, listCollectibleActivitiesQueryOptions, listCollectiblesPaginatedQueryOptions, listCollectiblesQueryOptions } from "./collectibles-DCOZz90g.js";
...
import { inventoryOptions } from "./inventory-D0gC9S74.js";
import { countOfPrimarySaleItemsOptions, listPrimarySaleItemsQueryOptions, primarySaleItemsCountQueryOptions } from "./primary-sales-COL_9DR5.js";
import { getTokenRangesQueryOptions, listBalancesOptions, listTokenMetadataQueryOptions, searchTokenMetadataQueryOptions, tokenSuppliesQueryOptions } from "./tokens-BVBs0bQB.js";
import { comparePricesQueryOptions, convertPriceToUSDQueryOptions } from "./utils-CVwc7_Lk.js";
import { waitForTransactionReceipt } from "./waitForTransactionReceipt-TI_KtY7V.js";
import { CalendarIcon_default, CartIcon_default, InfoIcon_default } from "./CartIcon-BTmOoZLo.js";
import { FooterName, PriceDisplay, SaleDetailsPill, TokenTypeBalancePill } from "./components-BUf-vw9t.js";
...
const useLoadData = () => {
	...
	return {
		...
		isError: collectionError || collectableError || currencyError || marketplaceCheckoutOptionsError || salesContractCheckoutOptionsError
	};
};
...
const BuyModalRouter = () => {
	...
	const isShop = isShopProps(modalProps);
	const onError = useOnError();
	const { collection, collectable, address, isLoading, order, checkoutOptions, currency, shopData, isError } = useLoadData();
...
function PriceInput({ chainId, collectionAddress, price, onPriceChange, onCurrencyChange, checkBalance, secondCurrencyAsDefault, includeNativeCurrency, disabled, orderbookKind, setOpenseaLowestPriceCriteriaMet, modalType, feeData }) {
	...
	const getRoyaltyFeeAmount = () => {
		...
		const royaltyFeeAmount = BigInt(priceAmountRaw) * BigInt(Math.round(feeData.royaltyPercentage * 100)) / BigInt(1e4);
...
//# sourceMappingURL=react-B2dNrFIk.js.map