import { $ as SdkConfig, $r as ListPrimarySaleItemsReturn, Gt as ContractType, It as CollectiblePrimarySaleItem, Ki as TokenMetadata$1, M as QueryArg, Nt as CheckoutOptionsSalesContractReturn, Ot as CheckoutOptionsItem, Q as MarketplaceSdkContext, bi as PrimarySaleItem, ir as GetCountOfPrimarySaleItemsReturn, j as Optional } from "./create-config-CrbgqkBr.js";
import { n as UseInventoryArgs, t as CollectiblesResponse } from "./index-DWkdkymr.js";
import { i as fetchCheckoutOptionsSalesContract, t as CheckoutOptionsSalesContractQueryOptions } from "./index-vHGrEOOz.js";
import { f as PrimarySaleItemQueryOptions, g as UseCountOfPrimarySaleItemsArgs, s as ListPrimarySaleItemsQueryOptions } from "./index-L55w_Fen.js";
import { c as ComparePricesReturn, n as ConvertPriceToUSDReturn, s as ComparePricesQueryOptions, t as ConvertPriceToUSDQueryOptions } from "./index-CYC2IFDp.js";
...
import * as viem35 from "viem";
import { Address, Hex } from "viem";

//#region src/react/hooks/data/primary-sales/useCountOfPrimarySaleItems.d.ts
declare function useCountOfPrimarySaleItems(args: UseCountOfPrimarySaleItemsArgs): _tanstack_react_query80.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useGetCountOfPrimarySaleItems(params: UseGetCountParams): _tanstack_react_query80.UseQueryResult<GetCountOfPrimarySaleItemsReturn, Error>;
//#endregion
...
declare function useList721ShopCardData({
  ...
  saleDetailsError: viem35.ReadContractErrorType | null;
  saleDetails: {
    supplyCap: bigint;
    cost: bigint;
    paymentToken: `0x${string}`;
  ...
  isLoading: boolean;
  tokenSuppliesData: _tanstack_react_query80.InfiniteData<_0xsequence_indexer0.GetTokenSuppliesReturn, unknown> | undefined;
};
//#endregion
...
declare function useInventory(args: UseInventoryArgs): _tanstack_react_query80.UseQueryResult<CollectiblesResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCheckoutOptionsSalesContract(params: UseCheckoutOptionsSalesContractParams | typeof skipToken): _tanstack_react_query80.UseQueryResult<CheckoutOptionsSalesContractReturn, Error>;
 ...
 * ```
 */
declare function useComparePrices(params: UseComparePricesParams): _tanstack_react_query80.UseQueryResult<ComparePricesReturn, Error>;
 ...
 * ```
 */
declare function useConvertPriceToUSD(params: UseConvertPriceToUSDParams): _tanstack_react_query80.UseQueryResult<ConvertPriceToUSDReturn, Error>;
...
declare const useEnsureCorrectChain: () => {
  ...
  ensureCorrectChainAsync: (targetChainId: number) => Promise<void | {
    ...
    contracts?: {
      [x: string]: viem35.ChainContract | {
        [sourceId: number]: viem35.ChainContract | undefined;
      } | undefined;
      ensRegistry?: viem35.ChainContract | undefined;
      ensUniversalResolver?: viem35.ChainContract | undefined;
      multicall3?: viem35.ChainContract | undefined;
      erc6492Verifier?: viem35.ChainContract | undefined;
    } | undefined;
    ...
    fees?: viem35.ChainFees<viem35.ChainFormatters | undefined> | undefined;
    formatters?: viem35.ChainFormatters | undefined;
    serializers?: viem35.ChainSerializers<viem35.ChainFormatters | undefined, viem35.TransactionSerializable> | undefined;
  }>;
...
declare const useGetReceiptFromHash: () => {
  waitForReceipt: (transactionHash: Hex) => Promise<viem35.TransactionReceipt>;
};
//#endregion
...
declare function useRoyalty(args: UseRoyaltyArgs): {
  ...
  error: viem35.ReadContractErrorType;
  isError: true;
  isPending: false;
  isLoading: false;
  ...
  failureCount: number;
  failureReason: viem35.ReadContractErrorType | null;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query80.RefetchOptions) => Promise<_tanstack_react_query80.QueryObserverResult<readonly [`0x${string}`, bigint], viem35.ReadContractErrorType>>;
  fetchStatus: _tanstack_react_query80.FetchStatus;
  promise: Promise<readonly [`0x${string}`, bigint]>;
  queryKey: _tanstack_react_query80.QueryKey;
} | {
  data: {
    percentage: bigint;
    recipient: Address;
...
declare function MarketplaceProvider({
  ...
  children,
  openConnectModal
}: MarketplaceSdkProviderProps): react_jsx_runtime25.JSX.Element;
 ...
 * ```
 */
declare function useListPrimarySaleItems(params: UseListPrimarySaleItemsParams): _tanstack_react_query80.UseInfiniteQueryResult<_tanstack_react_query80.InfiniteData<ListPrimarySaleItemsReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function usePrimarySaleItem(params: UsePrimarySaleItemParams): _tanstack_react_query80.UseQueryResult<CollectiblePrimarySaleItem, Error>;
//#endregion
...
//# sourceMappingURL=index-DowA7FY5.d.ts.map