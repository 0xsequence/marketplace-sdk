import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-BQet0plq.js";
import { FiltersQueryOptions } from "./filters-CntAimzg.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query156.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query156.RefetchOptions) => Promise<_tanstack_react_query156.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query156.FetchStatus;
...
//# sourceMappingURL=index-B_JB6fbK.d.ts.map