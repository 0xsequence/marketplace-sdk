...
function toTransactionReceipt(raw) {
	...
	if (raw.from?.startsWith("0x") && raw.from.length === 42) result.from = normalizeAddress(raw.from);
	if (raw.to?.startsWith("0x") && raw.to.length === 42) result.to = normalizeAddress(raw.to);
	return result;
}
...
//#endregion
export { FilterCondition as C, WalletKind as S, MarketplaceWalletType as T, PropertyType as _, builder_exports as a, TransactionCrypto as b, CollectionStatus as c, MarketplaceKind as d, MetadataStatus as f, OrderbookKind as g, OrderStatus as h, MetadataClient as i, CurrencyStatus as l, OrderSide as m, IndexerClient as n, isSignatureStep as o, OfferType as p, MarketplaceClient as r, isTransactionStep as s, ContractType$1 as t, ExecuteType as u, SortOrder as v, MarketplaceService as w, TransactionOnRampProvider as x, StepType as y };
