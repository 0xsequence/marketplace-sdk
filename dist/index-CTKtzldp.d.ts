import { CheckoutOptionsItem, CheckoutOptionsMarketplaceReturn, CheckoutOptionsSalesContractReturn, CollectiblePrimarySaleItem, ContractType, GetCountOfPrimarySaleItemsReturn, ListPrimarySaleItemsReturn, MarketplaceKind, MarketplaceSdkContext, Optional, PrimarySaleItem, QueryArg, SdkConfig, TokenMetadata as TokenMetadata$1 } from "./create-config-DrQDberp.js";
import { CollectiblesResponse, UseInventoryArgs } from "./index-DCoWq1FM.js";
import { CheckoutOptionsQueryOptions, CheckoutOptionsSalesContractQueryOptions, fetchCheckoutOptions, fetchCheckoutOptionsSalesContract } from "./index-DFKd7RDc.js";
import { ListPrimarySaleItemsQueryOptions, UseCountOfPrimarySaleItemsArgs } from "./index-B7sMtFsk.js";
import { ComparePricesQueryOptions, ComparePricesReturn, ConvertPriceToUSDQueryOptions, ConvertPriceToUSDReturn } from "./index-DW53ohcm.js";
import * as react0 from "react";
import * as _tanstack_react_query207 from "@tanstack/react-query";
import { skipToken } from "@tanstack/react-query";
import * as _0xsequence_indexer4 from "@0xsequence/indexer";
import { TokenMetadata } from "@0xsequence/metadata";
import * as react_jsx_runtime35 from "react/jsx-runtime";
import * as viem29 from "viem";
import { Address, Hex } from "viem";

//#region src/react/hooks/data/primary-sales/useCountOfPrimarySaleItems.d.ts
declare function useCountOfPrimarySaleItems(args: UseCountOfPrimarySaleItemsArgs): _tanstack_react_query207.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useGetCountOfPrimarySaleItems(params: UseGetCountParams): _tanstack_react_query207.UseQueryResult<GetCountOfPrimarySaleItemsReturn, Error>;
//#endregion
...
declare function useList721ShopCardData({
  ...
  saleDetailsError: viem29.ReadContractErrorType | null;
  saleDetails: {
    supplyCap: bigint;
    cost: bigint;
    paymentToken: `0x${string}`;
  ...
  isLoading: boolean;
  tokenSuppliesData: _tanstack_react_query207.InfiniteData<_0xsequence_indexer4.GetTokenSuppliesReturn, unknown> | undefined;
};
//#endregion
...
declare function useInventory(args: UseInventoryArgs): _tanstack_react_query207.UseQueryResult<CollectiblesResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCheckoutOptions(params: UseCheckoutOptionsParams): _tanstack_react_query207.UseQueryResult<CheckoutOptionsMarketplaceReturn, Error>;
 ...
 * ```
 */
declare function useCheckoutOptionsSalesContract(params: UseCheckoutOptionsSalesContractParams | typeof skipToken): _tanstack_react_query207.UseQueryResult<CheckoutOptionsSalesContractReturn, Error>;
 ...
 * ```
 */
declare function useComparePrices(params: UseComparePricesParams): _tanstack_react_query207.UseQueryResult<ComparePricesReturn, Error>;
 ...
 * ```
 */
declare function useConvertPriceToUSD(params: UseConvertPriceToUSDParams): _tanstack_react_query207.UseQueryResult<ConvertPriceToUSDReturn, Error>;
...
declare const useEnsureCorrectChain: () => {
  ...
  ensureCorrectChainAsync: (targetChainId: number) => Promise<void | {
    ...
    contracts?: {
      [x: string]: viem29.ChainContract | {
        [sourceId: number]: viem29.ChainContract | undefined;
      } | undefined;
      ensRegistry?: viem29.ChainContract | undefined;
      ensUniversalResolver?: viem29.ChainContract | undefined;
      multicall3?: viem29.ChainContract | undefined;
      erc6492Verifier?: viem29.ChainContract | undefined;
    } | undefined;
    ...
    fees?: viem29.ChainFees<viem29.ChainFormatters | undefined> | undefined;
    formatters?: viem29.ChainFormatters | undefined;
    serializers?: viem29.ChainSerializers<viem29.ChainFormatters | undefined, viem29.TransactionSerializable> | undefined;
  }>;
...
declare const useGetReceiptFromHash: () => {
  waitForReceipt: (transactionHash: Hex) => Promise<viem29.TransactionReceipt>;
};
//#endregion
...
declare function useRoyalty(args: UseRoyaltyArgs): {
  ...
  error: viem29.ReadContractErrorType;
  isError: true;
  isPending: false;
  isLoading: false;
  ...
  failureCount: number;
  failureReason: viem29.ReadContractErrorType | null;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query207.RefetchOptions) => Promise<_tanstack_react_query207.QueryObserverResult<readonly [`0x${string}`, bigint], viem29.ReadContractErrorType>>;
  fetchStatus: _tanstack_react_query207.FetchStatus;
  promise: Promise<readonly [`0x${string}`, bigint]>;
  queryKey: _tanstack_react_query207.QueryKey;
} | {
  data: {
    percentage: bigint;
    recipient: Address;
...
declare function MarketplaceProvider({
  ...
  children,
  openConnectModal
}: MarketplaceSdkProviderProps): react_jsx_runtime35.JSX.Element;
 ...
 * ```
 */
declare function useListPrimarySaleItems(params: UseListPrimarySaleItemsParams): _tanstack_react_query207.UseInfiniteQueryResult<_tanstack_react_query207.InfiniteData<ListPrimarySaleItemsReturn, unknown>, Error>;
//#endregion
export { MarketplaceProvider, MarketplaceQueryClientProvider, MarketplaceSdkContext$1 as MarketplaceSdkContext, MarketplaceSdkProviderProps, UseCheckoutOptionsArgs, UseCheckoutOptionsParams, UseCheckoutOptionsReturn, UseCheckoutOptionsSalesContractArgs, UseCheckoutOptionsSalesContractParams, UseCheckoutOptionsSalesContractReturn, UseComparePricesArgs, UseComparePricesParams, UseComparePricesReturn, UseConvertPriceToUSDArgs, UseConvertPriceToUSDParams, UseConvertPriceToUSDReturn, UseGetCountParams, UseListPrimarySaleItemsParams, UseRoyaltyArgs, useAutoSelectFeeOption, useCheckoutOptions, useCheckoutOptionsSalesContract, useComparePrices, useConvertPriceToUSD, useCountOfPrimarySaleItems, useEnsureCorrectChain, useErc721SaleDetails, useGetCountOfPrimarySaleItems, useGetReceiptFromHash, useInventory, useList1155ShopCardData, useList721ShopCardData, useListPrimarySaleItems, useRoyalty };
//# sourceMappingURL=index-CTKtzldp.d.ts.map