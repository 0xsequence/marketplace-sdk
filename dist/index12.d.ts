 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query390.UseQueryResult<GetTokenBalancesDetailsResponse, Error>;
 ...
 * ```
 */
declare function useCollectionList(params?: UseCollectionListParams): _tanstack_react_query390.UseQueryResult<({
  symbol: string;
...
declare const collectionMarketDetailPollingOptions: (args: UseCollectionMarketDetailPollingParams, config: SdkConfig) => _tanstack_react_query390.OmitKeyof<_tanstack_react_query390.UseQueryOptions<Collection, Error, Collection, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query390.QueryFunction<Collection, readonly unknown[], never> | undefined;
} & {
...
declare const useCollectionMarketDetailPolling: (args: UseCollectionMarketDetailPollingParams) => _tanstack_react_query390.UseQueryResult<Collection, Error>;
//#endregion
...
declare function useCollectionMarketFilteredCount(params: UseCollectionMarketFilteredCountParams): _tanstack_react_query390.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionMarketFloor(params: UseCollectionMarketFloorParams): _tanstack_react_query390.UseQueryResult<CollectibleOrder, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionMarketItems(params: UseCollectionMarketItemsParams): _tanstack_react_query390.UseInfiniteQueryResult<_tanstack_react_query390.InfiniteData<ListOrdersWithCollectiblesResponse, unknown>, Error>;
 ...
 * ```
 */
declare function useCollectionMarketItemsCount(params: UseCollectionMarketItemsCountParams): _tanstack_react_query390.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionMarketItemsPaginated(params: UseCollectionMarketItemsPaginatedParams): _tanstack_react_query390.UseQueryResult<ListOrdersWithCollectiblesResponse, Error>;
 ...
 * ```
 */
declare function useCollectionMetadata(params: UseCollectionMetadataParams): _tanstack_react_query390.UseQueryResult<ContractInfo$1$1, Error>;
//#endregion
...
declare function collectionActiveListingsCurrenciesQueryOptions(params: WithOptionalParams<WithRequired<CollectionActiveListingsCurrenciesQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query390.OmitKeyof<_tanstack_react_query390.UseQueryOptions<Currency[], Error, Currency[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query390.QueryFunction<Currency[], readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
 ...
 * ```
 */
declare function useCollectionActiveListingsCurrencies(params: UseCollectionActiveListingsCurrenciesParams): _tanstack_react_query390.UseQueryResult<Currency[], Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionActiveOffersCurrencies(params: UseCollectionActiveOffersCurrenciesParams): _tanstack_react_query390.UseQueryResult<Currency[], Error>;
//#endregion
