import { Cr as ListCollectiblesReturn, Dt as CollectibleOrder, Jt as CurrencyStatus, Lt as ContractType, bi as PropertyFilter, ii as OrderbookKind, li as PriceFilter, q as CollectibleCardAction, qt as Currency, w as Optional } from "./create-config.js";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query174.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query174.FetchNextPageOptions) => Promise<_tanstack_react_query174.InfiniteQueryObserverResult<_tanstack_react_query174.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query174.UseQueryResult<{
