import { Ct as ChainId, Mt as Collection, R as ListOrdersWithCollectiblesResponse, St as Address$1, Tt as TokenId, Ut as ListCollectionActivitiesResponse, Xt as OrderbookKind, _t as GetTokenBalancesDetailsResponse, dt as ContractInfoExtensions, i as CollectibleOrder, l as Currency, o as CollectionFilterSettings, ut as ContractInfo$2, wt as ProjectId } from "./index2.js";
import { G as Optional, Y as SdkQueryParams, lt as WithOptionalParams, m as SdkConfig, mt as StandardQueryOptions, tt as WithRequired } from "./create-config.js";
...
import * as _0xsequence_indexer29 from "@0xsequence/indexer";
...
declare function useCollectionList(params?: UseCollectionListParams): _tanstack_react_query413.UseQueryResult<({
  ...
  source: string;
  name: string;
  type: _0xsequence_indexer29.ContractType;
  symbol: string;
  decimals?: number;
  logoURI: string;
  deployed: boolean;
  ...
  contractType: _0xsequence_indexer29.ContractType;
 ...
 * ```
 */
declare function useCollectionMarketActivities(params: UseCollectionMarketActivitiesParams): _tanstack_react_query413.UseQueryResult<ListCollectionActivitiesResponse, Error>;
...
type UseCollectionMetadataParams = WithRequired<CollectionQueryOptions, 'chainId' | 'collectionAddress'> & {
  config?: SdkConfig;
 ...
 * ```
 */
declare function useCollectionMetadata(params: UseCollectionMetadataParams): _tanstack_react_query413.UseQueryResult<ContractInfo$2, Error>;
//#endregion
