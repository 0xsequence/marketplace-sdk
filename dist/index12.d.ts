import { Ct as ChainId, Gt as ListCollectionActivitiesResponse, Pt as Collection, Qt as OrderbookKind, R as ListOrdersWithCollectiblesResponse, St as Address$1, Tt as TokenId, _t as GetTokenBalancesDetailsResponse, dt as ContractInfoExtensions, i as CollectibleOrder, l as Currency, o as CollectionFilterSettings, ut as ContractInfo$1, wt as ProjectId } from "./index2.js";
import { G as Optional, Y as SdkQueryParams, lt as WithOptionalParams, m as SdkConfig, tt as WithRequired } from "./create-config.js";
 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query411.UseQueryResult<GetTokenBalancesDetailsResponse, Error>;
 ...
 * ```
 */
declare function useCollectionList(params?: UseCollectionListParams): _tanstack_react_query411.UseQueryResult<({
  chainId: ChainId;
  address: Address$1;
  source: string;
  name: string;
 ...
 * ```
 */
declare function useCollectionMarketActivities(params: UseCollectionMarketActivitiesParams): _tanstack_react_query411.UseQueryResult<ListCollectionActivitiesResponse, Error>;
...
declare const collectionMarketDetailPollingOptions: (args: UseCollectionMarketDetailPollingParams, config: SdkConfig) => _tanstack_react_query411.OmitKeyof<_tanstack_react_query411.UseQueryOptions<Collection, Error, Collection, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query411.QueryFunction<Collection, readonly unknown[], never> | undefined;
} & {
...
declare const useCollectionMarketDetailPolling: (args: UseCollectionMarketDetailPollingParams) => _tanstack_react_query411.UseQueryResult<Collection, Error>;
//#endregion
...
declare function useCollectionMarketFilteredCount(params: UseCollectionMarketFilteredCountParams): _tanstack_react_query411.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionMarketFloor(params: UseCollectionMarketFloorParams): _tanstack_react_query411.UseQueryResult<CollectibleOrder, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionMarketItems(params: UseCollectionMarketItemsParams): _tanstack_react_query411.UseInfiniteQueryResult<_tanstack_react_query411.InfiniteData<ListOrdersWithCollectiblesResponse, unknown>, Error>;
 ...
 * ```
 */
declare function useCollectionMarketItemsCount(params: UseCollectionMarketItemsCountParams): _tanstack_react_query411.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionMarketItemsPaginated(params: UseCollectionMarketItemsPaginatedParams): _tanstack_react_query411.UseQueryResult<ListOrdersWithCollectiblesResponse, Error>;
 ...
 * ```
 */
declare function useCollectionMetadata(params: UseCollectionMetadataParams): _tanstack_react_query411.UseQueryResult<ContractInfo$1, Error>;
//#endregion
...
declare function collectionActiveListingsCurrenciesQueryOptions(params: WithOptionalParams<WithRequired<CollectionActiveListingsCurrenciesQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query411.OmitKeyof<_tanstack_react_query411.UseQueryOptions<Currency[], Error, Currency[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query411.QueryFunction<Currency[], readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
 ...
 * ```
 */
declare function useCollectionActiveListingsCurrencies(params: UseCollectionActiveListingsCurrenciesParams): _tanstack_react_query411.UseQueryResult<Currency[], Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionActiveOffersCurrencies(params: UseCollectionActiveOffersCurrenciesParams): _tanstack_react_query411.UseQueryResult<Currency[], Error>;
//#endregion
