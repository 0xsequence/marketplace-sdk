import { Bt as CollectionFilterSettings, G as Optional, Ht as Currency, In as ContractInfo$1, Jn as ContractType, Ln as ContractInfoExtensions, Qn as TokenId, Rt as CollectibleOrder, Un as GetTokenBalancesDetailsResponse, Xn as ChainId, Y as SdkQueryParams, Yn as Address$1, Zn as ProjectId, _r as ListCollectionActivitiesResponse, gn as ListOrdersWithCollectiblesResponse, lt as WithOptionalParams, m as SdkConfig, or as Collection, tt as WithRequired, wr as OrderbookKind } from "./create-config.js";
...
import * as _tanstack_react_query378 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query378.UseQueryResult<GetTokenBalancesDetailsResponse, Error>;
 ...
 * ```
 */
declare function useCollectionList(params?: UseCollectionListParams): _tanstack_react_query378.UseQueryResult<({
  chainId: ChainId;
  address: Address$1;
  source: string;
  name: string;
 ...
 * ```
 */
declare function useCollectionMarketActivities(params: UseCollectionMarketActivitiesParams): _tanstack_react_query378.UseQueryResult<ListCollectionActivitiesResponse, Error>;
...
declare const collectionMarketDetailPollingOptions: (args: UseCollectionMarketDetailPollingParams, config: SdkConfig) => _tanstack_react_query378.OmitKeyof<_tanstack_react_query378.UseQueryOptions<Collection, Error, Collection, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query378.QueryFunction<Collection, readonly unknown[], never> | undefined;
} & {
...
declare const useCollectionMarketDetailPolling: (args: UseCollectionMarketDetailPollingParams) => _tanstack_react_query378.UseQueryResult<Collection, Error>;
//#endregion
...
declare function useCollectionMarketFilteredCount(params: UseCollectionMarketFilteredCountParams): _tanstack_react_query378.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionMarketFloor(params: UseCollectionMarketFloorParams): _tanstack_react_query378.UseQueryResult<CollectibleOrder, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionMarketItems(params: UseCollectionMarketItemsParams): _tanstack_react_query378.UseInfiniteQueryResult<_tanstack_react_query378.InfiniteData<ListOrdersWithCollectiblesResponse, unknown>, Error>;
 ...
 * ```
 */
declare function useCollectionMarketItemsCount(params: UseCollectionMarketItemsCountParams): _tanstack_react_query378.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionMarketItemsPaginated(params: UseCollectionMarketItemsPaginatedParams): _tanstack_react_query378.UseQueryResult<ListOrdersWithCollectiblesResponse, Error>;
 ...
 * ```
 */
declare function useCollectionMetadata(params: UseCollectionMetadataParams): _tanstack_react_query378.UseQueryResult<ContractInfo$1, Error>;
//#endregion
...
declare function collectionActiveListingsCurrenciesQueryOptions(params: WithOptionalParams<WithRequired<CollectionActiveListingsCurrenciesQueryOptions, 'chainId' | 'collectionAddress' | 'config'>>): _tanstack_react_query378.OmitKeyof<_tanstack_react_query378.UseQueryOptions<Currency[], Error, Currency[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query378.QueryFunction<Currency[], readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
 ...
 * ```
 */
declare function useCollectionActiveListingsCurrencies(params: UseCollectionActiveListingsCurrenciesParams): _tanstack_react_query378.UseQueryResult<Currency[], Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionActiveOffersCurrencies(params: UseCollectionActiveOffersCurrenciesParams): _tanstack_react_query378.UseQueryResult<Currency[], Error>;
//#endregion
