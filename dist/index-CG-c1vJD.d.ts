import { CardType, Collection, CollectionFilterSettings, ContractType, Currency, ListCollectionActivitiesReturn, Optional, OrderbookKind, SdkConfig } from "./create-config-rrEYvm6u.js";
import { CollectionActiveListingsCurrenciesQueryOptions, CollectionActiveOffersCurrenciesQueryOptions, CollectionBalanceDetailsQueryOptions, CollectionBalanceFilter, CollectionDetailsQueryOptions, CollectionQueryOptions, ListCollectionActivitiesQueryOptions, ListCollectionsQueryOptions, fetchCollectionBalanceDetails$1 as fetchCollectionBalanceDetails, fetchListCollectionActivities$1 as fetchListCollectionActivities } from "./listCollections-Br3_Oc6H.js";
...
import * as _tanstack_react_query370 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useCollection(params: UseCollectionParams): _tanstack_react_query350.UseQueryResult<_0xsequence_metadata134.ContractInfo, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionActiveListingsCurrencies(params: UseCollectionActiveListingsCurrenciesParams): _tanstack_react_query356.UseQueryResult<Currency[], Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionActiveOffersCurrencies(params: UseCollectionActiveOffersCurrenciesParams): _tanstack_react_query360.UseQueryResult<Currency[], Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query366.UseQueryResult<_0xsequence_indexer24.GetTokenBalancesDetailsReturn, Error>;
 ...
 * ```
 */
declare function useCollectionDetails(params: UseCollectionDetailsParams): _tanstack_react_query370.UseQueryResult<Collection, Error>;
//#endregion
...
declare const collectionDetailsPollingOptions: (args: UseCollectionDetailsPolling, config: SdkConfig) => _tanstack_react_query371.OmitKeyof<_tanstack_react_query371.UseQueryOptions<Collection, Error, Collection, readonly ["collections", "detail", {
  chainId: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query371.QueryFunction<Collection, readonly ["collections", "detail", {
    chainId: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare const useCollectionDetailsPolling: (args: UseCollectionDetailsPolling) => _tanstack_react_query371.UseQueryResult<Collection, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectionActivities(params: UseListCollectionActivitiesParams): _tanstack_react_query387.UseQueryResult<ListCollectionActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollections(params?: UseListCollectionsParams): _tanstack_react_query394.UseQueryResult<({
  chainId: number;
  address: string;
  source: string;
  name: string;
...
//#endregion
export { UseCollectionActiveListingsCurrenciesParams, UseCollectionActiveOffersCurrenciesParams, UseCollectionBalanceDetailsArgs, UseCollectionBalanceDetailsParams, UseCollectionBalanceDetailsReturn, UseCollectionDetailsParams, UseCollectionParams, UseListCollectionActivitiesArgs, UseListCollectionActivitiesParams, UseListCollectionActivitiesReturn, UseListCollectionsParams, collectionDetailsPollingOptions as collectionDetailsPollingOptions$1, useCollection as useCollection$1, useCollectionActiveListingsCurrencies as useCollectionActiveListingsCurrencies$1, useCollectionActiveOffersCurrencies as useCollectionActiveOffersCurrencies$1, useCollectionBalanceDetails as useCollectionBalanceDetails$1, useCollectionDetails as useCollectionDetails$1, useCollectionDetailsPolling as useCollectionDetailsPolling$1, useListCollectionActivities as useListCollectionActivities$1, useListCollections as useListCollections$1 };
//# sourceMappingURL=index-CG-c1vJD.d.ts.map