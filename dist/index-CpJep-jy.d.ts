import { CardType, Collection, CollectionFilterSettings, ContractType, ListCollectionActivitiesReturn, Optional, OrderbookKind, SdkConfig } from "./create-config-goz-zUX1.js";
import { CollectionBalanceDetailsQueryOptions, CollectionBalanceFilter, CollectionDetailsQueryOptions, CollectionQueryOptions, ListCollectionActivitiesQueryOptions, ListCollectionsQueryOptions, fetchCollectionBalanceDetails, fetchListCollectionActivities } from "./listCollections-UO5WOmhA.js";
 ...
 * ```
 */
declare function useCollection(params: UseCollectionParams): _tanstack_react_query1.UseQueryResult<_0xsequence_metadata3.ContractInfo, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query1.UseQueryResult<_0xsequence_indexer0.GetTokenBalancesDetailsReturn, Error>;
 ...
 * ```
 */
declare function useCollectionDetails(params: UseCollectionDetailsParams): _tanstack_react_query1.UseQueryResult<Collection, Error>;
//#endregion
...
declare const collectionDetailsPollingOptions: (args: UseCollectionDetailsPolling, config: SdkConfig) => _tanstack_react_query1.OmitKeyof<_tanstack_react_query1.UseQueryOptions<Collection, Error, Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query1.QueryFunction<Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[], never> | undefined;
} & {
...
declare const useCollectionDetailsPolling: (args: UseCollectionDetailsPolling) => _tanstack_react_query1.UseQueryResult<Collection, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectionActivities(params: UseListCollectionActivitiesParams): _tanstack_react_query1.UseQueryResult<ListCollectionActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollections(params?: UseListCollectionsParams): _tanstack_react_query1.UseQueryResult<({
  chainId: number;
  address: string;
  source: string;
  name: string;
...
//# sourceMappingURL=index-CpJep-jy.d.ts.map