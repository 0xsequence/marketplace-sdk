 ...
 */
declare function tokenBalancesOptions(args: UseTokenBalancesArgs, config: SdkConfig): _tanstack_react_query246.UseQueryOptions<xtrails6.TokenBalance[], Error, xtrails6.TokenBalance[], readonly ["collectable", "collectable", "details", "userBalances", {
  chainId: number;
  accountAddress: `0x${string}` | undefined;
  contractAddress: `0x${string}`;
  includeMetadata: boolean | undefined;
  ...
  initialData?: xtrails6.TokenBalance[] | _tanstack_react_query246.InitialDataFunction<xtrails6.TokenBalance[]> | undefined;
} & {
...
//# sourceMappingURL=index-DAb8saiZ.d.ts.map