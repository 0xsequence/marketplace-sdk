import { $ as SdkConfig, Bn as GetCollectionActiveOffersCurrenciesReturn, Bt as Collection, Gt as ContractType, Hn as GetCollectionDetailArgs, Ir as ListCollectionActivitiesArgs, Ln as GetCollectionActiveListingsCurrenciesArgs, Lr as ListCollectionActivitiesReturn, Mi as SortBy, Rn as GetCollectionActiveListingsCurrenciesReturn, et as CardType, f as CollectionFilterSettings, fi as OrderbookKind, h as MarketplaceConfig, tn as Currency, z as ValuesOptional, zn as GetCollectionActiveOffersCurrenciesArgs } from "./create-config-CrbgqkBr.js";
...
declare function collectionQueryOptions(params: CollectionQueryOptions): _tanstack_react_query23.OmitKeyof<_tanstack_react_query23.UseQueryOptions<_0xsequence_metadata48.ContractInfo, Error, _0xsequence_metadata48.ContractInfo, readonly ["collections", "detail", {
  chainID: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query23.QueryFunction<_0xsequence_metadata48.ContractInfo, readonly ["collections", "detail", {
    chainID: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare function collectionActiveListingsCurrenciesQueryOptions(params: CollectionActiveListingsCurrenciesQueryOptions): _tanstack_react_query23.OmitKeyof<_tanstack_react_query23.UseQueryOptions<Currency[], Error, Currency[], readonly ["collections", "activeListingsCurrencies", {
  chainId: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query23.QueryFunction<Currency[], readonly ["collections", "activeListingsCurrencies", {
    chainId: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare function collectionActiveOffersCurrenciesQueryOptions(params: CollectionActiveOffersCurrenciesQueryOptions): _tanstack_react_query23.OmitKeyof<_tanstack_react_query23.UseQueryOptions<Currency[], Error, Currency[], readonly ["collections", "activeOffersCurrencies", {
  chainId: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query23.QueryFunction<Currency[], readonly ["collections", "activeOffersCurrencies", {
    chainId: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare function collectionBalanceDetailsQueryOptions(params: CollectionBalanceDetailsQueryOptions): _tanstack_react_query23.OmitKeyof<_tanstack_react_query23.UseQueryOptions<GetTokenBalancesDetailsReturn, Error, GetTokenBalancesDetailsReturn, readonly ["balances", "collectionBalanceDetails", {
  chainId: number;
  filter: CollectionBalanceFilter;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query23.QueryFunction<GetTokenBalancesDetailsReturn, readonly ["balances", "collectionBalanceDetails", {
    chainId: number;
    filter: CollectionBalanceFilter;
  }], never> | undefined;
} & {
...
declare function collectionDetailsQueryOptions(params: CollectionDetailsQueryOptions): _tanstack_react_query23.OmitKeyof<_tanstack_react_query23.UseQueryOptions<Collection, Error, Collection, readonly ["collections", "detail", {
  chainId: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query23.QueryFunction<Collection, readonly ["collections", "detail", {
    chainId: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare function listCollectionActivitiesQueryOptions(params: ListCollectionActivitiesQueryOptions): _tanstack_react_query23.OmitKeyof<_tanstack_react_query23.UseQueryOptions<ListCollectionActivitiesReturn, Error, ListCollectionActivitiesReturn, readonly ["collections", "collectionActivities", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  page: {
    page: number;
  ...
  queryFn?: _tanstack_react_query23.QueryFunction<ListCollectionActivitiesReturn, readonly ["collections", "collectionActivities", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    page: {
      page: number;
...
declare function listCollectionsQueryOptions(params: ListCollectionsQueryOptions): _tanstack_react_query23.UseQueryOptions<({
  chainId: number;
  address: string;
  source: string;
  name: string;
  ...
  initialData?: ({
    ...
    sortOrder?: number;
    private: boolean;
  })[] | _tanstack_react_query23.InitialDataFunction<({
    chainId: number;
    address: string;
    source: string;
    name: string;
...
declare const listCollectionsOptions: ({
  ...
  config: SdkConfig;
}) => _tanstack_react_query23.UseQueryOptions<({
  chainId: number;
  address: string;
  source: string;
  name: string;
...
//# sourceMappingURL=listCollections-DdePFELt.d.ts.map