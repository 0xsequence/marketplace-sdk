import { $ as SdkConfig, $r as ListPrimarySaleItemsReturn, Gt as ContractType, It as CollectiblePrimarySaleItem, Ki as TokenMetadata$1, M as QueryArg, Nt as CheckoutOptionsSalesContractReturn, Ot as CheckoutOptionsItem, Q as MarketplaceSdkContext, bi as PrimarySaleItem, ir as GetCountOfPrimarySaleItemsReturn, j as Optional } from "./create-config-BA_ne-vj.js";
import { n as UseInventoryArgs, t as CollectiblesResponse } from "./index-pmDoUU2I.js";
import { i as fetchCheckoutOptionsSalesContract, t as CheckoutOptionsSalesContractQueryOptions } from "./index-D841m9qi.js";
import { f as PrimarySaleItemQueryOptions, g as UseCountOfPrimarySaleItemsArgs, s as ListPrimarySaleItemsQueryOptions } from "./index-C1AzYOo9.js";
import { c as ComparePricesReturn, n as ConvertPriceToUSDReturn, s as ComparePricesQueryOptions, t as ConvertPriceToUSDQueryOptions } from "./index-CNETegUE.js";
import * as react0 from "react";
import * as _tanstack_react_query360 from "@tanstack/react-query";
import { skipToken } from "@tanstack/react-query";
import * as _0xsequence_indexer2 from "@0xsequence/indexer";
import { TokenMetadata } from "@0xsequence/metadata";
import * as react_jsx_runtime24 from "react/jsx-runtime";
import * as viem61 from "viem";
import { Address, Hex } from "viem";

//#region src/react/hooks/data/primary-sales/useCountOfPrimarySaleItems.d.ts
declare function useCountOfPrimarySaleItems(args: UseCountOfPrimarySaleItemsArgs): _tanstack_react_query360.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useGetCountOfPrimarySaleItems(params: UseGetCountParams): _tanstack_react_query360.UseQueryResult<GetCountOfPrimarySaleItemsReturn, Error>;
//#endregion
...
declare function useList721ShopCardData({
  ...
  saleDetailsError: viem61.ReadContractErrorType | null;
  saleDetails: {
    supplyCap: bigint;
    cost: bigint;
    paymentToken: `0x${string}`;
  ...
  isLoading: boolean;
  tokenSuppliesData: _tanstack_react_query360.InfiniteData<_0xsequence_indexer2.GetTokenSuppliesReturn, unknown> | undefined;
};
//#endregion
...
declare function useInventory(args: UseInventoryArgs): _tanstack_react_query360.UseQueryResult<CollectiblesResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCheckoutOptionsSalesContract(params: UseCheckoutOptionsSalesContractParams | typeof skipToken): _tanstack_react_query360.UseQueryResult<CheckoutOptionsSalesContractReturn, Error>;
 ...
 * ```
 */
declare function useComparePrices(params: UseComparePricesParams): _tanstack_react_query360.UseQueryResult<ComparePricesReturn, Error>;
 ...
 * ```
 */
declare function useConvertPriceToUSD(params: UseConvertPriceToUSDParams): _tanstack_react_query360.UseQueryResult<ConvertPriceToUSDReturn, Error>;
...
declare const useEnsureCorrectChain: () => {
  ...
  ensureCorrectChainAsync: (targetChainId: number) => Promise<void | {
    ...
    contracts?: {
      [x: string]: viem61.ChainContract | {
        [sourceId: number]: viem61.ChainContract | undefined;
      } | undefined;
      ensRegistry?: viem61.ChainContract | undefined;
      ensUniversalResolver?: viem61.ChainContract | undefined;
      multicall3?: viem61.ChainContract | undefined;
      erc6492Verifier?: viem61.ChainContract | undefined;
    } | undefined;
    ...
    fees?: viem61.ChainFees<viem61.ChainFormatters | undefined> | undefined;
    formatters?: viem61.ChainFormatters | undefined;
    serializers?: viem61.ChainSerializers<viem61.ChainFormatters | undefined, viem61.TransactionSerializable> | undefined;
  }>;
...
declare const useGetReceiptFromHash: () => {
  waitForReceipt: (transactionHash: Hex) => Promise<viem61.TransactionReceipt>;
};
//#endregion
...
declare function useRoyalty(args: UseRoyaltyArgs): {
  ...
  error: viem61.ReadContractErrorType;
  isError: true;
  isPending: false;
  isLoading: false;
  ...
  failureCount: number;
  failureReason: viem61.ReadContractErrorType | null;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query360.RefetchOptions) => Promise<_tanstack_react_query360.QueryObserverResult<readonly [`0x${string}`, bigint], viem61.ReadContractErrorType>>;
  fetchStatus: _tanstack_react_query360.FetchStatus;
  promise: Promise<readonly [`0x${string}`, bigint]>;
  queryKey: _tanstack_react_query360.QueryKey;
} | {
  data: {
    percentage: bigint;
    recipient: Address;
...
declare function MarketplaceProvider({
  ...
  children,
  openConnectModal
}: MarketplaceSdkProviderProps): react_jsx_runtime24.JSX.Element;
 ...
 * ```
 */
declare function useListPrimarySaleItems(params: UseListPrimarySaleItemsParams): _tanstack_react_query360.UseInfiniteQueryResult<_tanstack_react_query360.InfiniteData<ListPrimarySaleItemsReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function usePrimarySaleItem(params: UsePrimarySaleItemParams): _tanstack_react_query360.UseQueryResult<CollectiblePrimarySaleItem, Error>;
//#endregion
export { useGetCountOfPrimarySaleItems as A, UseCheckoutOptionsSalesContractReturn as C, useList1155ShopCardData as D, useInventory as E, useCountOfPrimarySaleItems as M, useList721ShopCardData as O, UseCheckoutOptionsSalesContractParams as S, useAutoSelectFeeOption as T, UseComparePricesArgs as _, MarketplaceProvider as a, useComparePrices as b, MarketplaceSdkProviderProps as c, useGetReceiptFromHash as d, useEnsureCorrectChain as f, useConvertPriceToUSD as g, UseConvertPriceToUSDReturn as h, useListPrimarySaleItems as i, useErc721SaleDetails as j, UseGetCountParams as k, UseRoyaltyArgs as l, UseConvertPriceToUSDParams as m, usePrimarySaleItem as n, MarketplaceQueryClientProvider as o, UseConvertPriceToUSDArgs as p, UseListPrimarySaleItemsParams as r, MarketplaceSdkContext$1 as s, UsePrimarySaleItemParams as t, useRoyalty as u, UseComparePricesParams as v, useCheckoutOptionsSalesContract as w, UseCheckoutOptionsSalesContractArgs as x, UseComparePricesReturn as y };
//# sourceMappingURL=index-zkhcQISj.d.ts.map