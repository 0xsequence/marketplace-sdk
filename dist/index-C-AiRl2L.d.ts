import { CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PropertyFilter } from "./create-config-Cg2OSDO8.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-LYXNXGc_.js";
import { MarketCollectibleCardProps } from "./types-B12NMNhJ.js";
import * as _tanstack_react_query138 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query138.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query138.FetchNextPageOptions) => Promise<_tanstack_react_query138.InfiniteQueryObserverResult<_tanstack_react_query138.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query138.UseQueryResult<{
...
//# sourceMappingURL=index-C-AiRl2L.d.ts.map