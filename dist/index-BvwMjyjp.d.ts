import { BuyModalProps, CollectionType, ModalCallbacks, Order, OrderbookKind, TokenMetadata } from "./create-config-CsagtMvq.js";
...
declare const ModalProvider: ({
  children
}: ModalProviderProps) => react_jsx_runtime25.JSX.Element;
//#endregion
...
declare function Media({
  ...
  fallbackContent,
  shouldListenForLoad
}: MediaProps): react_jsx_runtime27.JSX.Element;
//#endregion
...
//#endregion
export { Media as Media$1, ModalProvider as ModalProvider$1, useBuyModal as useBuyModal$1, useCreateListingModal as useCreateListingModal$1, useMakeOfferModal as useMakeOfferModal$1, useSellModal as useSellModal$1, useSuccessfulPurchaseModal as useSuccessfulPurchaseModal$1, useTransferModal as useTransferModal$1 };
//# sourceMappingURL=index-BvwMjyjp.d.ts.map