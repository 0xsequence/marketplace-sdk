import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-gz6zNqhE.js";
import { FiltersQueryOptions } from "./filters-KwxF5Hed.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query367.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query367.RefetchOptions) => Promise<_tanstack_react_query367.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query367.FetchStatus;
...
//# sourceMappingURL=index-BZYTrGV-.d.ts.map