import { Optional, PropertyFilter, PropertyType } from "./create-config-CpiC1m8h.js";
import { FiltersQueryOptions } from "./filters-DNSupX0b.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query63.UseQueryResult<PropertyFilter$1[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query63.RefetchOptions) => Promise<_tanstack_react_query63.QueryObserverResult<PropertyFilter$1[], Error>>;
...
//# sourceMappingURL=index-ZWaukzX3.d.ts.map