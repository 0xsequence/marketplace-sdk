...
declare function useSellModalContext(): {
  ...
  error: Error | null;
  queries: {
    collectible: _tanstack_react_query0.UseQueryResult<TokenMetadata$1 | undefined, Error>;
    collection: _tanstack_react_query0.UseQueryResult<ContractInfo$1, Error>;
    currency: _tanstack_react_query0.UseQueryResult<Currency | undefined, Error>;
  };
  readonly actions: {
    approve: {
...
declare const SellModal: () => react_jsx_runtime21.JSX.Element | null;
//#endregion
