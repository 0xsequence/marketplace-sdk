import { Xt as OrderbookKind, l as Currency, ut as ContractInfo$2, xt as TokenBalance$1 } from "./index2.js";
...
declare function useCreateListingModalContext(): {
  ...
  error: Error | null;
  queries: {
    collection: _tanstack_react_query54.UseQueryResult<ContractInfo$2, Error>;
    currencies: _tanstack_react_query54.UseQueryResult<Currency[], Error>;
    collectibleBalance: _tanstack_react_query54.UseQueryResult<TokenBalance$1, Error>;
  };
