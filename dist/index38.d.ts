import { Ht as Currency, In as ContractInfo$1, Vn as TokenMetadata$1, qn as TokenBalance$1, wr as OrderbookKind } from "./create-config.js";
...
declare function useCreateListingModalContext(): {
  ...
  error: Error | null;
  queries: {
    collectible: _tanstack_react_query86.UseQueryResult<TokenMetadata$1, Error>;
    collection: _tanstack_react_query86.UseQueryResult<ContractInfo$1, Error>;
    currencies: _tanstack_react_query86.UseQueryResult<Currency[], Error>;
    collectibleBalance: _tanstack_react_query86.UseQueryResult<TokenBalance$1, Error>;
  };
