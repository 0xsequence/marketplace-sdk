import { Qt as OrderbookKind, l as Currency, ut as ContractInfo$1, xt as TokenBalance$1 } from "./index2.js";
...
declare function useCreateListingModalContext(): {
  ...
  error: Error | null;
  queries: {
    collection: _tanstack_react_query50.UseQueryResult<ContractInfo$1, Error>;
    currencies: _tanstack_react_query50.UseQueryResult<Currency[], Error>;
    collectibleBalance: _tanstack_react_query50.UseQueryResult<TokenBalance$1, Error>;
  };
