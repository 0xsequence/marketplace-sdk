import { ContractType, MetadataStatus, Page as Page$1, SdkConfig } from "./create-config-DrQDberp.js";
...
declare function inventoryOptions(args: UseInventoryArgs, config: SdkConfig): _tanstack_react_query250.OmitKeyof<_tanstack_react_query250.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, (string | number)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query250.QueryFunction<CollectiblesResponse, (string | number)[], never> | undefined;
} & {
...
//# sourceMappingURL=index-DCoWq1FM.d.ts.map