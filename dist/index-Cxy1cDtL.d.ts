import { CardType, Collection, CollectionFilterSettings, ContractType, ListCollectionActivitiesReturn, Optional, OrderbookKind, SdkConfig } from "./create-config-Cvi1W2a1.js";
import { CollectionBalanceDetailsQueryOptions, CollectionBalanceFilter, CollectionDetailsQueryOptions, CollectionQueryOptions, ListCollectionActivitiesQueryOptions, ListCollectionsQueryOptions, fetchCollectionBalanceDetails, fetchListCollectionActivities } from "./listCollections-C7EmHtPh.js";
 ...
 * ```
 */
declare function useCollection(params: UseCollectionParams): _tanstack_react_query6.UseQueryResult<_0xsequence_metadata3.ContractInfo, Error>;
//#endregion
...
declare function useListCollections(params?: UseListCollectionsParams): _tanstack_react_query6.UseQueryResult<({
  ...
  deployed: boolean;
  bytecodeHash: string;
  extensions: _0xsequence_metadata3.ContractInfoExtensions;
  updatedAt: string;
  queuedAt?: string;
...
//# sourceMappingURL=index-Cxy1cDtL.d.ts.map