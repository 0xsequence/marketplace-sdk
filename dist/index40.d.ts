import { Cn as Order, Ht as Currency, In as ContractInfo$1, Vn as TokenMetadata$1 } from "./create-config.js";
...
declare function useSellModalContext(): {
  ...
  error: Error | null;
  queries: {
    collectible: _tanstack_react_query83.UseQueryResult<TokenMetadata$1, Error>;
    collection: _tanstack_react_query83.UseQueryResult<ContractInfo$1, Error>;
    currency: _tanstack_react_query83.UseQueryResult<Currency | undefined, Error>;
  };
  readonly actions: {
    approve: {
