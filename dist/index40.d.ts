import { X as Order, ht as TokenMetadata$2, l as Currency, ut as ContractInfo$2 } from "./index2.js";
...
declare function useSellModalContext(): {
  ...
  error: Error | null;
  queries: {
    collectible: _tanstack_react_query47.UseQueryResult<TokenMetadata$2, Error>;
    collection: _tanstack_react_query47.UseQueryResult<ContractInfo$2, Error>;
