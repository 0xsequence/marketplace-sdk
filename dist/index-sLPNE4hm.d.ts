import { A as Optional, It as Collection, Vt as ContractType, X as CardType, Y as SdkConfig, Zr as OrderbookKind, f as CollectionFilterSettings, wr as ListCollectionActivitiesReturn } from "./create-config-Dz-QylqB.js";
import { c as fetchListCollectionActivities, h as CollectionBalanceFilter, m as CollectionBalanceDetailsQueryOptions, n as ListCollectionsQueryOptions, s as ListCollectionActivitiesQueryOptions, u as CollectionDetailsQueryOptions, v as fetchCollectionBalanceDetails, y as CollectionQueryOptions } from "./listCollections-B-SW4fPE.js";
 ...
 * ```
 */
declare function useCollection(params: UseCollectionParams): _tanstack_react_query6.UseQueryResult<_0xsequence_metadata0.ContractInfo, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectionBalanceDetails(params: UseCollectionBalanceDetailsParams): _tanstack_react_query6.UseQueryResult<_0xsequence_indexer0.GetTokenBalancesDetailsReturn, Error>;
 ...
 * ```
 */
declare function useCollectionDetails(params: UseCollectionDetailsParams): _tanstack_react_query6.UseQueryResult<Collection, Error>;
//#endregion
...
declare const collectionDetailsPollingOptions: (args: UseCollectionDetailsPolling, config: SdkConfig) => _tanstack_react_query6.OmitKeyof<_tanstack_react_query6.UseQueryOptions<Collection, Error, Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query6.QueryFunction<Collection, ("collections" | "detail" | CollectionDetailsQueryOptions)[], never> | undefined;
} & {
...
declare const useCollectionDetailsPolling: (args: UseCollectionDetailsPolling) => _tanstack_react_query6.UseQueryResult<Collection, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectionActivities(params: UseListCollectionActivitiesParams): _tanstack_react_query6.UseQueryResult<ListCollectionActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollections(params?: UseListCollectionsParams): _tanstack_react_query6.UseQueryResult<({
  chainId: number;
  address: string;
  source: string;
  name: string;
...
//# sourceMappingURL=index-sLPNE4hm.d.ts.map