import { SdkConfig, ValuesOptional } from "./create-config-DmCoYOfk.js";
...
declare function listTokenMetadataQueryOptions(params: ListTokenMetadataQueryOptions): _tanstack_react_query85.OmitKeyof<_tanstack_react_query85.UseQueryOptions<_0xsequence_metadata53.TokenMetadata[], Error, _0xsequence_metadata53.TokenMetadata[], ("tokens" | "metadata" | ListTokenMetadataQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query85.QueryFunction<_0xsequence_metadata53.TokenMetadata[], ("tokens" | "metadata" | ListTokenMetadataQueryOptions)[], never> | undefined;
} & {
...
declare function tokenSuppliesQueryOptions(params: TokenSuppliesQueryOptions): _tanstack_react_query85.OmitKeyof<_tanstack_react_query85.UseInfiniteQueryOptions<_0xsequence_indexer0.GetTokenSuppliesReturn, Error, _tanstack_react_query85.InfiniteData<_0xsequence_indexer0.GetTokenSuppliesReturn, unknown>, ("tokens" | "supplies" | TokenSuppliesQueryOptions)[], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query85.QueryFunction<_0xsequence_indexer0.GetTokenSuppliesReturn, ("tokens" | "supplies" | TokenSuppliesQueryOptions)[], Page> | undefined;
} & {
  queryKey: ("tokens" | "supplies" | TokenSuppliesQueryOptions)[] & {
    [dataTagSymbol]: _tanstack_react_query85.InfiniteData<_0xsequence_indexer0.GetTokenSuppliesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
//# sourceMappingURL=tokenSupplies-8jT757EZ.d.ts.map