import { bi as PropertyFilter$1, li as PriceFilter, w as Optional, xi as PropertyType } from "./create-config.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query327.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query327.RefetchOptions) => Promise<_tanstack_react_query327.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query327.FetchStatus;
