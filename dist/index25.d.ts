import { Dn as WithRequired, X as Currency$1, xn as SdkQueryParams } from "./create-config.js";
...
declare function comparePricesQueryOptions(params: ComparePricesQueryOptions): _tanstack_react_query407.OmitKeyof<_tanstack_react_query407.UseQueryOptions<ComparePricesReturn, Error, ComparePricesReturn, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query407.QueryFunction<ComparePricesReturn, readonly unknown[], never> | undefined;
} & {
...
declare function convertPriceToUSDQueryOptions(params: ConvertPriceToUSDQueryOptions): _tanstack_react_query407.OmitKeyof<_tanstack_react_query407.UseQueryOptions<ConvertPriceToUSDReturn, Error, ConvertPriceToUSDReturn, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query407.QueryFunction<ConvertPriceToUSDReturn, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function currencyQueryOptions(params: CurrencyQueryOptions): _tanstack_react_query407.UseQueryOptions<Currency$1 | undefined, Error, Currency$1 | undefined, readonly ["currency", "currency", {
  chainId: string;
  currencyAddress: string;
}]> & {
  initialData?: Currency$1 | _tanstack_react_query407.InitialDataFunction<Currency$1> | undefined;
} & {
...
declare function marketCurrenciesQueryOptions(params: MarketCurrenciesQueryOptions): _tanstack_react_query407.OmitKeyof<_tanstack_react_query407.UseQueryOptions<Currency[], Error, Currency[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query407.QueryFunction<Currency[], readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
