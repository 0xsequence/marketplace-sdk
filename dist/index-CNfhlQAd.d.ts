import { CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PriceFilter, PropertyFilter } from "./create-config-gz6zNqhE.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-Bt2evIRr.js";
import { MarketCollectibleCardProps } from "./types-CRaeAHUq.js";
import * as _tanstack_react_query192 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query192.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query192.FetchNextPageOptions) => Promise<_tanstack_react_query192.InfiniteQueryObserverResult<_tanstack_react_query192.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query192.UseQueryResult<{
...
//# sourceMappingURL=index-CNfhlQAd.d.ts.map