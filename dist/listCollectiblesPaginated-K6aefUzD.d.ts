import { CollectiblesFilter, ListCollectibleActivitiesArgs, ListCollectibleActivitiesReturn, ListCollectiblesArgs, ListCollectiblesReturn, MarketplaceType, OrderSide, Page, SdkConfig, SortBy, ValuesOptional } from "./create-config-DjQjhu3-.js";
 ...
 */
declare function balanceOfCollectibleOptions(args: UseBalanceOfCollectibleArgs, config: SdkConfig): _tanstack_react_query39.UseQueryOptions<_0xsequence_indexer0.TokenBalance, Error, _0xsequence_indexer0.TokenBalance, ("collectable" | "details" | UseBalanceOfCollectibleArgs | "userBalances")[]> & {
  initialData?: _0xsequence_indexer0.TokenBalance | _tanstack_react_query39.InitialDataFunction<_0xsequence_indexer0.TokenBalance> | undefined;
} & {
...
declare function collectibleQueryOptions(params: CollectibleQueryOptions): _tanstack_react_query39.OmitKeyof<_tanstack_react_query39.UseQueryOptions<_0xsequence_metadata0.TokenMetadata, Error, _0xsequence_metadata0.TokenMetadata, ("collectable" | "details" | CollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query39.QueryFunction<_0xsequence_metadata0.TokenMetadata, ("collectable" | "details" | CollectibleQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectiblesQueryOptions(params: ListCollectiblesQueryOptions): _tanstack_react_query39.OmitKeyof<_tanstack_react_query39.UseInfiniteQueryOptions<ListCollectiblesReturn, Error, _tanstack_react_query39.InfiniteData<ListCollectiblesReturn, unknown>, ("collectable" | "list" | ListCollectiblesQueryOptions)[], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query39.QueryFunction<ListCollectiblesReturn, ("collectable" | "list" | ListCollectiblesQueryOptions)[], Page> | undefined;
} & {
...
//# sourceMappingURL=listCollectiblesPaginated-K6aefUzD.d.ts.map