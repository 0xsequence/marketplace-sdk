import { $ as SdkConfig, Ar as ListCollectiblesArgs, Mi as SortBy, Tr as ListCollectibleActivitiesReturn, et as CardType, jr as ListCollectiblesReturn, mi as Page$1, ui as OrderSide, wr as ListCollectibleActivitiesArgs, z as ValuesOptional, zt as CollectiblesFilter } from "./create-config-CrbgqkBr.js";
 ...
 */
declare function balanceOfCollectibleOptions(args: UseBalanceOfCollectibleArgs, config: SdkConfig): _tanstack_react_query91.UseQueryOptions<xtrails6.TokenBalance, Error, xtrails6.TokenBalance, readonly ["collectable", "collectable", "details", "userBalances", {
  chainId: number;
  accountAddress: `0x${string}` | undefined;
  contractAddress: `0x${string}`;
  tokenID: string;
  ...
  initialData?: xtrails6.TokenBalance | _tanstack_react_query91.InitialDataFunction<xtrails6.TokenBalance> | undefined;
} & {
...
declare function collectibleQueryOptions(params: CollectibleQueryOptions): _tanstack_react_query91.OmitKeyof<_tanstack_react_query91.UseQueryOptions<_0xsequence_metadata54.TokenMetadata, Error, _0xsequence_metadata54.TokenMetadata, readonly ["collectable", "details", {
  chainID: string;
  contractAddress: string | undefined;
  tokenIDs: string[];
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query91.QueryFunction<_0xsequence_metadata54.TokenMetadata, readonly ["collectable", "details", {
    chainID: string;
    contractAddress: string | undefined;
    tokenIDs: string[];
  }], never> | undefined;
...
declare function countOfCollectablesQueryOptions(params: CountOfCollectablesQueryOptions): _tanstack_react_query91.OmitKeyof<_tanstack_react_query91.UseQueryOptions<number, Error, number, readonly ["collectable", "counts", {
  chainId: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query91.QueryFunction<number, readonly ["collectable", "counts", {
    chainId: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare function listCollectibleActivitiesQueryOptions(params: ListCollectibleActivitiesQueryOptions): _tanstack_react_query91.OmitKeyof<_tanstack_react_query91.UseQueryOptions<ListCollectibleActivitiesReturn, Error, ListCollectibleActivitiesReturn, readonly ["collectable", "collectibleActivities", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  tokenId: string | undefined;
  page: {
  ...
  queryFn?: _tanstack_react_query91.QueryFunction<ListCollectibleActivitiesReturn, readonly ["collectable", "collectibleActivities", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    tokenId: string | undefined;
    page: {
...
declare function listCollectiblesQueryOptions(params: ListCollectiblesQueryOptions): _tanstack_react_query91.OmitKeyof<_tanstack_react_query91.UseInfiniteQueryOptions<ListCollectiblesReturn, Error, _tanstack_react_query91.InfiniteData<ListCollectiblesReturn, unknown>, readonly ["collectable", "list", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  side: OrderSide | undefined;
  filter: CollectiblesFilter | undefined;
}], Page$1>, "queryFn"> & {
  queryFn?: _tanstack_react_query91.QueryFunction<ListCollectiblesReturn, readonly ["collectable", "list", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    side: OrderSide | undefined;
    filter: CollectiblesFilter | undefined;
  ...
  queryKey: readonly ["collectable", "list", {
    ...
    [dataTagSymbol]: _tanstack_react_query91.InfiniteData<ListCollectiblesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listCollectiblesPaginatedQueryOptions(params: ListCollectiblesPaginatedQueryOptions): _tanstack_react_query91.OmitKeyof<_tanstack_react_query91.UseQueryOptions<ListCollectiblesReturn, Error, ListCollectiblesReturn, readonly ["collectable", "list", "paginated", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  side: OrderSide | undefined;
  filter: CollectiblesFilter | undefined;
  ...
  queryFn?: _tanstack_react_query91.QueryFunction<ListCollectiblesReturn, readonly ["collectable", "list", "paginated", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    side: OrderSide | undefined;
    filter: CollectiblesFilter | undefined;
...
//# sourceMappingURL=listCollectiblesPaginated-DRe4cIcT.d.ts.map