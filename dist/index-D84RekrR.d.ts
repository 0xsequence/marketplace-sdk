import { BuyModalProps, CollectionType, ModalCallbacks, Order, OrderbookKind, TokenMetadata } from "./create-config-Cg2OSDO8.js";
...
declare const ModalProvider: ({
  children
}: ModalProviderProps) => react_jsx_runtime5.JSX.Element;
//#endregion
...
declare function Media({
  ...
  fallbackContent,
  shouldListenForLoad
}: MediaProps): react_jsx_runtime5.JSX.Element;
//#endregion
...
//# sourceMappingURL=index-D84RekrR.d.ts.map