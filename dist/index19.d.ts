...
declare function countOfPrimarySaleItemsOptions(args: UseCountOfPrimarySaleItemsArgs, config: SdkConfig): _tanstack_react_query73.OmitKeyof<_tanstack_react_query73.UseQueryOptions<number, Error, number, readonly ["primarySaleItemsCount", {
  chainId: string;
  primarySaleContractAddress: `0x${string}`;
  filter: PrimarySaleItemsFilter | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query73.QueryFunction<number, readonly ["primarySaleItemsCount", {
    chainId: string;
    primarySaleContractAddress: `0x${string}`;
    filter: PrimarySaleItemsFilter | undefined;
  }], never> | undefined;
...
declare function primarySaleItemQueryOptions(params: PrimarySaleItemQueryOptions): _tanstack_react_query73.OmitKeyof<_tanstack_react_query73.UseQueryOptions<CollectiblePrimarySaleItem, Error, CollectiblePrimarySaleItem, readonly ["primarySaleItem", {
  chainId: string;
  primarySaleContractAddress: string | undefined;
  tokenId: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query73.QueryFunction<CollectiblePrimarySaleItem, readonly ["primarySaleItem", {
    chainId: string;
    primarySaleContractAddress: string | undefined;
    tokenId: string | undefined;
  }], never> | undefined;
...
declare const listPrimarySaleItemsQueryOptions: (params: ListPrimarySaleItemsQueryOptions) => _tanstack_react_query73.OmitKeyof<_tanstack_react_query73.UseInfiniteQueryOptions<ListPrimarySaleItemsReturn, Error, _tanstack_react_query73.InfiniteData<ListPrimarySaleItemsReturn, unknown>, readonly ["listPrimarySaleItems", {
  chainId: string;
  primarySaleContractAddress: `0x${string}` | undefined;
  filter: PrimarySaleItemsFilter | undefined;
}], {
  ...
  queryFn?: _tanstack_react_query73.QueryFunction<ListPrimarySaleItemsReturn, readonly ["listPrimarySaleItems", {
    chainId: string;
    primarySaleContractAddress: `0x${string}` | undefined;
    filter: PrimarySaleItemsFilter | undefined;
  }], {
  ...
  queryKey: readonly ["listPrimarySaleItems", {
    ...
    [dataTagSymbol]: _tanstack_react_query73.InfiniteData<ListPrimarySaleItemsReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare const primarySaleItemsCountQueryOptions: (args: PrimarySaleItemsCountQueryOptions) => _tanstack_react_query73.OmitKeyof<_tanstack_react_query73.UseQueryOptions<GetCountOfPrimarySaleItemsReturn, Error, GetCountOfPrimarySaleItemsReturn, readonly ["primarySaleItemsCount", {
  chainId: string;
  primarySaleContractAddress: `0x${string}` | undefined;
  filter: PrimarySaleItemsFilter | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query73.QueryFunction<GetCountOfPrimarySaleItemsReturn, readonly ["primarySaleItemsCount", {
    chainId: string;
    primarySaleContractAddress: `0x${string}` | undefined;
    filter: PrimarySaleItemsFilter | undefined;
  }], never> | undefined;
