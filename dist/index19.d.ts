import { Ar as PropertyFilter, Or as PriceFilter, jr as PropertyType } from "./create-config.js";
import { TransitionStartFunction } from "react";

//#region ../node_modules/.pnpm/nuqs@2.7.3_next@15.5.6_@babel+core@7.28.5_babel-plugin-macros@3.1.0_react-dom@19.2.0_react@19_vbakh3a5nmfbc4zvxcrbbpglje/node_modules/nuqs/dist/defs-BFMOAnmN.d.ts
...
declare function useFilterState(): {
  ...
  setPriceFilters: (value: PriceFilter[] | ((old: PriceFilter[]) => PriceFilter[] | null) | null, options?: Options) => Promise<URLSearchParams>;
};
//#endregion
