import { Currency, CurrencyStatus, SdkConfig, ValuesOptional } from "./create-config-CpiC1m8h.js";
...
declare function currencyQueryOptions(params: CurrencyQueryOptions): _tanstack_react_query120.UseQueryOptions<Currency | undefined, Error, Currency | undefined, ("details" | "currencies" | CurrencyQueryOptions)[]> & {
  initialData?: Currency | _tanstack_react_query120.InitialDataFunction<Currency> | undefined;
} & {
...
declare function marketCurrenciesQueryOptions(params: MarketCurrenciesQueryOptions): _tanstack_react_query120.OmitKeyof<_tanstack_react_query120.UseQueryOptions<{
  contractAddress: string;
  chainId: number;
  status: CurrencyStatus;
  name: string;
  ...
  queryFn?: _tanstack_react_query120.QueryFunction<{
    contractAddress: string;
    chainId: number;
    status: CurrencyStatus;
    name: string;
...
//# sourceMappingURL=marketCurrencies-Cg6W8p5u.d.ts.map