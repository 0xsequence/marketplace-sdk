import { SdkConfig } from "./create-config-DrQDberp.js";
 ...
 */
declare function tokenBalancesOptions(args: UseTokenBalancesArgs, config: SdkConfig): _tanstack_react_query341.UseQueryOptions<_0xsequence_indexer20.TokenBalance[], Error, _0xsequence_indexer20.TokenBalance[], readonly ["collectable", "collectable", "details", "userBalances", {
  chainId: number;
  accountAddress: `0x${string}` | undefined;
  contractAddress: `0x${string}`;
  includeMetadata: boolean | undefined;
  ...
  initialData?: _0xsequence_indexer20.TokenBalance[] | _tanstack_react_query341.InitialDataFunction<_0xsequence_indexer20.TokenBalance[]> | undefined;
} & {
...
//# sourceMappingURL=index-DwGSy6pZ.d.ts.map