import { ListCollectibleActivitiesReturn, ListCollectiblesReturn, Optional } from "./create-config-CsagtMvq.js";
import { CollectibleQueryOptions, CountOfCollectablesQueryOptions, ListCollectibleActivitiesQueryOptions, ListCollectiblesPaginatedQueryOptions, ListCollectiblesQueryOptions, UseBalanceOfCollectibleArgs, fetchListCollectibleActivities$1 as fetchListCollectibleActivities, fetchListCollectiblesPaginated$1 as fetchListCollectiblesPaginated } from "./listCollectiblesPaginated-CkYQ9Quo.js";
...
import * as _tanstack_react_query379 from "@tanstack/react-query";
import * as _tanstack_react_query381 from "@tanstack/react-query";
import * as _0xsequence_indexer19 from "@0xsequence/indexer";
import * as _0xsequence_metadata90 from "@0xsequence/metadata";
 ...
 * ```
 */
declare function useBalanceOfCollectible(args: UseBalanceOfCollectibleArgs): _tanstack_react_query370.UseQueryResult<_0xsequence_indexer19.TokenBalance, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectible(params: UseCollectibleParams): _tanstack_react_query377.UseQueryResult<_0xsequence_metadata90.TokenMetadata, Error>;
//#endregion
 ...
 * ```
 */
declare function useCountOfCollectables(params: UseCountOfCollectablesParams): _tanstack_react_query378.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectibles(params: UseListCollectiblesParams): _tanstack_react_query379.UseInfiniteQueryResult<_tanstack_react_query379.InfiniteData<ListCollectiblesReturn, unknown>, Error>;
 ...
 * ```
 */
declare function useListCollectiblesPaginated(params: UseListCollectiblesPaginatedParams): _tanstack_react_query381.UseQueryResult<ListCollectiblesReturn, Error>;
...
//#endregion
export { UseCollectibleParams, UseCountOfCollectablesParams, UseListCollectibleActivitiesArgs, UseListCollectibleActivitiesParams, UseListCollectibleActivitiesReturn, UseListCollectiblesArgs, UseListCollectiblesPaginatedArgs, UseListCollectiblesPaginatedParams, UseListCollectiblesPaginatedReturn, UseListCollectiblesParams, useBalanceOfCollectible as useBalanceOfCollectible$1, useCollectible as useCollectible$1, useCountOfCollectables as useCountOfCollectables$1, useListCollectibleActivities as useListCollectibleActivities$1, useListCollectibles as useListCollectibles$1, useListCollectiblesPaginated as useListCollectiblesPaginated$1 };
//# sourceMappingURL=index-PzrJW20c.d.ts.map