import { AdditionalFee, BuyModalProps, ContractType, CreateReq, GenerateCancelTransactionArgs, GenerateListingTransactionArgs, GenerateOfferTransactionArgs, GenerateSellTransactionArgs, MarketplaceKind, ModalCallbacks, SdkConfig, Step, TransactionType$2 as TransactionType, WalletKind } from "./create-config-CsagtMvq.js";
...
declare function useBuyTransaction(modalProps: BuyModalProps): {
  ...
  error: Error | null;
  isError: boolean;
  refetch: (options?: _tanstack_react_query285.RefetchOptions) => Promise<_tanstack_react_query285.QueryObserverResult<Step[], Error>>;
};
//#endregion
...
declare const useGenerateCancelTransaction: (params: UseGenerateCancelTransactionArgs) => {
  generateCancelTransaction: _tanstack_react_query295.UseMutateFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  generateCancelTransactionAsync: _tanstack_react_query295.UseMutateAsyncFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateListingTransaction: (params: UseGenerateListingTransactionArgs) => {
  generateListingTransaction: _tanstack_react_query303.UseMutateFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateListingTransactionAsync: _tanstack_react_query303.UseMutateAsyncFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateOfferTransaction: (params: UseGenerateOfferTransactionArgs) => {
  generateOfferTransaction: _tanstack_react_query311.UseMutateFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateOfferTransactionAsync: _tanstack_react_query311.UseMutateAsyncFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateSellTransaction: (params: UseGenerateSellTransactionArgs) => {
  generateSellTransaction: _tanstack_react_query287.UseMutateFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateSellTransactionAsync: _tanstack_react_query287.UseMutateAsyncFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare function useMarketTransactionSteps({
  ...
  additionalFees,
  enabled
}: UseMarketTransactionStepsParams): _tanstack_react_query319.UseQueryResult<Step[], Error>;
//#endregion
...
declare function usePrimarySaleTransactionSteps({
  ...
  contractType,
  enabled
}: UsePrimarySaleTransactionStepsParams): _tanstack_react_query321.UseQueryResult<Step[], Error>;
//#endregion
...
//#endregion
export { CreateReqWithDateExpiry$1 as CreateReqWithDateExpiry, GenerateListingTransactionProps, GenerateOfferTransactionProps, TransactionStep, TransferTokensParams, UseGenerateListingTransactionArgs, UseGenerateOfferTransactionArgs, UseMarketTransactionStepsParams, UsePrimarySaleTransactionStepsParams, generateCancelTransaction as generateCancelTransaction$1, generateListingTransaction as generateListingTransaction$1, generateOfferTransaction as generateOfferTransaction$1, generateSellTransaction as generateSellTransaction$1, useBuyTransaction as useBuyTransaction$1, useCancelOrder as useCancelOrder$1, useCancelTransactionSteps as useCancelTransactionSteps$1, useGenerateCancelTransaction as useGenerateCancelTransaction$1, useGenerateListingTransaction as useGenerateListingTransaction$1, useGenerateOfferTransaction as useGenerateOfferTransaction$1, useGenerateSellTransaction as useGenerateSellTransaction$1, useMarketTransactionSteps as useMarketTransactionSteps$1, useOrderSteps as useOrderSteps$1, usePrimarySaleTransactionSteps as usePrimarySaleTransactionSteps$1, useProcessStep as useProcessStep$1, useTransactionExecution as useTransactionExecution$1, useTransactionType as useTransactionType$1, useTransferTokens as useTransferTokens$1 };
//# sourceMappingURL=index-Pj-SiP5Z.d.ts.map