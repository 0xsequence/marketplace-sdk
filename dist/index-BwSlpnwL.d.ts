import { Oi as PropertyFilter$1, _i as PriceFilter, j as Optional, ki as PropertyType } from "./create-config-Cws5O44a.js";
import { n as FiltersQueryOptions } from "./filters-iQMVtlRs.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query371.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query371.RefetchOptions) => Promise<_tanstack_react_query371.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query371.FetchStatus;
...
//# sourceMappingURL=index-BwSlpnwL.d.ts.map