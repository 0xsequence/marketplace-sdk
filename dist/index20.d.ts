import { Ar as PropertyFilter, Cn as Order, G as Optional } from "./create-config.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query393.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query393.RefetchOptions) => Promise<_tanstack_react_query393.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query393.FetchStatus;
