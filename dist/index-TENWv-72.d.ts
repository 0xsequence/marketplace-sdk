import { ContractType, CreateReq, GenerateCancelTransactionArgs, GenerateListingTransactionArgs, GenerateOfferTransactionArgs, GenerateSellTransactionArgs, MarketplaceKind, SdkConfig, Step, WalletKind } from "./create-config-CpiC1m8h.js";
import { ModalCallbacks } from "./types-BqUv3IAY.js";
import * as _tanstack_react_query156 from "@tanstack/react-query";
...
declare const useGenerateCancelTransaction: (params: UseGenerateCancelTransactionArgs) => {
  generateCancelTransaction: _tanstack_react_query156.UseMutateFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  generateCancelTransactionAsync: _tanstack_react_query156.UseMutateAsyncFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateListingTransaction: (params: UseGenerateListingTransactionArgs) => {
  generateListingTransaction: _tanstack_react_query156.UseMutateFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateListingTransactionAsync: _tanstack_react_query156.UseMutateAsyncFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateOfferTransaction: (params: UseGenerateOfferTransactionArgs) => {
  generateOfferTransaction: _tanstack_react_query156.UseMutateFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateOfferTransactionAsync: _tanstack_react_query156.UseMutateAsyncFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateSellTransaction: (params: UseGenerateSellTransactionArgs) => {
  generateSellTransaction: _tanstack_react_query156.UseMutateFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateSellTransactionAsync: _tanstack_react_query156.UseMutateAsyncFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
//# sourceMappingURL=index-TENWv-72.d.ts.map