import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-DrQDberp.js";
import { FiltersQueryOptions } from "./filters-8hWdGA6z.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query343.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query343.RefetchOptions) => Promise<_tanstack_react_query343.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query343.FetchStatus;
...
//# sourceMappingURL=index-CXCMLM2Q.d.ts.map