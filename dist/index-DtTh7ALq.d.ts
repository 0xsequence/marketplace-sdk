import { Ft as CollectibleOrder, Gt as ContractType, Oi as PropertyFilter, _i as PriceFilter, fi as OrderbookKind, j as Optional, jr as ListCollectiblesReturn, nn as CurrencyStatus, tn as Currency, tt as CollectibleCardAction } from "./create-config-BA_ne-vj.js";
import { n as MarketCurrenciesQueryOptions, o as CurrencyQueryOptions } from "./marketCurrencies-DfUy7Z__.js";
import { r as MarketCollectibleCardProps } from "./types-IuIgdKmI.js";
import * as _tanstack_react_query385 from "@tanstack/react-query";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query385.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query385.FetchNextPageOptions) => Promise<_tanstack_react_query385.InfiniteQueryObserverResult<_tanstack_react_query385.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query385.UseQueryResult<{
...
//# sourceMappingURL=index-DtTh7ALq.d.ts.map