import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-goz-zUX1.js";
import { FiltersQueryOptions } from "./filters-BGVF-L-m.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query189.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query189.RefetchOptions) => Promise<_tanstack_react_query189.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query189.FetchStatus;
...
//# sourceMappingURL=index-B257S7Or.d.ts.map