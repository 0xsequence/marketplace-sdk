import { $ as SdkConfig, Gt as ContractType, mi as Page$1, ni as MetadataStatus } from "./create-config-BA_ne-vj.js";
...
declare function inventoryOptions(args: UseInventoryArgs, config: SdkConfig): _tanstack_react_query118.OmitKeyof<_tanstack_react_query118.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, (string | number)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query118.QueryFunction<CollectiblesResponse, (string | number)[], never> | undefined;
} & {
...
//# sourceMappingURL=index-pmDoUU2I.d.ts.map