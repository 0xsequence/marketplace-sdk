...
import * as _tanstack_react_query335 from "@tanstack/react-query";
...
import * as _tanstack_react_query367 from "@tanstack/react-query";
import * as _tanstack_react_query375 from "@tanstack/react-query";
import * as _tanstack_react_query381 from "@tanstack/react-query";
...
declare function countItemsOrdersForCollectionQueryOptions(params: CountItemsOrdersForCollectionQueryOptions): _tanstack_react_query384.OmitKeyof<_tanstack_react_query384.UseQueryOptions<number, Error, number, readonly ["collections", "collectionItemsOrdersCount", {
  chainId: string;
  contractAddress: string | undefined;
  side: OrderSide | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query384.QueryFunction<number, readonly ["collections", "collectionItemsOrdersCount", {
    chainId: string;
    contractAddress: string | undefined;
    side: OrderSide | undefined;
  }], never> | undefined;
...
declare function countListingsForCollectibleQueryOptions(params: CountListingsForCollectibleQueryOptions): _tanstack_react_query388.OmitKeyof<_tanstack_react_query388.UseQueryOptions<number, Error, number, readonly ["collectable", "listingsCount", {
  chainId: string;
  contractAddress: string | undefined;
  tokenId: string | undefined;
  filter: OrderFilter | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query388.QueryFunction<number, readonly ["collectable", "listingsCount", {
    chainId: string;
    contractAddress: string | undefined;
    tokenId: string | undefined;
    filter: OrderFilter | undefined;
...
declare function countOffersForCollectibleQueryOptions(params: CountOffersForCollectibleQueryOptions): _tanstack_react_query335.OmitKeyof<_tanstack_react_query335.UseQueryOptions<number, Error, number, readonly ["collectable", "offersCount", {
  chainId: string;
  contractAddress: string | undefined;
  tokenId: string | undefined;
  filter: OrderFilter | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query335.QueryFunction<number, readonly ["collectable", "offersCount", {
    chainId: string;
    contractAddress: string | undefined;
    tokenId: string | undefined;
    filter: OrderFilter | undefined;
...
declare function floorOrderQueryOptions(params: FloorOrderQueryOptions): _tanstack_react_query338.OmitKeyof<_tanstack_react_query338.UseQueryOptions<CollectibleOrder, Error, CollectibleOrder, readonly ["collectable", "floorOrders", {
  chainId: string;
  contractAddress: string | undefined;
  filter: CollectiblesFilter | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query338.QueryFunction<CollectibleOrder, readonly ["collectable", "floorOrders", {
    chainId: string;
    contractAddress: string | undefined;
    filter: CollectiblesFilter | undefined;
  }], never> | undefined;
...
declare function getCountOfFilteredOrdersQueryOptions(params: GetCountOfFilteredOrdersQueryOptions): _tanstack_react_query341.OmitKeyof<_tanstack_react_query341.UseQueryOptions<number, Error, number, readonly ["collections", "getCountOfFilteredOrders", {
  chainId: string;
  contractAddress: string | undefined;
  side: OrderSide | undefined;
  filter: OrdersFilter | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query341.QueryFunction<number, readonly ["collections", "getCountOfFilteredOrders", {
    chainId: string;
    contractAddress: string | undefined;
    side: OrderSide | undefined;
    filter: OrdersFilter | undefined;
...
declare function highestOfferQueryOptions(params: HighestOfferQueryOptions): _tanstack_react_query347.OmitKeyof<_tanstack_react_query347.UseQueryOptions<Order | null, Error, Order | null, readonly ["collectable", "collectable", "details", "highestOffers", {
  chainId: string;
  contractAddress: string | undefined;
  tokenId: string | undefined;
  filter: OrderFilter | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query347.QueryFunction<Order | null, readonly ["collectable", "collectable", "details", "highestOffers", {
    chainId: string;
    contractAddress: string | undefined;
    tokenId: string | undefined;
    filter: OrderFilter | undefined;
...
declare function listItemsOrdersForCollectionQueryOptions(params: ListItemsOrdersForCollectionQueryOptions): _tanstack_react_query351.OmitKeyof<_tanstack_react_query351.UseInfiniteQueryOptions<ListOrdersWithCollectiblesReturn, Error, _tanstack_react_query351.InfiniteData<ListOrdersWithCollectiblesReturn, unknown>, readonly ["collections", "collectionItemsOrders", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  side: OrderSide | undefined;
  filter: OrdersFilter | undefined;
}], Page>, "queryFn"> & {
  queryFn?: _tanstack_react_query351.QueryFunction<ListOrdersWithCollectiblesReturn, readonly ["collections", "collectionItemsOrders", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    side: OrderSide | undefined;
    filter: OrdersFilter | undefined;
  ...
  queryKey: readonly ["collections", "collectionItemsOrders", {
    ...
    [dataTagSymbol]: _tanstack_react_query351.InfiniteData<ListOrdersWithCollectiblesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listItemsOrdersForCollectionPaginatedQueryOptions(params: ListItemsOrdersForCollectionPaginatedQueryOptions): _tanstack_react_query367.OmitKeyof<_tanstack_react_query367.UseQueryOptions<ListOrdersWithCollectiblesReturn, Error, ListOrdersWithCollectiblesReturn, (string | ListItemsOrdersForCollectionPaginatedQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query367.QueryFunction<ListOrdersWithCollectiblesReturn, (string | ListItemsOrdersForCollectionPaginatedQueryOptions)[], never> | undefined;
} & {
...
declare function listListingsForCollectibleQueryOptions(params: ListListingsForCollectibleQueryOptions): _tanstack_react_query375.OmitKeyof<_tanstack_react_query375.UseQueryOptions<ListCollectibleListingsReturn, Error, ListCollectibleListingsReturn, readonly ["collectable", "listings", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  tokenId: string | undefined;
  filter: OrderFilter | undefined;
  ...
  queryFn?: _tanstack_react_query375.QueryFunction<ListCollectibleListingsReturn, readonly ["collectable", "listings", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    tokenId: string | undefined;
    filter: OrderFilter | undefined;
...
declare function listOffersForCollectibleQueryOptions(params: ListOffersForCollectibleQueryOptions): _tanstack_react_query381.OmitKeyof<_tanstack_react_query381.UseQueryOptions<ListCollectibleOffersReturn, Error, ListCollectibleOffersReturn, readonly ["collectable", "offers", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  tokenId: string | undefined;
  filter: OrderFilter | undefined;
  ...
  queryFn?: _tanstack_react_query381.QueryFunction<ListCollectibleOffersReturn, readonly ["collectable", "offers", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    tokenId: string | undefined;
    filter: OrderFilter | undefined;
...
declare function lowestListingQueryOptions(params: LowestListingQueryOptions): _tanstack_react_query391.OmitKeyof<_tanstack_react_query391.UseQueryOptions<Order | null | undefined, Error, Order | null | undefined, readonly ["collectable", "collectable", "details", "lowestListings", {
  chainId: string;
  contractAddress: string | undefined;
  tokenId: string | undefined;
  filter: OrderFilter | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query391.QueryFunction<Order | null | undefined, readonly ["collectable", "collectable", "details", "lowestListings", {
    chainId: string;
    contractAddress: string | undefined;
    tokenId: string | undefined;
    filter: OrderFilter | undefined;
...
//# sourceMappingURL=lowestListing-D8n6UjBW.d.ts.map