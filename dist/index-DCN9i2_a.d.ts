import { ContractType, MetadataStatus, Page as Page$1, SdkConfig } from "./create-config-DoEY40YQ.js";
...
declare function inventoryOptions(args: UseInventoryArgs, config: SdkConfig): _tanstack_react_query37.OmitKeyof<_tanstack_react_query37.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, (string | number)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query37.QueryFunction<CollectiblesResponse, (string | number)[], never> | undefined;
} & {
...
//# sourceMappingURL=index-DCN9i2_a.d.ts.map