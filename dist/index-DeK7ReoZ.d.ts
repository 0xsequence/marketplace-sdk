import { A as Optional, fr as ListCollectibleActivitiesReturn, vr as ListCollectiblesReturn } from "./create-config-Dz-QylqB.js";
 ...
 * ```
 */
declare function useBalanceOfCollectible(args: UseBalanceOfCollectibleArgs): _tanstack_react_query218.UseQueryResult<_0xsequence_indexer3.TokenBalance, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectible(params: UseCollectibleParams): _tanstack_react_query218.UseQueryResult<_0xsequence_metadata80.TokenMetadata, Error>;
//#endregion
 ...
 * ```
 */
declare function useCountOfCollectables(params: UseCountOfCollectablesParams): _tanstack_react_query218.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useListCollectibleActivities(params: UseListCollectibleActivitiesParams): _tanstack_react_query218.UseQueryResult<ListCollectibleActivitiesReturn, Error>;
 ...
 * ```
 */
declare function useListCollectibles(params: UseListCollectiblesParams): _tanstack_react_query218.UseInfiniteQueryResult<_tanstack_react_query218.InfiniteData<ListCollectiblesReturn, unknown>, Error>;
 ...
 * ```
 */
declare function useListCollectiblesPaginated(params: UseListCollectiblesPaginatedParams): _tanstack_react_query218.UseQueryResult<ListCollectiblesReturn, Error>;
...
//# sourceMappingURL=index-DeK7ReoZ.d.ts.map