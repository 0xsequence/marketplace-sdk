 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query354.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query354.RefetchOptions) => Promise<_tanstack_react_query354.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query354.FetchStatus;
