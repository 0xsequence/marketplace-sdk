import { Di as Step, G as SdkConfig, Kt as CreateReq, Lt as ContractType, Xi as WalletKind, _n as GenerateSellTransactionArgs, dn as GenerateCancelTransactionArgs, hn as GenerateOfferTransactionArgs, nt as ModalCallbacks, pn as GenerateListingTransactionArgs, qr as MarketplaceKind } from "./create-config.js";
...
declare const useGenerateCancelTransaction: (params: UseGenerateCancelTransactionArgs) => {
  generateCancelTransaction: _tanstack_react_query370.UseMutateFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  generateCancelTransactionAsync: _tanstack_react_query370.UseMutateAsyncFunction<Step[], Error, GenerateCancelTransactionArgsWithNumberChainId, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateListingTransaction: (params: UseGenerateListingTransactionArgs) => {
  generateListingTransaction: _tanstack_react_query370.UseMutateFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateListingTransactionAsync: _tanstack_react_query370.UseMutateAsyncFunction<Step[], Error, Omit<GenerateListingTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateOfferTransaction: (params: UseGenerateOfferTransactionArgs) => {
  generateOfferTransaction: _tanstack_react_query370.UseMutateFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateOfferTransactionAsync: _tanstack_react_query370.UseMutateAsyncFunction<Step[], Error, Omit<GenerateOfferTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
declare const useGenerateSellTransaction: (params: UseGenerateSellTransactionArgs) => {
  generateSellTransaction: _tanstack_react_query370.UseMutateFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  generateSellTransactionAsync: _tanstack_react_query370.UseMutateAsyncFunction<Step[], Error, Omit<GenerateSellTransactionArgsWithNumberChainId, "chainId">, unknown>;
  data: undefined;
  variables: undefined;
  error: null;
  isError: false;
...
//#endregion
export { useGenerateCancelTransaction as _, generateSellTransaction as a, useCancelOrder as b, UseGenerateOfferTransactionArgs as c, CreateReqWithDateExpiry$1 as d, GenerateListingTransactionProps as f, generateCancelTransaction as g, useGenerateListingTransaction as h, useOrderSteps as i, generateOfferTransaction as l, generateListingTransaction as m, useTransferTokens as n, useGenerateSellTransaction as o, UseGenerateListingTransactionArgs as p, useProcessStep as r, GenerateOfferTransactionProps as s, TransferTokensParams as t, useGenerateOfferTransaction as u, useCancelTransactionSteps as v, TransactionStep as y };
