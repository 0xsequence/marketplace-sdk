...
declare function comparePricesQueryOptions(params: WithOptionalParams<WithRequired<ComparePricesQueryOptions, 'chainId' | 'priceAmountRaw' | 'priceCurrencyAddress' | 'compareToPriceAmountRaw' | 'compareToPriceCurrencyAddress' | 'config'>>): _tanstack_react_query82.OmitKeyof<_tanstack_react_query82.UseQueryOptions<ComparePricesReturn, Error, ComparePricesReturn, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query82.QueryFunction<ComparePricesReturn, readonly unknown[], never> | undefined;
} & {
...
declare function convertPriceToUSDQueryOptions(params: WithOptionalParams<WithRequired<ConvertPriceToUSDQueryOptions, 'chainId' | 'currencyAddress' | 'amountRaw' | 'config'>>): _tanstack_react_query82.OmitKeyof<_tanstack_react_query82.UseQueryOptions<ConvertPriceToUSDReturn, Error, ConvertPriceToUSDReturn, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query82.QueryFunction<ConvertPriceToUSDReturn, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function currencyQueryOptions(params: WithOptionalParams<WithRequired<CurrencyQueryOptions, 'chainId' | 'currencyAddress' | 'config'>>): _tanstack_react_query82.OmitKeyof<_tanstack_react_query82.UseQueryOptions<Currency | undefined, Error, Currency | undefined, readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query82.QueryFunction<Currency | undefined, readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
...
declare function marketCurrenciesQueryOptions(params: WithOptionalParams<WithRequired<MarketCurrenciesQueryOptions, 'chainId' | 'config'>>): _tanstack_react_query82.OmitKeyof<_tanstack_react_query82.UseQueryOptions<Currency[], Error, Currency[], readonly unknown[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query82.QueryFunction<Currency[], readonly unknown[], never> | undefined;
} & {
  queryKey: readonly unknown[] & {
