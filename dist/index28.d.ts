...
declare function tokenSuppliesQueryOptions(params: TokenSuppliesQueryOptions): _tanstack_react_query66.OmitKeyof<_tanstack_react_query66.UseInfiniteQueryOptions<Indexer.GetTokenSuppliesResponse, Error, _tanstack_react_query66.InfiniteData<Indexer.GetTokenSuppliesResponse, unknown>, readonly ["token", string, {
  chainId: number;
  collectionAddress: string;
  includeMetadata: boolean | undefined;
  metadataOptions: {
  ...
  queryFn?: _tanstack_react_query66.QueryFunction<Indexer.GetTokenSuppliesResponse, readonly ["token", string, {
    chainId: number;
    collectionAddress: string;
    includeMetadata: boolean | undefined;
    metadataOptions: {
  ...
  queryKey: readonly ["token", string, {
    ...
    [dataTagSymbol]: _tanstack_react_query66.InfiniteData<Indexer.GetTokenSuppliesResponse, unknown>;
