 ...
 * ```
 */
declare function useCollectibleBalance(args: Omit<BalanceOfCollectibleQueryOptions, 'config'>): _tanstack_react_query388.UseQueryResult<_0xsequence_api_client306.IndexerTokenBalance, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketActivities(params: UseCollectibleMarketActivitiesParams): _tanstack_react_query388.UseQueryResult<_0xsequence_api_client306.ListCollectibleActivitiesResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketCount(params: UseCollectibleMarketCountParams): _tanstack_react_query388.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketList(params: UseCollectibleMarketListParams): _tanstack_react_query388.UseInfiniteQueryResult<_tanstack_react_query388.InfiniteData<_0xsequence_api_client306.ListCollectiblesResponse, unknown>, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketListPaginated(params: UseCollectibleMarketListPaginatedParams): _tanstack_react_query388.UseQueryResult<_0xsequence_api_client306.ListCollectiblesResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketListings(params: UseCollectibleMarketListingsParams): _tanstack_react_query388.UseQueryResult<_0xsequence_api_client306.ListCollectibleListingsResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketListingsCount(params: UseCollectibleMarketListingsCountParams): _tanstack_react_query388.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMarketOffers(params: UseCollectibleMarketOffersParams): _tanstack_react_query388.UseQueryResult<_0xsequence_api_client306.ListCollectibleOffersResponse, Error>;
 ...
 * ```
 */
declare function useCollectibleMarketOffersCount(params: UseCollectibleMarketOffersCountParams): _tanstack_react_query388.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleMetadata(params: UseCollectibleMetadataParams): _tanstack_react_query388.UseQueryResult<_0xsequence_api_client306.TokenMetadata, Error>;
//#endregion
 ...
 * ```
 */
declare function usePrimarySaleItem(params: UsePrimarySaleItemParams): _tanstack_react_query388.UseQueryResult<_0xsequence_api_client306.GetPrimarySaleItemResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function usePrimarySaleItems(params: UsePrimarySaleItemsParams): _tanstack_react_query388.UseInfiniteQueryResult<_tanstack_react_query388.InfiniteData<_0xsequence_api_client306.ListPrimarySaleItemsResponse, unknown>, Error>;
//#endregion
...
declare function usePrimarySaleItemsCount(args: UsePrimarySaleItemsCountParams): _tanstack_react_query388.UseQueryResult<_0xsequence_api_client306.GetCountOfPrimarySaleItemsResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCollectibleTokenBalances(args: Omit<TokenBalancesQueryOptions, 'config'>): _tanstack_react_query388.UseQueryResult<_0xsequence_api_client306.IndexerTokenBalance[], Error>;
//#endregion
