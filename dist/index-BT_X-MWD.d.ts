import { CollectibleCardAction$1 as CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PriceFilter, PropertyFilter } from "./create-config-BpPJGqAC.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-CrwTRa90.js";
import { MarketCollectibleCardProps } from "./types-C9LTKJDC.js";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query379.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query380.FetchNextPageOptions) => Promise<_tanstack_react_query380.InfiniteQueryObserverResult<_tanstack_react_query380.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
...
//# sourceMappingURL=index-BT_X-MWD.d.ts.map