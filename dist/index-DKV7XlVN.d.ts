...
declare function useBuyTransaction(modalProps: BuyModalProps): {
  ...
  error: Error | null;
  isError: boolean;
  refetch: (options?: _tanstack_react_query370.RefetchOptions) => Promise<_tanstack_react_query370.QueryObserverResult<Step[], Error>>;
};
//#endregion
...
declare function useMarketTransactionSteps({
  ...
  additionalFees,
  enabled
}: UseMarketTransactionStepsParams): _tanstack_react_query370.UseQueryResult<Step[], Error>;
//#endregion
...
declare function usePrimarySaleTransactionSteps({
  ...
  contractType,
  enabled
}: UsePrimarySaleTransactionStepsParams): _tanstack_react_query370.UseQueryResult<Step[], Error>;
//#endregion
...
//# sourceMappingURL=index-DKV7XlVN.d.ts.map