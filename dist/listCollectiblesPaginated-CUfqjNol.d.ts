import { CardType, CollectiblesFilter, ListCollectibleActivitiesArgs, ListCollectibleActivitiesReturn, ListCollectiblesArgs, ListCollectiblesReturn, OrderSide, Page as Page$2, SdkConfig, SortBy, ValuesOptional } from "./create-config-D6v7S2xr.js";
 ...
 */
declare function balanceOfCollectibleOptions(args: UseBalanceOfCollectibleArgs, config: SdkConfig): _tanstack_react_query217.UseQueryOptions<_0xsequence_indexer4.TokenBalance, Error, _0xsequence_indexer4.TokenBalance, ("details" | "collectable" | "userBalances" | UseBalanceOfCollectibleArgs)[]> & {
  initialData?: _0xsequence_indexer4.TokenBalance | _tanstack_react_query217.InitialDataFunction<_0xsequence_indexer4.TokenBalance> | undefined;
} & {
...
declare function collectibleQueryOptions(params: CollectibleQueryOptions): _tanstack_react_query217.OmitKeyof<_tanstack_react_query217.UseQueryOptions<_0xsequence_metadata80.TokenMetadata, Error, _0xsequence_metadata80.TokenMetadata, ("details" | "collectable" | CollectibleQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query217.QueryFunction<_0xsequence_metadata80.TokenMetadata, ("details" | "collectable" | CollectibleQueryOptions)[], never> | undefined;
} & {
...
declare function countOfCollectablesQueryOptions(params: CountOfCollectablesQueryOptions): _tanstack_react_query217.OmitKeyof<_tanstack_react_query217.UseQueryOptions<number, Error, number, ("collectable" | "counts" | CountOfCollectablesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query217.QueryFunction<number, ("collectable" | "counts" | CountOfCollectablesQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectibleActivitiesQueryOptions(params: ListCollectibleActivitiesQueryOptions): _tanstack_react_query217.OmitKeyof<_tanstack_react_query217.UseQueryOptions<ListCollectibleActivitiesReturn, Error, ListCollectibleActivitiesReturn, ("collectable" | "collectibleActivities" | ListCollectibleActivitiesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query217.QueryFunction<ListCollectibleActivitiesReturn, ("collectable" | "collectibleActivities" | ListCollectibleActivitiesQueryOptions)[], never> | undefined;
} & {
...
declare function listCollectiblesQueryOptions(params: ListCollectiblesQueryOptions): _tanstack_react_query217.OmitKeyof<_tanstack_react_query217.UseInfiniteQueryOptions<ListCollectiblesReturn, Error, _tanstack_react_query217.InfiniteData<ListCollectiblesReturn, unknown>, ("list" | "collectable" | ListCollectiblesQueryOptions)[], Page$2>, "queryFn"> & {
  queryFn?: _tanstack_react_query217.QueryFunction<ListCollectiblesReturn, ("list" | "collectable" | ListCollectiblesQueryOptions)[], Page$2> | undefined;
} & {
  queryKey: ("list" | "collectable" | ListCollectiblesQueryOptions)[] & {
    [dataTagSymbol]: _tanstack_react_query217.InfiniteData<ListCollectiblesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listCollectiblesPaginatedQueryOptions(params: ListCollectiblesPaginatedQueryOptions): _tanstack_react_query217.OmitKeyof<_tanstack_react_query217.UseQueryOptions<ListCollectiblesReturn, Error, ListCollectiblesReturn, (string | ListCollectiblesPaginatedQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query217.QueryFunction<ListCollectiblesReturn, (string | ListCollectiblesPaginatedQueryOptions)[], never> | undefined;
} & {
...
//# sourceMappingURL=listCollectiblesPaginated-CUfqjNol.d.ts.map