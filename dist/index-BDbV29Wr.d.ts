import { CollectibleCardAction, CollectibleOrder, ContractType, Currency, CurrencyStatus, ListCollectiblesReturn, Optional, OrderbookKind, PropertyFilter } from "./create-config-DjQjhu3-.js";
import { CurrencyQueryOptions, MarketCurrenciesQueryOptions } from "./marketCurrencies-BFLsaoTU.js";
import { MarketCollectibleCardProps } from "./types-Cn1uqBNg.js";
 ...
 * ```
 */
declare function useCurrency(params: UseCurrencyParams): _tanstack_react_query175.UseQueryResult<Currency | undefined, Error>;
//#endregion
...
declare function useListMarketCardData({
  ...
  fetchNextPage: (options?: _tanstack_react_query175.FetchNextPageOptions) => Promise<_tanstack_react_query175.InfiniteQueryObserverResult<_tanstack_react_query175.InfiniteData<ListCollectiblesReturn, unknown>, Error>>;
 ...
 * ```
 */
declare function useMarketCurrencies(params: UseMarketCurrenciesParams): _tanstack_react_query175.UseQueryResult<{
...
//# sourceMappingURL=index-BDbV29Wr.d.ts.map