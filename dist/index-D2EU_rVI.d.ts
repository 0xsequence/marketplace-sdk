...
declare function checkoutOptionsQueryOptions(params: CheckoutOptionsQueryOptions): _tanstack_react_query280.OmitKeyof<_tanstack_react_query280.UseQueryOptions<CheckoutOptionsMarketplaceReturn, Error, CheckoutOptionsMarketplaceReturn, (string | CheckoutOptionsQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query280.QueryFunction<CheckoutOptionsMarketplaceReturn, (string | CheckoutOptionsQueryOptions)[], never> | undefined;
} & {
...
declare function checkoutOptionsSalesContractQueryOptions(params: CheckoutOptionsSalesContractQueryOptions): _tanstack_react_query280.OmitKeyof<_tanstack_react_query280.UseQueryOptions<CheckoutOptionsSalesContractReturn, Error, CheckoutOptionsSalesContractReturn, (string | CheckoutOptionsSalesContractQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query280.QueryFunction<CheckoutOptionsSalesContractReturn, (string | CheckoutOptionsSalesContractQueryOptions)[], never> | undefined;
} & {
...
declare function comparePricesQueryOptions(params: ComparePricesQueryOptions): _tanstack_react_query280.OmitKeyof<_tanstack_react_query280.UseQueryOptions<ComparePricesReturn, Error, ComparePricesReturn, (string | ComparePricesQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query280.QueryFunction<ComparePricesReturn, (string | ComparePricesQueryOptions)[], never> | undefined;
} & {
...
declare function convertPriceToUSDQueryOptions(params: ConvertPriceToUSDQueryOptions): _tanstack_react_query280.OmitKeyof<_tanstack_react_query280.UseQueryOptions<ConvertPriceToUSDReturn, Error, ConvertPriceToUSDReturn, (string | ConvertPriceToUSDQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query280.QueryFunction<ConvertPriceToUSDReturn, (string | ConvertPriceToUSDQueryOptions)[], never> | undefined;
} & {
...
declare function countOfPrimarySaleItemsOptions(args: UseCountOfPrimarySaleItemsArgs, config: SdkConfig): _tanstack_react_query280.OmitKeyof<_tanstack_react_query280.UseQueryOptions<number, Error, number, (string | UseCountOfPrimarySaleItemsArgs)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query280.QueryFunction<number, (string | UseCountOfPrimarySaleItemsArgs)[], never> | undefined;
} & {
...
declare function inventoryOptions(args: UseInventoryArgs, config: SdkConfig): _tanstack_react_query280.OmitKeyof<_tanstack_react_query280.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, (string | number)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query280.QueryFunction<CollectiblesResponse, (string | number)[], never> | undefined;
} & {
...
declare const listPrimarySaleItemsQueryOptions: (params: ListPrimarySaleItemsQueryOptions) => _tanstack_react_query280.OmitKeyof<_tanstack_react_query280.UseInfiniteQueryOptions<ListPrimarySaleItemsReturn, Error, _tanstack_react_query280.InfiniteData<ListPrimarySaleItemsReturn, unknown>, (string | ListPrimarySaleItemsQueryOptions)[], {
  page: number;
  pageSize: number;
}>, "queryFn"> & {
  queryFn?: _tanstack_react_query280.QueryFunction<ListPrimarySaleItemsReturn, (string | ListPrimarySaleItemsQueryOptions)[], {
    page: number;
    pageSize: number;
  }> | undefined;
} & {
  queryKey: (string | ListPrimarySaleItemsQueryOptions)[] & {
    [dataTagSymbol]: _tanstack_react_query280.InfiniteData<ListPrimarySaleItemsReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare const primarySaleItemsCountQueryOptions: (args: PrimarySaleItemsCountQueryOptions) => _tanstack_react_query280.OmitKeyof<_tanstack_react_query280.UseQueryOptions<GetCountOfPrimarySaleItemsReturn, Error, GetCountOfPrimarySaleItemsReturn, (string | PrimarySaleItemsCountQueryOptions)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query280.QueryFunction<GetCountOfPrimarySaleItemsReturn, (string | PrimarySaleItemsCountQueryOptions)[], never> | undefined;
} & {
...
//# sourceMappingURL=index-D2EU_rVI.d.ts.map