import { Cr as ListCollectiblesReturn, G as SdkConfig, K as CardType, Sr as ListCollectiblesArgs, _r as ListCollectibleActivitiesReturn, gr as ListCollectibleActivitiesArgs, j as ValuesOptional, jt as CollectiblesFilter, ni as OrderSide, oi as Page$2, wi as SortBy } from "./create-config.js";
...
declare function fetchBalanceOfCollectible(args: Omit<UseBalanceOfCollectibleArgs, 'userAddress'> & {
  userAddress: Address;
}, config: SdkConfig): Promise<_0xsequence_indexer11.TokenBalance>;
 ...
 */
declare function balanceOfCollectibleOptions(args: UseBalanceOfCollectibleArgs, config: SdkConfig): _tanstack_react_query254.UseQueryOptions<_0xsequence_indexer11.TokenBalance, Error, _0xsequence_indexer11.TokenBalance, readonly ["collectable", "collectable", "details", "userBalances", {
  chainId: number;
  accountAddress: `0x${string}` | undefined;
  contractAddress: `0x${string}`;
  tokenID: string;
  ...
  initialData?: _0xsequence_indexer11.TokenBalance | _tanstack_react_query254.InitialDataFunction<_0xsequence_indexer11.TokenBalance> | undefined;
} & {
  queryKey: readonly ["collectable", "collectable", "details", "userBalances", {
    ...
    [dataTagSymbol]: _0xsequence_indexer11.TokenBalance;
...
declare function collectibleQueryOptions(params: CollectibleQueryOptions): _tanstack_react_query254.OmitKeyof<_tanstack_react_query254.UseQueryOptions<_0xsequence_metadata81.TokenMetadata, Error, _0xsequence_metadata81.TokenMetadata, readonly ["collectable", "details", {
  chainID: string;
  contractAddress: string | undefined;
  tokenIDs: string[];
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query254.QueryFunction<_0xsequence_metadata81.TokenMetadata, readonly ["collectable", "details", {
    chainID: string;
    contractAddress: string | undefined;
    tokenIDs: string[];
  }], never> | undefined;
...
declare function countOfCollectablesQueryOptions(params: CountOfCollectablesQueryOptions): _tanstack_react_query254.OmitKeyof<_tanstack_react_query254.UseQueryOptions<number, Error, number, readonly ["collectable", "counts", {
  chainId: string;
  contractAddress: string | undefined;
}]>, "queryFn"> & {
  queryFn?: _tanstack_react_query254.QueryFunction<number, readonly ["collectable", "counts", {
    chainId: string;
    contractAddress: string | undefined;
  }], never> | undefined;
} & {
...
declare function listCollectibleActivitiesQueryOptions(params: ListCollectibleActivitiesQueryOptions): _tanstack_react_query254.OmitKeyof<_tanstack_react_query254.UseQueryOptions<ListCollectibleActivitiesReturn, Error, ListCollectibleActivitiesReturn, readonly ["collectable", "collectibleActivities", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  tokenId: string | undefined;
  page: {
  ...
  queryFn?: _tanstack_react_query254.QueryFunction<ListCollectibleActivitiesReturn, readonly ["collectable", "collectibleActivities", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    tokenId: string | undefined;
    page: {
...
declare function listCollectiblesQueryOptions(params: ListCollectiblesQueryOptions): _tanstack_react_query254.OmitKeyof<_tanstack_react_query254.UseInfiniteQueryOptions<ListCollectiblesReturn, Error, _tanstack_react_query254.InfiniteData<ListCollectiblesReturn, unknown>, readonly ["collectable", "list", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  side: OrderSide | undefined;
  filter: CollectiblesFilter | undefined;
}], Page$2>, "queryFn"> & {
  queryFn?: _tanstack_react_query254.QueryFunction<ListCollectiblesReturn, readonly ["collectable", "list", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    side: OrderSide | undefined;
    filter: CollectiblesFilter | undefined;
  ...
  queryKey: readonly ["collectable", "list", {
    ...
    [dataTagSymbol]: _tanstack_react_query254.InfiniteData<ListCollectiblesReturn, unknown>;
    [dataTagErrorSymbol]: Error;
  };
};
//#endregion
...
declare function listCollectiblesPaginatedQueryOptions(params: ListCollectiblesPaginatedQueryOptions): _tanstack_react_query254.OmitKeyof<_tanstack_react_query254.UseQueryOptions<ListCollectiblesReturn, Error, ListCollectiblesReturn, readonly ["collectable", "list", "paginated", {
  chainId: string;
  contractAddress: `0x${string}` | undefined;
  side: OrderSide | undefined;
  filter: CollectiblesFilter | undefined;
  ...
  queryFn?: _tanstack_react_query254.QueryFunction<ListCollectiblesReturn, readonly ["collectable", "list", "paginated", {
    chainId: string;
    contractAddress: `0x${string}` | undefined;
    side: OrderSide | undefined;
    filter: CollectiblesFilter | undefined;
...
//# sourceMappingURL=listCollectiblesPaginated.d.ts.map