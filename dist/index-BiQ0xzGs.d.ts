import { Optional, PriceFilter, PropertyFilter as PropertyFilter$1, PropertyType } from "./create-config-CcodGlRp.js";
import { FiltersQueryOptions } from "./filters-3H9v890W.js";
 ...
 * ```
 */
declare function useFilters(params: UseFiltersParams): _tanstack_react_query340.UseQueryResult<PropertyFilter[], Error>;
/**
...
declare function useFiltersProgressive(params: UseFiltersParams): {
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query340.RefetchOptions) => Promise<_tanstack_react_query340.QueryObserverResult<PropertyFilter[], Error>>;
  fetchStatus: _tanstack_react_query340.FetchStatus;
...
//# sourceMappingURL=index-BiQ0xzGs.d.ts.map