import { BuyModalProps, CollectionType, Order, OrderbookKind, TokenMetadata } from "./create-config-Sy3PDbP4.js";
...
declare const ModalProvider: ({
  children
}: ModalProviderProps) => react_jsx_runtime26.JSX.Element;
//#endregion
...
declare function Media({
  ...
  fallbackContent,
  shouldListenForLoad
}: MediaProps): react_jsx_runtime26.JSX.Element;
//#endregion
...
//# sourceMappingURL=index-DfbqPUo1.d.ts.map