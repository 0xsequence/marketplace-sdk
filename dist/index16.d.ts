import { Bn as SearchTokenMetadataReturn, G as Optional, Gn as GetTokenIDRangesResponse, Vn as TokenMetadata$1, Wn as GetTokenBalancesResponse, zn as Page } from "./create-config.js";
 ...
 * ```
 */
declare function useTokenBalances(args: UseListBalancesArgs): _tanstack_react_query130.UseInfiniteQueryResult<_tanstack_react_query130.InfiniteData<GetTokenBalancesResponse, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useTokenMetadata(params: UseTokenMetadataParams): _tanstack_react_query130.UseQueryResult<TokenMetadata$1[], Error>;
//#endregion
...
declare function useTokenMetadataSearch(params: UseTokenMetadataSearchParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query130.FetchNextPageOptions) => Promise<_tanstack_react_query130.InfiniteQueryObserverResult<_tanstack_react_query130.InfiniteData<SearchTokenMetadataReturn, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query130.FetchPreviousPageOptions) => Promise<_tanstack_react_query130.InfiniteQueryObserverResult<_tanstack_react_query130.InfiniteData<SearchTokenMetadataReturn, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query130.RefetchOptions) => Promise<_tanstack_react_query130.QueryObserverResult<_tanstack_react_query130.InfiniteData<SearchTokenMetadataReturn, unknown>, Error>>;
  fetchStatus: _tanstack_react_query130.FetchStatus;
  promise: Promise<_tanstack_react_query130.InfiniteData<SearchTokenMetadataReturn, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
 ...
 * ```
 */
declare function useTokenRanges(params: UseTokenRangesParams): _tanstack_react_query130.UseQueryResult<GetTokenIDRangesResponse, Error>;
