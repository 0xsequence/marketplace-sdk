...
import { i as MarketCollectibleCardProps } from "./types2.js";
import * as _0xsequence_api_client16 from "@0xsequence/api-client";
...
declare function usePrimarySale721CardData({
  ...
  collectibleCards: ({
    ...
    tokenMetadata: {
      ...
      decimals?: number;
      updatedAt?: string;
      assets?: Array<_0xsequence_api_client16.MarketplaceAsset>;
      status: _0xsequence_api_client16.MetadataStatus;
    };
    cardLoading: boolean;
  ...
  isLoading: boolean;
  tokenSuppliesData: _tanstack_react_query53.InfiniteData<_0xsequence_api_client16.GetTokenSuppliesResponse, unknown> | undefined;
};
//#endregion
