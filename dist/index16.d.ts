import { G as SdkConfig, Jr as MetadataStatus, Lt as ContractType, oi as Page$1 } from "./create-config.js";
...
declare function inventoryOptions(args: UseInventoryArgs, config: SdkConfig): _tanstack_react_query301.OmitKeyof<_tanstack_react_query301.UseQueryOptions<CollectiblesResponse, Error, CollectiblesResponse, (string | number)[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query301.QueryFunction<CollectiblesResponse, (string | number)[], never> | undefined;
} & {
