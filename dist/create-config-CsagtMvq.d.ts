...
import * as _tanstack_react_query49 from "@tanstack/react-query";
...
declare const marketplaceConfigOptions: (config: SdkConfig) => _tanstack_react_query49.OmitKeyof<_tanstack_react_query49.UseQueryOptions<MarketplaceConfig, Error, MarketplaceConfig, ("configs" | "marketplace")[]>, "queryFn"> & {
  queryFn?: _tanstack_react_query49.QueryFunction<MarketplaceConfig, ("configs" | "marketplace")[], never> | undefined;
} & {
...
//#endregion
export { Activity, ActivityAction, AddCollectiblesArgs, AddCollectiblesReturn, AdditionalFee, Admin, ApiArgs, ApiConfig, Asset, BaseTransactionParams, BuilderAPI, BuyInput, BuyModalProps, CancelInput, CardType, CheckoutOptions, CheckoutOptionsItem, CheckoutOptionsMarketplaceArgs, CheckoutOptionsMarketplaceOrder, CheckoutOptionsMarketplaceReturn, CheckoutOptionsSalesContractArgs, CheckoutOptionsSalesContractReturn, CollectableId, Collectible, CollectibleCardAction as CollectibleCardAction$1, CollectibleOrder, CollectiblePrimarySaleItem, CollectibleSource, CollectibleStatus, CollectiblesFilter, Collection, CollectionConfig, CollectionFilterSettings, CollectionLastSynced, CollectionPriority, CollectionStatus, CollectionType, ContractType, CreateCollectionArgs, CreateCollectionReturn, CreateCurrenciesArgs, CreateCurrenciesReturn, CreateCurrencyArgs, CreateCurrencyReturn, CreatePrimarySaleContractArgs, CreatePrimarySaleContractReturn, CreateReq, Currency, CurrencyStatus, DEFAULT_NETWORK, DatabeatAnalytics as DatabeatAnalytics$1, DeleteCollectionArgs, DeleteCollectionReturn, DeleteCurrencyArgs, DeleteCurrencyReturn, DeletePrimarySaleContractArgs, DeletePrimarySaleContractReturn, Domain, EcosystemWalletSettings, Env, Event$1 as Event, EventTypes, ExecuteArgs, ExecuteInput, ExecuteReturn, ExecuteType, FeeBreakdown, Fetch, Filter$1 as Filter, FilterCondition, GenerateBuyTransactionArgs, GenerateBuyTransactionReturn, GenerateCancelTransactionArgs, GenerateCancelTransactionReturn, GenerateListingTransactionArgs, GenerateListingTransactionReturn, GenerateOfferTransactionArgs, GenerateOfferTransactionReturn, GenerateSellTransactionArgs, GenerateSellTransactionReturn, GetCollectibleArgs, GetCollectibleHighestListingArgs, GetCollectibleHighestListingReturn, GetCollectibleHighestOfferArgs, GetCollectibleHighestOfferReturn, GetCollectibleLowestListingArgs, GetCollectibleLowestListingReturn, GetCollectibleLowestOfferArgs, GetCollectibleLowestOfferReturn, GetCollectibleReturn, GetCollectionActiveListingsCurrenciesArgs, GetCollectionActiveListingsCurrenciesReturn, GetCollectionActiveOffersCurrenciesArgs, GetCollectionActiveOffersCurrenciesReturn, GetCollectionArgs, GetCollectionDetailArgs, GetCollectionDetailReturn, GetCollectionReturn, GetCountOfAllCollectiblesArgs, GetCountOfAllCollectiblesReturn, GetCountOfAllOrdersArgs, GetCountOfAllOrdersReturn, GetCountOfFilteredCollectiblesArgs, GetCountOfFilteredCollectiblesReturn, GetCountOfFilteredOrdersArgs, GetCountOfFilteredOrdersReturn, GetCountOfListingsForCollectibleArgs, GetCountOfListingsForCollectibleReturn, GetCountOfOffersForCollectibleArgs, GetCountOfOffersForCollectibleReturn, GetCountOfPrimarySaleItemsArgs, GetCountOfPrimarySaleItemsReturn, GetFloorOrderArgs, GetFloorOrderReturn, GetHighestPriceListingForCollectibleArgs, GetHighestPriceListingForCollectibleReturn, GetHighestPriceOfferForCollectibleArgs, GetHighestPriceOfferForCollectibleReturn, GetLowestPriceListingForCollectibleArgs, GetLowestPriceListingForCollectibleReturn, GetLowestPriceOfferForCollectibleArgs, GetLowestPriceOfferForCollectibleReturn, GetOrdersArgs, GetOrdersInput, GetOrdersReturn, GetPrimarySaleItemArgs, GetPrimarySaleItemReturn, InvalidArgumentError, InvalidTierError, ItemsContract, ItemsContractStatus, ListCollectibleActivitiesArgs, ListCollectibleActivitiesReturn, ListCollectibleListingsArgs, ListCollectibleListingsReturn, ListCollectibleOffersArgs, ListCollectibleOffersReturn, ListCollectiblesArgs, ListCollectiblesReturn, ListCollectiblesWithHighestOfferArgs, ListCollectiblesWithHighestOfferReturn, ListCollectiblesWithLowestListingArgs, ListCollectiblesWithLowestListingReturn, ListCollectionActivitiesArgs, ListCollectionActivitiesReturn, ListCollectionsArgs, ListCollectionsReturn, ListCurrenciesArgs, ListCurrenciesReturn, ListListingsArgs, ListListingsForCollectibleArgs, ListListingsForCollectibleReturn, ListListingsReturn, ListOffersArgs, ListOffersForCollectibleArgs, ListOffersForCollectibleReturn, ListOffersReturn, ListOrdersWithCollectiblesArgs, ListOrdersWithCollectiblesReturn, ListPrimarySaleItemsArgs, ListPrimarySaleItemsReturn, ListingInput, MarketCollection$1 as MarketCollection, MarketPage, MarketTransactionParams, Marketplace, MarketplaceConfig, MarketplaceKind, MarketplaceSdkContext as MarketplaceSdkContext$1, MarketplaceSocials, type MarketplaceWallet, MarketplaceWalletOptions, MarketplaceWalletWaasSettings, MetadataFilterRule, MetadataStatus, MethodNotFoundError, ModalCallbacks, NATIVE_TOKEN_ADDRESS as NATIVE_TOKEN_ADDRESS$1, NotFoundError, NotImplementedError, OfferInput, OfferType, Optional, Order, OrderData, OrderFilter, OrderSide, OrderStatus, OrderbookKind, OrdersFilter, PROVIDER_ID as PROVIDER_ID$1, Page$2 as Page, PermissionDeniedError, PostRequest, Price, PriceFilter, PrimarySaleContract, PrimarySaleContractStatus, PrimarySaleItem, PrimarySaleItemDetailType, PrimarySaleItemsFilter, PrimarySaleTransactionParams, PrimarySaleVersion, Project, ProjectLimitReachedError, ProjectNotFoundError, ProjectStatus, PropertyFilter$1 as PropertyFilter, PropertyType, QueryArg, QueryKeyArgs, RequiredKeys, SdkConfig, SellInput, SequenceMarketplace as SequenceMarketplace$1, SessionExpiredError, ShopCollection$1 as ShopCollection, ShopPage, Signature, SortBy, SortOrder, SourceKind, Step, StepType, SupportedMarketplacesArgs, SupportedMarketplacesReturn, SyncCollectionArgs, SyncCollectionReturn, SyncOrderArgs, SyncOrderReturn, SyncOrdersArgs, SyncOrdersReturn, TimeoutError, TokenMetadata$1 as TokenMetadata, Transaction, TransactionCrypto, TransactionNFTCheckoutProvider, TransactionOnRampProvider, TransactionParams, TransactionSteps, TransactionStepsParams, TransactionSwapProvider, TransactionType as TransactionType$2, TransactionType$1 as TransactionType$3, UnauthorizedError, UpdateCollectionArgs, UpdateCollectionReturn, UpdateCurrencyArgs, UpdateCurrencyReturn, UserNotFoundError, ValuesOptional, VersionFromHeader, WalletKind, WebRPCSchemaHash, WebRPCSchemaVersion, WebRPCVersion, WebrpcBadMethodError, WebrpcBadRequestError, WebrpcBadResponseError, WebrpcBadRouteError, WebrpcClientDisconnectedError, WebrpcEndpointError, WebrpcError, WebrpcErrorCodes, WebrpcHeader, WebrpcHeaderValue, WebrpcInternalErrorError, WebrpcRequestFailedError, WebrpcServerPanicError, WebrpcStreamFinishedError, WebrpcStreamLostError, balanceQueries as balanceQueries$1, checkoutKeys as checkoutKeys$1, collectableKeys as collectableKeys$1, collectionKeys as collectionKeys$1, configKeys as configKeys$1, createWagmiConfig, currencyKeys as currencyKeys$1, errors, fetchMarketplaceConfig, getBuilderClient as getBuilderClient$1, getConnectors, getEcosystemConnector, getIndexerClient as getIndexerClient$1, getMarketplaceClient as getMarketplaceClient$1, getMetadataClient as getMetadataClient$1, getProviderEl as getProviderEl$1, getQueryClient as getQueryClient$1, getSequenceApiClient as getSequenceApiClient$1, getWaasConnectors, getWagmiChainsAndTransports, marketplaceApiURL as marketplaceApiURL$1, marketplaceConfigOptions, sequenceApiUrl as sequenceApiUrl$1, tokenKeys as tokenKeys$1, tokenSuppliesKeys as tokenSuppliesKeys$1, useAnalytics as useAnalytics$1, webrpcErrorByCode };
//# sourceMappingURL=create-config-CsagtMvq.d.ts.map