import { Fn as WithOptionalParams, V as CheckoutOptionsItem$1, _n as Optional } from "./create-config.js";
...
import * as _0xsequence_api_client317 from "@0xsequence/api-client";
...
type UsePrimarySaleCheckoutOptionsParams = Optional<WithOptionalParams<PrimarySaleCheckoutOptionsQueryOptions>, 'config' | 'walletAddress'>;
/**
 ...
 * ```
 */
declare function usePrimarySaleCheckoutOptions(params: UsePrimarySaleCheckoutOptionsParams | typeof skipToken): _tanstack_react_query410.UseQueryResult<_0xsequence_api_client317.CheckoutOptionsSalesContractResponse, Error>;
