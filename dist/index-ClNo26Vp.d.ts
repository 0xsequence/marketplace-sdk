import { A as Optional, Ai as TokenMetadata$1, Gn as GetCountOfPrimarySaleItemsReturn, J as MarketplaceSdkContext, Mt as CollectiblePrimarySaleItem, Rr as ListPrimarySaleItemsReturn, Vt as ContractType, Y as SdkConfig, ii as PrimarySaleItem, j as QueryArg, kt as CheckoutOptionsSalesContractReturn, wt as CheckoutOptionsItem } from "./create-config-BdFQXjVv.js";
import { E as CheckoutOptionsSalesContractQueryOptions, S as ComparePricesReturn, _ as ConvertPriceToUSDReturn, g as ConvertPriceToUSDQueryOptions, k as fetchCheckoutOptionsSalesContract, l as CollectiblesResponse, o as ListPrimarySaleItemsQueryOptions, p as UseCountOfPrimarySaleItemsArgs, u as UseInventoryArgs, x as ComparePricesQueryOptions } from "./index-BhFWJz9W.js";
...
declare function useCountOfPrimarySaleItems(args: UseCountOfPrimarySaleItemsArgs): _tanstack_react_query260.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useGetCountOfPrimarySaleItems(params: UseGetCountParams): _tanstack_react_query260.UseQueryResult<GetCountOfPrimarySaleItemsReturn, Error>;
//#endregion
...
declare function useList721ShopCardData({
  ...
  isLoading: boolean;
  tokenSuppliesData: _tanstack_react_query260.InfiniteData<_0xsequence_indexer3.GetTokenSuppliesReturn, unknown> | undefined;
};
//#endregion
...
declare function useInventory(args: UseInventoryArgs): _tanstack_react_query260.UseQueryResult<CollectiblesResponse, Error>;
//#endregion
 ...
 * ```
 */
declare function useCheckoutOptionsSalesContract(params: UseCheckoutOptionsSalesContractParams | typeof skipToken): _tanstack_react_query260.UseQueryResult<CheckoutOptionsSalesContractReturn, Error>;
 ...
 * ```
 */
declare function useComparePrices(params: UseComparePricesParams): _tanstack_react_query260.UseQueryResult<ComparePricesReturn, Error>;
 ...
 * ```
 */
declare function useConvertPriceToUSD(params: UseConvertPriceToUSDParams): _tanstack_react_query260.UseQueryResult<ConvertPriceToUSDReturn, Error>;
...
declare const useEnsureCorrectChain: () => {
  ...
  ensureCorrectChainAsync: (targetChainId: number) => Promise<void | {
    ...
    contracts?: {
      [x: string]: viem31.ChainContract | {
        [sourceId: number]: viem31.ChainContract | undefined;
      } | undefined;
      ensRegistry?: viem31.ChainContract | undefined;
      ensUniversalResolver?: viem31.ChainContract | undefined;
      multicall3?: viem31.ChainContract | undefined;
      erc6492Verifier?: viem31.ChainContract | undefined;
    } | undefined;
    ...
    fees?: viem31.ChainFees<viem31.ChainFormatters | undefined> | undefined;
    formatters?: viem31.ChainFormatters | undefined;
    serializers?: viem31.ChainSerializers<viem31.ChainFormatters | undefined, viem31.TransactionSerializable> | undefined;
  }>;
...
declare const useGetReceiptFromHash: () => {
  waitForReceipt: (transactionHash: Hex) => Promise<viem31.TransactionReceipt>;
};
//#endregion
...
declare function useRoyalty(args: UseRoyaltyArgs): {
  ...
  error: viem31.ReadContractErrorType;
  isError: true;
  isPending: false;
  isLoading: false;
  ...
  failureCount: number;
  failureReason: viem31.ReadContractErrorType | null;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query260.RefetchOptions) => Promise<_tanstack_react_query260.QueryObserverResult<readonly [`0x${string}`, bigint], viem31.ReadContractErrorType>>;
  fetchStatus: _tanstack_react_query260.FetchStatus;
  promise: Promise<readonly [`0x${string}`, bigint]>;
  queryKey: _tanstack_react_query260.QueryKey;
} | {
  data: {
    percentage: bigint;
    recipient: Address;
 ...
 * ```
 */
declare function useListPrimarySaleItems(params: UseListPrimarySaleItemsParams): _tanstack_react_query260.UseInfiniteQueryResult<_tanstack_react_query260.InfiniteData<ListPrimarySaleItemsReturn, unknown>, Error>;
//#endregion
...
//# sourceMappingURL=index-ClNo26Vp.d.ts.map