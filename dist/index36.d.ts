...
import * as _0xsequence_api_client4 from "@0xsequence/api-client";
import "dnum";
...
declare function useMakeOfferModalContext(): {
  ...
  item: {
    ...
    tokenId: bigint;
    orderbookKind: _0xsequence_api_client4.OrderbookKind | undefined;
  };
  tokenId: bigint;
  collectionAddress: `0x${string}`;
  chainId: number;
  collectible: _0xsequence_api_client4.TokenMetadata | undefined;
  collection: _0xsequence_api_client4.ContractInfo | undefined;
  offer: {
    price: {
      input: string;
      amountRaw: bigint;
      currency: _0xsequence_api_client4.Currency | null;
    };
    quantity: {
      input: string;
      parsed: bigint;
  ...
  currencies: {
    available: _0xsequence_api_client4.Currency[];
    selected: _0xsequence_api_client4.Currency | null;
  ...
  error: Error | null;
  queries: {
    collectible: _tanstack_react_query49.UseQueryResult<_0xsequence_api_client4.TokenMetadata, Error>;
    collection: _tanstack_react_query49.UseQueryResult<_0xsequence_api_client4.ContractInfo, Error>;
    currencies: _tanstack_react_query49.UseQueryResult<_0xsequence_api_client4.Currency[], Error>;
    lowestListing: _tanstack_react_query49.UseQueryResult<_0xsequence_api_client4.Order | undefined, Error>;
  };
