 ...
 * ```
 */
declare function useCountItemsOrdersForCollection(params: UseCountItemsOrdersForCollectionParams): _tanstack_react_query330.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCountListingsForCollectible(params: UseCountListingsForCollectibleParams): _tanstack_react_query330.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useCountOffersForCollectible(params: UseCountOffersForCollectibleParams): _tanstack_react_query330.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useFloorOrder(params: UseFloorOrderParams): _tanstack_react_query330.UseQueryResult<CollectibleOrder, Error>;
//#endregion
...
declare function useGetCountOfFilteredOrders(params: UseGetCountOfFilteredOrdersParams): _tanstack_react_query330.UseQueryResult<number, Error>;
//#endregion
 ...
 * ```
 */
declare function useHighestOffer(params: UseHighestOfferParams): _tanstack_react_query330.UseQueryResult<Order | null, Error>;
//#endregion
 ...
 * ```
 */
declare function useListItemsOrdersForCollection(params: UseListItemsOrdersForCollectionParams): _tanstack_react_query330.UseInfiniteQueryResult<_tanstack_react_query330.InfiniteData<ListOrdersWithCollectiblesReturn, unknown>, Error>;
 ...
 * ```
 */
declare function useListItemsOrdersForCollectionPaginated(params: UseListItemsOrdersForCollectionPaginatedParams): _tanstack_react_query330.UseQueryResult<ListOrdersWithCollectiblesReturn, Error>;
 ...
 * ```
 */
declare function useListListingsForCollectible(params: UseListListingsForCollectibleParams): _tanstack_react_query330.UseQueryResult<ListCollectibleListingsReturn, Error>;
 ...
 * ```
 */
declare function useListOffersForCollectible(params: UseListOffersForCollectibleParams): _tanstack_react_query330.UseQueryResult<ListCollectibleOffersReturn, Error>;
