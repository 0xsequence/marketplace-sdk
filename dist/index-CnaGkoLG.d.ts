import { Optional } from "./create-config-DDGnmsgd.js";
import { GetTokenRangesQueryOptions, ListTokenMetadataQueryOptions, SearchTokenMetadataQueryOptions, TokenSuppliesQueryOptions, UseListBalancesArgs, fetchGetTokenRanges } from "./tokenSupplies-DbT2e8U4.js";
 ...
 * ```
 */
declare function useGetTokenRanges(params: UseGetTokenRangesParams): _tanstack_react_query8.UseQueryResult<_0xsequence_indexer0.GetTokenIDRangesReturn, Error>;
 ...
 * ```
 */
declare function useListBalances(args: UseListBalancesArgs): _tanstack_react_query8.UseInfiniteQueryResult<_tanstack_react_query8.InfiniteData<_0xsequence_indexer0.GetTokenBalancesReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useListTokenMetadata(params: UseListTokenMetadataParams): _tanstack_react_query8.UseQueryResult<_0xsequence_metadata0.TokenMetadata[], Error>;
//#endregion
...
declare function useSearchTokenMetadata(params: UseSearchTokenMetadataParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query8.FetchNextPageOptions) => Promise<_tanstack_react_query8.InfiniteQueryObserverResult<_tanstack_react_query8.InfiniteData<_0xsequence_metadata0.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query8.FetchPreviousPageOptions) => Promise<_tanstack_react_query8.InfiniteQueryObserverResult<_tanstack_react_query8.InfiniteData<_0xsequence_metadata0.SearchTokenMetadataReturn, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query8.RefetchOptions) => Promise<_tanstack_react_query8.QueryObserverResult<_tanstack_react_query8.InfiniteData<_0xsequence_metadata0.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchStatus: _tanstack_react_query8.FetchStatus;
  promise: Promise<_tanstack_react_query8.InfiniteData<_0xsequence_metadata0.SearchTokenMetadataReturn, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
 ...
 * ```
 */
declare function useTokenSupplies(params: UseTokenSuppliesParams): _tanstack_react_query8.UseInfiniteQueryResult<_tanstack_react_query8.InfiniteData<_0xsequence_indexer0.GetTokenSuppliesReturn, unknown>, Error>;
//#endregion
...
//# sourceMappingURL=index-CnaGkoLG.d.ts.map