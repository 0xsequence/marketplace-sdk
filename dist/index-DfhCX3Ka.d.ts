import { Optional } from "./create-config-DoEY40YQ.js";
import { GetTokenRangesQueryOptions, ListTokenMetadataQueryOptions, SearchTokenMetadataQueryOptions, TokenSuppliesQueryOptions, UseListBalancesArgs, fetchGetTokenRanges } from "./tokenSupplies-Ca6tdQhm.js";
import * as _tanstack_react_query363 from "@tanstack/react-query";
import * as _0xsequence_indexer22 from "@0xsequence/indexer";
 ...
 * ```
 */
declare function useGetTokenRanges(params: UseGetTokenRangesParams): _tanstack_react_query363.UseQueryResult<_0xsequence_indexer22.GetTokenIDRangesReturn, Error>;
 ...
 * ```
 */
declare function useListBalances(args: UseListBalancesArgs): _tanstack_react_query363.UseInfiniteQueryResult<_tanstack_react_query363.InfiniteData<_0xsequence_indexer22.GetTokenBalancesReturn, unknown>, Error>;
//#endregion
 ...
 * ```
 */
declare function useListTokenMetadata(params: UseListTokenMetadataParams): _tanstack_react_query363.UseQueryResult<_0xsequence_metadata58.TokenMetadata[], Error>;
//#endregion
...
declare function useSearchTokenMetadata(params: UseSearchTokenMetadataParams): {
  ...
  status: "error";
  fetchNextPage: (options?: _tanstack_react_query363.FetchNextPageOptions) => Promise<_tanstack_react_query363.InfiniteQueryObserverResult<_tanstack_react_query363.InfiniteData<_0xsequence_metadata58.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchPreviousPage: (options?: _tanstack_react_query363.FetchPreviousPageOptions) => Promise<_tanstack_react_query363.InfiniteQueryObserverResult<_tanstack_react_query363.InfiniteData<_0xsequence_metadata58.SearchTokenMetadataReturn, unknown>, Error>>;
  hasNextPage: boolean;
  ...
  isStale: boolean;
  isEnabled: boolean;
  refetch: (options?: _tanstack_react_query363.RefetchOptions) => Promise<_tanstack_react_query363.QueryObserverResult<_tanstack_react_query363.InfiniteData<_0xsequence_metadata58.SearchTokenMetadataReturn, unknown>, Error>>;
  fetchStatus: _tanstack_react_query363.FetchStatus;
  promise: Promise<_tanstack_react_query363.InfiniteData<_0xsequence_metadata58.SearchTokenMetadataReturn, unknown>>;
} | {
  isError: boolean;
  error: Error;
  data: undefined;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata58.TokenMetadata[];
    page: _0xsequence_metadata58.Page;
  } | undefined;
  error: Error;
  isError: true;
  isPending: false;
  ...
  data: {
    tokenMetadata: _0xsequence_metadata58.TokenMetadata[];
    page: _0xsequence_metadata58.Page | undefined;
  } | undefined;
  isLoading: boolean;
  isFetching: boolean;
  error: Error | null;
 ...
 * ```
 */
declare function useTokenSupplies(params: UseTokenSuppliesParams): _tanstack_react_query363.UseInfiniteQueryResult<_tanstack_react_query363.InfiniteData<_0xsequence_indexer22.GetTokenSuppliesReturn, unknown>, Error>;
//#endregion
...
//# sourceMappingURL=index-DfhCX3Ka.d.ts.map