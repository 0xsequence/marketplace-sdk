...
const BuyModalContent = () => {
	const chainId = String(use$(buyModal$.order.chainId));
	const collectionAddress = use$(
		buyModal$.order.collectionContractAddress,
	) as Hex;
	const collectibleId = use$(buyModal$.order.tokenId);
	const callbacks = use$(buyModal$.callbacks);
	const order = use$(buyModal$.order);
	const isOpen = use$(buyModal$.isOpen);
