...
const createMarketplaceLogo = (src: string, alt: string) => {
  return function MarketplaceLogo({ alt: altProp, ...props }: MarketplaceLogoProps) {
    return <Image src={src} alt={altProp || alt} {...props}  />;
  };
};

export const AlienSwapLogo = createMarketplaceLogo(AlienSwapLogoSrc, 'AlienSwap Logo');
export const AquaXyzLogo = createMarketplaceLogo(AquaXyzLogoSrc, 'AquaXyz Logo');
...
export const CoinbaseLogo = createMarketplaceLogo(CoinbaseLogoSrc, 'Coinbase Logo');
export const ElementLogo = createMarketplaceLogo(ElementLogoSrc, 'Element Logo');
export const FoundationLogo = createMarketplaceLogo(FoundationLogoSrc, 'Foundation Logo');
export const LooksRareLogo = createMarketplaceLogo(LooksRareLogoSrc, 'LooksRare Logo');
export const MagicEdenLogo = createMarketplaceLogo(MagicEdenLogoSrc, 'MagicEden Logo');
export const ManifoldLogo = createMarketplaceLogo(ManifoldLogoSrc, 'Manifold Logo');
export const MintifyLogo = createMarketplaceLogo(MintifyLogoSrc, 'Mintify Logo');
...
export const OpenSeaLogo = createMarketplaceLogo(OpenSeaLogoSrc, 'OpenSea Logo');
export const RaribleLogo = createMarketplaceLogo(RaribleLogoSrc, 'Rarible Logo');
export const SequenceLogo = createMarketplaceLogo(SequenceLogoSrc, 'Sequence Logo');
export const SudoSwapLogo = createMarketplaceLogo(SudoSwapLogoSrc, 'SudoSwap Logo');
export const SuperRareLogo = createMarketplaceLogo(SuperRareLogoSrc, 'SuperRare Logo');
