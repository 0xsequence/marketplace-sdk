...
const fetchFloorOrder = async (args: UseFloorOrderArgs, config: SdkConfig): Promise<CollectibleOrder> => {
...
export const useFloorOrder = (args: UseFloorOrderArgs): DefinedQueryObserverResult<TData, TError> => {
