...
const UseHighestOfferArgsSchema: z.ZodObject<z.objectUtil.extendShape<Omit<{
...
}>, "strip"> = getCollectibleHighestOfferArgsSchema
	.omit({
...
export const useHighestOffer = (args: UseHighestOfferArgs): DefinedQueryObserverResult<TData, TError> => {
