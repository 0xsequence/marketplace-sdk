...
export type UseListCollectionActivitiesArgs = z.infer<typeof UseListCollectionActivitiesSchema>;

export type UseListCollectionActivitiesReturn = Awaited<ReturnType<typeof fetchListCollectionActivities>>;

const fetchListCollectionActivities = async (args: UseListCollectionActivitiesArgs, config: SdkConfig) => {
...
export const useListCollectionActivities = (args: UseListCollectionActivitiesArgs) => {
