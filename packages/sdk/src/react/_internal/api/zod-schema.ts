...
export const sortOrderSchema: z.ZodNativeEnum<typeof SortOrder> =
	z.nativeEnum(SortOrder);

export const propertyTypeSchema: z.ZodNativeEnum<typeof PropertyType> =
	z.nativeEnum(PropertyType);

export const marketplaceKindSchema: z.ZodNativeEnum<typeof MarketplaceKind> =
	z.nativeEnum(MarketplaceKind);

export const orderbookKindSchema: z.ZodNativeEnum<typeof OrderbookKind> =
	z.nativeEnum(OrderbookKind);

export const sourceKindSchema: z.ZodNativeEnum<typeof SourceKind> =
	z.nativeEnum(SourceKind);

export const orderSideSchema: z.ZodNativeEnum<typeof OrderSide> =
	z.nativeEnum(OrderSide);

export const orderStatusSchema: z.ZodNativeEnum<typeof OrderStatus> =
	z.nativeEnum(OrderStatus);

export const contractTypeSchema: z.ZodNativeEnum<typeof ContractType> =
	z.nativeEnum(ContractType);

export const collectionStatusSchema: z.ZodNativeEnum<typeof CollectionStatus> =
	z.nativeEnum(CollectionStatus);

export const projectStatusSchema: z.ZodNativeEnum<typeof ProjectStatus> =
	z.nativeEnum(ProjectStatus);

export const collectibleStatusSchema: z.ZodNativeEnum<
	typeof CollectibleStatus
> = z.nativeEnum(CollectibleStatus);

export const walletKindSchema: z.ZodNativeEnum<typeof WalletKind> =
	z.nativeEnum(WalletKind);

export const stepTypeSchema: z.ZodNativeEnum<typeof StepType> =
	z.nativeEnum(StepType);

export const transactionCryptoSchema: z.ZodNativeEnum<
	typeof TransactionCrypto
> = z.nativeEnum(TransactionCrypto);

export const transactionNFTCheckoutProviderSchema: z.ZodNativeEnum<
	typeof TransactionNFTCheckoutProvider
> = z.nativeEnum(TransactionNFTCheckoutProvider);

export const transactionOnRampProviderSchema: z.ZodNativeEnum<
	typeof TransactionOnRampProvider
> = z.nativeEnum(TransactionOnRampProvider);

export const transactionSwapProviderSchema: z.ZodNativeEnum<
	typeof TransactionSwapProvider
> = z.nativeEnum(TransactionSwapProvider);

export const executeTypeSchema: z.ZodNativeEnum<typeof ExecuteType> =
	z.nativeEnum(ExecuteType);
...
export const collectiblesFilterSchema: z.ZodObject<
	{
		...
		marketplaces: z.ZodOptional<
			z.ZodArray<z.ZodNativeEnum<typeof MarketplaceKind>, 'many'>
		>;
...
export const checkoutOptionsSchema: z.ZodObject<
	{
		...
		nftCheckout: z.ZodArray<
			z.ZodNativeEnum<typeof TransactionNFTCheckoutProvider>,
			'many'
		>;
		onRamp: z.ZodArray<
			z.ZodNativeEnum<typeof TransactionOnRampProvider>,
			'many'
		>;
	},
	'strip'
		...
		options: z.ZodObject<
			{
				crypto: z.ZodNativeEnum<typeof TransactionCrypto>;
				swap: z.ZodArray<
					z.ZodNativeEnum<typeof TransactionSwapProvider>,
					'many'
				>;
				nftCheckout: z.ZodArray<
					z.ZodNativeEnum<typeof TransactionNFTCheckoutProvider>,
